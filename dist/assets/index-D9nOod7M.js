...
In practice the system proved unreliable. The switch contacts carry the full solenoid current, causing arcing and wear over time. Dirt in the solenoid valves and poor earth connections were further failure points. As a result, the majority of surviving C-V8s have either had the Selectaride removed, replaced with conventional shock absorbers, or — for the dedicated enthusiast — refurbished back to working order. The documentation on this page covers the original Armstrong wiring, community-developed modifications that improve reliability, and the original fitting instructions.`,Te={"mk1-mk2":{title:`Armstrong Selectaride — Mk I & Mk II`,subtitle:`Electrically adjustable shock absorber system — wiring, operation and fitting`,models:[`all`,`mk1`,`mk2`],overview:we,pdf:`/manuals/jensen-cv8-mk1-mk2-selectaride.pdf`,contributors:[{name:`Derek Chapman`,role:`Technical diagrams, wiring documentation & fitting instructions`},{name:`Phillip Coltman`,role:`Technical diagrams & wiring documentation`},{name:`Andreas Kreis`,role:`Original electrical theory (September 2001)`}],sections:[{id:`how-it-works`,title:`How the Selectaride Electrical System Works`,subtitle:`The switching sequence, solenoid activation and the manual memory principle`,page:3,image:`/selectaride/SELECTARIDE-G01.jpg`,tags:[`theory`,`solenoid`,`switching`,`T1–T4`,`S1–S4`,`memory`,`synchronisation`],notes:`The Selectaride system operates as a sequential electro-mechanical memory. Turning the selector switch briefly closes contacts T1, T2, T3 or T4 in turn — each contact closure lasts only a split second, which protects the solenoid coils from overheating.
...
IMPORTANT — the manual memory: if the selector switch is moved with the ignition switched off, the switch position will no longer match the valve positions. To re-synchronise, switch on the ignition and turn the selector through one complete revolution until you can hear the solenoids activate — the system is then back in sync. When operating the selector, never hold the pointer between the indexed positions.`},{id:`wiring-complete`,title:`Complete Wiring Modification Diagram`,subtitle:`Full rewire — Control Switch, LED Display, Relays and Shock Absorbers`,page:1,tags:[`wiring modification`,`control switch`,`relay`,`LED display`,`shock absorber`,`T1–T4`,`S1–S4`],notes:`The complete modified wiring diagram shows the four-position Control Switch (T1–T4) connected via the LED indicator display to two relays, which drive the left and right shock absorber solenoid valves (S1–S4). Wire colours: Red = 12V supply, Black = ground, White/Green/Blue = control signals, Brown = coil feed to solenoids, Yellow = relay output. This modification is strongly recommended — see the External Relay section for why.`},{id:`external-relay`,title:`Optional Modification — External Relay`,subtitle:`Protecting switch contacts from high current — the most important upgrade`,page:2,tags:[`modification`,`relay`,`external relay`,`high current`,`switch contacts`,`coil`,`sparking`,`contact burn`],notes:`The fundamental weakness of the original Selectaride wiring is that the selector switch contacts carry the full solenoid current. Every time a contact closes, a spark occurs. Over time this burns and pits the contact surfaces until the system stops working reliably.
...
This single modification addresses the most common cause of Selectaride failure and is strongly recommended on any car being returned to working order. The original Armstrong system had no such relay — this is a community-developed improvement.`},{id:`overview-1`,title:`General Overview — Part 1`,subtitle:`Block diagram: Control Switch → Wiring Loom → Shock Absorber Electrical Boxes`,page:3,image:`/selectaride/SELECTARIDE-G01.jpg`,tags:[`overview`,`wiring loom`,`control switch`,`shock absorber`,`left`,`right`,`T1–T4`,`S1–S4`],notes:`Simplified block diagram showing how the single Selectaride Control Switch (T1–T4) connects via the wiring loom to two identical Shock Absorber Electrical Boxes — one for the left damper (S1–S4) and one for the right (R1–R4). Each box contains a solenoid coil which, when energised, moves the internal valve to the selected damping rate. Note: S1=R1, S2=R2, S3=R3, S4=R4 — the left and right boxes use identical layouts, labelled differently in the wiring diagrams.`},{id:`overview-2`,title:`General Overview — Part 2`,subtitle:`Detailed views: Control Switch (bottom view) and Shock Absorber Box (top view)`,page:4,image:`/selectaride/SELECTARIDE-G02.jpg`,tags:[`overview`,`rotor`,`bottom view`,`top view`,`S1–S4`,`R1–R4`,`coil`,`ground`],notes:`Shows the physical construction of the Control Switch rotor (bottom view, T1–T4 contacts) and the Shock Absorber Electrical Box (top view, S1–S4 contacts). The rotor design means contacts T1–T4 can only be closed briefly — this is by design to protect the solenoid coils. A contact held closed for longer than a split second risks coil damage from overheating.`},{id:`switching-soft`,title:`Switching Procedure — To Position SOFT`,subtitle:`Rotor and valve positions when moving to the SOFT setting`,page:5,image:`/selectaride/SELECTARIDE-switching-proceedure-0.jpg`,tags:[`switching`,`SOFT`,`rotor`,`T1`,`S1`,`R1`,`valve`,`procedure`],notes:`When turning the selector from position 4 to SOFT, contact T1 briefly closes during rotor travel. Because S1 and R1 are already closed in this position, the solenoid activates and the valve rotates to SOFT. The rotor transition period is critical — worn or dirty contacts may not hold contact long enough to fully activate the solenoid, which is why the system can appear intermittent before failing completely.`},{id:`switching-soft-ab`,title:`Switching Procedure — SOFT Steps A & B`,subtitle:`Before and after: T1 closes (A), then S1/R1 open and S2/R2 close (B)`,page:6,image:`/selectaride/SELECTARIDE-switching-proceedure-1.jpg`,tags:[`switching`,`SOFT`,`T1`,`T2`,`S1`,`S2`,`R1`,`R2`,`procedure`,`step A`,`step B`],notes:`A: While turning from position 4 to SOFT, T1 closes briefly (S1 & R1 already closed) — solenoid fires, valve moves to SOFT. B: After the switch settles at SOFT, S1 & R1 open and S2 & R2 close — the system is now "set" at SOFT and ready for the impulse of T2 when the next selection is made.`},{id:`switching-pos2-cd`,title:`Switching Procedure — Position 2 Steps C & D`,subtitle:`Transitioning from SOFT to position 2: T2 closes, S3/R3 take over`,page:7,image:`/selectaride/SELECTARIDE-switching-proceedure-2.jpg`,tags:[`switching`,`position 2`,`T2`,`T3`,`S2`,`S3`,`R2`,`R3`,`procedure`,`step C`,`step D`],notes:`C: While turning from SOFT to position 2, T2 closes briefly (S2 & R2 already closed) — solenoid fires, valve advances. D: After settling at position 2, S2 & R2 open and S3 & R3 close — ready for T3 when moving to position 3. This sequential stepping is the "memory" — each position physically sets up the next.`},{id:`fitting-instructions`,title:`Fitting Instructions — Jensen C-V8`,subtitle:`Original Armstrong fitting procedure adapted for the C-V8 installation`,page:null,image:null,tags:[`fitting`,`installation`,`control switch`,`wiring harness`,`earth`,`synchronisation`],notes:`SHOCK ABSORBERS: Fit the Selectaride units with the control box on the side pointing towards the centre front of the car. For telescopic-type installations, the units locate naturally on the mountings — the spigotted washer on the special bottom mounting provides angular location not achieved with the original stem-type end.
...
PREPARATION FOR USE: After completing the installation, switch on the ignition and turn the Selectaride selector through one full revolution. This synchronises the selector switch position with the shock absorber valve positions and confirms the installation is working. If the selector is ever moved with the ignition off, repeat this procedure before use.`}]},mk3:{title:`Armstrong Selectaride — Mk III`,subtitle:`Full wiring diagram including Selectaride shock absorber system`,models:[`mk3`],overview:we,pdf:`/manuals/jensen-cv8-mk3-selectaride.pdf`,contributors:[{name:`Derek Chapman`,role:`Technical diagrams, wiring documentation & fitting instructions`},{name:`Phillip Coltman`,role:`Technical diagrams & wiring documentation`},{name:`Andreas Kreis`,role:`Original electrical theory (September 2001)`}],sections:[{id:`mk3-wiring-full`,title:`Mk III Full Wiring Diagram with Selectaride`,subtitle:`Complete wiring diagram showing the Selectaride system integrated into the Mk III loom`,page:1,tags:[`wiring`,`Mk III`,`Selectaride`,`shock absorber`,`full diagram`],notes:`The Mk III wiring diagram showing the full loom including the Selectaride adjustable damper circuit. The Mk III uses a dedicated Selectaride switch on the transmission tunnel (referenced in the Controls & Instruments section of the manual). For how the electrical system works and fitting instructions, refer to the Mk I & II section — the principles and procedure are the same across all marks.`}]}};function Ee(e){return e===`mk3`?Te.mk3:Te[`mk1-mk2`]}var De=[{id:`engine`,label:`Engine`,emoji:`🔧`},{id:`cooling`,label:`Cooling`,emoji:`🌡️`},{id:`fuel`,label:`Fuel System`,emoji:`⛽`},{id:`ignition`,label:`Ignition`,emoji:`⚡`},{id:`electrical`,label:`Electrical`,emoji:`💡`},{id:`brakes`,label:`Brakes`,emoji:`🛑`},{id:`suspension`,label:`Suspension & Steering`,emoji:`⚙️`},{id:`service`,label:`Service Schedule`,emoji:`📋`},{id:`body`,label:`Body & Interior`,emoji:`🚗`}],Oe=[{id:`engine-oil-change`,category:`engine`,title:`Engine Oil & Filter Change`,subtitle:`Sump drain, filter replacement and refill`,models:[`all`],difficulty:`easy`,overview:`The Jensen C-V8 uses a Chrysler 383 cu in V8 engine. The oil and filter should be changed every 4,000 miles or 3 months, whichever comes first. Use SAE 20W/50 multigrade oil. The sump capacity is approximately 8 pints including the filter.`,symptoms:[],tools:[`Drain plug spanner / 9/16" socket`,`Oil filter strap wrench`,`Oil drain tray (at least 9 pint capacity)`,`Funnel`,`Torque wrench`,`Clean rags`],parts:[`Engine oil — SAE 20W/50 multigrade (approx. 8 pints)`,`Replaceable oil filter element`,`Drain plug copper washer (if worn)`],procedure:[`Warm the engine to operating temperature, then switch off and allow 5 minutes for oil to drain back.`,`Place the drain tray beneath the sump drain plug on the underside of the engine.`,`Remove the drain plug using a 9/16" socket and allow the oil to drain completely.`,`Remove the oil filter. On the Mk III the filter is accessible from above; on earlier models access is from below.`,`Wipe the filter seating face clean and smear a little fresh oil on the new filter gasket.`,`Install the new filter — hand tighten only, then a further 3/4 turn with the strap wrench.`,`Refit the drain plug with a new copper washer. Tighten firmly — do not overtighten.`,`Refill with fresh SAE 20W/50 oil through the filler cap on the rocker cover. Add approximately 7 pints initially.`,`Start the engine and run for 2 minutes. Check the filter and drain plug for leaks.`,`Switch off and wait 5 minutes, then check the dipstick. Top up to the MAX mark if required.`,`Reset the oil change reminder and record the mileage.`],checklist:[`Check drain plug is fully tightened and not leaking`,`Check oil filter is tight and dry — no seepage`,`Check oil level is between MIN and MAX on dipstick`,`Check there is no oil on the exhaust — wipe any spillage`,`Record date, mileage and oil brand used`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11]},{label:`Engine Lubrication System`,model:`mk3`,pages:[19]},{label:`Service Lubrication Schedule`,model:`mk3`,pages:[55,56,57,58]}],wiringRef:null},{id:`engine-tune-up`,category:`engine`,title:`Engine Tune-Up`,subtitle:`Spark plugs, contact points, timing and carburetor`,models:[`all`],difficulty:`moderate`,overview:`A full tune-up on the C-V8 covers spark plug renewal, contact breaker point replacement and gap setting, ignition timing and carburetor idle adjustment. This should be carried out every 12,000 miles. The Chrysler 383 uses Champion N10Y plugs with a gap of 0.025".`,symptoms:[`Rough idle or misfiring`,`Poor fuel economy`,`Hard starting, especially when cold`,`Lack of power or hesitation on acceleration`,`Black sooty exhaust smoke`],tools:[`Spark plug spanner (13/16")`,`Feeler gauges`,`Timing light (stroboscope)`,`Screwdrivers (flat and Phillips)`,`Contact breaker point file or fine emery cloth`,`Distributor spanner`],parts:[`Spark plugs — Champion N10Y (set of 8)`,`Contact breaker points`,`Condenser (renew with points)`,`Distributor cap (inspect, replace if cracked)`,`HT leads (inspect)`],procedure:[`Allow the engine to cool before beginning work.`,`Remove and inspect all 8 spark plugs. Note the colour of each — light tan/grey is correct. Black sooty deposits indicate rich mixture; white/blistered indicates overheating.`,`Set plug gap to 0.025" (0.635mm) using feeler gauges. The gauge should drag slightly when pulled through the gap.`,`Refit plugs by hand to avoid cross-threading, then tighten with the plug spanner — firm but do not overtighten.`,`Remove the distributor cap and rotor arm. Inspect the cap for cracks, carbon tracking or corroded contacts.`,`Examine the contact breaker points. If pitted or worn, replace the complete point set and condenser.`,`Set the contact breaker gap to 0.014–0.016" (0.35–0.40mm) using feeler gauges with the rubbing block on the peak of the cam lobe.`,`Refit the rotor arm and cap. Reconnect all HT leads ensuring correct firing order: 1-8-4-3-6-5-7-2.`,`Start the engine and connect the timing light. Static timing should be 5° BTDC; check against specifications for the model.`,`With the engine at idle (600 rpm), check the timing mark on the crankshaft pulley aligns with the correct pointer.`,`Adjust timing if necessary by slackening the distributor clamp bolt and rotating the distributor body until the mark aligns.`,`Tighten the clamp bolt and recheck timing under a blip of throttle to confirm advance is working.`,`Finally, carry out the carburetor idle adjustment procedure.`],checklist:[`Check all 8 plug leads are firmly seated on plugs and distributor cap`,`Check distributor cap for cracks or tracking marks`,`Verify timing mark aligns at idle with timing light`,`Check contact breaker gap with feeler gauge — 0.014–0.016"`,`Confirm idle speed is 600 rpm in neutral`,`Check for smooth throttle response — no flat spots`],manualRefs:[{label:`Specifications & Dimensions`,model:`base`,pages:[5,6]},{label:`Ignition System`,model:`mk3`,pages:[29,30]},{label:`Service Lubrication`,model:`mk3`,pages:[55,56]}],wiringRef:`ignition`},{id:`valve-clearance`,category:`engine`,title:`Valve Clearance Check`,subtitle:`Tappet adjustment on the Chrysler 383 V8`,models:[`all`],difficulty:`advanced`,overview:`Valve clearances (tappet clearances) on the hydraulic-lifter Chrysler 383 are self-adjusting under normal conditions and do not require periodic adjustment. However, if a persistent ticking is heard from the valve train, it may indicate a collapsed or stuck hydraulic lifter. This procedure covers inspection and bleed-down testing.`,symptoms:[`Persistent clicking or ticking from the top of the engine`,`Noise that does not clear after warming up`,`Noise that is speed-related and rhythmic`],tools:[`Rocker cover gasket set`,`Torque wrench`,`Socket set`,`Clean drain tray`,`Engine flush oil (if suspected sludge)`],parts:[`Rocker cover gaskets (set of 2)`,`Hydraulic valve lifters (if defective)`],procedure:[`Allow the engine to cool. Remove both rocker covers after slackening all retaining bolts.`,`With the engine running at idle, observe each rocker arm for excessive movement or obvious lack of tension.`,`A hydraulic lifter that has bled down will show excessive rocker arm travel. A stuck-open lifter will have no movement.`,`If a collapsed lifter is suspected, top up oil to MAX, run the engine at fast idle (1200 rpm) for 5 minutes to allow lifters to pump up.`,`If ticking persists, the suspect lifter must be removed, cleaned or replaced. This requires camshaft access — a workshop job.`,`Before refitting rocker covers, clean all gasket faces and fit new rocker cover gaskets.`,`Refit rocker covers and tighten bolts evenly in a cross pattern to approximately 25 in/lb — do not overtighten.`,`Start the engine and check for oil leaks from rocker cover gaskets.`],checklist:[`Check oil level is at MAX before running engine`,`Check ticking disappears after running at fast idle`,`Check rocker covers are not leaking after refitting`,`Check oil pressure gauge shows normal reading (30–40 psi at idle)`],manualRefs:[{label:`Specifications & Dimensions`,model:`base`,pages:[5,6]},{label:`Engine Lubrication System`,model:`mk3`,pages:[19]}],wiringRef:null},{id:`running-in`,category:`engine`,title:`Running-In Procedure`,subtitle:`New engine and post-rebuild break-in`,models:[`all`],difficulty:`easy`,overview:`The Jensen C-V8 manual specifies a careful running-in procedure for new or rebuilt engines. Varying engine speed during the first 500 miles allows bearing surfaces to bed in correctly. Avoid sustained high speeds and heavy loads until 1,000 miles have been covered.`,symptoms:[],tools:[],parts:[`Engine oil — SAE 20W/50 (for oil change at 500 miles)`,`Oil filter`],procedure:[`For the first 500 miles, do not exceed 50 mph (3,200 rpm). Vary the engine speed frequently — avoid sustained cruising at one speed.`,`Do not use full throttle at any stage during the first 500 miles.`,`Avoid towing or carrying heavy loads during running-in.`,`At 500 miles: drain and refill the engine oil and replace the filter. This removes metallic particles from the initial bed-in.`,`From 500 to 1,000 miles, speed may be gradually increased up to 70 mph. Still avoid sustained full-throttle use.`,`At 1,000 miles: carry out the standard 1,000-mile service — check all fluid levels, tyre pressures and lubrication points.`,`After 1,000 miles the engine can be used normally. Performance will continue to improve up to approximately 5,000 miles.`],checklist:[`Check engine oil level daily during running-in period`,`Check coolant level after first run and again at 200 miles`,`Change oil and filter at 500 miles`,`Record mileage at each check`],manualRefs:[{label:`Starting, Gearbox & Towing`,model:`base`,pages:[7,8,9]},{label:`Starting Up & Running`,model:`mk3`,pages:[15,16,17,18]},{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11]}],wiringRef:null},{id:`overheating-diagnosis`,category:`cooling`,title:`Overheating Diagnosis`,subtitle:`Finding the cause of high coolant temperature`,models:[`all`],difficulty:`moderate`,overview:`Overheating on the C-V8 is most commonly caused by low coolant level, a failed thermostat, a blocked radiator, a broken or slipping fan belt, or a failed water pump. The Mk III uses electric cooling fans in addition to the engine-driven fan. Work through the checks systematically before dismantling anything.`,symptoms:[`Temperature gauge reading in the red sector`,`Steam from under the bonnet`,`Coolant loss or puddles under the car`,`Boiling/bubbling sounds from the engine bay`,`Heater output suddenly hot then cold`],tools:[`Radiator pressure tester`,`Multimeter`,`Hose clamp pliers`,`Torchlight for inspection`],parts:[`Coolant (water + anti-freeze 50/50)`,`Thermostat (82°C)`,`Radiator top and bottom hoses`,`Fan belt`],procedure:[`Do not open the radiator cap when the engine is hot — wait at least 30 minutes after switching off.`,`Check the coolant level in the radiator and header tank. If low, top up and check for leaks.`,`Inspect all hoses and clips for leaks or swelling. Squeeze the hoses — they should feel firm, not spongy or hard.`,`Check the fan belt tension. The belt should have approximately 1/2" (12mm) deflection under moderate finger pressure at the midpoint of the longest run. A slack belt will also squeal under load.`,`Start the engine from cold and observe the temperature gauge. The thermostat should open (gauge rises steadily then stabilises) at approximately 82°C.`,`If the gauge rises continuously to the red zone, suspect a stuck-closed thermostat. Remove and test it in boiling water — it should open fully.`,`Check the electric fans operate (Mk III): they should cut in when the coolant temperature reaches approximately 90°C.`,`With the engine fully warm, feel both radiator hoses. The top hose should be hot; the bottom hose cooler. If both are the same temperature, suspect a blocked radiator.`,`Pressure-test the cooling system using a radiator pressure tester — hold 14 psi for 10 minutes with no drop.`,`If the system loses pressure with no visible external leak, suspect a failed head gasket — look for white exhaust smoke and check for oil in the coolant.`],checklist:[`Check coolant level — cold, with engine off`,`Check fan belt tension — 1/2" deflection at midpoint`,`Check all hose clips are tight`,`Confirm thermostat opens correctly — gauge stabilises`,`Check Mk III electric fans operate when hot`,`Check for white exhaust smoke (possible head gasket)`],manualRefs:[{label:`Cooling, Heating & Rear Axle`,model:`base`,pages:[20,21]},{label:`Cooling System`,model:`mk3`,pages:[31,32]}],wiringRef:`cooling`},{id:`coolant-service`,category:`cooling`,title:`Coolant System Service`,subtitle:`Drain, flush and refill with fresh antifreeze`,models:[`all`],difficulty:`easy`,overview:`The cooling system should be flushed and refilled with fresh antifreeze mixture every 2 years or 20,000 miles. The correct mixture is 50% water and 50% ethylene glycol antifreeze, providing protection to approximately -36°C and raising the boiling point. Total system capacity is approximately 20 pints.`,symptoms:[],tools:[`Drain plug spanner`,`Funnel and measuring jug`,`Hose clamp pliers`,`Hosepipe for flushing`],parts:[`Antifreeze — ethylene glycol (approx. 10 pints)`,`Distilled water (10 pints)`,`Radiator/hose clips if worn`],procedure:[`Allow the engine to cool completely before draining.`,`Place a drain tray beneath the radiator. Remove the bottom hose from the radiator outlet or open the drain tap at the base of the radiator.`,`Remove the radiator filler cap to allow air in and speed draining.`,`Once drained, reconnect the hose or close the drain tap.`,`Flush the system by filling with clean water via the filler and running the engine for 10 minutes with the heater on full heat to flush the heater matrix.`,`Drain the flush water completely.`,`Prepare the coolant mixture: 10 pints of antifreeze plus 10 pints of clean water (distilled or de-ionised preferred).`,`Pour the mixture into the radiator and header/expansion tank slowly to avoid airlocks.`,`Start the engine with the filler cap off and run until the thermostat opens. Top up as the level drops.`,`Refit the filler cap. Check all hoses and clips for leaks after the first drive.`],checklist:[`Check antifreeze concentration with a hydrometer or test strip`,`Check all hose clips are tight after refilling`,`Check coolant level in header tank when cold — should be between MIN and MAX`,`Verify no leaks after first drive`],manualRefs:[{label:`Cooling, Heating & Rear Axle`,model:`base`,pages:[20,21]},{label:`Cooling System`,model:`mk3`,pages:[31,32]}],wiringRef:null},{id:`fan-belt`,category:`cooling`,title:`Fan Belt Inspection & Renewal`,subtitle:`Drive belt condition, tension and replacement`,models:[`all`],difficulty:`easy`,overview:`The fan belt on the C-V8 drives the alternator/dynamo, water pump and cooling fan from the crankshaft pulley. It should be inspected every 4,000 miles. A worn or slipping belt will cause charging failure and overheating. Tension: 1/2" deflection at the midpoint under firm thumb pressure.`,symptoms:[`Battery not charging / ammeter discharging`,`Overheating`,`Squealing from the front of the engine under load`,`Visible fraying, cracking or glazing on the belt`],tools:[`Spanner set`,`Ruler or belt tension gauge`,`Pry bar for tensioning (use carefully)`],parts:[`Fan belt (V-belt — measure old belt if unsure of size)`],procedure:[`With the engine off and cold, press down on the longest run of the fan belt at its midpoint. Correct deflection is approximately 1/2" (12mm) under firm thumb pressure.`,`Inspect the belt for cracks, fraying, glazing (shiny surface) or oil contamination. A glazed belt will slip even if the tension is correct.`,`To replace the belt: slacken the alternator/dynamo pivot bolt and adjuster bolt. Pivot the alternator/dynamo towards the engine to release tension.`,`Slip the old belt off all three pulleys: crankshaft, water pump and alternator/dynamo.`,`Loop the new belt over the crankshaft pulley, then the water pump, then the alternator/dynamo.`,`Pivot the alternator/dynamo outwards to tension the belt. Aim for 1/2" deflection.`,`Tighten the adjuster bolt first, then the pivot bolt.`,`Start the engine and run for 5 minutes. Re-check tension — new belts stretch slightly during the first few minutes of running.`,`Readjust if necessary.`],checklist:[`Check tension — 1/2" deflection mid-span`,`Check belt surface — no cracks, glazing or oil contamination`,`Check all three pulleys are aligned — no edge wear on belt`,`Confirm alternator is charging after replacement`],manualRefs:[{label:`Cooling, Heating & Rear Axle`,model:`base`,pages:[20,21]},{label:`Cooling System`,model:`mk3`,pages:[31,32]}],wiringRef:null},{id:`carb-idle`,category:`fuel`,title:`Carburettor Idle Adjustment`,subtitle:`Carter AFB idle mixture and idle speed setting`,models:[`all`],difficulty:`moderate`,overview:`The Jensen C-V8 is fitted with a Carter AFB (Aluminum Four-Barrel) carburettor. The idle mixture and idle speed screws are accessible from outside the carburettor. The target idle speed is 600 rpm in neutral. The Mk III manual provides detailed adjustment procedures including the secondary throttle and accelerator pump.`,symptoms:[`Rough or unstable idle`,`Engine stalls at idle or when coming to a stop`,`Black smoke from exhaust (rich mixture)`,`Popping on overrun (lean mixture)`,`High fuel consumption`],tools:[`Tachometer / rev counter`,`Flat-bladed screwdriver`,`Vacuum gauge (optional but helpful)`],parts:[],procedure:[`Warm the engine to full operating temperature — at least 10 minutes of running.`,`Locate the idle mixture screws on the carburettor body — there are two, one on each side of the primary throttle body.`,`Turn each mixture screw gently clockwise until it just seats — count and record the number of turns. Do not tighten hard as the tapered tip is easily damaged.`,`Return each screw to the recorded position as a baseline.`,`Adjust the idle speed screw (on the throttle linkage) to give 600 rpm on the tachometer.`,`Turn the first idle mixture screw out (anti-clockwise) by 1/8 turn at a time, pausing after each adjustment to allow the idle to stabilise. The idle speed will rise as mixture improves.`,`Repeat for the second mixture screw. Adjust alternately.`,`Once maximum idle speed is reached, readjust the idle speed screw back to 600 rpm.`,`Fine-tune mixture screws until the smoothest idle at 600 rpm is achieved.`,`Check idle quality with the choke fully off and all electrical loads on (lights, heater).`,`Road test: check for smooth pull-away, no hesitation or rich stumble.`],checklist:[`Check idle speed is 600 rpm in neutral`,`Check engine pulls cleanly from idle without stumble`,`Check choke plate is fully open when engine is hot`,`Check throttle linkage moves freely to full throttle and returns to idle`,`Check air filter is fitted — do not adjust with it removed`],manualRefs:[{label:`Fuel System & Carburettor`,model:`base`,pages:[15,16,17]},{label:`Fuel System & Carburettor`,model:`mk3`,pages:[23,24,25,26,27]}],wiringRef:null},{id:`fuel-filter`,category:`fuel`,title:`Fuel Filter Service`,subtitle:`Inline filter and carburettor inlet strainer`,models:[`all`],difficulty:`easy`,overview:`The C-V8 fuel system has a replaceable fuel filter in the line between the fuel pump and carburettor. There is also a small strainer at the carburettor fuel inlet union. Both should be inspected at 12,000 miles. A blocked filter causes fuel starvation, particularly at high speed.`,symptoms:[`Engine cuts out at high speed or under load`,`Fuel starvation on long climbs`,`Flat spots on acceleration`,`Engine runs well at idle but poorly at speed`],tools:[`Spanners`,`Small drain tray`,`Petrol-resistant gloves`,`Clean cloths`],parts:[`Inline fuel filter`,`Fibre washers for carburettor inlet union`],procedure:[`Ensure ignition is off and the engine is cool. Have a fire extinguisher accessible.`,`Locate the inline fuel filter in the engine bay between the fuel pump and carburettor.`,`Place a small tray under the filter connections to catch spilled fuel.`,`Slacken the hose clips or unions at each end of the filter and remove it.`,`Fit the new filter, observing the flow direction arrow on the body.`,`Tighten the clips or unions firmly.`,`Also remove the fuel inlet union on the carburettor and clean the brass gauze strainer inside with a petrol-dampened cloth.`,`Refit the inlet union with new fibre washers and tighten firmly.`,`Run the engine and check for leaks at both fuel connections.`],checklist:[`Check new filter is fitted in the correct flow direction`,`Check no fuel leaks at filter ends after starting`,`Check carburettor inlet union is tight — no seepage`,`Check engine pulls strongly at full throttle on road test`],manualRefs:[{label:`Fuel System & Carburettor`,model:`base`,pages:[15,16]},{label:`Fuel System & Carburettor`,model:`mk3`,pages:[23,24,25]}],wiringRef:null},{id:`air-cleaner`,category:`fuel`,title:`Air Cleaner Service`,subtitle:`Air filter element replacement and housing clean`,models:[`all`],difficulty:`easy`,overview:`The air cleaner on the C-V8 uses a dry paper element which should be replaced every 12,000 miles or annually, whichever comes first. In dusty conditions more frequent replacement is needed. Never run the engine without the air cleaner fitted.`,symptoms:[`Rich running / black smoke (severely blocked filter)`,`Slightly higher fuel consumption`,`Visible dirt or discolouration on the element`],tools:[`Wing nut spanner or by hand`,`Clean cloths or brush`],parts:[`Air filter element (paper element for Carter AFB)`],procedure:[`Remove the wing nut securing the air cleaner lid.`,`Lift off the lid and extract the paper filter element.`,`Clean the inside of the air cleaner housing with a damp cloth. Do not allow dirt to fall into the carburettor.`,`Tap the old element gently to dislodge loose dust and inspect by holding it up to a light. If blocked or damaged, replace it.`,`Fit the new element and refit the lid and wing nut.`,`Check the crankcase breather hose from the rocker cover to the air cleaner is securely connected.`],checklist:[`Check element is correctly seated in the housing`,`Check lid is secured with wing nut`,`Check crankcase breather hose is connected`,`Check underside of lid for oil deposits — excessive oil indicates crankcase breathing problems`],manualRefs:[{label:`Fuel System & Carburettor`,model:`base`,pages:[15,16]},{label:`Fuel System & Carburettor`,model:`mk3`,pages:[23,24,25,26,27]}],wiringRef:null},{id:`spark-plugs`,category:`ignition`,title:`Spark Plug Service`,subtitle:`Removal, inspection and gap setting`,models:[`all`],difficulty:`easy`,overview:`The C-V8 uses eight Champion N10Y spark plugs (or equivalent) with a gap of 0.025". Plugs should be inspected at 6,000 miles and replaced at 12,000 miles. The plug condition is a valuable diagnostic indicator of engine health.`,symptoms:[`Rough idle or misfire on one or more cylinders`,`Hard starting`,`Poor fuel economy`],tools:[`Spark plug spanner (13/16")`,`Extension bar`,`Feeler gauges or plug gapping tool`,`Torque wrench`,`Wire brush`],parts:[`Spark plugs — Champion N10Y x8 (or NGK BP6ES equivalent)`,`Anti-seize compound (optional)`],procedure:[`Allow the engine to cool — removing plugs from a hot aluminium head can damage threads.`,`Remove HT leads by pulling the boot, not the wire. Label leads if unsure of routing.`,`Clean around each plug with compressed air or a brush before removal to prevent dirt entering the cylinder.`,`Unscrew each plug and examine the firing end.`,`Normal appearance: light tan or grey insulator. Rich: black sooty. Lean: white or blistered. Oily: valve stem seals or rings worn.`,`Clean any serviceable plugs with a wire brush. Do not sandblast as abrasive gets into the engine.`,`Set the gap on new or cleaned plugs to 0.025" (0.635mm). Adjust by bending the outer electrode only.`,`Apply a small amount of anti-seize to the threads of new plugs if the heads are aluminium.`,`Start each plug by hand to avoid cross-threading. Tighten to approximately 25 ft/lb (new plugs) or 15 ft/lb (reused).`,`Refit HT leads ensuring correct firing order: 1-8-4-3-6-5-7-2 (Chrysler 383 firing order).`],checklist:[`Check plug gap is 0.025" — use wire type feeler gauge`,`Check all HT leads are firmly pushed home on plugs`,`Check firing order is correct if leads were removed`,`Check no traces of coolant in any plug bore (possible head gasket leak)`],manualRefs:[{label:`Specifications & Dimensions`,model:`base`,pages:[5,6]},{label:`Ignition`,model:`mk3`,pages:[29,30]}],wiringRef:`ignition`},{id:`contact-breaker`,category:`ignition`,title:`Contact Breaker Points`,subtitle:`Inspection, setting and replacement`,models:[`all`],difficulty:`moderate`,overview:`The distributor uses conventional contact breaker points and a condenser. The contact gap must be set to 0.014–0.016" with the rubbing block on the peak of the distributor cam. Points should be replaced every 12,000 miles and the condenser renewed with them. A worn condenser causes point burning and erratic advance.`,symptoms:[`Engine misfire especially at high speed`,`Difficulty starting`,`Erratic ignition advance (hunting idle)`,`Visible pitting or burning on contact faces`],tools:[`Feeler gauges`,`Screwdrivers`,`Spanner for distributor clamp`,`Low-voltage test light (optional)`],parts:[`Contact breaker point set`,`Condenser`],procedure:[`Remove the distributor cap by unclipping or unscrewing the retaining clips. Set it aside without disconnecting the HT leads.`,`Remove the rotor arm by pulling it straight off.`,`Examine the contact faces. Slight pitting is normal; severe burning or a pip-and-crater pattern means the condenser has failed.`,`To replace: remove the retaining screw and disconnect the condenser wire from the contact set. Lift out the points.`,`Fit the new condenser, routing its wire clear of the rotor arm.`,`Fit the new contact set without tightening the adjustment screw fully.`,`Turn the engine over (by hand or using the starter in short bursts with the ignition off) until the rubbing block rests on a peak of the cam lobe — the points should be at maximum opening.`,`Insert feeler gauge 0.015" into the contact gap. It should be a smooth drag fit. Adjust the contact base plate with the screwdriver slot until correct.`,`Tighten the adjustment screw and recheck the gap — it often moves slightly when tightened.`,`Refit the rotor arm and cap. Set the ignition timing as described in the Ignition Timing card.`],checklist:[`Check contact gap is 0.014–0.016" with rubbing block on cam peak`,`Check condenser wire is clear of rotor arm rotation path`,`Check rotor arm is firmly seated`,`Check cap is clipped or screwed down firmly`,`Verify ignition timing after fitting new points`],manualRefs:[{label:`Specifications & Dimensions`,model:`base`,pages:[5,6]},{label:`Ignition`,model:`mk3`,pages:[29,30]}],wiringRef:`ignition`},{id:`ignition-timing`,category:`ignition`,title:`Ignition Timing`,subtitle:`Static and dynamic timing with a stroboscope`,models:[`all`],difficulty:`moderate`,overview:`Correct ignition timing is critical for performance and preventing detonation (pinking) on the Chrysler 383. The Mk III manual specifies the timing and notes the use of a ballast resistor in the ignition circuit. Dynamic timing should be checked with a stroboscope at 600 rpm idle. The Mk III uses a distributor with vacuum and centrifugal advance.`,symptoms:[`Pinking or detonation under load`,`Lack of power`,`Poor fuel economy`,`Overheating (over-advanced timing causes heat)`,`Hard starting (retarded timing)`],tools:[`Stroboscopic timing light`,`Distributor clamp spanner`,`Tachometer`],parts:[],procedure:[`Locate the timing marks on the crankshaft pulley and the timing cover pointer. Clean them with a cloth and mark them with white paint or chalk for visibility.`,`Connect the timing light to the Number 1 cylinder HT lead (front right on the Chrysler V8) following the timing light manufacturer's instructions.`,`Start the engine and warm to operating temperature.`,`Set idle speed to 600 rpm using the tachometer.`,`Disconnect the vacuum advance pipe from the distributor and plug it.`,`Point the timing light at the crankshaft pulley. The mark should align with the correct notch on the timing scale.`,`Refer to the specifications: the base manual shows timing for Mk I/II; the Mk III manual shows the Mk III specification.`,`If adjustment is needed: slacken the distributor clamp bolt (single bolt at the base of the distributor).`,`Rotate the distributor body slowly — clockwise to retard, anti-clockwise to advance (standing at the front of the car facing the engine).`,`When the timing mark aligns, hold the distributor and tighten the clamp bolt. Recheck timing.`,`Reconnect the vacuum advance pipe. With the vacuum connected the timing mark should advance further — this confirms the vacuum advance is working.`,`Blip the throttle sharply — timing should advance immediately and return to base on release, confirming centrifugal advance.`],checklist:[`Check timing marks are clean and visible`,`Check idle speed is 600 rpm when measuring timing`,`Check vacuum pipe is disconnected during base timing check`,`Confirm centrifugal advance works — timing advances with rpm`,`Confirm vacuum advance works — timing advances when pipe reconnected`,`Check for pinking on road test under load`],manualRefs:[{label:`Specifications & Dimensions`,model:`base`,pages:[5,6]},{label:`Ignition`,model:`mk3`,pages:[29,30]}],wiringRef:`ignition`},{id:`charging-diagnosis`,category:`electrical`,title:`Charging System Diagnosis`,subtitle:`Alternator, dynamo, regulator and battery checks`,models:[`all`],difficulty:`moderate`,overview:`Early C-V8 models (Mk I/II) use a Lucas dynamo and control box. The Mk III uses a Lucas alternator. Both charge through a positive earth system on early cars and negative earth on later ones. The ammeter on the dashboard is a useful diagnostic tool. A discharging reading at speed indicates a charging fault.`,symptoms:[`Ammeter showing constant discharge`,`Battery going flat`,`Warning light not extinguishing after starting`,`Dim lights that fade at idle`,`Battery requiring frequent top-up of water`],tools:[`Multimeter (volts/amps)`,`Test light`,`Cleaning brush and emery cloth`],parts:[`Fan belt (if slipping)`,`Battery (if failed)`,`Brushes for alternator/dynamo`],procedure:[`Check the fan belt tension first — a slipping belt is the most common cause of charging failure.`,`Check battery voltage with the engine off: should be 12.0–12.6V for a charged battery.`,`Start the engine and rev to approximately 2,000 rpm. Battery voltage should rise to 13.8–14.4V for negative earth systems.`,`If voltage does not rise, the fault is in the charging circuit — check the alternator or dynamo output first.`,`Check all connections at the battery terminals, alternator/dynamo and earthing point. Corrosion and loose connections are common.`,`For the Lucas alternator (Mk III): check the warning light circuit — the light itself provides the initial field excitation. If the bulb has blown, the alternator will not charge.`,`Inspect the alternator/dynamo brushes. Worn brushes that no longer make contact will stop charging.`,`On dynamo-equipped cars (Mk I/II): check the voltage regulator control box — contacts may need cleaning. This requires specialist knowledge.`,`Test the battery under load using a battery tester. A battery that cannot hold voltage under load needs replacement.`],checklist:[`Check fan belt is tight and not slipping`,`Check battery terminal connections are clean and tight`,`Check charging voltage is 13.8–14.4V at 2,000 rpm`,`Check charge warning light goes out when engine starts`,`Check earth connections at battery negative and engine block`],manualRefs:[{label:`Electrical Equipment`,model:`base`,pages:[12,13]},{label:`Electrical System`,model:`mk3`,pages:[47,48]}],wiringRef:`charging`},{id:`fuse-identification`,category:`electrical`,title:`Fuse Identification`,subtitle:`Fuse box location, ratings and circuit mapping`,models:[`all`],difficulty:`easy`,overview:`The Jensen C-V8 fuse box is located in the engine compartment. The base manual covers the Mk I/II fuse arrangement; the Mk III has a different fuse layout with different amperage ratings. Always replace a blown fuse with one of the correct rating — fitting a higher-rated fuse can cause wiring fire.`,symptoms:[`Electrical circuit completely dead`,`Lights not working on one circuit`,`Horn, wipers or heater not working`,`Specific accessories dead`],tools:[`Fuse puller or small flat screwdriver`,`Test light or multimeter`],parts:[`Fuse set — various ratings (check the manual for the correct rating for each circuit)`],procedure:[`Locate the fuse box in the engine compartment. On the Mk I/II it is on the bulkhead; on the Mk III it is also near the bulkhead.`,`Identify the blown fuse — it will have a visibly broken wire inside the glass tube. Some failures are only visible when the fuse is removed and held up to the light.`,`Identify the circuit rating from the label on the fuse box cover or the manual before replacing.`,`Before fitting a replacement, use a test light to check for a fault in the circuit — if a new fuse blows immediately there is a short circuit that must be traced.`,`If the circuit is clear, fit a new fuse of the exact same rating.`,`Test the circuit and check the new fuse has not blown.`,`If the fuse blows again, systematically disconnect loads on that circuit until the fault is isolated.`],checklist:[`Check new fuse is the correct amperage rating`,`Check fuse box cover is replaced after work`,`Check circuit functions correctly after replacement`,`Check for the cause if fuse blew unexpectedly — do not just replace repeatedly`],manualRefs:[{label:`Electrical Equipment`,model:`base`,pages:[12,13]},{label:`Electrical System`,model:`mk3`,pages:[47,48]}],wiringRef:null},{id:`headlamp-circuit`,category:`electrical`,title:`Headlamp Circuit`,subtitle:`Bulb replacement, beam alignment and circuit check`,models:[`all`],difficulty:`easy`,overview:`The C-V8 uses sealed-beam headlamps on early models and replaceable bulbs on the Mk III. The Mk III manual details the lighting circuits on pages 49–50. The headlamps are controlled by the lighting switch on the dashboard and the dip switch.`,symptoms:[`One or both headlamps not working`,`Headlamps dim`,`Headlamps not dipping`,`Incorrect beam aim — dazzling oncoming traffic`],tools:[`Phillips and flat screwdrivers`,`Multimeter or test light`],parts:[`Sealed beam unit (Mk I/II) or replacement bulb (Mk III)`,`Dip switch (if faulty)`],procedure:[`If a single headlamp has failed, remove the headlamp rim retaining screws and pull the sealed beam unit forward.`,`Disconnect the wiring plug from the back of the sealed beam and fit the new unit.`,`On the Mk III: the bulb is accessed from behind the headlamp assembly in the engine compartment.`,`If both headlamps fail simultaneously, check the headlamp fuse and the headlamp relay (where fitted).`,`If main beam works but dip does not (or vice versa), suspect the dip switch.`,`Check the earth connections at the headlamp bodies — a poor earth is a common cause of dim lights.`,`Beam alignment: set the headlamps on a level surface 25 feet from a wall. The centre of the dipped beam pattern should be 2 inches below the headlamp centre height.`,`Adjust beam aim using the headlamp adjustment screws — typically one for vertical and one for horizontal.`],checklist:[`Check both headlamps work on main and dipped beam`,`Check sidelights and number plate lights work with headlamps`,`Check earth connections at headlamp bodies`,`Check beam aim is not dazzling oncoming traffic`],manualRefs:[{label:`Electrical Equipment`,model:`base`,pages:[12,13]},{label:`Lights`,model:`mk3`,pages:[49,50]}],wiringRef:`lighting`},{id:`brake-fluid`,category:`brakes`,title:`Brake Fluid & Bleeding`,subtitle:`Fluid change, level check and air bleeding`,models:[`all`],difficulty:`moderate`,overview:`The C-V8 uses a Girling hydraulic brake system with a vacuum servo. Brake fluid must be kept between MIN and MAX in the master cylinder reservoir. Use Girling Crimson or equivalent DOT 3/DOT 4 fluid only. Fluid should be changed every 2 years as it absorbs moisture and lowers the boiling point.`,symptoms:[`Spongy or springy brake pedal`,`Brake pedal goes to the floor`,`Uneven braking — car pulls to one side`,`Brake fluid level dropping without visible leak`],tools:[`Brake bleeding kit (one-man bleed valve or helper)`,`Clear plastic tube and jar`,`Spanner for bleed nipples (usually 7mm)`,`Syringe for drawing down old fluid`],parts:[`Brake fluid — Girling Crimson / DOT 4 (approx. 1 litre)`],procedure:[`Check the fluid level in the master cylinder reservoir — located on the bulkhead in the engine compartment.`,`Ensure the reservoir is full before beginning bleeding.`,`Start bleeding from the wheel furthest from the master cylinder — normally the rear nearside.`,`Fit the bleed tube to the bleed nipple and place the free end in a jar containing a small amount of clean fluid.`,`Slacken the nipple by 1/2 turn. Pump the brake pedal (or use a pressure bleeder) and watch the tube.`,`Continue until no air bubbles appear in the fluid emerging from the bleed nipple.`,`With the pedal held down, tighten the bleed nipple. Release the pedal.`,`Repeat for the rear offside, then front nearside, then front offside.`,`Top up the reservoir with fresh fluid between wheels — never let it run dry.`,`Check pedal feel — it should be firm with no sponginess. If soft, repeat the bleeding sequence.`,`Check all bleed nipples are tightened and no fluid is leaking.`],checklist:[`Check fluid level is between MIN and MAX after bleeding`,`Check all bleed nipples are tight`,`Check pedal is firm — not spongy`,`Check no fluid has been spilt on painted surfaces — clean immediately`,`Check brake servo vacuum hose is connected and sound`],manualRefs:[{label:`Brakes & Servo`,model:`base`,pages:[14]},{label:`Brake Servo Unit`,model:`mk3`,pages:[38]}],wiringRef:null},{id:`brake-adjustment`,category:`brakes`,title:`Brake Adjustment & Servo`,subtitle:`Rear drum adjustment and servo vacuum check`,models:[`all`],difficulty:`moderate`,overview:`The C-V8 has disc brakes at the front and drum brakes at the rear. Rear drums require periodic manual adjustment to compensate for lining wear. The vacuum servo is fed from the inlet manifold and must be working for effective braking. A failed servo results in very heavy pedal effort.`,symptoms:[`Heavy brake pedal requiring excessive force`,`Rear brakes dragging or binding`,`Brake pedal travel excessive`,`Uneven braking rear-to-front`],tools:[`Brake adjuster tool or large flat screwdriver`,`Vacuum gauge`,`Jack and axle stands`],parts:[`Brake servo vacuum hose (if cracked)`],procedure:[`Jack up the rear of the car and support securely on axle stands. Do not work under the car on a jack alone.`,`Locate the adjuster on the rear brake backplate — on each rear wheel.`,`Rotate the adjuster (usually a star wheel accessible through a slot in the backplate) until the drum just drags as you rotate the wheel by hand.`,`Back off the adjuster until the wheel spins freely with only slight drag.`,`Repeat for the other rear brake.`,`Check servo operation: with the engine off, pump the brake pedal several times to exhaust any vacuum reserve. The pedal should be very firm.`,`Hold firm pressure on the pedal and start the engine. The pedal should move slightly towards the floor as the servo vacuum builds — this confirms the servo is working.`,`If pedal does not change with engine running, check the vacuum hose from the inlet manifold to the servo for cracks, kinks or loose connections.`,`Check the non-return valve in the servo vacuum line — it should only allow air to flow one way (towards the engine).`],checklist:[`Check rear wheels spin freely with no drag after adjustment`,`Check pedal assists when engine is started — servo is working`,`Check vacuum hose is firm and not cracked`,`Check handbrake holds car on a gradient after rear adjustment`,`Test brakes at low speed in a safe area before road use`],manualRefs:[{label:`Brakes & Servo`,model:`base`,pages:[14]},{label:`Brake Servo Unit`,model:`mk3`,pages:[38]}],wiringRef:null},{id:`suspension-lubrication`,category:`suspension`,title:`Front Suspension Lubrication`,subtitle:`Grease nipples on wishbones, ball joints and king pins`,models:[`all`],difficulty:`easy`,overview:`The C-V8 front suspension uses double-wishbone geometry. The suspension joints have grease nipples requiring regular lubrication. The Mk III maintenance schedule identifies all lubrication points with letter codes A–J referenced to the lubrication diagram on page 20. All nipples should be greased every 4,000 miles.`,symptoms:[`Clicking or knocking over bumps from the front`,`Vague or wandering steering`,`Wear visible in suspension joints`],tools:[`Grease gun (hand-operated)`,`Correct grease nipple fitting for the gun`,`Wire brush to clean nipples before greasing`,`Jack and axle stands (recommended)`],parts:[`Lithium EP2 grease`],procedure:[`Jack up the front of the car and support on axle stands to take the load off the suspension joints.`,`Identify all grease nipples. Refer to the lubrication diagram in the manual (Mk III: page 20).`,`Clean each nipple with a wire brush before attaching the gun — dirt forced into the joint will cause wear.`,`Attach the grease gun and pump until fresh grease appears at the seal or the joint is firm.`,`Do not over-grease — forcing excessive grease past seals damages them.`,`Lubrication points include: upper and lower wishbone pivots, king pin/ball joints, track rod end ball joints, anti-roll bar drop links.`,`Wipe excess grease from around nipples.`,`Lower the car and check steering movement feels smooth.`],checklist:[`Check all nipples have been greased — tick off against the lubrication diagram`,`Check no nipples are blocked — grease should flow freely`,`Check for split or cracked rubber gaiters on ball joints and track rod ends`,`Check steering feels smooth and consistent lock-to-lock after greasing`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11]},{label:`Maintenance Schedule`,model:`mk3`,pages:[20,21,22]},{label:`Steering & Suspension`,model:`mk3`,pages:[35,36,37]},{label:`Service Lubrication`,model:`mk3`,pages:[55,56,57,58]}],wiringRef:null},{id:`steering-rack`,category:`suspension`,title:`Steering Rack Service`,subtitle:`Rack lubrication, gaiter check and play assessment`,models:[`all`],difficulty:`moderate`,overview:`The C-V8 uses rack and pinion steering. The steering rack requires periodic lubrication and the rubber gaiters must be kept intact to retain lubricant and exclude dirt. Excessive free play in the steering wheel is often traced to worn rack or track rod end joints.`,symptoms:[`Excessive free play at the steering wheel (more than 1" at the rim)`,`Wandering or imprecise steering`,`Clicking from the steering on lock`,`Steering pulling to one side`],tools:[`Spanner set`,`Grease gun`,`Torque wrench`,`Steering wheel play gauge (or ruler)`],parts:[`Steering rack gaiter kit`,`Lithium grease for rack`,`Track rod end (if worn)`],procedure:[`Inspect the steering rack rubber gaiters — one at each end of the rack. They must be intact with no splits, cracks or loose clips.`,`A split gaiter allows water and dirt in, destroying the rack. Replace split gaiters immediately.`,`To assess play: with the car on the ground, rock the steering wheel gently. Movement before the wheels start to turn indicates play in the system.`,`Identify where the play is by having an assistant move the steering wheel while you watch joints under the bonnet and under the car.`,`Track rod end ball joints are the most common wear point — grasp the track rod end and feel for movement in the ball joint.`,`The rack adjustment: some racks have a yoke adjuster screw. Slackening the locknut and tightening the adjuster slightly can remove minor rack play — consult a workshop manual for the specific procedure.`,`Lubricate the rack via the grease nipple if fitted, or by removing a gaiter and applying fresh grease.`],checklist:[`Check both gaiters are intact and clips are tight`,`Check track rod end ball joints for play — replace if worn`,`Measure steering wheel free play — should be less than 1" at rim`,`Check rack mounting bolts are tight`,`Check steering column universal joints are greased and not worn`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11]},{label:`Steering & Suspension`,model:`mk3`,pages:[35,36,37]}],wiringRef:null},{id:`wheel-alignment`,category:`suspension`,title:`Wheel Alignment`,subtitle:`Toe-in check and track rod adjustment`,models:[`all`],difficulty:`advanced`,overview:`Wheel alignment on the C-V8 covers toe-in of the front wheels. The specification is a small amount of toe-in (typically 1/16"–3/32") which provides stable straight-line running. Incorrect toe causes tyre wear (feathering on the inner or outer edges) and can affect handling. Castor and camber are set by the suspension geometry and are not adjustable on most models.`,symptoms:[`Feathered or scrubbed tyre wear on front tyres`,`Car pulling to one side under braking`,`Steering wheel not centred on a straight road`,`Heavy or uneven steering`],tools:[`Toe gauge (trammel bars or optical alignment tool)`,`Tape measure`,`Chalk or tyre pen`,`Track rod end spanner`,`Torque wrench`],parts:[],procedure:[`Alignment is best measured after driving to settle the suspension. Park on level ground.`,`Mark the front tyres at hub height on the inside of the tread — one mark on each tyre at the front of the wheel.`,`Measure the distance between the two marks (the "track" dimension at the front of the wheels).`,`Roll the car forward exactly half a wheel revolution so the marks are now at the rear of the wheels.`,`Measure between the marks again at the rear.`,`Toe-in = rear measurement minus front measurement. Correct specification: 1/16"–3/32" toe-in (front narrower than rear at the mark height).`,`To adjust: slacken the locknut on each track rod end and rotate the track rod (inner tube) to lengthen or shorten the track rod equally on both sides.`,`Rotating the track rod to lengthen it reduces toe-in; shortening increases toe-in.`,`Recheck the measurement after adjustment and when satisfied tighten the locknuts to the specified torque.`,`Always re-check toe after replacing steering or suspension components.`],checklist:[`Check measurement is taken with tyres at correct pressure`,`Check car is on level ground for accurate measurement`,`Check both track rod ends are equally adjusted`,`Check track rod end locknuts are tightened after adjustment`,`Check steering wheel is centred on a straight road after adjustment`],manualRefs:[{label:`Tyres, Wheels & Alignment`,model:`base`,pages:[18,19]},{label:`Steering & Suspension`,model:`mk3`,pages:[35,36,37]}],wiringRef:null},{id:`service-1000`,category:`service`,title:`1,000 Mile Service`,subtitle:`Initial service after delivery or rebuild`,models:[`all`],difficulty:`easy`,overview:`The 1,000 mile service is a critical initial check for new or restored cars. It catches loose fixings, fluid levels settled after initial use, and any bedding-in issues. The Mk III manual details this service on pages 20–22.`,symptoms:[],tools:[`Basic spanner and socket set`,`Torque wrench`,`Grease gun`,`Feeler gauges`,`Tyre pressure gauge`],parts:[`Engine oil top-up if required`,`Coolant top-up if required`,`Grease (EP2)`],procedure:[`Check and top up engine oil to MAX mark on dipstick.`,`Check and top up coolant — refer to coolant service card.`,`Check brake fluid level in master cylinder reservoir.`,`Check clutch fluid level (if hydraulic clutch).`,`Check gearbox and overdrive oil level.`,`Check rear axle oil level.`,`Check all grease nipples on front suspension — grease as required.`,`Check tyre pressures including spare: front 26 psi, rear 26 psi (verify against specifications for loaded/unloaded).`,`Check all wheel nuts are tight — torque to specification.`,`Check battery electrolyte level and terminal security.`,`Check all lights, horn, wipers and washers function.`,`Carry out a road test — check brakes, steering, gearbox change quality and listen for unusual noises.`],checklist:[`Engine oil level checked and correct`,`Coolant level checked and correct`,`Brake fluid level checked`,`Gearbox oil level checked`,`Rear axle oil level checked`,`All suspension nipples greased`,`Tyre pressures correct`,`All wheel nuts tight`,`All lights, horn and wipers working`,`Road test completed with no faults noted`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11]},{label:`Maintenance Schedule`,model:`mk3`,pages:[20,21,22]},{label:`Service Lubrication`,model:`mk3`,pages:[55,56,57,58]}],wiringRef:null},{id:`service-4000`,category:`service`,title:`4,000 Mile Service`,subtitle:`Oil change and comprehensive inspection`,models:[`all`],difficulty:`easy`,overview:`The 4,000 mile service is the regular maintenance interval covering oil change, lubrication of all grease points, and inspection of key systems. The Mk III manual schedules this on pages 20–22 with coded reference to the lubrication diagram.`,symptoms:[],tools:[`Oil drain tools`,`Grease gun`,`Basic spanner set`,`Tyre pressure gauge`,`Torque wrench`],parts:[`Engine oil — SAE 20W/50 (8 pints)`,`Oil filter`,`EP2 grease`],procedure:[`Carry out engine oil and filter change — refer to the Oil & Filter Change card.`,`Grease all front suspension nipples: upper and lower wishbone pivots, king pin or ball joints.`,`Grease steering rack nipple (if fitted), track rod ends.`,`Grease propeller shaft universal joints (front and rear) — 2 nipples on each joint.`,`Grease handbrake cable pivots.`,`Check gearbox and overdrive oil level — top up if required. Capacity: refer to specifications.`,`Check rear axle oil level — top up if required.`,`Check battery electrolyte level — top up individual cells to correct level with distilled water.`,`Inspect and clean battery terminals — apply petroleum jelly to prevent corrosion.`,`Check all tyre pressures and inspect for wear.`,`Check brake fluid level.`,`Inspect coolant level and hose condition.`,`Inspect fan belt condition and tension.`,`Road test and listen for any new noises.`],checklist:[`Engine oil and filter changed`,`All suspension and steering grease points lubricated`,`Propeller shaft universal joints greased`,`Gearbox oil level checked`,`Rear axle oil level checked`,`Battery topped up and terminals clean`,`Tyre pressures correct`,`Fan belt tension correct`,`Brake fluid level correct`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11,25,26,27,28]},{label:`Maintenance Schedule`,model:`mk3`,pages:[20,21,22]},{label:`Service Lubrication`,model:`mk3`,pages:[55,56,57,58]}],wiringRef:null},{id:`service-20000`,category:`service`,title:`20,000 Mile Service`,subtitle:`Full service with tune-up and component renewal`,models:[`all`],difficulty:`moderate`,overview:`The 20,000 mile service is the major service interval covering all 4,000 mile items plus tune-up components, coolant change and a comprehensive inspection of wear items. The Mk III manual details this with G-prefix items on the maintenance schedule pages.`,symptoms:[],tools:[`Full toolkit`,`Timing light`,`Tachometer`,`Compression tester`],parts:[`Spark plugs x8 — Champion N10Y`,`Contact breaker points and condenser`,`Air filter element`,`Fuel filter`,`Engine oil and filter`,`Coolant — antifreeze (10 pints)`,`Gearbox oil (if drain and refill)`,`Rear axle oil (if drain and refill)`],procedure:[`Complete all items on the 4,000 mile service list.`,`Renew all 8 spark plugs — Champion N10Y. Gap: 0.025".`,`Renew contact breaker points and condenser.`,`Set contact breaker gap to 0.015" and check ignition timing.`,`Renew air filter element.`,`Renew inline fuel filter.`,`Drain and refill cooling system with fresh 50/50 antifreeze mixture.`,`Drain and refill gearbox with fresh oil to the correct specification.`,`Drain and refill rear axle with fresh hypoid oil.`,`Carry out a compression test on all 8 cylinders — all should be within 10% of each other and above 130 psi.`,`Inspect all rubber hoses (coolant, vacuum, fuel) and replace any that are swelling, cracking or showing age.`,`Inspect the exhaust system for leaks and corrosion.`,`Inspect brake pads (front discs) for wear — minimum thickness 3mm.`,`Inspect rear brake drum linings through the inspection hole.`,`Carry out a full road test.`],checklist:[`All 4,000 mile items completed`,`Spark plugs renewed and gapped at 0.025"`,`Contact breaker points and condenser renewed`,`Ignition timing set correctly`,`Air filter renewed`,`Fuel filter renewed`,`Coolant drained and refilled`,`Gearbox oil renewed`,`Rear axle oil renewed`,`Compression test — all cylinders within 10%`,`All rubber hoses inspected`,`Brake pad and lining thickness checked`,`Road test completed`],manualRefs:[{label:`Lubrication & Maintenance`,model:`base`,pages:[10,11,25,26,27,28]},{label:`Maintenance Schedule`,model:`mk3`,pages:[20,21,22]},{label:`Service Lubrication`,model:`mk3`,pages:[55,56,57,58]},{label:`Ignition`,model:`mk3`,pages:[29,30]}],wiringRef:null}],ke=[{id:`model-history`,label:`Model History`,emoji:`📋`},{id:`known-issues`,label:`Known Issues`,emoji:`⚠️`},{id:`upgrades`,label:`Upgrades & Modifications`,emoji:`🚀`},{id:`ignition`,label:`Ignition & Electrics`,emoji:`⚡`},{id:`engine`,label:`Engine`,emoji:`🔧`},{id:`fuel`,label:`Fuel System`,emoji:`⛽`},{id:`wheels`,label:`Wheels & Tyres`,emoji:`🛞`},{id:`suspension`,label:`Suspension`,emoji:`⚙️`},{id:`body`,label:`Body & Paint`,emoji:`🎨`},{id:`interior`,label:`Interior`,emoji:`🪑`},{id:`suppliers`,label:`Parts & Suppliers`,emoji:`📦`}],Ae=[{id:`mk1-mk2-mk3-differences`,category:`model-history`,title:`Mk I, Mk II & Mk III — Model Differences & Dating Guide`,subtitle:`How to identify your car, what changed between marks, and a complete chassis number dating reference`,models:[`all`],difficulty:`beginner`,readTime:`8 min read`,tags:[`Mk I`,`Mk II`,`Mk III`,`chassis number`,`dating`,`identification`,`production`,`differences`],contributors:[`Jensen Motors Limited factory records`,`Motor Sport / Autocar production data (published)`],lastUpdated:`2025`,intro:`The Jensen C-V8 was produced in three distinct marks between October 1962 and October 1966, with a total of approximately 500 cars built. While the three marks share the same fundamental fibreglass body and Chrysler V8 architecture, there are meaningful differences in specification, engine, trim and fittings that allow any car to be accurately identified — and dated to within a few months — using the chassis number alone. This guide covers those differences in full, drawing on the original Jensen Motors factory dating records.`,sections:[{type:`heading`,content:`How to Read Your Chassis Number`},{type:`paragraph`,content:`The chassis number is stamped on a plate on the front of the scuttle (firewall) and also on the front cross member of the chassis frame. It takes the form of a three-digit prefix followed by a four-digit sequential number — for example 104/2001 or 112/2315. The prefix encodes both the mark and the gearbox type:`},{type:`table`,headers:[`Prefix`,`Mark`,`Gearbox`,`Production period`],rows:[[`104`,`Mk I & Mk II`,`Automatic`,`Oct 1962 – Jan 1965`],[`105`,`Mk II`,`Manual`,`Oct 1964 – Jul 1965`],[`112`,`Mk III`,`Automatic`,`Jul 1965 – Oct 1966`],[`113`,`Mk III`,`Manual`,`Jul 1965 – Oct 1966`]]},{type:`tip`,content:`A prefix of 104 does not by itself tell you whether you have a Mk I or Mk II — you need to check the sequential number against the dating table below. 104/2001–104/2066 are Mk I; 104/2067 onward are Mk II.`},{type:`heading`,content:`At-a-Glance Model Comparison`},{type:`paragraph`,content:`The table below summarises the key differences between marks. Changes introduced mid-production are noted in the dating table further down.`},{type:`table`,headers:[`Feature`,`Mk I`,`Mk II`,`Mk III`],rows:[[`Production`,`Oct 1962 – Oct 1963`,`Oct 1963 – Jul 1965`,`Jul 1965 – Oct 1966`],[`Chassis prefix (auto)`,`104/2001 – 104/2066`,`104/2067 – 104/2314`,`112/2315 – 112/2493`],[`Chassis prefix (manual)`,`—`,`105/2274 – 105/2298`,`113/2315 – 113/2366`],[`Engine (auto)`,`5916 cc (105 × 86 mm)`,`5916 cc → 6276 cc from 104/2120 (Jan 1964)`,`6276 cc (107.9 × 85.72 mm)`],[`Engine (manual)`,`—`,`5916 cc`,`6276 cc`],[`Gearbox`,`Automatic only`,`Automatic + Manual (from Oct 1964)`,`Automatic + Manual`],[`Overall length`,`15 ft 4¾ in`,`15 ft 4¾ in`,`15 ft 3¾ in (reduced 1 in)`],[`Wheelbase`,`8 ft 9 in`,`8 ft 9 in`,`8 ft 9 in`],[`Width`,`5 ft 7½ in`,`5 ft 7½ in`,`5 ft 7½ in`],[`Headlamps`,`Twin, set diagonally, chrome surround`,`As Mk I`,`Equal size, no chrome surround, set into recess`],[`Front indicators`,`Sidelights on top of wings`,`Sidelights combined with flashers, below headlamps`,`Separate round flashers`],[`Rear lights`,`3 separate round units`,`3 separate round units`,`3 separate round units`],[`Bumpers`,`Standard`,`Standard`,`New section with overriders`],[`Bonnet handle`,`Chrome external handle`,`Lockable button replaces chrome handle (from Oct 1963)`,`Lockable button`],[`Boot lid`,`Moulding in centre`,`Smooth, no moulding`,`Smooth, name on lid, internal hinges`],[`Braking system`,`Single circuit`,`Single circuit`,`Dual circuit (servo-assisted)`],[`Facia / dashboard`,`Standard`,`Standard`,`Redesigned with face-level ventilators`],[`Front seats`,`Standard`,`Standard`,`Fully reclining`],[`Heater outlets`,`Footwell`,`Footwell`,`Extended to rear footwells`],[`Selectaride dampers`,`Not standard`,`Standard (from Oct 1963)`,`Standard`],[`Radio aerial`,`Built into roof`,`External (from 104/2210, Jul 1964)`,`External`],[`Rear demister control`,`Transmission tunnel`,`Moved off tunnel (from 104/2240, Nov 1964)`,`Removed from tunnel`],[`Petrol filler`,`Standard`,`Chrome bead around base (from 104/2240, Nov 1964)`,`Chrome bead around base`],[`Roof & bonnet panel`,`Original pressing`,`Changed from 104/2025 (during Mk I production)`,`As late Mk II`]]},{type:`heading`,content:`Complete Chassis Number Dating Reference`},{type:`paragraph`,content:`The following table is derived from the original Jensen Motors factory dating records. Each entry marks a point in the chassis number sequence where a change was introduced. All cars from that number onward carry the new specification unless noted otherwise.`},{type:`table`,headers:[`Chassis No.`,`Date`,`Event / Change`],rows:[[`104/2001`,`Oct 1962`,`Mk I Saloon introduced. 5916 cc engine, automatic gearbox standard. Resin-bonded fibreglass body, 4 individual seats.`],[`104/2025`,`c.1962–63`,`Roof and bonnet panel pressing changed (applies through to 104/2066).`],[`104/2067`,`Oct 1963`,`Mk II introduced. Sidelights combined with flashers, now below headlamps. Lockable button replaces chrome bonnet handle. Smooth boot lid (no centre moulding). Selectaride rear dampers now standard.`],[`104/2119`,`Jan 1964`,`5916 cc engine discontinued — final chassis with this unit.`],[`104/2120`,`Jan 1964`,`6276 cc (107.9 × 85.72 mm) engine introduced. Suffix "V" added to engine number prefix.`],[`104/2209`,`Jul 1964`,`Bonnet shroud hinge assembly altered.`],[`104/2210`,`Jul 1964`,`Radio aerial changed to external mounting (previously built into roof).`],[`104/2229`,`Sep 1964`,`Door locking handle, assembly and remote control handle redesigned.`],[`104/2240`,`Nov 1964`,`Rear demister control removed from transmission tunnel. Chrome bead added around base of petrol filler.`],[`104/2258`,`Jan 1965`,`Saloon automatic production continues.`],[`105/2274`,`Oct 1964`,`Mk II Manual introduced — body as automatic model.`],[`104/2314`,`Jan 1965`,`Last recorded automatic Mk II date entry before Mk III.`],[`105/2298`,`Jul 1965`,`Mk II Manual discontinued. Final chassis number for manual Mk II.`],[`112/2315`,`Jul 1965`,`Mk III introduced (automatic). Headlamps equal size, no chrome surround, set into recess. New section bumpers with overriders. Separate round flashers. Dual braking system. Redesigned facia with face-level ventilators. Fully reclining front seats. Heater outlets extended to rear footwells. "Jensen" name on boot lid. Internal boot hinges. Overall length reduced by 1 inch.`],[`113/2315`,`Jul 1965`,`Mk III Manual introduced — 6276 cc engine. Otherwise as automatic model.`],[`112/2386`,`Jan 1966`,`Mk III automatic production continues.`],[`113/2336`,`Jan 1966`,`Mk III manual production continues.`],[`113/2366`,`Oct 1966`,`Mk III Manual discontinued. Final chassis number for manual Mk III.`],[`112/2493`,`Oct 1966`,`Mk III discontinued. Final chassis number — end of C-V8 production.`]]},{type:`tip`,content:`Total C-V8 production was approximately 500 cars. Automatic models significantly outnumber manuals — only 25 manual Mk IIs and 52 manual Mk IIIs were built. If you own a manual C-V8, it is a rare car.`},{type:`heading`,content:`Engine Number Identification`},{type:`paragraph`,content:`The engine number is stamped on the left-hand (driver's side) bank of the cylinder block, immediately forward of No. 1 cylinder. Two Chrysler V8 engines were used across the production run:`},{type:`table`,headers:[`Engine`,`Bore × stroke`,`Capacity`,`BHP`,`Fitted from`,`Fitted to`],rows:[[`Chrysler V8 (early)`,`105 × 86 mm`,`5916 cc (361 cu in)`,`305 bhp at 4,800 rpm`,`104/2001 (Oct 1962)`,`104/2119 (Jan 1964)`],[`Chrysler V8 (later)`,`107.9 × 85.72 mm`,`6276 cc (383 cu in)`,`c.330 bhp`,`104/2120 (Jan 1964)`,`112/2493 (Oct 1966)`]]},{type:`paragraph`,content:`The later 6276 cc engine can be identified by the suffix "V" added to the engine number prefix. Compression ratio on both engines was 9:1 in standard form. Firing order: 1–8–4–3–6–5–7–2. Cylinders are numbered R.H. bank front to rear: 2–4–6–8; L.H. bank front to rear: 1–3–5–7.`},{type:`warning`,content:`Engine swaps are common on surviving C-V8s, so the engine number alone cannot confirm originality. The chassis number record (available from Martin Robey, who holds the original Jensen Motors factory documentation) is the definitive source for a car's original specification.`}]},{id:`rear-spring-axle-plate-cracking`,category:`known-issues`,title:`Rear Spring Axle Plate Cracking`,subtitle:`A widely reported structural fault on the C-V8 rear axle — detection, risks and repair options`,models:[`all`],difficulty:`advanced`,readTime:`10 min read`,severity:`critical`,tags:[`rear axle`,`spring plate`,`suspension`,`structural`,`cracking`,`weld`,`known issue`],contributors:[`JOC C-V8 Tech Forum — community discussion 2022–2025`],sourceUrl:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,lastUpdated:`2025`,intro:`Cracking of the rear spring axle mounting plate is a well-documented structural problem on the Jensen C-V8, known to Jensen Motors Limited since the car was new and confirmed as widespread by the current owner community. The fault occurs at the welded steel bracket on the rear axle casing that locates the leaf spring — a critical structural component. Because the failure can result in loss of axle control and directional instability, this issue warrants inspection on any C-V8 being prepared for road use, regardless of mileage or apparent condition.`,sections:[{type:`warning`,content:`This is a safety-critical structural fault. If cracking or deformation is found on one side, assume the opposite bracket is also overloaded and inspect it immediately. Do not drive the car at full throttle until both sides have been inspected and any damage repaired by a competent welder or engineer.`},{type:`heading`,content:`What is the Axle Plate?`},{type:`paragraph`,content:`On most rear-wheel-drive vehicles of the era, the leaf spring is clamped to the axle casing by U-bolts. The Jensen C-V8 uses a different arrangement: a steel bracket is welded directly to the axle casing during manufacture (before the axle end flanges were fitted), and four high-tensile bolts pass through this welded bracket and through a flat plate beneath the leaf spring pack, clamping the spring firmly to the axle. This bracket has two functions: it locates the spring on the axle, and it resists axle wrap — the rotational torque reaction that tries to twist the axle nose upward under hard acceleration, causing the rear springs to adopt an S-shape (commonly called axle tramp).`},{type:`paragraph`,content:`On the left-hand side of the car, the bracket is extended to also provide the lower mounting point for the Panhard rod, which controls lateral movement of the axle. This means the LHS bracket carries additional loads not present on the RHS.`},{type:`heading`,content:`Why It Fails`},{type:`paragraph`,content:`The primary failure point is the 90-degree folded section of the bracket where it transitions from vertical to horizontal. Under the repeated torsional and bending loads imposed by hard acceleration and road surface impacts, this fold is prone to cracking. JML acknowledged the problem in a service bulletin dated 13 July 1966 — before the car had even been in production for three full years — noting that loose anchor bolt nuts were a contributing factor, and introducing an updated bracket with increased thickness.`},{type:`list`,content:[`The original bracket was 1/4" (4/16") thick. JML introduced a revised bracket of 5/16" thickness as a service replacement.`,`If the anchor bolt nuts work loose at any point, the spring can rock on the axle under load, dramatically accelerating fatigue cracking of the bracket.`,`A high-BHP modified C-V8 known to the JOC community tore the bracket completely off the axle casing under hard acceleration — demonstrating the severity of the loads involved.`,`Decades of use mean even the thicker revised bracket can reach the end of its fatigue life on cars that have covered significant mileage or been driven hard.`,`Previous poor repairs — where the bracket has been welded without proper preparation or heat treatment — are common and tend to fail again at the weld or adjacent to it.`]},{type:`heading`,content:`Jensen Service Bulletin — July 1966`},{type:`paragraph`,content:`JML Service Bulletin (13 July 1966, unnumbered) states: "It has been reported from the field that rear-spring to axle anchor bolts have been found loose... This can produce a gradual fracturing of the rear-axle spring mounting plate and we, therefore, recommend the following procedure:"`},{type:`list`,content:[`At 12,000 mile intervals: check torque loading of anchor bolt nuts — 40 lb/ft.`,`If deformation of the rear spring plate is noted: fit the latest assembly, which has an overall thickness of 5/16", an increase of 1/16" on the original specified part.`]},{type:`tip`,content:`The 12,000-mile anchor bolt torque check from the 1966 JML service bulletin is a simple, routine task that should be added to your standard service procedure. 40 lb/ft — use a torque wrench, not a judgement call.`},{type:`heading`,content:`Consequences of Failure`},{type:`list`,content:[`If the bracket fractures while driving, the rear axle is free to move fore and aft under the car, and the body will drop on the affected corner.`,`Uncontrolled axle movement will cause immediate and unpredictable steering deviation — potentially pulling the car sharply to one side.`,`An unconstrained axle nose can twist freely under acceleration, putting the rear leaf springs under extreme S-loading that may cause spring failure.`,`In the worst case, catastrophic propshaft failure is possible if the rear flange angle changes suddenly.`,`The LHS bracket failure additionally compromises Panhard rod geometry, affecting lateral axle location.`]},{type:`heading`,content:`Inspection`},{type:`paragraph`,content:`Inspection requires the car to be raised safely on axle stands or a lift with the rear suspension at ride height. The bracket is visible on the outboard face of the axle casing at each spring location. Look carefully at the 90-degree fold of the bracket, the weld line where the bracket joins the axle casing, and any areas showing paint cracking, rust staining, or surface cracking in the metal. On cars that have had previous repairs, inspect the weld bead carefully — a repair weld that is simply laid over an existing crack without proper preparation will show as a discrete ridge over a visible underlying crack.`},{type:`steps`,content:[`Raise the rear of the car and support on axle stands placed under the chassis — not the axle.`,`With the rear suspension hanging free (unloaded), inspect both spring axle brackets from below.`,`Look for cracking at the 90-degree fold, at the weld line, and in the area adjacent to the brake backing plate.`,`Check for evidence of previous welding repairs — any weld bead that was not there from the factory.`,`With an assistant, gently rock the car from side to side and observe whether any movement exists between the spring and the axle at either bracket location.`,`Check the torque on the four anchor bolt nuts using a torque wrench — correct figure is 40 lb/ft.`,`Repeat for the opposite side — if one side is cracked, the other must be treated as suspect regardless of appearance.`]},{type:`heading`,content:`Repair Options`},{type:`paragraph`,content:`Three approaches have been used by C-V8 owners, ranging from like-for-like repair to a full engineering change. The correct choice depends on the severity of the existing damage and the availability of specialist skills and materials.`},{type:`heading`,content:`Option 1 — Professional Weld Repair and Reinforcement (Recommended)`},{type:`paragraph`,content:`The repair must be done by a competent welder experienced with structural steelwork, not a general body shop. The axle should be removed from the car for bench repair — this allows proper access, correct pre-heating, and avoids the risk of heat-induced scaling inside the axle tube damaging bearings or seals.`},{type:`list`,content:[`Remove the axle from the car. This is also the opportunity to replace the vacuum advance unit, clean and inspect the differential and wheel bearings.`,`The cracked area must be properly prepared — the crack must be fully opened up and cleaned back to sound metal before any weld is laid.`,`Pre-heat the bracket area to near blue/red (approximately 200–300°C) before MIG or TIG welding to achieve a deep, sound fusion weld and reduce the risk of heat cracking in the surrounding material.`,`After repairing the crack, add reinforcing plates front and rear of the bracket to spread the loading. These plates should incorporate clearance holes aligned with the existing spring anchor bolt holes.`,`The repair must not be done in situ on a hot engine with the axle under load — the repair weld will not achieve adequate penetration or fusion.`]},{type:`warning`,content:`The original brackets were welded to the axle casing before the axle end flanges were fitted during manufacture. A complete bracket replacement is therefore not straightforward — you cannot slide a new one over the axle shaft. A replacement bracket would need to be fabricated in two halves and welded in place. For most cases, a properly executed repair with reinforcement is the practical solution.`},{type:`heading`,content:`Option 2 — Jaguar XK150 U-Bolt Conversion`},{type:`paragraph`,content:`One approach suggested by experienced C-V8 engineers is to replace the welded bracket arrangement entirely with a set of U-bolt clamps from the rear axle of a Jaguar XK150, which uses a similar axle diameter. This replaces the fatigue-prone folded bracket with a conventional and robust U-bolt clamping arrangement.`},{type:`list`,content:[`The bump stop pad above the spring seat would need to be removed or relocated.`,`A fabricated saddle plate with curved ends to accept the U-bolt would need to be made for each side.`,`This is a more significant fabrication job but results in a more conventional, robust and maintainable spring-to-axle connection.`,`Compatibility with the Panhard rod mount on the LHS bracket would need to be resolved separately.`]},{type:`heading`,content:`Option 3 — Anti-Tramp Bar Installation (Optional Additional Measure)`},{type:`paragraph`,content:`To reduce the root cause of the stress — axle tramp under acceleration — a 4-link anti-tramp bar set-up can be added. This is a more expensive engineering solution used on higher-powered versions of the car. A simpler and cheaper partial measure is to add a heavy-duty leaf clamp between the spring leaves, reducing the spring S-deflection under acceleration. Neither of these replaces the need to repair the cracked bracket first — they are complementary measures to reduce future recurrence.`},{type:`heading`,content:`Ongoing Maintenance`},{type:`list`,content:[`Following the JML 1966 service bulletin: check and torque the four anchor bolt nuts to 40 lb/ft at every 12,000 mile service interval.`,`Include a visual inspection of both brackets at each service — look for new paint cracking or rust staining at the fold.`,`If any anchor bolt nut is found loose, re-torque it and inspect the bracket carefully for signs of deformation or crack initiation before driving further.`,`After any significant axle removal or rebuild, re-torque the anchor bolts and recheck after the first 500 miles of use.`]},{type:`tip`,content:`This is a known issue across essentially the entire C-V8 production run. If you are buying a C-V8 or preparing one for use after a period of storage, a visual inspection of both rear spring axle brackets should be on the pre-purchase or pre-road checklist regardless of what any previous owner or workshop report says.`}]},{id:`boot-lock-jammed`,category:`known-issues`,title:`Boot Lock — Identification, Jamming & Repair`,subtitle:`Which cars share the boot lock components and how to fix a jammed or seized mechanism`,models:[`mk2`],difficulty:`moderate`,readTime:`6 min read`,severity:null,tags:[`boot lock`,`Volvo P1800`,`Austin Westminster`,`Skandix`,`bodywork`,`known issue`,`Mk II`],contributors:[`JOC C-V8 Tech Forum — community discussion 2025`],sourceUrl:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,lastUpdated:`2025`,intro:`The boot lid lock on the Jensen C-V8 Mk II is a two-part assembly drawing from two different donor cars. When the push button jams or the lock seizes, identifying the correct cross-reference parts is the first challenge — most suppliers will have no idea what a "Jensen C-V8 boot lock" is, but will readily supply Volvo P1800 or Austin Westminster parts.`,sections:[{type:`heading`,content:`What the Boot Lock Is Made From`},{type:`paragraph`,content:`The Mk II C-V8 boot lock assembly consists of two components sourced from different vehicles:`},{type:`list`,content:[`The lock mechanism — push button and barrel assembly: from an Austin Westminster`,`The catch — the striker/receiving mechanism that the lock engages: from a Volvo P1800`]},{type:`tip`,content:`When sourcing parts or asking a locksmith, refer to these donor vehicles rather than asking for "Jensen C-V8 boot lock" — you will get much better results.`},{type:`heading`,content:`Why It Jams`},{type:`paragraph`,content:`The most common failure is the push button jamming and refusing to actuate the lock mechanism. The root cause is the retaining spring on the eccentric latch inside the assembly. The original spring is far too strong — when you press the button, the tang at the bottom (which is only screwed on, not welded) struggles against this spring. Instead of actuating, the tang rotates and the boot becomes permanently locked. This failure has happened to at least one owner mid-journey.`},{type:`paragraph`,content:`On older or high-mileage cars, general wear in the internal mechanism is also a factor — worn alloy components allow internal play before the button actuates, eventually causing the button to jam completely.`},{type:`warning`,content:`If the push button is becoming stiff or requiring extra force, address it before it fails completely. Once the tang rotates and locks, the boot cannot be opened without drilling out the lock. Do not force a stiff button.`},{type:`heading`,content:`Opening a Locked Boot`},{type:`paragraph`,content:`If the boot is already permanently locked, the lock will need to be drilled out. This is destructive but recoverable — the lock can be replaced with Volvo P1800 parts afterwards. A locksmith experienced with vintage car locks may be able to pick it, but drilling is the more reliable option if the mechanism has seized completely.`},{type:`heading`,content:`Parts to Order`},{type:`paragraph`,content:`Volvo P1800 boot lock parts are available new from Skandix AG, a German Volvo parts specialist who ship internationally. Two part numbers cover the lock and receiving catch:`},{type:`parts`,content:[{name:`Volvo P1800 boot lock parts (lock + catch)`,partNumber:`1018982 and 9122128`,notes:`Available from Skandix AG (skandix.de). Total parts cost approximately €29.78; allow additional for shipping and any import duty — total landed cost approximately €75 to the UK.`}]},{type:`heading`,content:`The Spring Fix — Essential After Fitting New Parts`},{type:`paragraph`,content:`Simply fitting new Volvo parts will not prevent the jamming problem recurring if the original spring is reused. The retaining spring on the eccentric latch must be replaced with a weaker spring. This allows the button tang to properly actuate the mechanism without the risk of it rotating instead.`},{type:`steps`,content:[`Source the Volvo P1800 parts from Skandix AG (part numbers 1018982 and 9122128).`,`Before reassembly, identify the retaining spring on the eccentric latch inside the assembly.`,`Replace this spring with one of lighter tension — a spring supplier or engineering shop can match the dimensions with a softer rate.`,`Reassemble and test the push button action — it should actuate smoothly without requiring excessive force.`,`Consider fitting a simple cable as a secondary failsafe, routed inside the boot to a discreet pull handle, in case the mechanism fails again in future.`]},{type:`heading`,content:`Chrome Restoration`},{type:`paragraph`,content:`If the chrome push button surround is worn but otherwise intact, it can be sent for re-chroming without replacing the mechanical parts. The chrome and alloy components can be separated for this purpose. Source new internal mechanical parts from Skandix and re-use the original chrome surround if it is in good condition.`}]},{id:`erratic-speedometer`,category:`known-issues`,title:`Erratic or Fluctuating Speedometer`,subtitle:`Why the speedo needle flickers or bounces — and how to fix it`,models:[`all`],difficulty:`easy`,readTime:`5 min read`,severity:null,tags:[`speedometer`,`speedo cable`,`instruments`,`known issue`,`gearbox`,`TorqueFlite`],contributors:[`JOC C-V8 Tech Forum — community discussion 2026`],sourceUrl:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,lastUpdated:`2026`,intro:`A wildly fluctuating or erratic speedometer needle is a common and long-standing complaint on the Jensen C-V8. The problem is almost always in the mechanical speedometer cable rather than the instrument itself — and in most cases it can be resolved without specialist tools or expensive parts.`,sections:[{type:`heading`,content:`Why It Happens`},{type:`paragraph`,content:`The C-V8 uses a mechanical speedometer driven by a flexible cable from the gearbox. Over time — particularly on cars that see infrequent use — the lubricant inside the cable dries out and the inner cable becomes sticky. As the cable rotates, it binds and slips instead of turning smoothly, causing the needle to flick and bounce erratically. A kinked or sharply bent cable, or a damaged outer sheath, will produce the same symptom.`},{type:`paragraph`,content:`A contributing factor on many C-V8s is the angle at which the cable exits the TorqueFlite automatic gearbox. The natural routing creates a fairly sharp bend at the gearbox end, which puts additional stress on the inner cable. Fitting a right-angle connector at the gearbox end reduces this bend and is a known improvement — though these connectors can themselves wear out internally over time, recreating the problem.`},{type:`heading`,content:`Fix 1 — Clean and Re-lubricate the Cable (Do This First)`},{type:`paragraph`,content:`This is the primary fix and should always be tried before replacing any parts. The key is to use a light oil rather than grease — grease can go sticky with infrequent use, whereas EP 80 or EP 90 rear axle oil stays fluid and coats the cable evenly.`},{type:`steps`,content:[`Disconnect the speedometer cable at both ends — at the speedometer head behind the dashboard and at the gearbox.`,`Pull the inner cable out of the outer sheath completely.`,`Clean the inner cable thoroughly using brake cleaner or white spirit. Wipe dry with a clean cloth.`,`Clean the inside of the outer sheath by running a clean cloth through it or flushing with brake cleaner.`,`Inspect the outer plastic sheath carefully for cracks, splits or missing sections. Tape repairs will not hold — the adhesive dissolves in the oil. A damaged sheath should be replaced.`,`Re-lubricate the inner cable with EP 80 or EP 90 rear axle oil. Work it along the full length.`,`Feed the inner cable back into the outer sheath, ensuring no sharp bends or kinks in the routing.`,`Reconnect at both ends and test.`]},{type:`warning`,content:`Do not use conventional grease inside the cable. Grease becomes sticky on a car used infrequently and will cause the same problem to recur. EP 80/90 rear axle oil is the recommended lubricant.`},{type:`heading`,content:`Fix 2 — Right-Angle Connector at the Gearbox`},{type:`paragraph`,content:`If the cable routing from the TorqueFlite gearbox creates a sharp bend, fitting a right-angle connector at the gearbox end reduces stress on the inner cable and can eliminate the erratic behaviour. These connectors are available from Rimmer Bros and on eBay — however, many eBay listings are for UK cars (Jaguar, Triumph, MG etc.) and may not fit the TorqueFlite gearbox directly. Always confirm fitment before ordering.`},{type:`parts`,content:[{name:`Speedometer cable right-angle gearbox connector`,partNumber:null,notes:`Available from Rimmer Bros — confirm TorqueFlite fitment. Also available on eBay — search for speedometer right-angle connector, but verify dimensions against your gearbox drive before purchasing as many listings are for British Leyland applications.`}]},{type:`tip`,content:`Rimmer Bros stock a suitable connector — see rimmerbros.com (item 120694). Note that right-angle connectors can themselves wear out internally over time. If a previously fitted connector has failed, replace it rather than attempting repair.`},{type:`heading`,content:`Checking the Cable Routing`},{type:`list`,content:[`The cable must have no sharp bends or kinks along its entire length — trace it from gearbox to dashboard and gently re-route any tight sections.`,`Make sure the cable is not trapped or pinched by other components.`,`Where the cable passes through the bulkhead, check the grommet is intact and the cable is not chafing.`,`If the outer sheath has any section of missing or damaged plastic, the sheath must be replaced — tape repairs do not work as the adhesive dissolves in the lubricant.`]},{type:`heading`,content:`When the Speedometer Head Itself is the Problem`},{type:`paragraph`,content:`If cleaning and lubricating the cable makes no improvement, the fault may be in the speedometer instrument itself. The internal mechanism can wear or the magnet can weaken over time. Specialist speedometer repair and calibration services are available and can often restore a worn instrument to correct operation. This is a less common cause but worth considering if cable work has not resolved the issue.`}]},{id:`overheating-diagnosis-and-fixes`,category:`known-issues`,title:`Engine Overheating — Diagnosis & Fixes`,subtitle:`A systematic guide to the most common cooling system problems on the C-V8, drawn from community experience`,models:[`all`],difficulty:`moderate`,readTime:`12 min read`,severity:`critical`,tags:[`overheating`,`cooling`,`radiator`,`thermostat`,`fans`,`water pump`,`known issue`],contributors:[`JOC C-V8 Tech Forum — community discussion 2024`],sourceUrl:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,lastUpdated:`2024`,intro:`Overheating is one of the most frequently reported problems on the Jensen C-V8, particularly on cars that have been off the road, had cooling system work, or been fitted with modern recored radiators. The good news is that overheating on the C-V8 is almost always caused by one or more of a small set of identifiable problems — none of them requiring engine removal. This guide works through each issue systematically, from the simplest to address to the most involved.`,sections:[{type:`warning`,content:`If the temperature gauge is heading toward or into the red, pull over and let the engine cool before investigating. Continuing to drive an overheating engine risks warping the cylinder heads, especially if alloy heads have been fitted. Never remove the radiator cap while the engine is hot.`},{type:`heading`,content:`Is It Actually Overheating?`},{type:`paragraph`,content:`Before spending money on parts, confirm what the engine temperature actually is — not what the dashboard gauge says. The voltage regulator that feeds the instrument cluster can cause the temperature gauge to read high even when the engine is running at a perfectly normal temperature. This is a cheap and common fix. Use an infra-red thermometer on the top hose and thermostat housing to verify the actual coolant temperature before drawing conclusions.`},{type:`tip`,content:`The voltage regulator is inexpensive and easy to replace. If the temperature gauge reads high but the car does not seem to be genuinely hot — top hose pressure is moderate, no steam, fans cycling normally — replace the voltage regulator before doing anything else. It has cured this exact symptom on multiple Jensen owners' cars.`},{type:`heading`,content:`1. Radiator Cap Pressure — Check This First`},{type:`paragraph`,content:`The original C-V8 radiator cap is a 7 lb unit. This is far too low for reliable operation. A low-pressure cap allows coolant to be expelled from the system at a lower temperature than it should be, reducing the coolant volume in the system and causing genuine overheating on the next run. The correct replacement is a 13 lb cap; many owners use 15 lb caps. Check that the cap seats correctly on the radiator neck — if the radiator has been recored or replaced with an Interceptor unit, the neck dimensions may require the neck to be modified to accept the correct cap.`},{type:`list`,content:[`Original 7 lb cap: replace with 13 lb minimum, 15 lb preferred.`,`If the 15 lb cap does not seat firmly on the radiator neck, have the neck modified by a radiator specialist — a poorly seating cap will not hold pressure.`,`A correctly seating cap should require noticeable force to remove once the system is hot.`]},{type:`heading`,content:`2. Electric Fan Setup — The Most Common Root Cause`},{type:`paragraph`,content:`The original Smiths five-blade electric fans fitted to the C-V8 were designed to work with the original open tube-and-fin radiator core. A modern recored radiator has significantly smaller airways that require a much more forceful airflow to cool effectively. If the radiator has been recored and the original fans retained, this mismatch is very likely a primary cause of overheating at low speed and at idle.`},{type:`list`,content:[`Original fans work adequately with original open-core radiators. They are insufficient for modern close-fin recored units.`,`The fan installation must be shrouded — the fans must be mounted directly against the radiator face with a baffle or cowl so that all airflow is drawn through the radiator core, not around it. Fans hanging in free air in the engine bay recirculate air and are largely ineffective.`,`Recommended upgrade: two 12-inch puller fans mounted directly on the radiator in place of the originals, with close-fitting surrounds.`,`Adding push fans in front of the radiator is generally counterproductive — the fan mounts and motor housings reduce the clear radiator area more than the extra airflow helps.`,`Check the direction of fan rotation — fans blowing the wrong way (pushing air forward rather than pulling it rearward through the radiator) will cause overheating. This is easy to overlook after a fan replacement.`,`If retaining the original fans for originality reasons, a modern electronic fan controller that ramps fan speed progressively rather than switching on/off abruptly will improve their effectiveness.`]},{type:`tip`,content:`Use an IR thermometer to draw a heat map across the radiator face while the engine is hot at idle. If the top of the radiator is significantly hotter than the bottom, or if there are cool patches suggesting blocked tubes, the issue is radiator flow rather than fan performance.`},{type:`heading`,content:`3. Fan Temperature Sensor Position`},{type:`paragraph`,content:`The position of the fan temperature sensor critically affects how the fans behave. If the sensor is placed in the top hose (the hottest part of the cooling circuit), the fans will switch on and never switch off — this is not an indication of overheating, it is simply that the top hose is always above the trigger temperature. The factory Otter switch position (in the lower part of the radiator tank, sensing the temperature of cooled water returning to the engine) is the correct location. Sensors in this position cause the fans to cycle on and off normally as the cooled water temperature rises and falls.`},{type:`heading`,content:`4. Thermostat — Type and Condition`},{type:`paragraph`,content:`The thermostat on the C-V8 does not bypass cooling — it restricts coolant flow so that water stays in the radiator long enough to be properly cooled before returning to the engine. Removing the thermostat entirely does NOT help cooling and will typically make the problem worse, because the coolant passes through the radiator too quickly to give up its heat. A standard aftermarket thermostat designed for smaller engines may also restrict flow excessively on the large-capacity 383 V8.`},{type:`list`,content:[`Always use a high-flow thermostat specifically designed for large V8 engines. Standard thermostats have a smaller opening that is inadequate for the 383's coolant flow rate.`,`Test the thermostat before fitting: immerse it in a pan of water heated to the rated opening temperature and confirm it opens fully and promptly.`,`Inspect the thermostat housing for internal corrosion. On older cars, the housing bore can corrode and partially block the coolant path even when the thermostat is open.`,`The correct operating temperature thermostat for the C-V8 is as fitted from the factory — refer to your manual for the specific temperature. Do not fit a cooler-than-standard thermostat as a cooling fix; address the root cause instead.`]},{type:`heading`,content:`5. Water Pump — Impeller Type`},{type:`paragraph`,content:`Many C-V8s still have or have had fitted a water pump with a small pressed-steel impeller. These are significantly less efficient than pumps fitted with a cast impeller at moving the large volume of coolant a big-block V8 requires. Replacing the pump with a high-flow unit with a cast iron impeller has been found to make a meaningful difference to cooling performance. If the cooling system is being worked on for any reason, a high-flow water pump is a worthwhile upgrade.`},{type:`heading`,content:`6. System Flushing — Scale, Rust and Debris`},{type:`paragraph`,content:`After 60 years, the coolant passages in the block and heads of an unrestored C-V8 are likely to contain a significant accumulation of rust, scale, paint flakes and other debris. This restricts coolant flow and reduces heat transfer to the coolant. On cars that have been run without antifreeze, even recently, the system may already contain visible rust particles. A proper chemical flush is an essential first step before any other cooling system diagnosis.`},{type:`list`,content:[`Use a dedicated cooling system flush chemical designed to dissolve rust and scale — a two-part process over multiple days is more effective than a single-flush product for heavily contaminated systems.`,`Drain and flush until the water runs clear before refilling with fresh coolant and antifreeze.`,`Always use coolant with antifreeze even in warm climates — the corrosion inhibitors in antifreeze are as important as its freeze protection.`,`Running without antifreeze will cause new rust to form quickly, turning the coolant brown within days.`,`After flushing, refill with a 50/50 mix of antifreeze and distilled water.`]},{type:`heading`,content:`7. Expansion Tank — The Missing Component`},{type:`paragraph`,content:`The C-V8 was not fitted with an expansion tank from the factory. When the radiator cap vents, expelled coolant is simply lost rather than being retained and drawn back into the system as it cools. This means that any cap venting event (which may simply be normal thermal expansion rather than genuine overheating) leaves the system with less coolant, causing genuine overheating on the next occasion. Fitting an Interceptor-style expansion tank eliminates this problem — the pressure cap is moved to the expansion tank, and expelled coolant is retained and recycled.`},{type:`heading`,content:`8. Head Gaskets — Alloy Head Consideration`},{type:`paragraph`,content:`Cars that have been fitted with aluminium cylinder heads as part of a rebuild may require specific head gaskets different from those used with the original cast iron heads. Using standard modern head gaskets with alloy heads can affect coolant flow between the head and block. Additionally, alloy heads transfer heat to the coolant more rapidly than iron heads when the engine is shut down — this can cause steam or coolant loss immediately after switching off, even on engines that were running at a normal temperature while moving. If alloy heads have been recently fitted and overheating or post-shutdown coolant loss is the primary symptom, verify the correct head gaskets are installed with the engine builder.`},{type:`heading`,content:`Systematic Diagnosis Sequence`},{type:`steps`,content:[`Replace the voltage regulator — cheap, quick, rules out a gauge fault.`,`Verify actual coolant temperature with an IR thermometer before any other work.`,`Replace the radiator cap with a minimum 13 lb unit. Confirm it seats correctly.`,`Check fan rotation direction — they must pull air rearward through the radiator.`,`Confirm fan shrouding — fans must be mounted against the radiator face, not free in the engine bay.`,`Remove and bench-test the thermostat. Replace with a high-flow type if in any doubt.`,`Inspect the thermostat housing bore for corrosion — clean or replace as required.`,`Perform a full chemical flush of the cooling system until the water runs clear.`,`Refill with 50/50 antifreeze/distilled water. Check the system runs up to temperature with fans cycling normally.`,`If still overheating: consider the water pump impeller type; consider fitting an expansion tank.`,`If alloy heads are fitted and symptoms persist: verify correct head gaskets with the engine builder.`]},{type:`tip`,content:`At idle on a warm day, the electric fans should cycle on and off as they maintain temperature just above the thermostat opening point. If the fans run continuously without the temperature stabilising, the system does not have sufficient cooling capacity for idle conditions — almost always a fan or thermostat issue. If the car runs cool on the road but overheats in traffic, it is an idle-speed cooling capacity problem. If it overheats at all speeds, suspect blockage, thermostat, or water pump.`}]},{id:`wheel-dimensions`,category:`wheels`,title:`C-V8 Wheel Dimensions — Critical Specifications`,subtitle:`PCD, width, backspace and centre bore for sourcing replacement or alternative wheels`,models:[`all`],difficulty:`easy`,readTime:`4 min read`,severity:null,tags:[`wheels`,`PCD`,`backspace`,`centre bore`,`Austin Westminster`,`tyres`,`15 inch`,`dimensions`],contributors:[`Jensen C-V8 community — measured from original C-V8 wheels`],lastUpdated:`2025`,intro:`Finding correct replacement wheels for the Jensen C-V8 requires knowing the precise critical dimensions — PCD, rim width, backspace and centre bore. These are not commonly documented in one place, and getting any one of them wrong means the wheel will not fit correctly or safely. The dimensions below have been measured from original C-V8 wheels and are provided as a practical reference for owners sourcing replacements or alternatives.`,sections:[{type:`heading`,content:`Standard C-V8 Wheel Dimensions`},{type:`parts`,content:[{name:`Rim diameter`,partNumber:`15 inch`,notes:`Standard diameter across all C-V8 marks.`},{name:`Rim width`,partNumber:`4.5 inch`,notes:`Standard width of the original C-V8 wheel.`},{name:`PCD (Pitch Circle Diameter)`,partNumber:`5 × 5 inch  /  5 × 127 mm`,notes:`5-stud pattern on a 5-inch (127mm) pitch circle. Both measurements are the same dimension — use whichever your supplier requires.`},{name:`Backspace`,partNumber:`4 3/16 inch  (approx. 106 mm)`,notes:`Measured from the inner lip of the wheel to the mounting face. Critical for ensuring correct clearance with the brake callipers and suspension components.`},{name:`Centre bore`,partNumber:`3 1/8 inch  (approx. 79 mm)`,notes:`Diameter of the centre hole. The wheel must clear the hub/axle flange — if fitting a wheel with a larger centre bore, a hub-centric ring is recommended.`}]},{type:`warning`,content:`Always verify backspace and centre bore against your own car before purchasing wheels. Minor variations can exist between individual cars and marks. The backspace dimension in particular is critical — too little clearance will result in the wheel fouling the brake calliper or suspension.`},{type:`heading`,content:`Factory Tyre Specification`},{type:`list`,content:[`Original specification: Dunlop 6.70 × 15 road speed rating`,`Tyre pressure: 24 psi all round (see manual for laden/unladen notes)`,`Recommended modern equivalent: 205/70-15 — increase pressure by approximately 10% to compensate for the different section width`]},{type:`tip`,content:`The 205/70-15 is the most commonly recommended modern tyre for the C-V8. It is close in overall diameter to the original 6.70 × 15, preserving speedometer accuracy. Wider tyres are possible but may require checking for mudguard clearance.`},{type:`heading`,content:`Cross-Reference: Austin Westminster`},{type:`paragraph`,content:`The original C-V8 wheels are said to share their dimensions with the BMC Austin Westminster, and this cross-reference appears in the wider Jensen community. However, this has not been independently verified by the contributor of these measurements. If you are sourcing Austin Westminster wheels as an alternative, confirm the PCD, backspace and centre bore match against the dimensions above before fitting.`},{type:`paragraph`,content:`The alternative parts list on this site also notes the Rover P5, Vauxhall PA Cresta/Velox and Austin Westminster as potential 15-inch wheel donors, based on the original Eric Christoffersen parts list. Again, physical verification of dimensions is strongly recommended before purchase.`},{type:`heading`,content:`Important Notes When Sourcing Wheels`},{type:`list`,content:[`PCD is the most commonly quoted specification and is easy to verify — use a PCD gauge or measure centre-to-centre between opposite studs and multiply by 1.0515, or measure adjacent studs using standard formulas.`,`Backspace is not the same as offset — backspace is measured from the inner lip; offset is measured from the centre line. Confirm which your supplier is quoting.`,`Centre bore can often be enlarged by a machine shop to fit a hub-centric ring if you find a wheel with correct PCD but slightly wrong bore.`,`Period-correct steel wheels in good condition are increasingly difficult to find. Have any used wheels inspected for cracks or corrosion around the stud holes before fitting.`,`The original lug nuts are a specific thread — confirm compatibility when sourcing period or aftermarket wheels from different vehicles.`]}]},{id:`body-off-procedure`,category:`body`,title:`Removing the Body from the Chassis`,subtitle:`Procedure, fastener locations and hard-won advice from owners who have done it`,models:[`all`],difficulty:`advanced`,readTime:`12 min read`,severity:null,tags:[`body off`,`body removal`,`chassis`,`restoration`,`body-off restoration`,`fasteners`,`body-to-chassis`],contributors:[`Josh Sabah (fastener location diagram)`,`JOC Forum community accounts`],lastUpdated:`2025`,intro:`Removing the fibreglass body from the Jensen C-V8 chassis is one of the most significant steps in a full restoration. It gives full access to the chassis, fuel lines, wiring and structural members — but it requires careful preparation, good documentation and a realistic understanding of what you are taking on. This article combines Josh Sabah's comprehensive body-to-chassis fastener diagram with first-hand accounts from owners who have completed the procedure.`,sections:[{type:`warning`,content:`Body removal is a major, irreversible step. Many fasteners will shear. Filler will be disturbed. Brittle fibreglass cracks easily under uneven stress. Plan carefully, photograph everything, and do not start unless you have the space, time and budget to see it through. Owners have been known to be parted from their cars for over 25 years after starting this process.`},{type:`heading`,content:`Body-to-Chassis Fastener Diagram`},{type:`paragraph`,content:`The diagram below, produced by Josh Sabah, documents every fastener between the body and chassis — its location, type and quantity. Each colour-coded dot corresponds to a specific fastener specification listed in the key. This is the most comprehensive visual reference available for this procedure.`},{type:`images`,content:[{src:`/suspension/body-chassis-connections.jpg`,caption:`Body-to-chassis fastener locations — all fixings mapped by Josh Sabah. Each coloured dot represents a specific fastener type; see key on diagram.`}]},{type:`heading`,content:`Fastener Key`},{type:`list`,content:[`Yellow: 1/4" Flat Phillips machine screw @ hinge (2 per side) with nut`,`Small green: #8 round head × 1 1/4"`,`Large green: 1/4" Round head machine screw × 1" (2 @ bottom of front wheel well)`,`Blue: #8 × 1" round head SM screw (2 @ bottom of rear wheel well)`,`Purple: #10 × 5/8" slot round head machine screw/nut (2 @ each bracket)`,`Dark: #10 hex bolt w/ nut × 3/4" (1 @ each bracket)`,`Teal: 1/4" hex bolt × 1 1/4" w/ nut (8 @ boot)`,`Orange: #6 SS oval SM screw × 7/8" (4 — rocker cover to rocker)`,`Dark orange: #6 SS oval 5/8" sill cover (4 @ top & 4 @ side)`,`Dark red: Round head SM screw × 1 1/4" (6 @ face of body panel)`,`Brown: #10 × 1/2" flat machine screw w/ nut (4 @ centre to heater box)`,`Pink: 1/4" × 1 3/8" flat machine bolt w/ nut (3 @ seat belt)`,`Upper legend — #4 SS oval head Phillips 5/8": 4 @ lower trim & 19 upper`,`Upper legend — #4 SS truss head 5/8": 5 on A-pillar jamb (= 1 on SS trim)`,`Upper legend — #6 SS oval head Phillips 7/8": 3 @ A-pillar & 4 @ rear window bottom`,`Upper legend — #10 × 3/4" round head machine screw w/ Special T-nuts: 9 @ roof`,`Upper legend — #10 flat head Phillips machine screw 7/8" w/ T-nut: 7 @ jamb`,`Right side — #8 round head SM screw 1 1/4": at rear of quarter panel & 2 × 3/4" at front of quarter panel`,`Right side — 10 round machine screw × 3/4" w/ nut: at rear of quarter panel`,`Rectangle (blue-grey): 11 × 1" × 1/8" rubber sheet`]},{type:`heading`,content:`Before You Start — Preparation`},{type:`steps`,content:[`Remove all interior trim and glass including the windscreen. Label everything clearly with masking tape and permanent ink.`,`Remove both doors.`,`Remove the dashboard and wiring harness.`,`Remove the heater box complete — matrix, blower fan, and temperature control (Ranco) valve. Note: a capillary tube passes from the valve through the bulkhead and clips inside the heater box. Do not break it.`,`Check whether the heater air box is still bonded to the body under the windscreen. If so, remove the self-tappers screwing up into it through the top edge of the bulkhead before attempting to lift the body.`,`Remove the bonnet hinges — they screw through the body into brackets on the side frames.`,`Take extensive photographs of everything before disturbing any fastener.`,`Prepare adequate space — you will need at least another car's worth of floor area for the body once removed.`,`Have suitable props ready to support the body off the ground without putting it under stress.`]},{type:`heading`,content:`Locating the Fasteners`},{type:`paragraph`,content:`The fixings are not all obvious. Several are hidden behind trim, under filler, or only accessible once other components are removed. Work through the following systematically:`},{type:`list`,content:[`Cill sections: Bolts screw into captive nuts in the cill side sections. Access is through holes in the tops of the cills, visible once the aluminium kick panels are removed.`,`B-pillars: The body is screwed to the B-pillars. Fasteners are visible once the door lock striker plates and aluminium finishers are removed.`,`A-pillars / windscreen sides: There are 3 hidden screws in each A-pillar at the sides of the windscreen. These have been filled over — lightly sand the inner surface of the A-post and the filler will show as a different colour to the gel coat, revealing the holes.`,`Rear section: A large number of nuts and bolts hold the rear section to the boot floor and rear wheel arches.`,`Side frames: The body is attached to the side frames on the lower edge of the rear side windows as well as over the top. If you wish to leave the side frames attached to the chassis, remove the 40-odd self-tappers securing the frames to the body (visible once rear side windows and chrome trims are removed, both sides).`]},{type:`heading`,content:`Lifting the Body — In One Piece or Cut?`},{type:`paragraph`,content:`There are two schools of thought on how to remove the body once all fixings are released:`},{type:`list`,content:[`Traditional method: Cut through the C-pillars approximately 4 inches up from the top of the rear wings. Jensen Motors themselves did it this way — the body is too large to lift off in one piece in normal conditions.`,`Alternative (one piece): At least one owner has successfully removed the body in one piece by lifting the front (windscreen) end high and sliding it rearward off the chassis. There is enough flex in the fibreglass bodyshell to allow this with two people. Results may vary depending on the condition of the body.`]},{type:`warning`,content:`Be prepared for sheared fasteners. Many Phillips No.1 screwdriver bits will shear. Many bolts will shear. Have plenty of sharp drill bits and small masonry bits for extraction. You will need patience — and possibly stitches.`},{type:`heading`,content:`Practical Tips from Owners`},{type:`list`,content:[`Take more photographs than you think you need — then take more. You will thank yourself six months later when you cannot remember which way a bracket faces.`,`Label every nut, bolt and bracket with masking tape and permanent ink at the moment of removal, not afterwards.`,`The side frames are often in poor condition. If they are, leaving them attached to the chassis makes breaking the joint between the frames and body easier.`,`Work slowly. Fibreglass is brittle, captive nuts strip easily, and haste causes irreversible damage.`,`Have a plan for where the body will live. It needs to be propped securely and not under stress. An improperly stored body will distort over time.`,`Budget for the procedure to take significantly longer than you expect. One contributor to this article was parted from his car for over 25 years after beginning.`]}]},{id:`front-suspension-parts`,category:`suspension`,title:`Front Suspension — Parts, Numbers & Sourcing`,subtitle:`Original BMC part numbers, cross-car applications and sourcing notes for all front suspension components`,models:[`all`],difficulty:`advanced`,readTime:`10 min read`,severity:null,tags:[`front suspension`,`kingpin`,`swivel pin`,`trunnion`,`parts`,`BMC`,`MGB`,`Austin Healey`,`sourcing`],contributors:[`Jensen C-V8 community — compiled from AKD 3520 Mechanical Service Parts List`],lastUpdated:`2025`,intro:`The Jensen C-V8 front suspension uses components shared with, or adapted from, other BMC vehicles — particularly the MGB and Austin-Healey range. This makes sourcing significantly easier than for purely Jensen-specific parts. The table below cross-references every component with its original BMC part number, known alternative applications, and practical sourcing notes. Availability is indicated for each part.`,sections:[{type:`heading`,content:`Parts Diagram — Plate K2 (AKD 3520)`},{type:`paragraph`,content:`The numbered diagram below corresponds to the reference numbers in the parts table. All part numbers are from the AKD 3520 Mechanical Service Parts List, Issue 2.`},{type:`images`,content:[{src:`/suspension/front-suspension-diagram.jpg`,caption:`Front suspension exploded diagram — Plate K2, AKD 3520`},{src:`/suspension/front-suspension-parts-list.jpg`,caption:`Original parts list — AKD 3520`}]},{type:`heading`,content:`Parts List with Sourcing Information`},{type:`tip`,content:`Many parts are shared with the MGB and Austin-Healey BN1–BJ8. Classic car specialists stocking those marques are often the most reliable source. Parts highlighted as unavailable (original BMC number no longer supplied) will need to be sourced from specialists or fabricated.`},{type:`suspensionParts`,availabilityKey:!0,content:[{ref:`1`,description:`Kingpin / Swivel pin`,partNumber:`8G4176`,qty:1,applications:null,availability:`check`,notes:null},{ref:null,description:`Pin — swivel`,partNumber:`NSP`,qty:null,applications:null,availability:`unavailable`,notes:`Not a service part`},{ref:`1`,description:`Kingpin / Swivel pin + bushes (set)`,partNumber:`8G4207`,qty:1,applications:null,availability:`check`,notes:null},{ref:`2`,description:`Axle assembly — LHS`,partNumber:`ATC4242 / 21B253`,qty:1,applications:null,availability:`check`,notes:null},{ref:null,description:`Axle assembly — LHS (Mk II)`,partNumber:`BTC420`,qty:1,applications:null,availability:`check`,notes:`Mk II — possibly bigger bush`},{ref:null,description:`Axle assembly — RHS`,partNumber:`ATC4243 / 21B254`,qty:1,applications:null,availability:`check`,notes:null},{ref:null,description:`Axle assembly — RHS (Mk II)`,partNumber:`BTC421`,qty:1,applications:null,availability:`check`,notes:`Mk II — possibly bigger bush`},{ref:`6`,description:`Bush — top`,partNumber:`ATC4246`,qty:2,applications:`Lower Sprite/Midget · Upper MGB`,availability:`available`,notes:`MGB: Ream top bushing to 0.7815–0.7820"`},{ref:`7`,description:`Bush — bottom`,partNumber:`ATC4247`,qty:2,applications:`MGB lower`,availability:`available`,notes:`MGB: Ream bottom bushing to 0.9075–0.9080"`},{ref:`8`,description:`Lubricator — swivel axle upper`,partNumber:`UHN490`,qty:2,applications:`AH Spares`,availability:`available`,notes:`1/4" UNF, 45° grease nipple`},{ref:`9`,description:`Lubricator — swivel axle lower`,partNumber:`3H3028`,qty:2,applications:null,availability:`available`,notes:`1/4" UNF, 90° grease nipple`},{ref:`11`,description:`Ring — swivel axle (cork)`,partNumber:`ATC4248`,qty:2,applications:null,availability:`possible`,notes:`Possibly MGB 264-940 (o-ring equivalent)`},{ref:`12`,description:`Tube — dust excluder, bottom`,partNumber:`ATC4240`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`13`,description:`Ring — sealing, bottom dust excluder`,partNumber:`21B252`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`14`,description:`Spring — dust excluder`,partNumber:`2K8951`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`15`,description:`Tube — dust excluder, top`,partNumber:`1G4271`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`16`,description:`Washer — thrust`,partNumber:`ATC4264`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`17`,description:`Washer — floating thrust (0.052–0.057")`,partNumber:`ATC4261`,qty:null,applications:`MGB`,availability:`available`,notes:`Select shims to achieve correct clearance — fit minimum 4`},{ref:`17`,description:`Washer — floating thrust (0.058–0.063")`,partNumber:`ATC4262`,qty:null,applications:`MGB`,availability:`available`,notes:null},{ref:`17`,description:`Washer — floating thrust (0.064–0.069")`,partNumber:`ATC4263`,qty:null,applications:`MGB`,availability:`available`,notes:`Note: a seal should be fitted here`},{ref:`18`,description:`Trunnion — suspension link`,partNumber:`ATC4249`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:`19`,description:`Nut — trunnion to swivel pin`,partNumber:`ATC4265`,qty:2,applications:`MGB`,availability:`available`,notes:null},{ref:null,description:`Split pin`,partNumber:`GHF505`,qty:2,applications:`MGB`,availability:`available`,notes:`9/64"`},{ref:`20`,description:`Link — lower, LH front / RH rear`,partNumber:`ACB4067`,qty:2,applications:null,availability:`unavailable`,notes:`Jensen-specific — not available new. Source second-hand.`},{ref:`21`,description:`Link — lower, LH rear / RH front`,partNumber:`ACB4068`,qty:2,applications:null,availability:`unavailable`,notes:`Jensen-specific — not available new. Source second-hand.`},{ref:`22`,description:`Pin — fulcrum, lower link`,partNumber:`1A4788`,qty:2,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`23`,description:`Pin — fulcrum pin (cork)`,partNumber:`1G4505`,qty:4,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`24`,description:`Pin — cotter`,partNumber:`53K1764`,qty:2,applications:`Austin-Healey BN1–BJ8 (alt: 53K1770)`,availability:`healey`,notes:null},{ref:`25`,description:`Nut`,partNumber:`FNZ104`,qty:2,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`26`,description:`Washer — spring`,partNumber:`LWZ204`,qty:2,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`27`,description:`Bush — front link to swivel`,partNumber:`1G4346`,qty:2,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`28`,description:`Bush — rear link to swivel`,partNumber:`1G4348`,qty:2,applications:`Austin-Healey BN1–BJ8`,availability:`healey`,notes:null},{ref:`29`,description:`Lubricator (straight)`,partNumber:`UHN400`,qty:2,applications:`MG Midget · Austin-Healey Sprite`,availability:`available`,notes:`Straight grease nipple`},{ref:`30`,description:`Pin — cotter, link to bush`,partNumber:`1H4071`,qty:4,applications:`Austin-Healey BN1–BJ8 (alt: 1G4350)`,availability:`healey`,notes:`Also: Austin A55/A60, Wolseley 15/60 & 16/60, Riley 4/68 & 4/72, MG Magnette Mk3 & 5`},{ref:`31`,description:`Nut — Nyloc jam nut (comes with 1G4350)`,partNumber:`53K1662`,qty:4,applications:null,availability:`healey`,notes:`5/16-24, thin, fine thread`},{ref:`32`,description:`Lever — steering, left hand`,partNumber:`ATC4250`,qty:1,applications:null,availability:`check`,notes:`Jensen-specific — Jensen part CT633. ATC4250 not same as standard BMC.`},{ref:`33`,description:`Lever — steering, right hand`,partNumber:`ATC4251`,qty:1,applications:null,availability:`check`,notes:`Jensen-specific — Jensen part CT634. ATC4251 not same as standard BMC.`},{ref:`missing`,description:`Seal — top trunnion`,partNumber:null,qty:2,applications:null,availability:`check`,notes:`Not listed in original catalogue — should be present`},{ref:`42`,description:`Wheel bearing — inner`,partNumber:`Timken 07087X`,qty:2,applications:`Austin-Healey BN7–BJ8 (to chassis 26704)`,availability:`available`,notes:`Timken 07087X — widely available`},{ref:`44`,description:`Wheel bearing — outer`,partNumber:`Timken LM67049`,qty:2,applications:null,availability:`available`,notes:`Timken LM67049 — very commonly available`}]},{type:`heading`,content:`Sourcing Summary`},{type:`list`,content:[`MGB parts (green) are readily available from Moss Motors, MGOC Spares, Leacy Classics and most MG specialists worldwide.`,`Austin-Healey parts (yellow) are available from Healey specialists including Moss, AH Spares, and Heritage Motorsports.`,`The lower wishbone links (ACB4067, ACB4068) are Jensen-specific and no longer available new — sourcing from dismantled cars or specialist fabrication is the only route.`,`Jensen steering levers (ATC4250/ATC4251) are different from equivalent BMC parts despite sharing similar part number series — do not substitute without verification.`,`Timken wheel bearings (07087X and LM67049) are standard catalogue bearings available from any bearing supplier.`,`For grease nipples, standard 1/4" UNF fittings in 45° and 90° configurations are available from most fastener suppliers.`]}]},{id:`paint-colours-codes`,category:`body`,title:`Original Paint Colours & Codes`,subtitle:`ICI paint codes, modern equivalents and sourcing notes for all known C-V8 colours`,models:[`all`],difficulty:`easy`,readTime:`6 min read`,severity:null,tags:[`paint`,`paint codes`,`ICI`,`body colour`,`restoration`,`colour matching`],contributors:[`John Staddon (JOC C-V8 Registrar)`,`Tony Marshall`,`David Devine`,`Enda Molloy`,`Norman Paskin`,`Stephen Carter`,`community contributions via JOC Forum`],lastUpdated:`2025`,intro:`Matching or sourcing the correct paint for a Jensen C-V8 restoration requires the original ICI paint codes, which differ from modern supplier catalogues. This reference compiles the known codes for all C-V8 body colours, modern equivalents where identified, and sourcing notes contributed by owners and specialists over many years. Some codes remain unknown — particularly for the rarest colours applied to very few cars.`,sections:[{type:`warning`,content:`Paint codes should always be verified against a physical colour match before committing to a full respray. Batch variations, age and supplier differences mean a code alone does not guarantee an exact match. Where possible, source a test panel first.`},{type:`heading`,content:`Standard & Special Exterior Colours`},{type:`paintTable`,content:[{colour:`Black`,css:`#1a1a1a`,iciCode:`M030-122`,alternative:null,notes:`If same as Jensen Healey Black. Source: David Devine.`},{colour:`Botticelli Blue`,css:`#4a6fa5`,iciCode:`P030-2309 / M049-2309`,alternative:null,notes:`Also given as M049-2309. Source: Tony Marshall, JOCF 16.04.2006.`},{colour:`Oyster Grey`,css:`#b8b0a4`,iciCode:`M031-2116`,alternative:`Aston Martin Oyster Shell Metallic (possibly)`,notes:`Full ICI name: "Metallichrome Oyster Grey".`},{colour:`Californian Sage`,css:`#7a8c5e`,iciCode:`M031-2629`,alternative:`Aston Martin Californian Sage · DuPont A1338`,notes:`Same as Aston Martin Californian Sage. DuPont Color Code: A1338.`},{colour:`Regal Red`,css:`#8b1c1c`,iciCode:`P031-2394 / P031-2132`,alternative:`Rolls-Royce Regal Red (part no. 9500406) · M035-2642`,notes:`Multiple codes recorded. Source: Enda Molloy (restoring 2147).`},{colour:`Carmine`,css:`#960018`,iciCode:`M030-9039`,alternative:null,notes:`If same as Jensen Healey Carmine. Source: David Devine.`},{colour:`Princess Grey`,css:`#9ea3a8`,iciCode:`M049-2334`,alternative:null,notes:`Most popular colour — 100 of 500 cars.`},{colour:`Smoke Green`,css:`#506050`,iciCode:null,alternative:`Rolls-Royce (Autopaints Brighton code 9500816, 1965–71)`,notes:`Source: Norman Paskin. Rolls-Royce colour reference.`},{colour:`Sherwood Green`,css:`#2d5a27`,iciCode:null,alternative:`Sherwin Williams 8914 (if same as Austin Sherwood Green 1968)`,notes:`Fitment to be verified — only 1 car recorded in this colour.`},{colour:`Peony Red`,css:`#c5394d`,iciCode:`M049-4715`,alternative:`Austin/BMC Mini Peony Red (possibly)`,notes:`Source: Stephen Carter, 07.12.2012.`},{colour:`Off White`,css:`#f0ebe0`,iciCode:null,alternative:`Same as Old English White`,notes:`Treat as Old English White when sourcing.`},{colour:`Spa White`,css:`#f5f2ec`,iciCode:null,alternative:`Triumph Spa White (CDB) · similar to Mercedes Classicweiss`,notes:`Source: TR Register Forum.`},{colour:`Sun Bronze`,css:`#8b6914`,iciCode:`M049-2027`,alternative:null,notes:null},{colour:`Autumn Gold`,css:`#c8860a`,iciCode:`P031-2515`,alternative:null,notes:`Only 1 car recorded in this colour.`},{colour:`Deep Carriage Green`,css:`#2c4a2c`,iciCode:`P030-2747`,alternative:`Nexa 3716 · De Beer 500 line S2848 "Jailbar Green"`,notes:`Nexa code from Mickris (23.11.2013). De Beer last digit uncertain — may be 8 or 5. Source: JPMF Forum.`},{colour:`Indigo Blue`,css:`#2e3f6d`,iciCode:`M048-2086`,alternative:`Jaguar Indigo Blue (to 1964 — same or very close)`,notes:`Source: Mike Byrne.`},{colour:`Special White`,css:`#fafafa`,iciCode:null,alternative:`Unknown`,notes:`Only used on 4 cars: 104/2284, 104/2306, 112/2337, 112/2351.`},{colour:`Fawn`,css:`#c4a07a`,iciCode:`P031-2165`,alternative:null,notes:`Only used on JM/EXP/107. Source: Greg (Dormer?), forum post 20.01.2021.`},{colour:`Pastel Pink`,css:`#f0aab8`,iciCode:null,alternative:`Unknown`,notes:`Only used on 1 car: 104/2023.`},{colour:`Dawn Blue`,css:`#7ab0c8`,iciCode:null,alternative:`Unknown`,notes:`Only 1 car recorded.`},{colour:`Metallic Grey`,css:`#9a9ea3`,iciCode:null,alternative:`Unknown`,notes:`Only 1 car recorded.`},{colour:`Cadogan Brown`,css:`#6b4423`,iciCode:null,alternative:`Unknown`,notes:`Only 1 car recorded.`},{colour:`Reno Red`,css:`#9e3030`,iciCode:null,alternative:`Unknown`,notes:`Only 1 car recorded.`},{colour:`Royal Blue`,css:`#1a2f7a`,iciCode:`ICI 3310B`,alternative:null,notes:`Listed as "Other colour" — non-standard order.`}]},{type:`tip`,content:`Where a Jaguar, Aston Martin, Rolls-Royce or BMC equivalent is noted, classic car paint specialists who stock those marques' colours are often the most reliable source. Always request a physical chip or test panel before ordering for a full car.`},{type:`heading`,content:`How to Use This Information`},{type:`list`,content:[`ICI codes beginning M0XX are metallic finishes; P0XX are solid (non-metallic) colours.`,`When quoting a code to a paint supplier, also provide the colour name — some codes have been superseded or cross-referenced differently by different suppliers.`,`For the rarest colours (only 1 car known), a physical sample from the original car is the most reliable reference.`,`The Jensen C-V8 Registry may hold colour data for individual chassis numbers — John Staddon (JOC C-V8 Registrar) is the primary contact.`,`If you have identified a code not listed here, please contribute it to the community via the JOC C-V8 Tech Forum.`]}]},{id:`door-draught-excluders`,category:`body`,title:`Door Draught Excluders & Seals`,subtitle:`Replacing worn door seals with a snap-on moquette-covered draught excluder`,models:[`all`],difficulty:`easy`,readTime:`5 min read`,severity:null,tags:[`door seals`,`draught excluder`,`weatherproofing`,`body`,`trim`,`moquette`,`interior`],contributors:[`Jensen C-V8 community`],lastUpdated:`2025`,intro:`Worn or missing door seals are one of the most common sources of wind noise, water ingress and draughts on a classic Jensen C-V8. The original rubber door seals deteriorate over time and are increasingly difficult to source as an exact replacement. A practical and period-sympathetic alternative is a snap-on moquette-covered draught excluder, which fits a wide range of door opening edges without adhesive and is available in colours to match the interior.`,sections:[{type:`heading`,content:`The Recommended Product`},{type:`parts`,content:[{name:`Draught Excluder — Snap-on, plush moquette cover, 16mm bead`,partNumber:`SKU: 769`,notes:`Snap-on fitting with a large 16mm diameter soft sponge bead. Plush moquette covered. Reinforced carrier grips a wide range of door opening edge profiles without adhesive. Available in Black, Dark Blue, Brown and Red. Sold by the metre. Approximately £20.54 per metre (inc. VAT). Supplier: Vintage Car Parts — vintagecarparts.co.uk/products/769-container-large-plush-door-draught-excluder`}]},{type:`tip`,content:`The snap-on design means no adhesive is required and the seal can be removed and repositioned during fitting. This makes it far easier to work with than a glued rubber seal, particularly on a car being worked on over time.`},{type:`heading`,content:`Measuring Up — How Much Do You Need?`},{type:`paragraph`,content:`The product is sold by the metre, so accurate measurement before ordering will avoid waste. Measure the full perimeter of each door opening with a flexible tape measure, following the contour of the door shut face. The C-V8 is a two-door car, so you will need to measure both apertures.`},{type:`list`,content:[`Measure the full perimeter of each door opening separately — left and right apertures may differ slightly.`,`Add 10–15% to your total measurement to allow for trimming, corner forming and any fitting errors.`,`A typical full-size classic car door opening runs to approximately 3–4 metres per door. Budget for at least 7–8 metres for both doors combined, plus contingency.`,`If also sealing the boot lid, measure that aperture separately and add to your order.`]},{type:`heading`,content:`Colour Selection`},{type:`paragraph`,content:`The draught excluder is available in four colours: Black, Dark Blue, Brown and Red. For most C-V8 interiors, black or brown will be the most sympathetic match. The moquette texture is period-appropriate for a 1960s British car interior. If the existing door shut faces are in good condition, the colour of the excluder will be visible when the door is open, so it is worth matching to the interior trim rather than purely the door rubber colour.`},{type:`heading`,content:`Fitting`},{type:`steps`,content:[`Remove all traces of the old seal — peel away the existing rubber or adhesive residue. Clean the door shut face with a mild solvent to remove any adhesive, grease or corrosion.`,`Inspect the door shut face for rust or damage. Any rust should be treated and primed before the new seal is fitted, as sealing over rust will trap moisture.`,`Start at the bottom of the door opening (the sill area) where any slight misalignment will be least visible.`,`Press the snap-on carrier over the door shut face edge and work progressively around the aperture. The reinforced carrier will grip the edge firmly without adhesive.`,`At corners, cut the bead at an angle rather than stretching it around the bend — this gives a neater result and avoids the seal lifting off the carrier at the corner.`,`Where the two ends of the seal meet (usually at the bottom of the door), cut both ends squarely and butt them together neatly. A small dab of contact adhesive at the join will prevent the ends lifting.`,`Close the door gently and check the compression — the 16mm sponge bead should compress evenly around the full aperture without the door requiring excessive force to close.`,`Adjust any sections that appear compressed unevenly by gently pulling the carrier slightly outward or inward on the door lip to reposition.`]},{type:`heading`,content:`Boot Lid Seal`},{type:`paragraph`,content:`The alternative parts list for the C-V8 references Woolies part no. 268 for the boot rubber seal as a direct replacement. The Vintage Car Parts snap-on draught excluder (SKU 769) may also be suitable for the boot lid aperture, depending on the profile of the boot shut face — the snap-on carrier accommodates a wide range of edge profiles. If the original Woolies boot seal is not available, this snap-on alternative is worth considering as a practical replacement.`},{type:`tip`,content:`The original Woolies part numbers for C-V8 door and boot seals (264 for doors, 268 for boot) from the Eric Christoffersen parts list are listed in the Alternative Parts section of this site and are worth checking for availability before ordering a universal replacement.`}]},{id:`power-steering-conversion`,category:`upgrades`,title:`Installing Power Steering`,subtitle:`Options for adding power-assisted steering to the Jensen C-V8`,models:[`all`],difficulty:`advanced`,readTime:`8 min read`,severity:null,tags:[`power steering`,`electric power steering`,`steering`,`upgrade`,`EZ Power Steering`,`Easysteer`,`Interceptor rack`],contributors:[`JOC C-V8 Tech Forum — community discussion 2025`],sourceUrl:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,lastUpdated:`2025`,intro:`The Jensen C-V8 was never fitted with power steering from the factory. The original rack-and-pinion steering is generally considered heavy at low speeds and when parking — a common complaint among owners, particularly in modern urban driving conditions. Several conversion options have been explored by the C-V8 community, ranging from bolt-on electric systems to hydraulic rack transplants. This guide summarises the main approaches, their costs, and what to expect from each.`,sections:[{type:`heading`,content:`Option 1 — Electric Power Steering (Recommended)`},{type:`paragraph`,content:`Electric power steering (EPS) is the approach most favoured by the current C-V8 community. It requires no hydraulic pump, no fluid lines, and eliminates the risk of leaks. The assistance is provided by an electric motor mounted on the steering column, drawing power from the car's electrical system only when steering input is needed.`},{type:`tip`,content:`Electric power steering uses standard modern components from Opel/Vauxhall, Peugeot/Citroën and similar — making spare parts readily available and affordable long-term. No pump means no belts to replace, no fluid to leak, and no additional load on the cooling system.`},{type:`heading`,content:`EZ Power Steering Kit`},{type:`paragraph`,content:`EZ Power Steering produce an off-the-shelf electric power steering system that has been successfully fitted to at least one Mk II C-V8 (1964, VIN 104/2107). The system is not listed on the EZ website under Jensen, but Holden Vintage & Classic advertise it as a C-V8 application — availability should be confirmed before ordering as it may be to order only.`},{type:`list`,content:[`The motor unit is approximately the size of a large tin can and mounts to the steering column. On the C-V8 this requires cutting into the bulkhead to accommodate it — this is not a minor modification.`,`The installation is described as "not for the faint hearted" — plan and measure carefully before committing.`,`Once installed the system works well and produces a neat result.`,`EZ may have refined the installation process since earlier kits were supplied — worth asking them directly about current C-V8 fitment details.`,`Cost: approximately £3,000+ including VAT for parts only, not including installation labour.`]},{type:`heading`,content:`Easysteer — Electronic Power Steering Specialists`},{type:`paragraph`,content:`Easysteer (based in Chorley, Lancashire) are specialists in electric power steering conversions for classic cars. Their systems use smart electronics that adapt the level of assistance to driving speed — lighter at parking speeds, firming up at speed for better feel. The electronics are considered more sophisticated than many alternative EPS kits. Worth contacting to discuss C-V8 fitment before ordering any system.`},{type:`parts`,content:[{name:`Easysteer electric power steering system`,partNumber:null,notes:`Contact Easysteer directly to discuss C-V8 application. easysteer.co.uk/how-it-works/`},{name:`EZ Power Steering kit (C-V8 application)`,partNumber:null,notes:`Available via Holden Vintage & Classic (may be to order). Confirm availability before ordering. Approx. £3,000+ inc VAT parts only.`}]},{type:`heading`,content:`Option 2 — Mk I Interceptor Hydraulic Rack Conversion`},{type:`paragraph`,content:`The Mk I Jensen Interceptor uses a power-assisted rack that shares some heritage with the C-V8 platform and has been explored as a conversion. In principle the PAS mounting brackets from an Interceptor front crossmember can be grafted onto the C-V8 crossmember to accept the Interceptor rack. The PAS pump and brackets are available from Jensen specialists.`},{type:`warning`,content:`The Mk I Interceptor power steering rack has a reputation for leaks — confirmed by Paul Lawrence at Riverbourne who has specifically noted this issue. Research current rack condition and supplier availability carefully before committing to this route. At least one C-V8 owner experienced the rack locking up after installation, requiring it to be returned to the supplier.`},{type:`list`,content:[`Search the JOC forum for "power steering" and "Interceptor rack" — there are multiple threads covering this conversion in detail.`,`A complete Mk I Interceptor front crossmember and suspension assembly occasionally appears on eBay and can provide all the hardware needed.`,`This is a more involved fabrication job than an EPS conversion and introduces ongoing hydraulic maintenance requirements.`]},{type:`heading`,content:`Option 3 — DIY Using Modern Components`},{type:`paragraph`,content:`Forum member Jon Larkin (jglarkin) successfully fitted power steering to his C-V8 using affordable, readily available modern parts — not a proprietary kit. The project required significant planning and trial and error to get right, but the end result works well and was achieved at considerably lower cost than a dedicated kit. The details of this conversion have been discussed on the JOC forum and Jon may be willing to share his experience directly.`},{type:`heading`,content:`Before You Start — Key Considerations`},{type:`list`,content:[`Contact the supplier directly and confirm they have current experience with C-V8 fitment — not just a general claim of compatibility.`,`Budget for installation labour separately from parts cost. EPS conversions are manageable for a competent home restorer but the bulkhead modification requires careful planning.`,`Anton Raaymakers (Netherlands) has fitted the EZ electric system to a concours Mk III C-V8 — worth contacting via the JOC for direct experience.`,`Search the JOC C-V8 Tech Forum thoroughly before choosing a route — there are multiple detailed threads covering each approach.`]}]},{id:`electronic-ignition-conversion`,category:`upgrades`,title:`Converting from Points to Electronic Ignition`,subtitle:`A practical guide to upgrading the Chrysler distributor on the C-V8 V8`,models:[`all`],difficulty:`moderate`,readTime:`8 min read`,tags:[`ignition`,`points`,`electronic`,`pertronix`,`distributor`,`chrysler`,`tune-up`],contributors:[`Jensen C-V8 Community`],lastUpdated:`2025`,intro:`The Jensen C-V8 uses a Chrysler 383 cubic inch V8 with a conventional points-based ignition system as fitted from the factory. While this system works adequately when properly maintained, points wear over time, require regular adjustment, and can cause inconsistent firing — particularly at higher engine speeds. Converting to a modern electronic ignition eliminates the points entirely, replacing them with a solid-state trigger that requires no routine adjustment and delivers a more consistent spark throughout the rev range. This guide covers what to look for, which systems are available, and how to carry out the conversion correctly.`,sections:[{type:`heading`,content:`Why Convert?`},{type:`paragraph`,content:`Points-based ignition was the standard technology of the era but has several drawbacks on a regularly driven classic car. The contact breaker gap must be checked and reset every 3,000–4,000 miles, and worn points cause misfires, reduced power and hard starting. Electronic ignition modules replace the points with a magnetic or optical trigger that has no moving parts to wear, maintains timing accuracy indefinitely, and typically produces a stronger, hotter spark — which is particularly beneficial on a high-displacement V8 like the 383. The conversion is fully reversible if required, and the distributor otherwise remains original.`},{type:`heading`,content:`Choosing an Electronic Ignition System`},{type:`paragraph`,content:`Several manufacturers produce drop-in electronic ignition modules for the Chrysler distributor family. Pertronix is the most established brand for this application and makes three generations of product — the Ignitor I, II and III. All three use the same Hall-effect trigger principle but differ significantly in features and reliability:`},{type:`list`,content:[`Ignitor I — the original, now dated design. Will work but lacks modern protection features. Not recommended for a new conversion.`,`Ignitor II — the recommended choice for a street-driven classic. Modern circuit design, significantly better reliability, and critically includes ignition-on protection (the module will not burn out if the ignition is left on without the engine running — a common failure mode of the Ignitor I).`,`Ignitor III — adds rev limiting and timing curve features more suited to competition or highly modified engines. Unnecessary for a road-going C-V8 and introduces additional complexity without benefit.`]},{type:`tip`,content:`The Pertronix Ignitor II is the sweet spot for the C-V8. Modern, reliable technology without unnecessary complexity. Ensure you order the version for the Chrysler 8-cylinder electronic distributor.`},{type:`warning`,content:`Each Ignitor generation requires a matched Pertronix coil. Do not mix an Ignitor II module with a generic coil or an Ignitor I coil — the resistance specifications differ and the system will not function correctly. Always pair the Ignitor II with the Flame Thrower II coil (0.6 ohm resistance).`},{type:`heading`,content:`Confirming Your Distributor`},{type:`paragraph`,content:`This conversion assumes the car retains its original Chrysler electronic distributor. Most C-V8s still have the factory unit fitted, but it is worth confirming before ordering parts. The original Chrysler distributor can be identified by a small metal tag riveted to the side of the housing, stamped with a part number that can be verified online. If the distributor has previously been replaced with an aftermarket unit, the conversion procedure and applicable Pertronix part numbers may differ.`},{type:`heading`,content:`Parts Required`},{type:`parts`,content:[{name:`Pertronix Ignitor II Module`,partNumber:`9CH-181`,notes:`For Chrysler 8-cylinder electronic distributor. This is the critical part — verify the part number matches your distributor before ordering.`},{name:`Pertronix Flame Thrower II Coil`,partNumber:`45011 (oil-filled) or 45111 (epoxy-filled)`,notes:`Must be 0.6 ohm resistance. Oil-filled runs cooler under sustained use; epoxy-filled handles vibration better. Either is suitable for road use.`},{name:`New vacuum advance unit (optional)`,partNumber:`If required`,notes:`Worth inspecting while the distributor is out. A cracked or collapsed diaphragm will cause timing issues regardless of ignition type.`},{name:`Distributor cap and rotor (optional)`,partNumber:`Standard Chrysler 383`,notes:`Good practice to renew these while the distributor is accessible, particularly if the existing cap shows tracking marks or corrosion.`}]},{type:`costTable`,content:[{item:`Pertronix Ignitor II module`,usd:`$90–120`,gbp:`£70–95`,eur:`€80–110`},{item:`Flame Thrower II coil`,usd:`$80–120`,gbp:`£65–95`,eur:`€75–110`},{item:`Vacuum advance unit (if needed)`,usd:`$25–50`,gbp:`£20–40`,eur:`€23–45`},{item:`Cap and rotor (if renewing)`,usd:`$20–35`,gbp:`£16–28`,eur:`€18–32`},{item:`Total (module + coil)`,usd:`$170–240`,gbp:`£135–190`,eur:`€155–220`}]},{type:`tip`,content:`Pertronix products are widely available from automotive performance retailers globally. Summit Racing (summitRacing.com) carries the full range and ships internationally, typically within a week. Ensure any retailer packs the coil carefully — it is fragile in transit.`},{type:`heading`,content:`Installation: On the Car or on the Bench?`},{type:`paragraph`,content:`The Ignitor II module can be fitted with the distributor in situ, which is the simpler approach if the distributor is otherwise in good condition. However, removing the distributor for a bench installation is worthwhile if: the vacuum advance unit needs replacing, the cap and shaft bearings need inspection, or you want to clean and inspect the entire assembly. There are some excellent video resources on YouTube covering this exact Chrysler distributor which are worth watching before starting work.`},{type:`warning`,content:`If you remove the distributor: mark its rotational position on the engine block before removal, photograph the shaft alignment carefully, and do not turn the engine over while the distributor is out. If you do this, the distributor can be refitted in the same position and timing will require only minor tweaking. Failing to mark the position means resetting the ignition timing from scratch, which is significantly more work.`},{type:`heading`,content:`Installation Steps`},{type:`steps`,content:[`Disconnect the battery negative terminal before starting any ignition work.`,`If removing the distributor: mark its rotational position on the engine block, photograph the rotor alignment, and note all wire positions on the cap.`,`Remove the distributor cap, rotor, and points assembly. The points and condenser are no longer required once the Ignitor II is fitted.`,`Fit the Ignitor II module into the distributor body according to the Pertronix instructions. The module clips onto the breaker plate in place of the points.`,`Route the two wires from the Ignitor II module out through the distributor body. Red wire to positive (+), black wire to negative (−) on the coil.`,`Replace the original coil with the Pertronix Flame Thrower II. Observe correct polarity — the coil terminals are marked + and −.`,`Refit the rotor and distributor cap. If you removed the distributor, refit it aligned with your original marks.`,`Reconnect the battery. Start the engine and allow it to idle.`,`Check and adjust ignition timing using a strobe timing light. The base timing specification for the Chrysler 383 is 10° BTDC at 500 rpm — refer to your manual for your specific model.`,`Road test and recheck timing once the engine is fully warmed up.`]},{type:`heading`,content:`After Installation`},{type:`paragraph`,content:`Once installed, the Ignitor II requires no routine maintenance. There is no points gap to check, no condenser to replace, and no timing drift from mechanical wear. The system should be checked at the same intervals as any other ignition component — cap, rotor, and plug leads — but the module itself should last the life of the vehicle under normal use. If the engine is left with the ignition on but not running, the Ignitor II's built-in protection circuit prevents the module from burning out — a significant improvement over earlier electronic ignition designs.`},{type:`tip`,content:`Other electronic ignition brands are available for the Chrysler distributor, including Crane Cams (now discontinued but units still available second-hand) and various generic "points replacement" modules sold online. These may be suitable for the application but have not been specifically verified for the C-V8. The Pertronix Ignitor II represents a well-documented, proven choice for this engine. Further options may be added to this guide as they are evaluated by C-V8 owners.`},{type:`heading`,content:`Further Resources`},{type:`list`,content:[`Pertronix website (pertronix.com) — full technical specifications, installation guides and FAQ for all Ignitor products.`,`YouTube — search "Pertronix Ignitor II Chrysler 383 installation" for video guides covering this exact distributor.`,`JOC C-V8 Tech Forum — the Jensen Owners Club technical forum has detailed threads on ignition conversion from owners who have carried out this modification.`,`Ignition timing specifications for your model are in the manual — Mk III p. 29–30, base manual p. 5–6.`]}]}],je=[{id:`suspension`,label:`Suspension`,emoji:`🔩`},{id:`brakes`,label:`Brakes`,emoji:`🛑`},{id:`engine`,label:`Engine & Transmission`,emoji:`🔧`},{id:`cooling`,label:`Cooling System`,emoji:`🌡️`},{id:`electrical`,label:`Electrical`,emoji:`⚡`},{id:`lighting`,label:`Lighting`,emoji:`💡`},{id:`bodywork`,label:`Bodywork`,emoji:`🚗`},{id:`seals`,label:`Seals & Rubber`,emoji:`🔄`},{id:`interior`,label:`Interior & Trim`,emoji:`🪑`},{id:`steering`,label:`Steering & Driveline`,emoji:`⚙️`},{id:`suppliers`,label:`Suppliers`,emoji:`📦`}],Me=[{id:`s-01`,category:`suspension`,models:[`all`],part:`Front shock absorbers`,alternative:`Austin Westminster`,partNumber:null,supplier:null,notes:null},{id:`s-02`,category:`suspension`,models:[`all`],part:`Front damper rubber buffers`,alternative:`Austin Westminster`,partNumber:`1G4276`,supplier:`Moss, Guy Broad Spares`,notes:null},{id:`s-03`,category:`suspension`,models:[`all`],part:`Front suspension bottom spring pans`,alternative:`Austin Healey 3000 Mk III`,partNumber:null,supplier:null,notes:null},{id:`s-04`,category:`suspension`,models:[`all`],part:`Rear suspension rubber buffers`,alternative:`Austin Healey 3000 Mk III front suspension bump stops`,partNumber:null,supplier:null,notes:null},{id:`s-05`,category:`suspension`,models:[`all`],part:`Front damper suspension stops (buffers)`,alternative:`Austin Healey 3000 / Austin A60`,partNumber:null,supplier:`Moss`,notes:null},{id:`s-06`,category:`suspension`,models:[`all`],part:`Lower wishbone bushes`,alternative:`Superflex polyurethane bushes`,partNumber:`SPF 1430/19`,supplier:`Superflex`,notes:null},{id:`s-07`,category:`suspension`,models:[`all`],part:`Anti-roll bar bushes`,alternative:`Superflex`,partNumber:null,supplier:`Superflex`,notes:null},{id:`s-08`,category:`suspension`,models:[`all`],part:`Panhard rod rubber bushes`,alternative:`Jaguar Mk2 / XK120 / XK140 / XK150 anti-roll bar upper bushes`,partNumber:null,supplier:`Guy Broad Spares, Superflex`,notes:null},{id:`s-09`,category:`suspension`,models:[`all`],part:`All suspension bushes (polyurethane / stainless sleeves)`,alternative:`Superflex complete bush kit`,partNumber:null,supplier:`Superflex`,notes:null},{id:`s-10`,category:`suspension`,models:[`all`],part:`Rear shock absorbers (Selectaride replacement)`,alternative:`SPAX G255 Adjustable Rear Shock Absorber — fits Jensen C-V8 1962–68 and Interceptor Series II, III & IV 1969–90. Features 28-stage on-car bump and rebound adjustment, Krypton gas pressurised, epoxy powder coated. Price shown per unit.`,partNumber:`G255`,supplier:`Merlin Motorsport — merlinmotorsport.co.uk/p/jensen-interceptor-series-ii-iii-iv-1969-to-1990-adjustable-rear-shock-absorber-by-spax-g255-g255`,notes:`Primary replacement for the Armstrong Selectaride units. The 28-stage adjustability makes these a significant improvement over the original fixed-rate replacements. Also fits Jensen Interceptor (FF model) 1966–68. Alternative (exchange units): Aston Martin DB5 / Facel Vega Armstrong Selectaride units from Aston Martin specialists.`},{id:`s-11`,category:`suspension`,models:[`all`],part:`Bonnet rubber buffers`,alternative:`Austin Westminster suspension — Moss part no 1G4276`,partNumber:`1G4276`,supplier:`Moss`,notes:null},{id:`b-01`,category:`brakes`,models:[`all`],part:`Front brake callipers / cylinders / pistons / pads`,alternative:`Late Jaguar XK150, Jaguar Mk2 (V8), or Cooper Craft alternative`,partNumber:`Quinton Hazel BP105 (for Cooper Craft pads)`,supplier:`Cooper Craft`,notes:`Pads for Cooper Craft callipers: Quinton Hazel BP105.`},{id:`b-02`,category:`brakes`,models:[`all`],part:`Brake pads (cross-reference vehicles)`,alternative:`Jaguar MkIX / E-Type 59–71, MkX 61 · Bristol 59–65 · Alvis 62–68 · Aston Martin DB4 63–65 · MGA Twin Cam · BMW 3200CS / 2600L / 507 / 3200L/S · Daimler 59–66 · Datsun (various 65–71) · Facel Vega 59–64 · Mercedes 600 65- · Rover 2000 63–66 · Toyota (various 66–71)`,partNumber:null,supplier:null,notes:`Wide cross-reference — check dimensions against your specific caliper.`},{id:`b-03`,category:`brakes`,models:[`all`],part:`Rear brake callipers / cylinders / pistons / pads`,alternative:`As front — see above`,partNumber:`649332063 (cylinders/pistons)`,supplier:`Guy Broad Spares`,notes:null},{id:`b-04`,category:`brakes`,models:[`all`],part:`Brake servo`,alternative:`Lockheed`,partNumber:`LR17551`,supplier:`Guy Broad Spares`,notes:null},{id:`b-05`,category:`brakes`,models:[`all`],part:`3-way brake union`,alternative:`MG / Jaguar / etc. (commonly used type)`,partNumber:null,supplier:`Moss`,notes:null},{id:`b-06a`,category:`brakes`,models:[`all`],part:`Brake fluid reservoir`,alternative:`Alfa Romeo 105 Giulia (1965–69), including 1969 USA dual-circuit brake cars`,partNumber:`BC335 (supplier ref) · OEM: 607.29342 / 60729342 / 607-29342`,supplier:`Euroline International (eurolineinternational.com)`,notes:`New plastic reservoir with metal fitting on the base for the brake line. Direct application: Alfa Romeo 105 Giulia 1965–69. Approx. USD $79.50.`},{id:`b-06`,category:`brakes`,models:[`all`],part:`Brake fluid reservoir (alternative source)`,alternative:`XK150 / E-Type (1950s–60s Jaguars)`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`b-07`,category:`brakes`,models:[`all`],part:`Copper brake pipe set`,alternative:`Automec complete copper set`,partNumber:null,supplier:`Automec Engine`,notes:null},{id:`e-01`,category:`engine`,models:[`all`],part:`Air filter`,alternative:`Coopers`,partNumber:`AG280`,supplier:null,notes:null},{id:`e-02`,category:`engine`,models:[`all`],part:`Oil filter`,alternative:`FRAM CH 8PL · AC PF331 · Purolator PF331`,partNumber:`CH 8PL / PF331`,supplier:null,notes:null},{id:`e-03`,category:`engine`,models:[`all`],part:`Fan belt`,alternative:`Gates`,partNumber:`6227mc (size: AVX10 × 1175La)`,supplier:null,notes:null},{id:`e-04`,category:`engine`,models:[`all`],part:`Spark plugs`,alternative:`Champion J11Y or NGK BP5S`,partNumber:`J11Y / BP5S`,supplier:null,notes:`Earlier sources quote Champion J10Y. Check current supplier recommendations.`},{id:`e-05`,category:`engine`,models:[`all`],part:`All gaskets, seals and engine parts`,alternative:`Chrysler-specialist supplier`,partNumber:null,supplier:`Eadys American Car Spares`,notes:null},{id:`e-06`,category:`engine`,models:[`all`],part:`All gearbox parts`,alternative:`Chrysler-specialist supplier`,partNumber:null,supplier:`Eadys American Car Spares`,notes:null},{id:`e-07`,category:`engine`,models:[`all`],part:`Engine workshop manual`,alternative:`Haynes Techbook (Chrysler)`,partNumber:`103310`,supplier:null,notes:null},{id:`e-08`,category:`engine`,models:[`all`],part:`Transmission fluid`,alternative:`Dexron 2 or 3`,partNumber:null,supplier:null,notes:null},{id:`e-09`,category:`engine`,models:[`all`],part:`Carburettor tuning parts (needles / jets etc.)`,alternative:null,partNumber:null,supplier:`Roadcraft UK Ltd`,notes:null},{id:`c-01`,category:`cooling`,models:[`all`],part:`Alternative electric cooling fans`,alternative:`VW Golf`,partNumber:`431959455C`,supplier:null,notes:`VW Golf fans are well regarded as a direct upgrade alternative.`},{id:`c-02`,category:`cooling`,models:[`all`],part:`Radiator fan thermoswitch`,alternative:`VW Golf GTI / Mk2 Golf`,partNumber:`Intermotor 50030`,supplier:null,notes:null},{id:`c-03`,category:`cooling`,models:[`all`],part:`Top hose`,alternative:`Subaru Impreza 2.5 litre turbo 2007 top hose — very close match`,partNumber:null,supplier:null,notes:`Contributed by Paul Baker (Australia).`},{id:`c-04`,category:`cooling`,models:[`all`],part:`Bottom hose`,alternative:`Ford Fairlane 5.8 litre 1979–84 with 2" cut off both ends`,partNumber:null,supplier:null,notes:`Contributed by Paul Baker (Australia).`},{id:`c-05`,category:`cooling`,models:[`all`],part:`Heater hoses`,alternative:`Standard 12mm and 15mm hose by the metre`,partNumber:null,supplier:null,notes:`Easy to source. Contributed by Paul Baker (Australia).`},{id:`c-06`,category:`cooling`,models:[`all`],part:`Heater control valve`,alternative:`Some older Volvos`,partNumber:null,supplier:null,notes:`Fitment to be verified.`},{id:`el-01`,category:`electrical`,models:[`all`],part:`Alternator (uprated)`,alternative:`Uprated unit to approx. 60 amps (original was 37.5 amps)`,partNumber:null,supplier:`Eadys American Car Spares`,notes:null},{id:`el-02`,category:`electrical`,models:[`all`],part:`Voltage regulator`,alternative:`Available from American car spares specialists`,partNumber:null,supplier:`Eadys American Car Spares`,notes:`A faulty voltage regulator can cause the temperature gauge to read falsely high — worth replacing as a first step in overheating diagnosis.`},{id:`el-03`,category:`electrical`,models:[`all`],part:`Wiring harness`,alternative:`Custom loom`,partNumber:null,supplier:`Auto Sparks, Nottingham`,notes:null},{id:`el-04`,category:`electrical`,models:[`mk2`,`mk3`],part:`Petrol filler flap solenoid`,alternative:`E-Type and MGB 1962–67 overdrive solenoid (available new from Lucas)`,partNumber:null,supplier:`Moss`,notes:`The plunger will need slight modification to fit.`},{id:`el-05`,category:`electrical`,models:[`all`],part:`Steering column horn contacts`,alternative:`XK150`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`el-06`,category:`electrical`,models:[`all`],part:`Door light switches`,alternative:`Jaguar XK120 boot light switch`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`el-07`,category:`electrical`,models:[`all`],part:`Horns`,alternative:`MGA, Morris Minor etc. — reproductions available new`,partNumber:null,supplier:`Moss`,notes:null},{id:`el-08`,category:`electrical`,models:[`all`],part:`Wiper motor`,alternative:`Some Jaguars`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`li-01`,category:`lighting`,models:[`all`],part:`Headlights (not spotlights / lamp rims)`,alternative:`Morris Minor, early Mini, Austin A30/A35 and many other 1950s–60s British cars`,partNumber:null,supplier:`Lucas, Moss`,notes:`Available new from Lucas or Moss.`},{id:`li-02`,category:`lighting`,models:[`all`],part:`Brake lights / indicator lights / front side lights`,alternative:`Lucas L691/2 (still available new) or Austin Healey 2500/3000, Hillman Imp`,partNumber:`Lucas L691/2`,supplier:`Lucas`,notes:null},{id:`li-03`,category:`lighting`,models:[`all`],part:`Number plate / reversing light`,alternative:`Lucas 469 (available new) or Rover 90/100/110 and Jaguar Mk5`,partNumber:`Lucas 469`,supplier:`Guy Broad Spares`,notes:null},{id:`li-04`,category:`lighting`,models:[`all`],part:`Rear reflectors`,alternative:`Sunbeam Rapier / Singer Vogue`,partNumber:null,supplier:null,notes:null},{id:`li-05`,category:`lighting`,models:[`all`],part:`Indicator dash warning lights`,alternative:`Early Austin Healey, Rover 90/100/110`,partNumber:null,supplier:null,notes:null},{id:`bw-01`,category:`bodywork`,models:[`mk1`,`mk2`],part:`Front windscreen (Mk I and Mk II — same glass)`,alternative:null,partNumber:`Pilkington 9066ACL (previously 0121CL)`,supplier:null,notes:`The front windscreen glass is the same for Mk I and Mk II.`},{id:`bw-02`,category:`bodywork`,models:[`all`],part:`Door catches / strikers / door stops`,alternative:`Austin Healey 2500/3000`,partNumber:null,supplier:null,notes:`Available new.`},{id:`bw-03`,category:`bodywork`,models:[`all`],part:`Door hinges`,alternative:`Austin Healey 2500/3000 — top door hinge fits C-V8 top and bottom`,partNumber:null,supplier:null,notes:null},{id:`bw-04`,category:`bodywork`,models:[`all`],part:`Door captive plates for hinges`,alternative:`Austin Healey 2500/3000`,partNumber:null,supplier:null,notes:null},{id:`bw-05`,category:`bodywork`,models:[`all`],part:`Door adjustment shims`,alternative:`Austin Healey 2500/3000`,partNumber:null,supplier:null,notes:null},{id:`bw-06`,category:`bodywork`,models:[`all`],part:`Door handles (exterior)`,alternative:`Rover P4`,partNumber:null,supplier:null,notes:null},{id:`bw-07`,category:`bodywork`,models:[`all`],part:`Boot hinges`,alternative:`Riley 1.5 RME / 2.5 RME`,partNumber:null,supplier:`Asquith Bros (s/h)`,notes:null},{id:`bw-08`,category:`bodywork`,models:[`all`],part:`Boot support stay`,alternative:`Jaguar Mk V (looks the same but check length) or XK150 boot stay`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`bw-09`,category:`bodywork`,models:[`all`],part:`Rear bumper white rubber trim`,alternative:`Triumph Herald bumper trim`,partNumber:null,supplier:null,notes:null},{id:`bw-10`,category:`bodywork`,models:[`all`],part:`Chrome bumper bolts`,alternative:null,partNumber:null,supplier:`Woolies`,notes:null},{id:`bw-11`,category:`bodywork`,models:[`all`],part:`Bonnet stay`,alternative:`Duple Coach (luggage door)`,partNumber:null,supplier:null,notes:null},{id:`bw-12`,category:`bodywork`,models:[`all`],part:`Chrome trim screws / clips`,alternative:null,partNumber:null,supplier:`Woolies`,notes:null},{id:`bw-13`,category:`bodywork`,models:[`all`],part:`Bonnet lock (engine cover lock)`,alternative:`Lotus Europa (old type)`,partNumber:`SJ046B0009`,supplier:`SJS Sportcars`,notes:null},{id:`bw-14`,category:`bodywork`,models:[`mk3`],part:`Rear bonnet individual letter badges — "J E N S E N"`,alternative:`Sunbeam Tiger individual chrome letter set`,partNumber:null,supplier:`Sunbeam Car Parts — sunbeamcarparts.co.uk/brightwork-badges/s-u-n-b-e-a-m-badge-letter-set`,notes:`The Mk III C-V8 has individual chrome letters spelling JENSEN across the rear bonnet/boot lid. The Sunbeam Tiger letter set provides the letters E, N and S — which cover most of JENSEN — but does not include a J. The J must be sourced separately. Order: 1× J (alternate source), 1× E, 1× N, 1× S, 1× E, 1× N from the Sunbeam set.`},{id:`sr-01`,category:`seals`,models:[`all`],part:`Petrol cap / seal / spring`,alternative:`XK120 / XK140 / XK150`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`sr-02`,category:`seals`,models:[`all`],part:`Door rubber seals`,alternative:null,partNumber:`Woolies part no. 264`,supplier:`Woolies`,notes:null},{id:`sr-03`,category:`seals`,models:[`all`],part:`Boot rubber seal`,alternative:null,partNumber:`Woolies part no. 268`,supplier:`Woolies`,notes:null},{id:`sr-04`,category:`seals`,models:[`all`],part:`Rear window seals`,alternative:null,partNumber:`Woolies part no. 264`,supplier:`Woolies`,notes:null},{id:`sr-05`,category:`seals`,models:[`all`],part:`Front inner wing to bonnet D-seal`,alternative:null,partNumber:`Vintage Supplies SHRb`,supplier:`Vintage Supplies Ltd`,notes:null},{id:`sr-06`,category:`seals`,models:[`all`],part:`Door bottom to kick step seal`,alternative:null,partNumber:`Vintage Supplies SHRb`,supplier:`Vintage Supplies Ltd`,notes:null},{id:`sr-07`,category:`seals`,models:[`all`],part:`Windscreen rubber`,alternative:null,partNumber:`Woolies R747`,supplier:`Woolies`,notes:null},{id:`sr-08`,category:`seals`,models:[`all`],part:`Windscreen chrome insert`,alternative:null,partNumber:`Woolies part no. 358`,supplier:`Woolies`,notes:null},{id:`sr-09`,category:`seals`,models:[`all`],part:`Dotted trim rubber edge finisher`,alternative:null,partNumber:`Woolies R181`,supplier:`Woolies`,notes:null},{id:`sr-10`,category:`seals`,models:[`all`],part:`Silent channel felt (door windows)`,alternative:`3mm × 25mm (3m per window)`,partNumber:`Woolies part no. 87`,supplier:`Woolies`,notes:null},{id:`sr-11`,category:`seals`,models:[`all`],part:`Quarter light seal`,alternative:null,partNumber:`Woolies SRS91`,supplier:`Woolies`,notes:`Alternative that works OK.`},{id:`sr-12`,category:`seals`,models:[`all`],part:`Exhaust silencer box mounts (45mm)`,alternative:`Lord mounts`,partNumber:`Fly Drive item 364 series 200 (aircraft spares)`,supplier:null,notes:null},{id:`it-01`,category:`interior`,models:[`all`],part:`Interior door handles / window winders`,alternative:`Wolseley 1500 and Riley 1.5`,partNumber:null,supplier:null,notes:null},{id:`it-02`,category:`interior`,models:[`all`],part:`Rear view mirror`,alternative:`Jaguar Mk2 and E-Type (may be available new from Lucas)`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`it-03`,category:`interior`,models:[`all`],part:`Rear speaker covers`,alternative:`Jaguar Mk2 (slightly bigger)`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`it-04`,category:`interior`,models:[`all`],part:`Seat hinges ("Widney lie-back")`,alternative:`Rover P4`,partNumber:null,supplier:null,notes:null},{id:`it-05`,category:`interior`,models:[`all`],part:`Seat recliner mechanism`,alternative:`Ford Corsair 2000`,partNumber:null,supplier:null,notes:null},{id:`it-06`,category:`interior`,models:[`all`],part:`Interior light lens (light unit is same but has no on/off switch)`,alternative:`Rover P4`,partNumber:null,supplier:null,notes:null},{id:`it-07`,category:`interior`,models:[`all`],part:`Seat runners`,alternative:`XK150`,partNumber:null,supplier:`Guy Broad Spares`,notes:null},{id:`it-08`,category:`interior`,models:[`all`],part:`Alternative radio speakers`,alternative:`4" × 6" Pioneer TS-4621 (60W) — fitted to VWs and Fiats, fit well`,partNumber:`TS-4621`,supplier:null,notes:null},{id:`it-09`,category:`interior`,models:[`all`],part:`Dotted trim aluminium sheet`,alternative:null,partNumber:null,supplier:`Rejen`,notes:null},{id:`sd-01`,category:`steering`,models:[`all`],part:`Track rod ends`,alternative:`Bedford CF van`,partNumber:`Quinton Hazel QR1379`,supplier:null,notes:null},{id:`sd-02`,category:`steering`,models:[`all`],part:`Steering column universal joints`,alternative:`MGA / MGB (Hardy Spicer)`,partNumber:`HS120`,supplier:`Moss`,notes:null},{id:`sd-03`,category:`steering`,models:[`all`],part:`Steering column flex coupling`,alternative:`Austin Metro (works but not as strong)`,partNumber:null,supplier:null,notes:null},{id:`sd-04`,category:`steering`,models:[`all`],part:`Front wheel bearings`,alternative:`Rover 2000 Unipart GHB105 (inner) / Timken 07087X + 07210X`,partNumber:`GHB105 / 07087X + 07210X`,supplier:`Unipart / Timken`,notes:null},{id:`sd-05`,category:`steering`,models:[`all`],part:`Differential pinion seal`,alternative:`Jaguar or Jensen dealers — two sizes`,partNumber:`Small: 2HA-019 · Larger: 8HA-019-5`,supplier:`Jaguar specialists / Jensen dealers`,notes:null},{id:`sd-06`,category:`steering`,models:[`all`],part:`Rear axle (Salisbury axle)`,alternative:`Jaguar XK150 (note: C-V8 half shafts are heavy duty — not standard Jaguar)`,partNumber:null,supplier:null,notes:`Half shafts on Jensens are heavy duty and non-standard. Some brackets also differ.`},{id:`sd-07`,category:`steering`,models:[`all`],part:`Propshaft rubber boot`,alternative:`Citroën AX driveshaft boot — cut to fit (works well)`,partNumber:null,supplier:null,notes:null},{id:`sd-08`,category:`steering`,models:[`all`],part:`Wheels`,alternative:`Rover P5, Vauxhall PA Cresta/Velox, Austin Westminster — 15"`,partNumber:null,supplier:null,notes:null},{id:`sd-09`,category:`steering`,models:[`all`],part:`Tyres — recommended modern size`,alternative:`205/70-15 (increase pressure by 10%)`,partNumber:null,supplier:null,notes:null},{id:`sup-01`,category:`suppliers`,models:[`all`],part:`Eadys American Car Spares`,alternative:null,partNumber:null,supplier:`Dave Eadys Parts Centre`,notes:`Higham Road, Burton Latimer, Northants NN15 5PU. Contact: Dave Eady. Tel: 01536 420 201. Specialises in American/Chrysler parts.`},{id:`sup-02`,category:`suppliers`,models:[`all`],part:`Guy Broad Spares`,alternative:null,partNumber:null,supplier:`Guy Broad Spares`,notes:`Jensen specialist supplier — referenced for many hard-to-find items including Jaguar cross-reference parts.`},{id:`sup-03`,category:`suppliers`,models:[`all`],part:`Woolies (seals and rubber)`,alternative:null,partNumber:null,supplier:`Woolies`,notes:`Classic car seals and rubber trim specialist. Referenced for door seals, windscreen rubber, window channels and trim.`},{id:`sup-04`,category:`suppliers`,models:[`all`],part:`Superflex (polyurethane bushes)`,alternative:null,partNumber:null,supplier:`Superflex`,notes:`Polyurethane and stainless-sleeved bush kits for the full suspension.`},{id:`sup-05`,category:`suppliers`,models:[`all`],part:`Moss Motors`,alternative:null,partNumber:null,supplier:`Moss`,notes:`British Leyland and MG/Austin Healey specialist — many C-V8 cross-reference parts.`}],Ne=[{id:`all`,label:`All`,emoji:`🔍`},{id:`specialist`,label:`Jensen Specialist`,emoji:`🚗`},{id:`restoration`,label:`Restoration`,emoji:`🔧`},{id:`parts`,label:`Parts Supplier`,emoji:`📦`},{id:`supplier`,label:`Mechanical Supplier`,emoji:`⚙️`}],Pe=[{code:`all`,name:`All Countries`,flag:`🌍`},{code:`GB`,name:`United Kingdom`,flag:`🇬🇧`},{code:`AU`,name:`Australia`,flag:`🇦🇺`},{code:`US`,name:`United States`,flag:`🇺🇸`},{code:`NL`,name:`Netherlands`,flag:`🇳🇱`},{code:`DE`,name:`Germany`,flag:`🇩🇪`}],Fe=[{id:`cropredy-bridge`,name:`Cropredy Bridge Garage`,types:[`specialist`,`restoration`],country:`United Kingdom`,countryCode:`GB`,region:`Oxfordshire`,city:`Cropredy, Banbury`,website:`https://cropredybridge.com`,phone:`+44 (0)1295 758444`,email:`sales@cropredybridge.com`,social:{facebook:`https://www.facebook.com/cropredybridge`,twitter:`https://twitter.com/cropredybridge`,instagram:`https://www.instagram.com/cropredybridgecars`},logo:`/specialists/cropredy-bridge-logo.svg`,tagline:`The largest Jensen specialist in the world`,description:`Cropredy Bridge Garage has been the world's foremost Jensen specialist for over 50 years. Based at Riverside Works in Oxfordshire, they offer a full range of services for Jensen vehicles including the C-V8 — restoration, classic car paint studio, trim studio, servicing, maintenance, upgrades and vehicle sales. "Where passion meets precision."`,services:[`Full restoration`,`Paintwork`,`Trimming`,`Servicing & maintenance`,`Vehicle sales`,`Parts sourcing`,`Upgrades`],models:[`all`],featured:!0},{id:`appleyard-parts`,name:`Richard Appleyard Parts Ltd`,types:[`specialist`,`restoration`,`parts`],country:`United Kingdom`,countryCode:`GB`,region:`Derbyshire`,city:`Ilkeston, Derby`,website:`https://jensen.co.uk`,phone:`0115 932 5320`,email:`sales@jensen.co.uk`,logo:`/specialists/appleyard-parts-logo.png`,logoScale:2.2,tagline:`Parts · Car Sales · Servicing`,description:`Richard Appleyard Parts Ltd specialises exclusively in classic Jensen sports cars, covering the full range of Jensen models: 541, C-V8, Interceptor/FF and Healey/GT. Based at Quarry Hill Industrial Park, Ilkeston, they supply Jensen spare parts, carry out Jensen servicing and repair, and undertake restoration work. An active supporter of the Jensen Owners Club.`,services:[`Parts supply`,`Servicing`,`Repairs`,`Restoration`,`Vehicle sales`,`Jensen Owners Club supporter`],models:[`all`],featured:!0},{id:`ross-hockley-autos`,name:`Ross Hockley Autos — Jensen Bits`,types:[`parts`,`specialist`],country:`Australia`,countryCode:`AU`,region:`New South Wales`,city:`Brookvale, Sydney`,website:null,phone:`(02) 9938 1822`,email:`jensenbits@gmail.com`,logo:null,tagline:`Jensen Healey & Interceptor new and used parts`,description:`Ross Hockley Autos, trading as Jensen Bits, is a Sydney-based supplier of new and used Jensen parts specialising in the Jensen Healey and Interceptor. While their primary focus is Healey and Interceptor, they are a valuable resource for C-V8 owners — many parts cross over directly, and Ross has an extensive knowledge of the Chrysler V8 engines used across the Jensen range. Worth contacting before sourcing Chrysler engine parts from elsewhere.`,services:[`New Jensen parts`,`Used Jensen parts`,`Chrysler V8 expertise`,`Jensen Healey specialist`,`Jensen Interceptor specialist`,`Cross-model parts sourcing`],models:[`all`],featured:!1},{id:`martin-robey`,name:`Martin Robey`,types:[`parts`,`specialist`],country:`United Kingdom`,countryCode:`GB`,region:`Warwickshire`,city:`Coleshill`,website:`https://www.martinrobey.com/jensen`,phone:null,email:null,logo:`/specialists/martin-robey-logo.svg`,logoScale:1.8,tagline:`Jensen parts, heritage and original factory documents`,description:`Martin Robey is one of the UK's foremost suppliers of Jensen parts, covering the C-V8, Interceptor and Healey ranges. Uniquely, Martin Robey also holds the original Jensen Motors factory documentation — if you need an original factory document for your C-V8 (build records, factory options, dispatch information), this is the source. An invaluable resource for both parts sourcing and tracing the history of individual cars.`,services:[`Jensen parts supply`,`Original factory documents`,`Vehicle history tracing`,`C-V8 parts`,`Interceptor parts`,`Heritage documentation`],models:[`all`],featured:!0},{id:`riverbourne-classics`,name:`Riverbourne Classics`,types:[`specialist`,`restoration`,`parts`],country:`United Kingdom`,countryCode:`GB`,region:`Hampshire`,city:`Otterbourne, Winchester`,website:`https://riverbourneclassics.co.uk`,phone:`+44 (0) 1962 418141`,email:null,social:{facebook:`https://www.facebook.com/riverbourneclassics`},logo:`/specialists/riverbourne-classics-logo.png`,tagline:`Restorations, trim, Jensen parts and classic car sales`,description:`Riverbourne Classics is based at Williams Garage in Otterbourne, Winchester, Hampshire. The business is run by Jason Lawrence, who brings 45 years of experience working on Jensen cars — a depth of knowledge that is rare in the classic car world. They offer a comprehensive range of services for Jensen owners including full restoration, trim work, Jensen parts supply and classic car sales.`,services:[`Full restoration`,`Trimming`,`Jensen parts`,`Classic car sales`,`Servicing`],models:[`all`],featured:!0},{id:`jensen-service`,name:`Jensen Service Ltd`,types:[`specialist`,`parts`,`restoration`],country:`United Kingdom`,countryCode:`GB`,region:`Hampshire`,city:`Itchen Abbas`,website:`https://www.jensenservice.co.uk`,phone:null,email:null,social:{ebay:`https://www.ebay.co.uk/str/jensenserviceltd`},logo:`/specialists/jensen-service-logo.png`,tagline:`Specialist mechanics, genuine parts and bespoke trim`,description:`Jensen Service Ltd was founded by Director Paul Lawrence, who spent seven years sourcing and collecting genuine Jensen parts before establishing the business. Based at Abbas Business Centre in Itchen Abbas, Hampshire, they offer comprehensive support across all Jensen models including the C-V8. Their three pillars are specialist mechanics (led by auto electrical engineer Steve Clarke), a comprehensive collection of genuine Jensen parts, and bespoke trim craftsmanship using genuine Jensen forms and hand-stitched leather. Worldwide shipping available for parts and trim.`,services:[`Servicing & MOT prep`,`Engine rebuilds`,`Electrical rewiring`,`Genuine Jensen parts`,`Bespoke trim & upholstery`,`eBay parts shop`],models:[`all`],featured:!0},{id:`jensen-heritage-center`,name:`Jensen Heritage Center`,types:[`specialist`,`restoration`,`parts`],country:`Netherlands`,countryCode:`NL`,region:`Gelderland`,city:`Epe`,website:`https://jensenhc.nl/en/`,phone:`+31 (0) 06 53 16 21 25`,email:`info@jensenhc.nl`,social:{facebook:`https://www.facebook.com/Jensen-Heritage-Center-130745504325238`,instagram:`https://www.instagram.com/vanrijnt/`},logo:`/specialists/jensen-heritage-center-logo.jpg`,tagline:`Dedicated to preserving the Jensen marque`,description:`The Jensen Heritage Center was founded by Ton van Rijn and is based in the former Tomos factory in Epe, Netherlands. Ton is a passionate Jensen enthusiast who has transformed his dedication into a specialist operation — and is particularly well known in the community for his concours-winning restoration of a Jensen C-V8, a result he is justifiably proud of. The center offers full service, restoration, redesign, maintenance and parts for Jensen vehicles across the range, serving the European Jensen community.`,services:[`Full restoration`,`Concours preparation`,`Servicing & maintenance`,`Redesign`,`Jensen parts`,`Vehicle sales`],models:[`all`],featured:!0}],Ie=[{id:`instruments`,label:`Instruments`,emoji:`📊`},{id:`electrical`,label:`Electrical & Relays`,emoji:`⚡`},{id:`lighting`,label:`Lighting & Lamps`,emoji:`💡`},{id:`horns`,label:`Horns`,emoji:`📣`},{id:`switches`,label:`Switches & Controls`,emoji:`🔘`},{id:`wipers`,label:`Wipers & Washer`,emoji:`🌧️`},{id:`steering`,label:`Steering Column`,emoji:`⚙️`}],Le=[{id:`ammeter`,system:`instruments`,component:`Ammeter`,partNumber:`*36322A`,lucasModel:`CZU60`,notes:null,parts:[{description:`Nut, fixing clamp`,partNumber:`169050`,recommended:!1},{description:`Washer, fixing clamp nut`,partNumber:`185026`,recommended:!0},{description:`Clamp, fixing ammeter`,partNumber:`54360331`,recommended:!0},{description:`Nut, terminal`,partNumber:`166043`,recommended:!0},{description:`Washer, terminal nut`,partNumber:`185040`,recommended:!0},{description:`Connector, Lucar 'M' (large)`,partNumber:`199317`,recommended:!0},{description:`Connector, Lucar 'M' (small)`,partNumber:`199275`,recommended:!0},{description:`Bulb`,partNumber:`987`,recommended:!0},{description:`Bulbholder`,partNumber:`54944812`,recommended:!0}]},{id:`battery`,system:`instruments`,component:`Battery`,partNumber:null,lucasModel:`BT11A`,notes:null,parts:[]},{id:`flasher-unit`,system:`electrical`,component:`Flasher Unit`,partNumber:`35020A`,lucasModel:`FL5`,notes:null,parts:[]},{id:`fuse-box`,system:`electrical`,component:`Fuse Box`,partNumber:`†033283 (54038033)`,lucasModel:`7J`,notes:`† When ordering, quote part number shown in brackets.`,parts:[{description:`Fuse, 35 amp`,partNumber:`188218`,recommended:!0},{description:`Cover`,partNumber:`54380114`,recommended:!0},{description:`Screw, terminal`,partNumber:`120560`,recommended:!1}]},{id:`relay-alternator`,system:`electrical`,component:`Relay, Alternator`,partNumber:`33213`,lucasModel:`6RA`,notes:null,parts:[]},{id:`relay-ballast`,system:`electrical`,component:`Relay, Ballast Resistance`,partNumber:`33209D`,lucasModel:`6RA`,notes:null,parts:[]},{id:`relay-fan`,system:`electrical`,component:`Relay, Fan Motor`,partNumber:`33213D`,lucasModel:`6RA`,notes:null,parts:[]},{id:`relay-horn`,system:`electrical`,component:`Relay, Horn`,partNumber:`33209D`,lucasModel:`6RA`,notes:null,parts:[]},{id:`relay-starter`,system:`electrical`,component:`Relay, Starting Motor`,partNumber:`33188D`,lucasModel:`6RA`,notes:null,parts:[]},{id:`lamp-bonnet`,system:`lighting`,component:`Lamp, Bonnet Illumination`,partNumber:`53264B`,lucasModel:`519`,notes:null,parts:[{description:`Bulb`,partNumber:`989`,recommended:!0}]},{id:`lamp-flasher`,system:`lighting`,component:`Lamp, Flasher`,partNumber:`53956B`,lucasModel:`691`,notes:null,parts:[{description:`Lens`,partNumber:`54572776`,recommended:!0},{description:`Screw, fixing lens`,partNumber:`54111111`,recommended:!1},{description:`Washer, retaining screw`,partNumber:`161385`,recommended:!1},{description:`Gasket, seating lens`,partNumber:`54572200`,recommended:!0},{description:`Interior bulbholder`,partNumber:`573832`,recommended:!0},{description:`Bulb`,partNumber:`382`,recommended:!0},{description:`Grommet, cable entry`,partNumber:`54572247`,recommended:!0},{description:`Gasket, seating lamp`,partNumber:`54572755`,recommended:!0},{description:`Body`,partNumber:`54572734`,recommended:!1},{description:`Nut, fixing lamp`,partNumber:`166019`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`188330`,recommended:!1}]},{id:`lamp-head-1a`,system:`lighting`,component:`Lamp, Headlamp (1A Unit — Nor/Dip)`,partNumber:`*58993A`,lucasModel:`54`,notes:null,parts:[{description:`Rim`,partNumber:`*54521087`,recommended:!0},{description:`Rim, light unit retaining`,partNumber:`54520356`,recommended:!0},{description:`Screw, unit rim fixing`,partNumber:`186134`,recommended:!1},{description:`Light unit`,partNumber:`54521805`,recommended:!0},{description:`Adaptor`,partNumber:`553738`,recommended:!1},{description:`Trimmer screw set`,partNumber:`54520384`,recommended:!1},{description:`Rim, unit seating`,partNumber:`54520209`,recommended:!1},{description:`Bush, rubber, fixed point pin`,partNumber:`54520214`,recommended:!1},{description:`Pin, fixed point`,partNumber:`54520213`,recommended:!1},{description:`Gasket, lamp seating`,partNumber:`*54521040`,recommended:!0},{description:`Sleeve, sealing`,partNumber:`54520216`,recommended:!1}]},{id:`lamp-head-2a`,system:`lighting`,component:`Lamp, Headlamp (2A Unit — Dip)`,partNumber:`*59059A`,lucasModel:`F700`,notes:null,parts:[{description:`Rim or door`,partNumber:`54520443`,recommended:!0},{description:`Plate, retaining light unit`,partNumber:`54520549`,recommended:!0},{description:`Screw, fixing unit retaining plate`,partNumber:`186137`,recommended:!1},{description:`Rim, unit seating`,partNumber:`54520446`,recommended:!1},{description:`Light unit`,partNumber:`54521060`,recommended:!0},{description:`Adaptor`,partNumber:`553738`,recommended:!1},{description:`Spring, fixing unit seating rim`,partNumber:`54520514`,recommended:!1},{description:`Screw, trimmer`,partNumber:`54520451`,recommended:!1},{description:`Housing, trimmer screw nut`,partNumber:`54520550`,recommended:!1},{description:`Nut, trimmer screw`,partNumber:`54520551`,recommended:!1}]},{id:`lamp-number-plate`,system:`lighting`,component:`Lamp, Number Plate Illumination & Reverse`,partNumber:`53159A`,lucasModel:`469`,notes:null,parts:[{description:`Cover`,partNumber:`572347`,recommended:!1},{description:`Glass, reverse`,partNumber:`572328`,recommended:!1},{description:`Screw, cover fixing`,partNumber:`113531`,recommended:!1},{description:`Washer, screw retaining`,partNumber:`161385`,recommended:!1},{description:`Bead, cover joint`,partNumber:`572326`,recommended:!1},{description:`Sleeve, terminal`,partNumber:`188818`,recommended:!1},{description:`Bung, rubber`,partNumber:`572685`,recommended:!1},{description:`Nut, fixing lamp`,partNumber:`177014`,recommended:!1},{description:`Washer, shakeproof`,partNumber:`188329`,recommended:!1},{description:`Bulb, reverse`,partNumber:`382`,recommended:!0},{description:`Bulb, number plate`,partNumber:`989`,recommended:!0},{description:`Base`,partNumber:`572689`,recommended:!1},{description:`Grommet, cable entry`,partNumber:`199001`,recommended:!1}]},{id:`lamp-side`,system:`lighting`,component:`Lamp, Side`,partNumber:`52406B`,lucasModel:`516`,notes:null,parts:[{description:`Screw, fixing bulbholder`,partNumber:`116141`,recommended:!1},{description:`Washer, retaining screw`,partNumber:`161385`,recommended:!1},{description:`Rim, front`,partNumber:`573646`,recommended:!0},{description:`Gasket, mounting lens`,partNumber:`573619`,recommended:!1},{description:`Lens`,partNumber:`573615`,recommended:!0},{description:`Bracket complete with bulbholder`,partNumber:`573624`,recommended:!1},{description:`Interior, bulbholder`,partNumber:`553780`,recommended:!1},{description:`Bulb`,partNumber:`909`,recommended:!0},{description:`Nut, fixing lamp`,partNumber:`181261`,recommended:!1},{description:`Washer, lamp fixing nut`,partNumber:`185085`,recommended:!1},{description:`Washer, mudwing`,partNumber:`551803`,recommended:!1},{description:`Bolt, fixing lamp`,partNumber:`520395`,recommended:!1}]},{id:`lamp-stop-tail`,system:`lighting`,component:`Lamp, Stop/Tail`,partNumber:`53955B`,lucasModel:`692`,notes:null,parts:[{description:`Lens`,partNumber:`54572774`,recommended:!0},{description:`Screw, fixing lens`,partNumber:`54111111`,recommended:!1},{description:`Washer, retaining screw`,partNumber:`161385`,recommended:!1},{description:`Gasket, seating lens`,partNumber:`54572200`,recommended:!0},{description:`Interior, bulbholder`,partNumber:`573828`,recommended:!1},{description:`Bulb`,partNumber:`380`,recommended:!0},{description:`Grommet, cable entry`,partNumber:`54572202`,recommended:!0},{description:`Gasket, seating lamp`,partNumber:`54572755`,recommended:!0},{description:`Body`,partNumber:`54572660`,recommended:!1},{description:`Nut, fixing lamp`,partNumber:`166019`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`188330`,recommended:!1}]},{id:`reflex-reflector`,system:`lighting`,component:`Reflex Reflector`,partNumber:`57123B`,lucasModel:`RER30`,notes:null,parts:[{description:`Rim complete with reflector`,partNumber:`54571355`,recommended:!0},{description:`Rim, reflector`,partNumber:`574257`,recommended:!0},{description:`Reflector, reflex`,partNumber:`54571128`,recommended:!1},{description:`Ring, sliding`,partNumber:`574255`,recommended:!0},{description:`Gasket, seating reflex`,partNumber:`575640`,recommended:!1},{description:`Body, reflex reflector`,partNumber:`54571473`,recommended:!1},{description:`Nut, fixing reflex reflector`,partNumber:`166036`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`188483`,recommended:!1},{description:`Gasket, seating body`,partNumber:`54571148`,recommended:!0}]},{id:`horn-low`,system:`horns`,component:`Horn (Low Note)`,partNumber:`69127A`,lucasModel:`WT618`,notes:null,parts:[{description:`Cover`,partNumber:`54680655`,recommended:!0},{description:`Support, cover`,partNumber:`702626`,recommended:!1},{description:`Bracket`,partNumber:`707095`,recommended:!1},{description:`Contact, set`,partNumber:`702687`,recommended:!0},{description:`Clock terminal and resistance`,partNumber:`54680536`,recommended:!1},{description:`Diaphragm`,partNumber:`702836`,recommended:!0},{description:`Sundry parts, set`,partNumber:`702722`,recommended:!0}]},{id:`horn-high`,system:`horns`,component:`Horn (High Note)`,partNumber:`69128A`,lucasModel:`WT618`,notes:`Other details as Low Note horn 69127A.`,parts:[{description:`Diaphragm`,partNumber:`702851`,recommended:!0}]},{id:`switch-courtesy`,system:`switches`,component:`Switch, Courtesy Light`,partNumber:`†31180A (31404)`,lucasModel:`94`,notes:`† When ordering, quote part number shown in brackets.`,parts:[]},{id:`switch-dipper`,system:`switches`,component:`Switch, Dipper (Headlamp Dip)`,partNumber:`31800B`,lucasModel:`21SA`,notes:null,parts:[{description:`Pad, insulating`,partNumber:`360373`,recommended:!1}]},{id:`switch-indicator`,system:`switches`,component:`Switch, Direction Indicator`,partNumber:`*34638A`,lucasModel:`37SA`,notes:null,parts:[{description:`Contact, warning light`,partNumber:`54333160`,recommended:!1},{description:`Contact`,partNumber:`54332538`,recommended:!1},{description:`Spring, pawl centring`,partNumber:`346323`,recommended:!1}]},{id:`switch-heater`,system:`switches`,component:`Switch, Heater`,partNumber:`31788D`,lucasModel:`57SA`,notes:null,parts:[{description:`Nut, fixing`,partNumber:`153633`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`54148517`,recommended:!1}]},{id:`switch-lighting`,system:`switches`,component:`Switch, Lighting`,partNumber:`31788D`,lucasModel:`57SA`,notes:`Same Lucas model as Switch, Heater.`,parts:[]},{id:`switch-panel`,system:`switches`,component:`Switch, Panel`,partNumber:`*34640A`,lucasModel:`57SA`,notes:null,parts:[{description:`Nut, fixing`,partNumber:`153631`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`541485`,recommended:!1}]},{id:`switch-petrol-filler`,system:`switches`,component:`Switch, Petrol Filler Cap`,partNumber:`34570A`,lucasModel:`57SA`,notes:null,parts:[{description:`Nut, fixing`,partNumber:`153601`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`54148517`,recommended:!1}]},{id:`switch-solenoid-petrol`,system:`switches`,component:`Switch, Solenoid, Petrol Filler Cap`,partNumber:`*76543A`,lucasModel:`11S`,notes:null,parts:[{description:`Cover, contact`,partNumber:`765933`,recommended:!1},{description:`Cover, rubber`,partNumber:`765063`,recommended:!1}]},{id:`switch-starter-ignition`,system:`switches`,component:`Switch, Starter & Ignition`,partNumber:`31973E`,lucasModel:`47SA`,notes:null,parts:[{description:`Nut, fixing, front`,partNumber:`153591`,recommended:!1},{description:`Washer, fixing nut`,partNumber:`154506`,recommended:!1},{description:`Nut, fixing, rear`,partNumber:`156570`,recommended:!1}]},{id:`switch-stop-lamp`,system:`switches`,component:`Switch, Stop Lamp`,partNumber:`31802D`,lucasModel:`HL2`,notes:null,parts:[]},{id:`switch-wiper-screenjet`,system:`switches`,component:`Switch, Windshield Wiper & Screenjet`,partNumber:`31714A`,lucasModel:`50SA`,notes:null,parts:[{description:`Switch, screenjet`,partNumber:`31513`,recommended:!1},{description:`Knob`,partNumber:`313682`,recommended:!1}]},{id:`warning-light-flasher`,system:`switches`,component:`Warning Light, Flasher`,partNumber:`38177A`,lucasModel:`WL13`,notes:null,parts:[{description:`Cover and window`,partNumber:`319419`,recommended:!0},{description:`Bulb`,partNumber:`987`,recommended:!0},{description:`Bulbholder`,partNumber:`554734`,recommended:!0},{description:`Body, bracket`,partNumber:`319204`,recommended:!1},{description:`Nut, body`,partNumber:`319203`,recommended:!1}]},{id:`wiper-motor`,system:`wipers`,component:`Windshield Wiper — Motor`,partNumber:`75487A`,lucasModel:`DR3`,notes:null,parts:[{description:`Bolt, fixing 2BA`,partNumber:`145696`,recommended:!1},{description:`Cover end complete with bearing (commutator end)`,partNumber:`743653`,recommended:!1},{description:`Screw, earth lead`,partNumber:`126444`,recommended:!1},{description:`Brushgear`,partNumber:`743171`,recommended:!0},{description:`Brush set`,partNumber:`729367`,recommended:!0},{description:`Spring, brush`,partNumber:`735631`,recommended:!1},{description:`Armature`,partNumber:`743929`,recommended:!0},{description:`Coil`,partNumber:`54713957`,recommended:!0},{description:`Studs, fixing (set of parts)`,partNumber:`743176`,recommended:!1},{description:`Cover, gearbox`,partNumber:`743924`,recommended:!1},{description:`Screw, cover fixing`,partNumber:`186134`,recommended:!1},{description:`Switch, self parking`,partNumber:`743846`,recommended:!0},{description:`Sleeve, adjusting`,partNumber:`740557`,recommended:!1},{description:`Spring, adjusting screw`,partNumber:`733270`,recommended:!1},{description:`Screw, adjusting`,partNumber:`740556`,recommended:!1},{description:`Rod, connecting`,partNumber:`740563`,recommended:!0},{description:`Shaft and gear`,partNumber:`748797`,recommended:!0},{description:`Sundry parts, set`,partNumber:`740899`,recommended:!0}]},{id:`wiper-wheelbox`,system:`wipers`,component:`Windshield Wiper — Wheelbox`,partNumber:`*72777A`,lucasModel:null,notes:null,parts:[{description:`Spindle and gear`,partNumber:`54713660`,recommended:!0},{description:`Nut, fixing wheelbox`,partNumber:`54130691`,recommended:!1},{description:`Bush, front`,partNumber:`740818`,recommended:!1},{description:`Bush, centre`,partNumber:`744293`,recommended:!1},{description:`Washer`,partNumber:`740820`,recommended:!1},{description:`Bush, rear`,partNumber:`744358`,recommended:!1},{description:`Nut, fixing cover`,partNumber:`156726`,recommended:!1},{description:`Outer casing, short, wheelbox`,partNumber:`740746`,recommended:!1},{description:`Outer casing, wheelbox to wheelbox`,partNumber:`54716113`,recommended:!1},{description:`Rack (cut to 48-21/32")`,partNumber:`744257`,recommended:!1},{description:`Arm, right hand drive`,partNumber:`*54711442`,recommended:!1},{description:`Arm, left hand drive`,partNumber:`*54711441`,recommended:!1},{description:`Blade`,partNumber:`54714390`,recommended:!1}]},{id:`screenjet`,system:`wipers`,component:`Screenjet (Windscreen Washer)`,partNumber:`†077011 (54071191)`,lucasModel:`2SJ`,notes:`† When ordering, quote part number shown in brackets.`,parts:[{description:`Motor and pump`,partNumber:`78309D`,recommended:!1},{description:`Motor complete with coupling`,partNumber:`295085`,recommended:!0},{description:`Contact, switch complete with adjusting screw`,partNumber:`54714792`,recommended:!1},{description:`Brush set`,partNumber:`54711077`,recommended:!0},{description:`Armature`,partNumber:`295023`,recommended:!1},{description:`Cover, moulding`,partNumber:`295138`,recommended:!1},{description:`Cap, filler, rubber`,partNumber:`295043`,recommended:!0},{description:`Gasket, cover rubber`,partNumber:`295042`,recommended:!0},{description:`Union, motor to pump fixing`,partNumber:`295045`,recommended:!1},{description:`Pump`,partNumber:`295194`,recommended:!0},{description:`Sundry parts, set`,partNumber:`295196`,recommended:!0},{description:`Jar`,partNumber:`295058`,recommended:!1},{description:`Bracket`,partNumber:`295061`,recommended:!1},{description:`‡Nozzle`,partNumber:`295110`,recommended:!1},{description:`Nozzle`,partNumber:`295005`,recommended:!0},{description:`Plate, clamp, upper`,partNumber:`295067`,recommended:!1},{description:`Plate, clamp, lower`,partNumber:`295068`,recommended:!1},{description:`Gasket, clamp plate rubber`,partNumber:`295268`,recommended:!1},{description:`Washer, nozzle rubber`,partNumber:`295098`,recommended:!1},{description:`Spanner`,partNumber:`770652`,recommended:!1},{description:`Screw, fixing`,partNumber:`186147`,recommended:!1},{description:`‡Tubing`,partNumber:`295229`,recommended:!1},{description:`‡Screw, jar bracket fixing`,partNumber:`198865`,recommended:!1}]},{id:`steering-column-control`,system:`steering`,component:`Steering Column Control`,partNumber:`*32953B`,lucasModel:`CC5`,notes:null,parts:[{description:`Top cover`,partNumber:`32462`,recommended:!1},{description:`Spring, horn push`,partNumber:`32274`,recommended:!1},{description:`Bracket, stop horn contact`,partNumber:`323756`,recommended:!1},{description:`Contact, horn push`,partNumber:`323738`,recommended:!1},{description:`Bracket circlips and contact plate`,partNumber:`324338`,recommended:!1},{description:`Sundry parts, set`,partNumber:`322382`,recommended:!0},{description:`‖Cable`,partNumber:`862481`,recommended:!1},{description:`‖Knob, horn push`,partNumber:`333348`,recommended:!1}]}],Re={title:`Lucas Equipment & Spare Parts — Jensen C-V8`,reference:`NVS 1930`,issued:`October 1962`,publisher:`Joseph Lucas Ltd, Birmingham 18, England`,notes:`Original printed document. Some part numbers may have minor transcription uncertainty where the source document is partially illegible — always verify against the original scan before ordering.`},ze=[{id:`mk1`,name:`Jensen C-V8 Mk I`,tagline:`The exciting new Grand Touring saloon.`,years:`1962 – 1963`,produced:70,originalPriceGBP:2780,originalPriceNote:`approx. 1962 list price`,todayEquivalentGBP:61e3,heroImage:`/showroom/cv8-mk1-hero.jpg`,description:`Designed in the Jensen tradition of safety with speed. The C-V8 combines a modified Chrysler V8 engine — giving over 140 mph — with a super-streamlined resin bonded fibrous glass body, Dunlop self-adjusting disc brakes on all four wheels, and a de luxe interior that seats four adults in comfort. First shown at the International Motor Show, Earls Court, October 1962. Just 70 were built.`,highlights:[`Over 140 mph — modified Chrysler V8`,`0 to 100 mph and back to a stop in under 24 seconds`,`Dunlop self-adjusting disc brakes — all four wheels`,`Super-streamlined resin bonded fibrous glass body`,`De luxe interior — seats 4 adults in comfort`,`19 cu ft luggage accommodation`],differences:`Distinguished by chrome headlamp bezels and early interior trim details. The rarest of the three marks — one of just 70 ever built.`,adImages:[{src:`/showroom/mk1-ad-charles-follett.jpg`,caption:`"See the Exciting Jensen C-V8" — Charles Follett Ltd, Berkeley Street London W1, The Motor, October 1962`},{src:`/showroom/mk1-ad-announcing.jpg`,caption:`"Announcing the New Jensen C-V.8" — International Motor Show, Earls Court, October 17th 1962`},{src:`/showroom/mk1-ad-dunlop.jpg`,caption:`"Dunlop Road Speed Tyres & Disc Brakes — chosen for these two celebrities" — The Motor, October 1962`},{src:`/showroom/mk1-ad-snappon-ep.jpg`,caption:`Supplier advertisements — Snappon door seals and EP rack & pinion steering, The Motor, October 1962`}]},{id:`mk2`,name:`Jensen C-V8 Mk II`,tagline:`The definitive GT.`,years:`1963 – 1965`,produced:216,originalPriceGBP:2895,originalPriceNote:`approx. 1963 list price`,todayEquivalentGBP:64e3,heroImage:`/showroom/cv8-mk2-hero.jpg`,description:`The Mk II refined and consolidated the C-V8 formula, bringing improved interior appointments and detail changes that would define the car's character. With 216 built, the Mk II represents the heart of C-V8 production — and the version most closely associated with the car's golden era.`,highlights:[`Refined interior and improved detail finish`,`Full Connolly hide upholstery throughout`,`TorqueFlite automatic or 4-speed manual gearbox`,`216 produced — the most common of the three marks`],differences:`Updated headlamp treatment and revised interior compared to the Mk I. The most frequently seen mark in the community.`},{id:`mk3`,name:`Jensen C-V8 Mk III`,tagline:`The pinnacle of the line.`,years:`1965 – 1966`,produced:214,originalPriceGBP:3679,originalPriceManualGBP:3779,originalPriceNote:`total on-the-road price inc. Purchase Tax · automatic transmission`,originalPriceSource:`Jensen Motors Ltd official price list KS/BP/665/10M/I`,todayEquivalentGBP:81e3,todayEquivalentManualGBP:83e3,priceListImage:`/showroom/mk3-price-list.jpg`,heroImage:`/showroom/cv8-mk3-hero.jpg`,heroNightImage:`/showroom/cv8-mk3-hero.jpg`,frontImage:`/showroom/mk3-front-side.jpg`,overviewImages:[{src:`/showroom/mk3-rear.jpg`,alt:`Jensen C-V8 Mk III — rear view`},{src:`/showroom/mk3-rear-side.jpg`,alt:`Jensen C-V8 Mk III — three-quarter rear`},{src:`/showroom/mk3-close-up-artie.jpg`,alt:`Jensen C-V8 Mk III — bonnet badge`}],lifestyleImage:`/showroom/mk3-close-up-artie.jpg`,lifestyleCaption:`Jensen C-V8 Mk III — Indigo Blue. The Jensen winged badge, West Bromwich, England.`,colourImages:{"Botticelli Blue":`/showroom/cv8-mk3-botticelli-blue-day.jpg`,"Princess Grey":`/showroom/cv8-mk3-princess-grey-day.jpg`,"Regal Red":`/showroom/cv8-mk3-regal-red-day.jpg`,"Indigo Blue":`/showroom/cv8-mk3-indigo-blue-day.jpg`,"Pastel Pink":`/showroom/cv8-mk3-pastel-pink-day.jpg`},colourNightImages:{"Botticelli Blue":`/showroom/cv8-mk3-botticelli-blue-night.jpg`,"Princess Grey":`/showroom/cv8-mk3-princess-grey-night.jpg`,"Regal Red":`/showroom/cv8-mk3-regal-red-night.jpg`,"Pastel Pink":`/showroom/cv8-mk3-pastel-pink-night.jpg`},defaultInteriorImage:`/showroom/interior-bright-red.jpg`,defaultInteriorNightImage:`/showroom/interior-bright-red-night.jpg`,trimImages:{"Blue-Grey":`/showroom/interior-blue-grey.jpg`,"Bright Red":`/showroom/interior-bright-red.jpg`},trimNightImages:{"Blue-Grey":`/showroom/interior-blue-grey-night.jpg`,"Bright Red":`/showroom/interior-bright-red-night.jpg`},frontImage:`/showroom/cv8-mk3-front.jpg`,standardColours:[`Black`,`Indigo Blue`,`Princess Grey`,`Regal Red`,`Oyster Grey`,`Deep Carriage Green`,`Californian Sage`,`Peony`,`Botticelli Blue`],standardTrim:[`Beige`,`Bright Red`,`Blue-Grey`,`Dark Red`,`Light Mushroom`,`Grey`,`Green`,`Black`],specialExteriorSurcharge:{originalGBP:18,todayGBP:399,label:`£15.0.0 + £3.2.6 p.t.`},specialInteriorSurcharge:{originalGBP:36,todayGBP:798,label:`£30.0.0 + £6.5.0 p.t.`},description:`Docile but powerful — sleeker and more luxurious than ever before. The Mk III was the final and most accomplished expression of the C-V8, bringing the Armstrong Selectaride electrically-adjustable shock absorbers as standard — one of the first production cars in the world to offer this feature. A car for the top man. Calm. But very powerful. Very safe.`,highlights:[`Armstrong Selectaride adjustable dampers — a world first`,`Most refined interior of the three marks`,`Individual chrome JENSEN letters across the bonnet lid`,`Snetterton 24-hour record: 1,866 miles at 79 mph average — Commander's Cup`],differences:`The most complete C-V8. Selectaride dampers and a more lavishly appointed interior set it apart. Proven at Snetterton — 24 hours, requiring only refuelling.`,adImages:[{src:`/showroom/mk3-ad-commanders-cup.jpg`,caption:`Original Jensen advertisement — "New to Jensen: The C-V8 Mk III & The Commanders Cup"`}]}],Be=[{name:`Princess Grey`,css:`#9ea3a8`,made:100,popular:!0,iciCode:`M049-2334`},{name:`Indigo Blue`,css:`#2e3f6d`,made:71,popular:!0,iciCode:`M048-2086`},{name:`Botticelli Blue`,css:`#4a6fa5`,made:69,iciCode:`P030-2309`},{name:`Regal Red`,css:`#8b1c1c`,made:67,popular:!0,iciCode:`P031-2394`},{name:`Deep Carriage Green`,css:`#2c4a2c`,made:54,popular:!0,iciCode:`P030-2747`},{name:`Oyster Grey`,css:`#b8b0a4`,made:31,iciCode:`M031-2116`},{name:`Sun Bronze`,css:`#8b6914`,made:23,iciCode:`M049-2027`},{name:`California Sage`,css:`#7a8c5e`,made:15,iciCode:`M031-2629`},{name:`Smoke Green`,css:`#506050`,made:14,iciCode:null},{name:`Off White`,css:`#f0ebe0`,made:13,iciCode:null},{name:`Peony Red`,css:`#c5394d`,made:12,iciCode:`M049-4715`},{name:`Black`,css:`#1a1a1a`,made:8,iciCode:`M030-122`},{name:`Spa White`,css:`#f5f2ec`,made:5,iciCode:null},{name:`Special White`,css:`#fafafa`,made:4,iciCode:null},{name:`Carmine`,css:`#960018`,made:2,iciCode:`M030-9039`},{name:`Metallic Quartz Blue`,css:`#6b88b8`,made:2,iciCode:null},{name:`Pastel Pink`,css:`#f0aab8`,made:2,iciCode:null},{name:`Reno Red`,css:`#9e3030`,made:1,iciCode:null},{name:`Dawn Blue`,css:`#7ab0c8`,made:1,iciCode:null},{name:`Fawn`,css:`#c4a07a`,made:1,iciCode:`P031-2165`},{name:`Metallic Grey`,css:`#9a9ea3`,made:1,iciCode:null},{name:`Sherwood Green`,css:`#2d5a27`,made:1,iciCode:null},{name:`Autumn Gold`,css:`#c8860a`,made:1,iciCode:`P031-2515`},{name:`Cadogan Brown`,css:`#6b4423`,made:1,iciCode:null}],Ve=[{name:`Beige`,css:`#c8b898`,made:93,popular:!0},{name:`Bright Red`,css:`#cc2222`,made:82,popular:!0},{name:`Blue-Grey`,css:`#8a9bb0`,made:76,popular:!0},{name:`Black`,css:`#1a1a1a`,made:73,popular:!0},{name:`Mushroom`,css:`#b5a090`,made:54},{name:`Dark Red`,css:`#7a1515`,made:39},{name:`Green`,css:`#4a6040`,made:28},{name:`Light Mushroom`,css:`#d4c4b0`,made:18},{name:`Bentley Grey`,css:`#8a8a85`,made:16},{name:`Tan`,css:`#b8935a`,made:4},{name:`Light Tan`,css:`#d4ae7a`,made:3},{name:`Brown`,css:`#6b4028`,made:1},{name:`Cerise`,css:`#de3163`,made:1},{name:`Dark Blue`,css:`#1a2a5c`,made:1}],He=[{id:`standard`,name:`Painted Steel Wheels`,description:`Original 15" painted steel wheels as standard, fitted with period hubcaps. 15 × 4.5", 5 × 127mm PCD.`,period:`Standard fitment`},{id:`wire`,name:`Dunlop Wire Wheels`,description:`Optional chrome wire wheels by Dunlop — a popular and period-correct upgrade that enhances the sporting character of the C-V8.`,period:`Optional factory fit`}],Ue={engine:{label:`Engine`,value:`Chrysler 383 cu in (5,916 cc) V8`},power:{label:`Power`,value:`305 bhp at 4,800 rpm`},torque:{label:`Torque`,value:`410 lb/ft`},compression:{label:`Compression`,value:`9:1`},transmission:{label:`Transmission`,value:`TorqueFlite 3-speed automatic (optional: 4-speed manual with overdrive)`},topSpeed:{label:`Top Speed`,value:`Approx. 136 mph`},acceleration:{label:`0–60 mph`,value:`Approx. 7.8 seconds`},body:{label:`Body`,value:`Hand-built fibreglass coupé over steel chassis`},weight:{label:`Weight`,value:`29 cwt (1,473 kg)`},wheelbase:{label:`Wheelbase`,value:`8 ft 9 in (2,667 mm)`},length:{label:`Length`,value:`15 ft 4 in (4,674 mm)`},fuel:{label:`Fuel Tank`,value:`16 gallons (72 litres)`},tyres:{label:`Tyres`,value:`Dunlop 6.70–15 (modern equivalent: 205/70-15)`}},We=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),j=o(((e,t)=>{t.exports=We()}))(),Ge=[{title:`Dashboard & Controls`,pages:[4],tags:`dashboard instruments controls switches gauges warning lights`},{title:`Specifications & Capacities`,pages:[5,6],tags:`specifications capacity timing plug gap compression oil dimensions`},{title:`Motor, Starting & Running`,pages:[7,8,9],tags:`engine motor starting running gearbox transmission overdrive towing`},{title:`Lubrication & Maintenance`,pages:[10,11,25,26,27,28],tags:`lubrication maintenance grease oil service miles`},{title:`Electrical, Battery & Fuses`,pages:[12,13],tags:`electrical lucas autolite battery positive earth fuse fuses bulbs lamps wiper`},{title:`Brakes & Servo`,pages:[13],tags:`brakes servo dunlop brake fluid handbrake vacuum`},{title:`Fuel System & Carburetter`,pages:[15,16],tags:`fuel carburetter carter idle fast idle choke throttle linkage`},{title:`Tyres, Wheels & Alignment`,pages:[17,18,19],tags:`tyres tires wheels alignment bearings toe-in castor camber`},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],tags:`cooling fan radiator heater ventilation antifreeze coolant rear axle powr-lok drive belt`},{title:`Interior & Owner Information`,pages:[2,3,22,23,31,32],tags:`owner warranty seats upholstery vehicle particulars chassis engine key`}],Ke=[{title:`Cover`,pages:[1],category:`overview`,tags:[]},{title:`Introduction`,pages:[2,3],category:`overview`,tags:[`owner`,`handbook`,`warranty`]},{title:`Dashboard & Controls`,pages:[4],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`gauges`,`switches`,`warning lights`]},{title:`Specifications & Dimensions`,pages:[5,6],category:`specs`,tags:[`specifications`,`dimensions`,`capacity`,`timing`,`compression`,`spark plug`,`ignition`]},{title:`Starting, Gearbox & Towing`,pages:[7,8,9],category:`mechanical`,tags:[`starting`,`engine`,`gearbox`,`overdrive`,`towing`,`transmission`,`running-in`]},{title:`Lubrication & Maintenance`,pages:[10,11],category:`lubrication`,tags:[`lubrication`,`oil`,`grease`,`maintenance`,`filter`,`dipstick`]},{title:`Electrical Equipment`,pages:[12,13],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`bulbs`,`wiring`,`lucas`,`autolite`,`wiper`]},{title:`Brakes & Servo`,pages:[14],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`handbrake`,`vacuum`,`dunlop`]},{title:`Fuel System & Carburettor`,pages:[15,16,17],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`carter`]},{title:`Tyres, Wheels & Alignment`,pages:[18,19],category:`wheels`,tags:[`tyres`,`wheels`,`alignment`,`toe-in`,`camber`,`bearings`,`tyre pressure`]},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],category:`cooling`,tags:[`cooling`,`radiator`,`antifreeze`,`heater`,`rear axle`,`fan belt`,`powr-lok`]},{title:`Interior & Owner Information`,pages:[22,23,24],category:`interior`,tags:[`seats`,`upholstery`,`interior`,`owner`,`chassis number`]},{title:`Service Lubrication`,pages:[25,26,27,28],category:`service`,tags:[`service`,`lubrication`,`grease points`,`capacities`,`oil change`]},{title:`Index`,pages:[29],category:`overview`,tags:[`index`]},{title:`Vehicle Particulars`,pages:[31,32],category:`overview`,tags:[`chassis number`,`engine number`,`registration`,`delivery`]}],qe=[{title:`Handbook Cover`,pages:[1],category:`overview`,tags:[]},{title:`Vehicle Particulars`,pages:[3],category:`overview`,tags:[`chassis number`,`key number`,`registration`,`delivery`]},{title:`Foreword`,pages:[5],category:`overview`,tags:[`handbook`,`owner`,`jensen motors`]},{title:`General Dimensions & Data`,pages:[7,8],category:`specs`,tags:[`dimensions`,`specifications`,`weight`,`wheelbase`,`turning circle`,`gear ratios`]},{title:`Instruments & Controls Diagram`,pages:[9],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`diagram`,`layout`]},{title:`Controls & Instruments`,pages:[11,12,13],category:`overview`,tags:[`controls`,`instruments`,`gauges`,`switches`,`headlights`,`horn`,`heater fan`,`selectaride`,`speedometer`,`ammeter`,`oil pressure`]},{title:`Starting Up & Running`,pages:[15,16,17,18],category:`mechanical`,tags:[`starting`,`running-in`,`gearbox`,`overdrive`,`towing`,`push starting`,`choke`,`transmission`]},{title:`Engine Lubrication System`,pages:[19],category:`lubrication`,tags:[`engine oil`,`oil filter`,`sump`,`oil change`,`dipstick`,`oil pressure`,`4000 miles`]},{title:`Maintenance Schedule`,pages:[20,21,22],category:`service`,tags:[`maintenance`,`service intervals`,`king pin`,`spark plugs`,`lubrication diagram`,`grease points`]},{title:`Fuel System & Carburettor`,pages:[23,24,25,26,27],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`air cleaner`,`crankcase vent`]},{title:`Ignition`,pages:[29,30],category:`electrical`,tags:[`ignition`,`contact breaker`,`timing`,`distributor`,`coil`,`ballast resistor`]},{title:`Cooling System`,pages:[31,32],category:`cooling`,tags:[`cooling`,`radiator`,`coolant`,`fan`,`thermostat`,`antifreeze`,`electric fans`]},{title:`Transmission & Propeller Shaft`,pages:[33,34],category:`mechanical`,tags:[`transmission`,`gearbox`,`propeller shaft`,`universal joint`,`transmission fluid`]},{title:`Steering & Suspension`,pages:[35,36,37],category:`mechanical`,tags:[`steering`,`suspension`,`rack and pinion`,`wishbone`,`front hubs`,`wheel alignment`,`dampers`]},{title:`Brake Servo Unit`,pages:[38],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`disc brakes`,`handbrake`]},{title:`Wheels & Tyres`,pages:[39,40],category:`wheels`,tags:[`wheels`,`tyres`,`tyre pressure`,`wheel changing`,`jack`,`spare wheel`]},{title:`Bodywork & Seats`,pages:[41,42],category:`interior`,tags:[`bodywork`,`doors`,`seats`,`upholstery`,`adjustment`]},{title:`Spare Wheel`,pages:[43],category:`wheels`,tags:[`spare wheel`,`boot`,`jack`]},{title:`Cabin Heating & Ventilation`,pages:[45,46],category:`interior`,tags:[`heating`,`ventilation`,`heater`,`fresh air`,`fan`,`demist`]},{title:`Electrical System`,pages:[47,48],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`wiring`,`earth`,`alternator`,`interior light`]},{title:`Lights`,pages:[49,50],category:`electrical`,tags:[`lights`,`headlamps`,`sidelights`,`bulbs`,`reversing light`,`number plate light`,`flasher`]},{title:`Tool Kit & Equipment`,pages:[51,52,53],category:`overview`,tags:[`tools`,`toolkit`,`equipment`,`accessories`]},{title:`Service Lubrication`,pages:[55,56,57,58],category:`service`,tags:[`service`,`lubrication`,`oil change`,`grease`,`intervals`,`capacities`,`transmission fluid`]},{title:`Index`,pages:[59,60],category:`overview`,tags:[`index`]}];function Je(e){let t=new Map;for(let n of e)n.pages.forEach((e,r)=>{t.set(e,{sectionTitle:n.title,isContinuation:r>0,category:n.category||`general`,tags:n.tags||[]})});return t}var Ye=Je(Ke),M=Je(qe);function Xe(e,t){return(t===`mk3`?M:Ye).get(e)||null}function Ze(e,t,n){let r=Xe(e,t);return r?r.isContinuation?`${r.sectionTitle} (cont.)`:r.sectionTitle:n}var Qe={all:`All Models`,mk1:`Mk I`,mk2:`Mk II`,mk3:`Mk III`},$e=`/manuals/jensen_cv8_owners_manual.pdf`,et=`/manuals/jensen-cv8-mk3-instruction-manual.pdf`;function N(e){let t=String(e.title||``).toLowerCase(),n=String(e.text??e.ocrText??``).trim();return e.hidden||e.type===`blank`||t===`blank page`?`blank`:e.type?e.type:n?`text`:`diagram`}function tt(e,t,n,r){return e.map(e=>{let i=e.text??e.ocrText??``,a=N({...e,text:i}),o=a===`blank`,s=a===`diagram`||e.isImageOnly===!0;return{...e,type:a,hidden:o||e.hidden===!0,isImageOnly:s,model:e.model||t,modelLabel:e.modelLabel||n,sourcePdf:e.sourcePdf||r,sourcePage:e.sourcePage||e.page,text:i,summary:e.summary??e.plainEnglish??(s?`Image-only reference page. Use the original scan for this page.`:``),title:e.title||`Page ${e.page}`}})}function nt(e){return e.filter(e=>!e.hidden)}function rt(e,t,n=1){let r=nt(e);if(!r.length)return null;let i=r.find(e=>e.page===t);if(i)return i;let a=[...r].sort((e,t)=>e.page-t.page);return n>=0?a.find(e=>e.page>=t)||a[a.length-1]:[...a].reverse().find(e=>e.page<=t)||a[0]}var it=tt(ye,`base`,`Jensen C-V8`,$e),at=tt(be,`mk3`,`Jensen C-V8 Mk III`,et),ot=`OCR text extracted from this scanned manual page`,st=[`foreword`,`introduction`,`handbook of instructions`,`vehicle particulars`,`warranty`,`index`,`contents`,`cover`,`title page`,`jensen`],ct=/^(check|inspect|change|replace|drain|fill|remove|install|adjust|clean|tighten|loosen|ensure|apply|add|use|do not|never|always|confirm|photograph|identify|select|engage|depress|set|verify|refit|recheck|run|start|allow|push|pull|turn|disconnect|connect|torque|grease|lubricate|bleed|test|reset|secure|re-?tighten|re-?fit|re-?check)/i;function lt(e){return!Array.isArray(e)||e.length<2?!1:e.filter(e=>e.length>35&&ct.test(e)).length>=2}function ut(e){if(!e||e.length<40)return[];let t=e.replace(/\n+/g,` `).split(/(?<=[.!?])\s+/).map(e=>e.trim()).filter(e=>e.length>25&&e.length<300),n=new Set,r=[];for(let e of t){let t=e.slice(0,40).toLowerCase();n.has(t)||(/every\s+[\d,]+\s*(miles?|km|months?|years?|hours?)/i.test(e)||/\d+[\s-]*(p\.?s\.?i\.?|psi|rpm|r\.p\.m|°|degrees?|mm|ins?\.)\b/i.test(e)||/should\s+be\s+(changed|checked|drained|replaced|inspected|cleaned|adjusted|refilled|topped|removed|fitted)/i.test(e)||/must\s+(be|not)\s+/i.test(e)||/\bdo not\b|\bnever\b/i.test(e)||ct.test(e))&&(n.add(t),r.push(e))}return r.slice(0,8)}function dt(e){if(e.isImageOnly||e.type===`diagram`||!e.text?.trim())return`diagram`;let t=(e.title||``).toLowerCase();return st.some(e=>t.includes(e))?`informational`:lt(e.checklist)||ut(e.text).length>0?`repair`:`reference`}function P(e){return e.toLowerCase().replace(/(\d),(\d)/g,`$1$2`).replace(/\s+/g,` `).trim()}function ft(e,t){return P(t).includes(P(e))}function pt(e,t){if(!e)return[];let n=t.replace(/[^\d]/g,``);if(!n||n.length<3)return[];let r=e.split(`
`).map(e=>e.trim()).filter(Boolean),i=!1,a=[];for(let e of r){let t=e.match(/([\d,]{4,})\s*(miles?|km)/i);if(t){if(t[1].replace(/,/g,``)===n){i=!0;continue}else if(i)break;continue}if(i&&e.length>3){let t=e.replace(/^[A-Z]\d+\.?\s*[—–\-]+\s*/,``).trim();t.length>4&&a.push(t)}}return a}function mt(e){if(!e)return[];let t=[...e.matchAll(/([\d,]+)\s*miles/gi)],n=new Set;for(let e of t){let t=parseInt(e[1].replace(/,/g,``),10);t>=500&&t<=15e4&&n.add(t)}return[...n].sort((e,t)=>e-t).map(e=>`${e.toLocaleString()} miles`)}function ht(e,t,n){let r=(Xe(e,t)?.tags||[]).filter(e=>!/\d.*miles/i.test(e)),i=mt(n);return[...r,...i]}var gt=/\b[A-J]\d+\s*[—–\-]/;function _t(e){return gt.test(e||``)}function vt(e,t){if(!t.trim())return e;let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return e.split(RegExp(`(${n})`,`ig`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,j.jsx)(`mark`,{children:e},n):e)}function yt(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)(4),[i,a]=(0,S.useState)(100),[o,s]=(0,S.useState)(()=>localStorage.getItem(`jensen-model`)||`all`),[c,l]=(0,S.useState)(!1),[u,d]=(0,S.useState)(`cards`),[f,p]=(0,S.useState)(!1),[m,h]=(0,S.useState)({}),[g,_]=(0,S.useState)(`all`),[v,y]=(0,S.useState)(null),[b,x]=(0,S.useState)(!1),[ee,C]=(0,S.useState)({recorded:91,undiscovered:163,snapped:395,missing:37,live:!1});(0,S.useEffect)(()=>{},[]);let[te,ne]=(0,S.useState)(!1),[w,ve]=(0,S.useState)(null),[ye,be]=(0,S.useState)(100),[xe,we]=(0,S.useState)(``),[Te,We]=(0,S.useState)(`all`),[Je,Ye]=(0,S.useState)(100),[M,N]=(0,S.useState)(()=>{if(typeof window<`u`){if(window.__SHOWROOM_MODE__||window.location.search.includes(`showroom`)||window.location.pathname.includes(`/showroom`))return`showroom`;if(window.location.search.includes(`registry`))return`registry`}return`home`}),[tt,st]=(0,S.useState)(`mk3`),[P,mt]=(0,S.useState)(!1),[gt,yt]=(0,S.useState)(Be[0]),[bt,xt]=(0,S.useState)(()=>Ve.find(e=>e.name===`Bright Red`)||Ve[0]),[St,Ct]=(0,S.useState)(He[0]),[wt,Tt]=(0,S.useState)(`exterior`),[Et,Dt]=(0,S.useState)(`models`),[Ot,kt]=(0,S.useState)(null),[At,jt]=(0,S.useState)(`all`),[Mt,Nt]=(0,S.useState)(`articles`),[Pt,Ft]=(0,S.useState)(`all`),[It,Lt]=(0,S.useState)(`all`),[Rt,zt]=(0,S.useState)(`all`),[Bt,Vt]=(0,S.useState)(``),[Ht,Ut]=(0,S.useState)(`all`),[Wt,Gt]=(0,S.useState)(`all`),[Kt,qt]=(0,S.useState)(`all`),[Jt,Yt]=(0,S.useState)(``),[Xt,Zt]=(0,S.useState)(`all`),[Qt,$t]=(0,S.useState)(null),[en,tn]=(0,S.useState)(``),nn=()=>{let e=`${window.location.origin}${window.location.pathname}?showroom&mark=${tt}&body=${encodeURIComponent(gt.name)}&trim=${encodeURIComponent(bt.name)}&wheels=${St.id}`;navigator.clipboard.writeText(e).then(()=>alert(`Configuration URL copied to clipboard`))},[rn,an]=(0,S.useState)(()=>{try{return JSON.parse(localStorage.getItem(`jensen-ocr-edits`)||`{}`)}catch{return{}}});(0,S.useEffect)(()=>{if(M!==`showroom`)return;let e=new URLSearchParams(window.location.search);if(e.get(`mark`)&&st(e.get(`mark`)),e.get(`body`)){let t=Be.find(t=>t.name===e.get(`body`));t&&yt(t)}if(e.get(`trim`)){let t=Ve.find(t=>t.name===e.get(`trim`));t&&xt(t)}if(e.get(`wheels`)){let t=He.find(t=>t.id===e.get(`wheels`));t&&Ct(t)}},[M]),(0,S.useEffect)(()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).then(e=>{!e||!Object.keys(e).length||an(t=>({...e,...t}))}).catch(()=>{})},[]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-model`,o),ve(null)},[o]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-ocr-edits`,JSON.stringify(rn))},[rn]);let on=Qe[o]||Qe.all,sn=(0,S.useMemo)(()=>o===`mk3`?at:it,[o]),cn=(0,S.useMemo)(()=>nt(sn),[sn]),ln=(0,S.useMemo)(()=>{let e=new Set(cn.map(e=>e.page));return Ge.map(t=>({...t,pages:t.pages.filter(t=>e.has(t))})).filter(e=>e.pages.length)},[cn]);(0,S.useEffect)(()=>{let e=rt(sn,n,1);e&&e.page!==n&&r(e.page)},[sn,n]);let F=cn.find(e=>e.page===n)||cn[0]||sn[0],un=dt(F),dn=`${o}:${F?.page||1}`,fn=rn[dn]??F.text??``,pn=Object.prototype.hasOwnProperty.call(rn,dn);Object.keys(rn).filter(e=>e.startsWith(`${o}:`)).length,cn.filter(e=>e.checklist&&e.checklist.length).length;let mn=(0,S.useMemo)(()=>cn.map(e=>{let t=`${o}:${e.page}`;return{...e,text:rn[t]??e.text??``}}),[rn,cn,o]),hn=(0,S.useMemo)(()=>{let t=e.trim().toLowerCase();if(!t)return[];let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return mn.map(e=>{let t=(`${e.title} ${e.text} ${e.summary}`.toLowerCase().match(new RegExp(n,`g`))||[]).length;return{...e,score:t}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score)},[e,mn]),gn=(e=n)=>{let t=sn.find(t=>t.page===e)||F,r=t?.sourcePdf||(o===`mk3`?et:$e),i=t?.sourcePage||t?.page||e;window.open(`${r}#page=${i}`,`_blank`)},_n=(e,t=1)=>{let n=rt(sn,e,t);if(n){r(n.page);let e=dt(n);e===`diagram`?d(`scan`):e===`repair`?d(`cards`):(e===`informational`||u===`cards`)&&d(`page`)}l(!1),p(!1),y(null)},vn=()=>_n(n-1,-1),yn=()=>_n(n+1,1),bn=e=>{an({...rn,[dn]:e})},xn=()=>{let e={...rn};delete e[dn],an(e)},Sn=async()=>{await navigator.clipboard.writeText(fn),p(!0),setTimeout(()=>p(!1),1600)},Cn=()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).catch(()=>({})).then(e=>{let t={...e,...rn},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`jensen-ocr-edits.json`,i.click(),URL.revokeObjectURL(r)})},wn=()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json,.json`,e.onchange=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);typeof t==`object`&&t&&an(e=>({...e,...t}))}catch{alert(`Could not read the file — make sure it is a valid jensen-ocr-edits.json export.`)}},n.readAsText(t)},e.click()},Tn=(0,j.jsxs)(`aside`,{className:c?`sidebar open`:`sidebar`,children:[(0,j.jsxs)(`div`,{className:`mobileClose`,children:[(0,j.jsx)(`strong`,{children:`Manual Library`}),(0,j.jsx)(`button`,{onClick:()=>l(!1),children:(0,j.jsx)(me,{size:20})})]}),(0,j.jsx)(`button`,{className:`sidebarHomeBtn`,onClick:()=>{N(`home`),l(!1)},children:`← Home`}),(0,j.jsxs)(`div`,{className:`searchBox`,children:[(0,j.jsxs)(`label`,{children:[(0,j.jsx)(fe,{size:16}),` Search manual`]}),(0,j.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: ballast resistor, brake fluid, tyre pressure...`})]}),e&&(0,j.jsxs)(`div`,{className:`resultsBox`,children:[(0,j.jsxs)(`strong`,{children:[hn.length,` result`,hn.length===1?``:`s`]}),hn.slice(0,8).map(e=>(0,j.jsxs)(`button`,{onClick:()=>_n(e.page),children:[`p`,e.page,`: `,e.title,(0,j.jsxs)(`small`,{children:[e.score,` hit`,e.score===1?``:`s`]})]},e.page))]}),(0,j.jsxs)(`button`,{className:`wiringNavBtn${b?` active`:``}`,onClick:()=>{x(!0),ne(!1),l(!1)},children:[(0,j.jsx)(he,{size:16}),` Wiring Diagrams`,(0,j.jsxs)(`small`,{children:[o===`mk3`?`Mk III`:`Mk I & II`,` · colourised`]})]}),(0,j.jsxs)(`button`,{className:`wiringNavBtn selectarideNavBtn${te?` active`:``}`,onClick:()=>{ne(!0),x(!1),l(!1)},children:[(0,j.jsx)(pe,{size:16}),` Selectaride`,(0,j.jsxs)(`small`,{children:[o===`mk3`?`Mk III`:`Mk I & II`,` · shock absorbers`]})]}),(0,j.jsx)(`h3`,{children:`Manual Sections`}),(0,j.jsx)(`nav`,{className:`topics`,children:ln.map(e=>(0,j.jsxs)(`button`,{onClick:()=>_n(e.pages[0]),children:[(0,j.jsx)(T,{size:16}),(0,j.jsx)(`span`,{children:e.title}),(0,j.jsxs)(`small`,{children:[`p`,e.pages.join(`, `)]})]},e.title))}),(0,j.jsx)(`h3`,{children:`All Pages`}),(0,j.jsx)(`nav`,{children:cn.map(e=>{let t=Ze(e.page,o,e.title),r=Xe(e.page,o);return(0,j.jsxs)(`button`,{className:[e.page===n?`selected`:``,r?.isContinuation?`continuation`:``].join(` `).trim(),onClick:()=>_n(e.page),children:[(0,j.jsx)(ce,{size:16}),(0,j.jsxs)(`span`,{children:[`Page `,e.page]}),(0,j.jsxs)(`small`,{children:[t,rn[`${o}:${e.page}`]?` · edited`:``]})]},e.page)})})]});return(0,j.jsxs)(`div`,{className:`app`,children:[(0,j.jsxs)(`header`,{className:`topBar`,children:[M===`manual`&&(0,j.jsx)(`button`,{className:`hamburger`,onClick:()=>l(!0),children:(0,j.jsx)(ue,{})}),(0,j.jsxs)(`div`,{className:`brand`,children:[(0,j.jsx)(`img`,{src:`/jensen-logo.png`,alt:`Jensen logo`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{children:`Jensen C-V8`}),(0,j.jsx)(`h1`,{children:`Workshop Companion`}),(0,j.jsx)(`small`,{children:on})]})]}),(0,j.jsx)(`div`,{className:`appNavScroll`,children:(0,j.jsxs)(`nav`,{className:`appNav`,children:[(0,j.jsx)(`button`,{className:M===`home`?`active`:``,onClick:()=>{N(`home`),$t(null),kt(null)},children:`Home`}),(0,j.jsx)(`button`,{className:M===`workshop`?`active`:``,onClick:()=>{N(`workshop`),$t(null)},children:`Workshop`}),(0,j.jsx)(`button`,{className:M===`restoration`?`active`:``,onClick:()=>{N(`restoration`),kt(null)},children:`Restoration`}),(0,j.jsx)(`button`,{className:M===`registry`?`active`:``,onClick:()=>N(`registry`),children:`Registry`}),(0,j.jsx)(`button`,{className:M===`manual`?`active`:``,onClick:()=>N(`manual`),children:`Manuals`})]})}),(0,j.jsxs)(`div`,{className:`headerRight`,children:[M===`manual`&&(0,j.jsx)(`button`,{className:`openPdf`,onClick:()=>gn(),children:`Open PDF`}),(0,j.jsxs)(`a`,{href:`https://jensencv8-org.webflow.io`,target:`_blank`,rel:`noopener noreferrer`,className:`parentSiteLink`,title:`jensencv8.org`,children:[(0,j.jsx)(E,{size:14}),(0,j.jsx)(`span`,{children:`jensencv8.org`})]})]})]}),(0,j.jsxs)(`div`,{className:M===`manual`?`layout`:M===`showroom`?`showroomWrapper`:M===`registry`?`registryWrapper`:`layoutFull`,children:[M===`home`&&(0,j.jsxs)(`main`,{className:`homePage`,children:[(0,j.jsxs)(`div`,{className:`homeHero`,children:[(0,j.jsx)(`p`,{className:`eyebrow`,children:`Jensen C-V8`}),(0,j.jsx)(`h2`,{children:`Workshop Companion`}),(0,j.jsx)(`p`,{children:`Repair guides, maintenance schedules, wiring diagrams and original manuals — everything you need in the driveway.`}),(0,j.jsx)(`p`,{className:`modelSelectLabel`,children:`Select your model of Jensen C-V8 to get started`}),(0,j.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),className:`modelSelect homeModelSelect`,children:[(0,j.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,j.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,j.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,j.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]})]}),(0,j.jsxs)(`div`,{className:`workInProgressBanner`,children:[(0,j.jsx)(`span`,{className:`wipIcon`,children:`🔧`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`This site is a work in progress.`}),(0,j.jsx)(`p`,{children:`Repair guides, parts information and known issues are being added continuously. Some manual text extracted from the original scans may contain errors — if you spot one, the Edit OCR function in the Manuals section lets you correct it directly. When in doubt, always verify against the original scanned page.`})]})]}),(0,j.jsxs)(`div`,{className:`homeSections`,children:[(0,j.jsxs)(`button`,{className:`homeSection primary`,onClick:()=>N(`workshop`),children:[(0,j.jsx)(`span`,{className:`homeSectionIcon`,children:`🔧`}),(0,j.jsx)(`h3`,{children:`Repair & Maintenance`}),(0,j.jsx)(`p`,{children:`Task-oriented repair cards, troubleshooting guides and maintenance schedules.`}),(0,j.jsx)(`span`,{className:`homeSectionArrow`,children:`→`})]}),(0,j.jsxs)(`button`,{className:`homeSection`,onClick:()=>N(`manual`),children:[(0,j.jsx)(`span`,{className:`homeSectionIcon`,children:`📖`}),(0,j.jsx)(`h3`,{children:`Manuals & Diagrams`}),(0,j.jsx)(`p`,{children:`Easily search the original manuals, wiring diagrams and scanned pages.`}),(0,j.jsx)(`span`,{className:`homeSectionArrow`,children:`→`})]}),(0,j.jsxs)(`button`,{onClick:()=>N(`registry`),className:`homeSection registrySection`,style:{cursor:`pointer`},children:[(0,j.jsx)(`div`,{className:`registryBadge`,children:`500 built · 1962–1966`}),(0,j.jsx)(`img`,{src:`/jensen-badge.png`,alt:`Jensen Motors Ltd.`,className:`homeSectionIcon registryBadgeIcon`}),(0,j.jsx)(`h3`,{children:`Registry`}),(0,j.jsx)(`p`,{className:`registryTagline`,children:`Tracking Every Jensen C-V8`}),(0,j.jsx)(`p`,{children:`A global community effort to locate every surviving car — restored, mid-project or barn find. Every detail helps tell the story.`}),(0,j.jsxs)(`div`,{className:`registryLiveStats`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:ee.recorded}),(0,j.jsx)(`span`,{children:`Recorded in last 12 months`})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:ee.undiscovered}),(0,j.jsx)(`span`,{children:`Yet to be found`})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:ee.snapped}),(0,j.jsx)(`span`,{children:`Photos recorded`})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:ee.missing}),(0,j.jsx)(`span`,{children:`Not been seen since`})]})]}),ee.live&&(0,j.jsx)(`span`,{className:`registryLiveIndicator`,children:`● live`}),(0,j.jsx)(`p`,{className:`registryCta`,children:`Update your car · Explore survivors →`})]}),(0,j.jsxs)(`button`,{className:`homeSection`,onClick:()=>{N(`restoration`),kt(null)},children:[(0,j.jsx)(`span`,{className:`homeSectionIcon`,children:`🔩`}),(0,j.jsx)(`h3`,{children:`Restoration Knowledge`}),(0,j.jsx)(`p`,{children:`Upgrade guides, parts advice, paint codes and restoration know-how from the C-V8 community.`}),(0,j.jsx)(`span`,{className:`homeSectionArrow`,children:`→`})]}),(0,j.jsxs)(`a`,{href:`/showroom`,className:`homeSection showroomFeatureTile`,children:[(0,j.jsx)(`div`,{className:`showroomFeatureBadge`,children:`New`}),(0,j.jsxs)(`div`,{className:`showroomFeatureContent`,children:[(0,j.jsx)(`p`,{className:`showroomFeatureEyebrow`,children:`Parallel Universe`}),(0,j.jsx)(`h3`,{className:`showroomFeatureTitle`,children:`What if you could order a Jensen C-V8 today?`}),(0,j.jsx)(`p`,{className:`showroomFeatureCopy`,children:`How much would it cost? What colour would you choose? Every option, every surcharge — exactly as Jensen Motors offered them in 1962. Configure yours in this what-if experience and find out what your car would have cost then, and what that means in today's money.`}),(0,j.jsx)(`span`,{className:`showroomFeatureCta`,children:`Enter the showroom →`})]}),(0,j.jsxs)(`div`,{className:`showroomFeatureImages`,children:[(0,j.jsx)(`img`,{src:`/showroom/cv8-mk3-hero.jpg`,alt:`Jensen C-V8 Mk III`,className:`showroomFeatureImg showroomFeatureImgMain`}),(0,j.jsx)(`img`,{src:`/showroom/cv8-mk2-hero.jpg`,alt:`Jensen C-V8 Mk II`,className:`showroomFeatureImg showroomFeatureImgSub`})]})]}),(0,j.jsxs)(`div`,{className:`homeSection communitySection`,children:[(0,j.jsxs)(`a`,{href:`https://joc.org.uk`,target:`_blank`,rel:`noopener noreferrer`,className:`jocFeatureBanner`,children:[(0,j.jsxs)(`div`,{className:`jocBannerLeft`,children:[(0,j.jsx)(`img`,{src:`/joc-logo.png`,alt:`Jensen Owners Club`,className:`jocBannerLogo`}),(0,j.jsxs)(`div`,{className:`jocBannerText`,children:[(0,j.jsx)(`strong`,{className:`jocBannerTitle`,children:`Jensen Owners Club`}),(0,j.jsx)(`p`,{className:`jocBannerDesc`,children:`The international club for Jensen enthusiasts since 1971 — technical forum, club magazine, events and regional sections worldwide.`})]})]}),(0,j.jsx)(`span`,{className:`jocBannerCta`,children:`Join the JOC ↗`})]}),(0,j.jsxs)(`div`,{className:`communitySectionHeader`,children:[(0,j.jsx)(`span`,{className:`homeSectionIcon`,children:`💬`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{children:`Community channels`}),(0,j.jsx)(`p`,{children:`Forums, social groups and owner networks.`})]})]}),(0,j.jsxs)(`div`,{className:`communityLinks`,children:[(0,j.jsxs)(`a`,{href:`https://joc.org.uk/joc-forum/?w3=dmlld2ZvcnVtLnBocD9mPTY=`,target:`_blank`,rel:`noopener noreferrer`,className:`communityLink`,children:[(0,j.jsx)(`div`,{className:`communityLinkIconWrap`,style:{background:`#1a1a2e`},children:(0,j.jsx)(`img`,{src:`/joc-logo.png`,alt:`JOC`,className:`communityLogo`,style:{width:28,height:28}})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`JOC C-V8 Tech Forum`}),(0,j.jsx)(`span`,{children:`Jensen Owners Club technical forum`})]}),(0,j.jsx)(E,{size:14,className:`communityArrow`})]}),(0,j.jsxs)(`a`,{href:`https://www.facebook.com/share/g/1BbPfYdm2v/`,target:`_blank`,rel:`noopener noreferrer`,className:`communityLink`,children:[(0,j.jsx)(`div`,{className:`communityLinkIconWrap`,style:{background:`#1877F2`},children:(0,j.jsx)(`svg`,{width:`22`,height:`22`,viewBox:`0 0 24 24`,fill:`white`,xmlns:`http://www.w3.org/2000/svg`,children:(0,j.jsx)(`path`,{d:`M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.514c-1.491 0-1.956.93-1.956 1.886v2.268h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z`})})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`Jensen C-V8 Facebook Group`}),(0,j.jsx)(`span`,{children:`Owners group — news, photos and discussion`})]}),(0,j.jsx)(E,{size:14,className:`communityArrow`})]}),(0,j.jsxs)(`a`,{href:`https://www.facebook.com/share/g/18rxSoRBHz/`,target:`_blank`,rel:`noopener noreferrer`,className:`communityLink`,children:[(0,j.jsx)(`div`,{className:`communityLinkIconWrap`,style:{background:`#1877F2`},children:(0,j.jsx)(`svg`,{width:`22`,height:`22`,viewBox:`0 0 24 24`,fill:`white`,xmlns:`http://www.w3.org/2000/svg`,children:(0,j.jsx)(`path`,{d:`M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.514c-1.491 0-1.956.93-1.956 1.886v2.268h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z`})})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`C-V8 Parts for Sale`}),(0,j.jsx)(`span`,{children:`Facebook group — parts buying and selling`})]}),(0,j.jsx)(E,{size:14,className:`communityArrow`})]}),(0,j.jsxs)(`a`,{href:`https://chat.whatsapp.com/DoyaYf5DEUuFgXuHS8qVZ3?s=cl&p=i&ilr=4`,target:`_blank`,rel:`noopener noreferrer`,className:`communityLink`,children:[(0,j.jsx)(`div`,{className:`communityLinkIconWrap`,style:{background:`#25D366`},children:(0,j.jsx)(`svg`,{width:`22`,height:`22`,viewBox:`0 0 24 24`,fill:`white`,xmlns:`http://www.w3.org/2000/svg`,children:(0,j.jsx)(`path`,{d:`M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z`})})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`C-V8 Owners WhatsApp Group`}),(0,j.jsx)(`span`,{children:`Direct chat with fellow owners`})]}),(0,j.jsx)(E,{size:14,className:`communityArrow`})]}),(0,j.jsxs)(`a`,{href:`https://worldsfastestjensen.co.uk`,target:`_blank`,rel:`noopener noreferrer`,className:`communityLink`,children:[(0,j.jsx)(`div`,{className:`communityLinkIconWrap`,style:{background:`#1a0a0a`},children:(0,j.jsx)(`img`,{src:`/community/wfj-badge.png`,alt:`World's Fastest Jensen`,style:{width:34,height:`auto`,objectFit:`contain`}})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:`World's Fastest Jensen`}),(0,j.jsx)(`span`,{children:`A Jensen C-V8 land speed record project, developed to prove just how fast Jensen's iconic grand tourer can go.`})]}),(0,j.jsx)(E,{size:14,className:`communityArrow`})]})]})]})]})]}),M===`workshop`&&!Qt&&(()=>{let e=Oe.filter(e=>{let t=o===`all`||e.models.includes(`all`)||e.models.includes(o),n=Xt===`all`||e.category===Xt,r=en.trim().toLowerCase(),i=!r||e.title.toLowerCase().includes(r)||e.subtitle.toLowerCase().includes(r)||e.overview.toLowerCase().includes(r)||e.symptoms.some(e=>e.toLowerCase().includes(r));return t&&n&&i}),t={easy:`diffEasy`,moderate:`diffModerate`,advanced:`diffAdvanced`};return(0,j.jsxs)(`main`,{className:`workshopView`,children:[(0,j.jsxs)(`div`,{className:`workshopHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{className:`eyebrow`,children:`Workshop Companion`}),(0,j.jsx)(`h2`,{children:`Repair & Maintenance`})]}),(0,j.jsxs)(`div`,{className:`workshopHeaderControls`,children:[(0,j.jsxs)(`div`,{className:`workshopSearch`,children:[(0,j.jsx)(fe,{size:16}),(0,j.jsx)(`input`,{value:en,onChange:e=>tn(e.target.value),placeholder:`Search: overheating, brake servo, idle...`}),en&&(0,j.jsx)(`button`,{onClick:()=>tn(``),children:`Clear`})]}),(0,j.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),className:`modelSelect`,children:[(0,j.jsx)(`option`,{value:`all`,children:`All Models`}),(0,j.jsx)(`option`,{value:`mk1`,children:`Mk I`}),(0,j.jsx)(`option`,{value:`mk2`,children:`Mk II`}),(0,j.jsx)(`option`,{value:`mk3`,children:`Mk III`})]})]})]}),(0,j.jsxs)(`div`,{className:`workshopCategoryFilters`,children:[(0,j.jsx)(`button`,{className:Xt===`all`?`active`:``,onClick:()=>Zt(`all`),children:`All`}),De.map(e=>(0,j.jsxs)(`button`,{className:Xt===e.id?`active`:``,onClick:()=>Zt(e.id),children:[e.emoji,` `,e.label]},e.id))]}),e.length===0?(0,j.jsxs)(`div`,{className:`workshopEmpty`,children:[(0,j.jsx)(A,{size:32}),(0,j.jsx)(`p`,{children:`No repair cards match your search. Try different keywords or clear the filter.`})]}):(0,j.jsx)(`div`,{className:`workshopCardGrid`,children:e.map(e=>{let n=De.find(t=>t.id===e.category);return(0,j.jsxs)(`button`,{className:`workshopCard`,onClick:()=>$t(e.id),children:[(0,j.jsxs)(`div`,{className:`workshopCardTop`,children:[(0,j.jsxs)(`span`,{className:`workshopCardCat`,children:[n?.emoji,` `,n?.label]}),(0,j.jsx)(`span`,{className:`workshopCardDiff ${t[e.difficulty]}`,children:e.difficulty})]}),(0,j.jsx)(`h3`,{children:e.title}),(0,j.jsx)(`p`,{className:`workshopCardSubtitle`,children:e.subtitle}),(0,j.jsxs)(`p`,{className:`workshopCardOverview`,children:[e.overview.slice(0,120),`…`]}),e.symptoms.length>0&&(0,j.jsxs)(`div`,{className:`workshopCardSymptoms`,children:[(0,j.jsx)(k,{size:12}),(0,j.jsx)(`span`,{children:e.symptoms.slice(0,2).join(` · `)})]}),(0,j.jsx)(`span`,{className:`workshopCardArrow`,children:`View card →`})]},e.id)})})]})})(),M===`workshop`&&Qt&&(()=>{let e=Oe.find(e=>e.id===Qt);if(!e)return null;let t=De.find(t=>t.id===e.category);return(0,j.jsxs)(`main`,{className:`repairCardDetail`,children:[(0,j.jsx)(`button`,{className:`backBtn workshopBackBtn`,onClick:()=>$t(null),children:`← Back to Workshop`}),(0,j.jsx)(`div`,{className:`cardDetailHeader`,children:(0,j.jsxs)(`div`,{className:`cardDetailHeaderLeft`,children:[(0,j.jsxs)(`div`,{className:`cardDetailBadges`,children:[(0,j.jsxs)(`span`,{className:`workshopCardCat`,children:[t?.emoji,` `,t?.label]}),(0,j.jsx)(`span`,{className:`workshopCardDiff ${{easy:`diffEasy`,moderate:`diffModerate`,advanced:`diffAdvanced`}[e.difficulty]}`,children:e.difficulty}),e.models[0]!==`all`&&(0,j.jsx)(`span`,{className:`workshopCardModel`,children:e.models.map(e=>e.toUpperCase()).join(` · `)})]}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsx)(`p`,{className:`cardDetailSubtitle`,children:e.subtitle})]})}),(0,j.jsx)(`div`,{className:`cardDetailSection`,children:(0,j.jsx)(`p`,{className:`cardDetailOverview`,children:e.overview})}),e.symptoms.length>0&&(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,children:[(0,j.jsx)(k,{size:18}),` Symptoms`]}),(0,j.jsx)(`ul`,{className:`cardDetailList symptomList`,children:e.symptoms.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))})]}),(0,j.jsxs)(`div`,{className:`toolsPartsGrid`,children:[(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,children:[(0,j.jsx)(A,{size:18}),` Tools Required`]}),(0,j.jsx)(`ul`,{className:`cardDetailList`,children:e.tools.length>0?e.tools.map((e,t)=>(0,j.jsx)(`li`,{children:e},t)):(0,j.jsx)(`li`,{children:`Standard hand tools`})})]}),(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,children:[(0,j.jsx)(pe,{size:18}),` Parts & Materials`]}),(0,j.jsx)(`ul`,{className:`cardDetailList`,children:e.parts.length>0?e.parts.map((e,t)=>(0,j.jsx)(`li`,{children:e},t)):(0,j.jsx)(`li`,{children:`No replacement parts required`})})]})]}),(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,children:[(0,j.jsx)(ae,{size:18}),` Procedure`]}),(0,j.jsx)(`ol`,{className:`procedureList`,children:e.procedure.map((e,t)=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`span`,{className:`procedureStep`,children:t+1}),(0,j.jsx)(`p`,{children:e})]},t))})]}),e.checklist.length>0&&(()=>{let t=e.checklist.filter((t,n)=>m[`card:${e.id}:${n}`]).length;return(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`div`,{className:`checklistHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,style:{margin:0},children:[(0,j.jsx)(ae,{size:18}),` Checklist`]}),(0,j.jsxs)(`p`,{className:`helperText`,children:[t,` of `,e.checklist.length,` checked`]})]}),t>0&&(0,j.jsx)(`button`,{className:`clearBtn`,onClick:()=>{let t={...m};e.checklist.forEach((n,r)=>delete t[`card:${e.id}:${r}`]),h(t)},children:`Clear`})]}),(0,j.jsx)(`ul`,{className:`interactiveChecklist`,children:e.checklist.map((t,n)=>{let r=`card:${e.id}:${n}`,i=!!m[r];return(0,j.jsxs)(`li`,{className:i?`checked`:``,onClick:()=>h(e=>({...e,[r]:!e[r]})),children:[(0,j.jsx)(`span`,{className:`checkbox`,children:i?`✓`:``}),(0,j.jsx)(`p`,{children:t})]},n)})})]})})(),e.manualRefs.length>0&&(0,j.jsxs)(`div`,{className:`cardDetailSection`,children:[(0,j.jsxs)(`h3`,{className:`cardDetailSectionTitle`,children:[(0,j.jsx)(T,{size:18}),` Manual References`]}),(0,j.jsx)(`div`,{className:`manualRefButtons`,children:e.manualRefs.map((e,t)=>(0,j.jsxs)(`button`,{className:`manualRefBtn${(e.model===`base`?o!==`mk3`:o===`mk3`||o===`all`)?``:` muted`}`,onClick:()=>{e.model!==o&&e.model!==`base`?s(`mk3`):e.model===`base`&&o===`mk3`&&s(`all`),_n(e.pages[0]),N(`manual`)},children:[(0,j.jsx)(T,{size:14}),(0,j.jsx)(`span`,{children:e.label}),(0,j.jsxs)(`small`,{children:[`p. `,e.pages.join(`, `),` · `,e.model===`mk3`?`Mk III manual`:`Base manual`]})]},t))})]})]})})(),M===`restoration`&&(()=>{let e=Ot?Ae.find(e=>e.id===Ot):null,t=Ae.filter(e=>{let t=At===`all`||e.category===At,n=Ht===`all`||e.models.includes(`all`)||e.models.includes(Ht);return t&&n}),n=(e,t)=>{switch(e.type){case`heading`:return(0,j.jsx)(`h4`,{className:`articleH4`,children:e.content},t);case`paragraph`:return(0,j.jsx)(`p`,{className:`articleParagraph`,children:e.content},t);case`warning`:return(0,j.jsxs)(`div`,{className:`articleCallout warning`,children:[(0,j.jsx)(k,{size:18}),(0,j.jsx)(`p`,{children:e.content})]},t);case`tip`:return(0,j.jsxs)(`div`,{className:`articleCallout tip`,children:[(0,j.jsx)(A,{size:18}),(0,j.jsx)(`p`,{children:e.content})]},t);case`list`:return(0,j.jsx)(`ul`,{className:`articleList`,children:e.content.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))},t);case`steps`:return(0,j.jsx)(`ol`,{className:`articleSteps`,children:e.content.map((e,t)=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`span`,{children:t+1}),(0,j.jsx)(`p`,{children:e})]},t))},t);case`parts`:return(0,j.jsx)(`div`,{className:`articlePartsTable`,children:e.content.map((e,t)=>(0,j.jsxs)(`div`,{className:`articlePart`,children:[(0,j.jsxs)(`div`,{className:`articlePartTop`,children:[(0,j.jsx)(`strong`,{children:e.name}),e.partNumber&&(0,j.jsx)(`code`,{className:`partNumber`,children:e.partNumber})]}),e.notes&&(0,j.jsx)(`p`,{children:e.notes})]},t))},t);case`costTable`:return(0,j.jsxs)(`div`,{className:`articleCostTable`,children:[(0,j.jsxs)(`div`,{className:`costTableHeader`,children:[(0,j.jsx)(`span`,{children:`Item`}),(0,j.jsx)(`span`,{children:`USD`}),(0,j.jsx)(`span`,{children:`GBP`}),(0,j.jsx)(`span`,{children:`EUR`})]}),e.content.map((e,t)=>(0,j.jsxs)(`div`,{className:`costTableRow${e.item.toLowerCase().includes(`total`)?` total`:``}`,children:[(0,j.jsx)(`span`,{children:e.item}),(0,j.jsx)(`span`,{children:e.usd}),(0,j.jsx)(`span`,{children:e.gbp}),(0,j.jsx)(`span`,{children:e.eur})]},t))]},t);case`table`:return(0,j.jsx)(`div`,{className:`articleTableWrap`,children:(0,j.jsxs)(`table`,{className:`articleTable`,children:[e.headers&&(0,j.jsx)(`thead`,{children:(0,j.jsx)(`tr`,{children:e.headers.map((e,t)=>(0,j.jsx)(`th`,{children:e},t))})}),(0,j.jsx)(`tbody`,{children:e.rows.map((e,t)=>(0,j.jsx)(`tr`,{children:e.map((e,t)=>(0,j.jsx)(`td`,{children:e},t))},t))})]})},t);case`images`:return(0,j.jsx)(`div`,{className:`articleImageGrid`,children:e.content.map((e,t)=>(0,j.jsxs)(`div`,{className:`articleImageWrap`,children:[(0,j.jsx)(`img`,{src:e.src,alt:e.caption,className:`articleImage`}),e.caption&&(0,j.jsx)(`p`,{className:`articleImageCaption`,children:e.caption})]},t))},t);case`suspensionParts`:{let n={available:`MGB/BMC`,healey:`Austin-Healey`,unavailable:`Not available`,possible:`Possible alt.`,check:`Verify`},r={available:`availGreen`,healey:`availYellow`,unavailable:`availRed`,possible:`availBlue`,check:`availGrey`};return(0,j.jsxs)(`div`,{children:[e.availabilityKey&&(0,j.jsxs)(`div`,{className:`suspAvailKey`,children:[(0,j.jsx)(`strong`,{children:`Availability key:`}),Object.entries(n).map(([e,t])=>(0,j.jsx)(`span`,{className:`suspAvailBadge ${r[e]}`,children:t},e))]}),(0,j.jsxs)(`div`,{className:`suspPartsTable`,children:[(0,j.jsxs)(`div`,{className:`suspPartsHeader`,children:[(0,j.jsx)(`span`,{children:`Ref`}),(0,j.jsx)(`span`,{children:`Description`}),(0,j.jsx)(`span`,{children:`Part No.`}),(0,j.jsx)(`span`,{children:`Qty`}),(0,j.jsx)(`span`,{children:`Applications`}),(0,j.jsx)(`span`,{children:`Notes`})]}),e.content.map((e,t)=>(0,j.jsxs)(`div`,{className:`suspPartsRow ${r[e.availability]||``}`,children:[(0,j.jsx)(`span`,{className:`suspRef`,children:e.ref||``}),(0,j.jsx)(`span`,{className:`suspDesc`,children:e.description}),(0,j.jsx)(`span`,{className:`suspPart`,children:e.partNumber?(0,j.jsx)(`code`,{children:e.partNumber}):(0,j.jsx)(`em`,{className:`paintUnknown`,children:`TBC`})}),(0,j.jsx)(`span`,{className:`suspQty`,children:e.qty||``}),(0,j.jsx)(`span`,{className:`suspApps`,children:e.applications||`—`}),(0,j.jsx)(`span`,{className:`suspNote`,children:e.notes||``})]},t))]})]},t)}case`paintTable`:return(0,j.jsxs)(`div`,{className:`paintTable`,children:[(0,j.jsxs)(`div`,{className:`paintTableHeader`,children:[(0,j.jsx)(`span`,{children:`Colour`}),(0,j.jsx)(`span`,{children:`ICI Code`}),(0,j.jsx)(`span`,{children:`Modern Alternative`}),(0,j.jsx)(`span`,{children:`Notes`})]}),e.content.map((e,t)=>(0,j.jsxs)(`div`,{className:`paintTableRow`,children:[(0,j.jsxs)(`span`,{className:`paintColourCell`,children:[(0,j.jsx)(`span`,{className:`paintSwatch`,style:{background:e.css}}),(0,j.jsx)(`strong`,{children:e.colour})]}),(0,j.jsx)(`span`,{className:`paintCode`,children:e.iciCode||(0,j.jsx)(`em`,{className:`paintUnknown`,children:`Unknown`})}),(0,j.jsx)(`span`,{children:e.alternative||`—`}),(0,j.jsx)(`span`,{className:`paintNoteCell`,children:e.notes||`—`})]},t))]},t);default:return null}};return(0,j.jsx)(`main`,{className:`restorationMain`,children:e?(0,j.jsxs)(`div`,{className:`articleDetail`,children:[(0,j.jsxs)(`div`,{className:`articleDetailHeader`,children:[(0,j.jsx)(`button`,{className:`backBtn`,onClick:()=>kt(null),children:`← Back to Restoration`}),(0,j.jsxs)(`div`,{className:`articleMeta`,children:[(0,j.jsxs)(`span`,{className:`articleCategory`,children:[ke.find(t=>t.id===e.category)?.emoji,` `,ke.find(t=>t.id===e.category)?.label]}),e.severity===`critical`&&(0,j.jsx)(`span`,{className:`severityBadge`,children:`⚠️ Safety Critical`}),(0,j.jsx)(`span`,{className:`articleDifficulty`,children:e.difficulty}),(0,j.jsxs)(`span`,{className:`articleReadTime`,children:[`📖 `,e.readTime]})]}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsx)(`p`,{className:`articleSubtitle`,children:e.subtitle})]}),(0,j.jsxs)(`div`,{className:`card articleBody`,children:[(0,j.jsx)(`p`,{className:`articleIntro`,children:e.intro}),e.sections.map((e,t)=>n(e,t)),e.contributors?.length>0&&(0,j.jsxs)(`div`,{className:`articleCredits`,children:[(0,j.jsx)(`strong`,{children:`Contributors:`}),` `,e.contributors.join(`, `),e.sourceUrl&&(0,j.jsxs)(j.Fragment,{children:[` · `,(0,j.jsxs)(`a`,{href:e.sourceUrl,target:`_blank`,rel:`noopener noreferrer`,className:`articleSourceLink`,children:[`View original discussion `,(0,j.jsx)(E,{size:12})]})]})]})]}),e.sections.some(e=>e.type===`list`&&e.content.some(e=>e.includes(`manual`)))&&(0,j.jsxs)(`div`,{className:`card`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`Manual References`}),(0,j.jsxs)(`div`,{className:`manualRefButtons`,children:[(0,j.jsxs)(`button`,{className:`manualRefBtn`,onClick:()=>{N(`manual`),_n(29)},children:[(0,j.jsx)(T,{size:14}),` Mk III — Ignition p. 29–30`]}),(0,j.jsxs)(`button`,{className:`manualRefBtn`,onClick:()=>{N(`manual`),_n(5)},children:[(0,j.jsx)(T,{size:14}),` Base Manual — Specs p. 5–6`]})]})]})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`restorationHeader`,children:[(0,j.jsx)(`h2`,{children:`Restoration Knowledge`}),(0,j.jsx)(`p`,{children:`Community guides, upgrade how-tos and restoration know-how for the Jensen C-V8.`})]}),(0,j.jsxs)(`div`,{className:`restorationTabs`,children:[(0,j.jsxs)(`button`,{className:Mt===`articles`?`active`:``,onClick:()=>Nt(`articles`),children:[(0,j.jsx)(T,{size:15}),` Articles & Guides`]}),(0,j.jsxs)(`button`,{className:Mt===`parts`?`active`:``,onClick:()=>Nt(`parts`),children:[(0,j.jsx)(A,{size:15}),` Alternative Parts`]}),(0,j.jsxs)(`button`,{className:Mt===`lucas`?`active`:``,onClick:()=>Nt(`lucas`),children:[(0,j.jsx)(D,{size:15}),` Lucas Parts Reference`]}),(0,j.jsxs)(`button`,{className:Mt===`specialists`?`active`:``,onClick:()=>Nt(`specialists`),children:[(0,j.jsx)(A,{size:15}),` Find a Specialist`]})]}),Mt===`parts`&&(0,j.jsxs)(`div`,{className:`partsListView`,children:[(0,j.jsx)(`div`,{className:`partsListHeader`,children:(0,j.jsxs)(`p`,{className:`partsCredit`,children:[`📋 `,`Parts list compiled by Eric Christoffersen (award-winning Jensen C-V8 MkII restoration). Additional hose alternatives by Paul Baker (Australia). Maintained by the Jensen C-V8 community.`]})}),(0,j.jsxs)(`div`,{className:`partsSearch`,children:[(0,j.jsx)(fe,{size:16}),(0,j.jsx)(`input`,{value:Jt,onChange:e=>Yt(e.target.value),placeholder:`Search by part, alternative, supplier or part number…`}),Jt&&(0,j.jsx)(`button`,{onClick:()=>Yt(``),children:`Clear`})]}),(0,j.jsxs)(`div`,{className:`modelFilterRow`,children:[(0,j.jsx)(`span`,{className:`modelFilterLabel`,children:`Model:`}),[[`all`,`All`],[`mk1`,`Mk I`],[`mk2`,`Mk II`],[`mk3`,`Mk III`]].map(([e,t])=>(0,j.jsx)(`button`,{className:Kt===e?`active`:``,onClick:()=>qt(e),children:t},e))]}),(0,j.jsxs)(`div`,{className:`categoryFilters`,children:[(0,j.jsx)(`button`,{className:Wt===`all`?`active`:``,onClick:()=>Gt(`all`),children:`All`}),je.map(e=>(0,j.jsxs)(`button`,{className:Wt===e.id?`active`:``,onClick:()=>Gt(e.id),children:[e.emoji,` `,e.label]},e.id))]}),(()=>{let e=Jt.trim().toLowerCase(),t=Me.filter(t=>!(Wt===`all`||t.category===Wt)||!(Kt===`all`||t.models.includes(`all`)||t.models.includes(Kt))?!1:e?t.part.toLowerCase().includes(e)||(t.alternative||``).toLowerCase().includes(e)||(t.partNumber||``).toLowerCase().includes(e)||(t.supplier||``).toLowerCase().includes(e)||(t.notes||``).toLowerCase().includes(e):!0),n={};return t.forEach(e=>{n[e.category]||(n[e.category]=[]),n[e.category].push(e)}),t.length===0?(0,j.jsxs)(`div`,{className:`emptyChecklist`,style:{marginTop:16},children:[(0,j.jsx)(A,{size:24}),(0,j.jsx)(`p`,{children:`No parts match your search. Try a different term or clear the filter.`})]}):Object.entries(n).map(([e,t])=>{let n=je.find(t=>t.id===e);return(0,j.jsxs)(`div`,{className:`partsGroup`,children:[(0,j.jsxs)(`h3`,{className:`partsGroupTitle`,children:[n?.emoji,` `,n?.label]}),(0,j.jsx)(`div`,{className:`partsTable`,children:t.map(e=>(0,j.jsxs)(`div`,{className:`partRow`,children:[(0,j.jsxs)(`div`,{className:`partMain`,children:[(0,j.jsx)(`strong`,{className:`partName`,children:e.part}),e.models&&!e.models.includes(`all`)&&(0,j.jsx)(`span`,{className:`partModels`,children:e.models.map(e=>e.toUpperCase()).join(` · `)})]}),e.alternative&&(0,j.jsxs)(`div`,{className:`partAlt`,children:[(0,j.jsx)(`span`,{className:`partAltLabel`,children:`Alternative`}),(0,j.jsx)(`span`,{children:e.alternative})]}),e.partNumber&&(0,j.jsxs)(`div`,{className:`partAlt`,children:[(0,j.jsx)(`span`,{className:`partAltLabel`,children:`Part no.`}),(0,j.jsx)(`code`,{className:`partNumber`,children:e.partNumber})]}),e.supplier&&(0,j.jsxs)(`div`,{className:`partAlt`,children:[(0,j.jsx)(`span`,{className:`partAltLabel`,children:`Supplier`}),(0,j.jsx)(`span`,{className:`partSupplier`,children:e.supplier})]}),e.notes&&(0,j.jsx)(`p`,{className:`partNotes`,children:e.notes})]},e.id))})]},e)})})()]}),Mt===`articles`&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`modelFilterRow`,children:[(0,j.jsx)(`span`,{className:`modelFilterLabel`,children:`Model:`}),[[`all`,`All`],[`mk1`,`Mk I`],[`mk2`,`Mk II`],[`mk3`,`Mk III`]].map(([e,t])=>(0,j.jsx)(`button`,{className:Ht===e?`active`:``,onClick:()=>Ut(e),children:t},e))]}),(0,j.jsxs)(`div`,{className:`categoryFilters`,children:[(0,j.jsx)(`button`,{className:At===`all`?`active`:``,onClick:()=>jt(`all`),children:`All`}),ke.map(e=>(0,j.jsxs)(`button`,{className:At===e.id?`active`:``,onClick:()=>jt(e.id),children:[e.emoji,` `,e.label]},e.id))]}),(0,j.jsxs)(`div`,{className:`articleGrid`,children:[t.map(e=>(0,j.jsxs)(`button`,{className:`articleCard`,onClick:()=>kt(e.id),children:[(0,j.jsxs)(`div`,{className:`articleCardTop`,children:[(0,j.jsxs)(`span`,{className:`articleCategory`,children:[ke.find(t=>t.id===e.category)?.emoji,` `,ke.find(t=>t.id===e.category)?.label]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:6,alignItems:`center`},children:[!e.models.includes(`all`)&&(0,j.jsx)(`span`,{className:`articleModelBadge`,children:e.models.map(e=>e.toUpperCase()).join(` · `)}),e.severity===`critical`?(0,j.jsx)(`span`,{className:`severityBadge severityBadgeCard`,children:`⚠️ Safety Critical`}):(0,j.jsx)(`span`,{className:`articleDifficulty`,children:e.difficulty})]})]}),(0,j.jsx)(`h3`,{children:e.title}),(0,j.jsx)(`p`,{children:e.subtitle}),(0,j.jsxs)(`div`,{className:`articleCardFooter`,children:[(0,j.jsx)(`span`,{children:e.readTime}),(0,j.jsx)(`span`,{className:`articleCardTags`,children:e.tags.slice(0,3).map(e=>(0,j.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]})]},e.id)),t.length===0&&(0,j.jsxs)(`div`,{className:`emptyChecklist`,style:{gridColumn:`1/-1`},children:[(0,j.jsx)(A,{size:24}),(0,j.jsx)(`p`,{children:`No articles in this category yet. More guides will be added as the community contributes them.`})]})]})]}),Mt===`lucas`&&(0,j.jsxs)(`div`,{className:`partsListView`,children:[(0,j.jsxs)(`div`,{className:`partsListHeader`,children:[(0,j.jsxs)(`p`,{className:`partsCredit`,children:[`📋 `,Re.title,` · `,Re.reference,` · Issued `,Re.issued,` · `,Re.publisher]}),(0,j.jsx)(`p`,{className:`partsCredit`,style:{marginTop:4,opacity:.7},children:Re.notes})]}),(0,j.jsxs)(`div`,{className:`partsSearch`,children:[(0,j.jsx)(fe,{size:16}),(0,j.jsx)(`input`,{value:Bt,onChange:e=>Vt(e.target.value),placeholder:`Search by part description or part number…`}),Bt&&(0,j.jsx)(`button`,{onClick:()=>Vt(``),children:`Clear`})]}),(0,j.jsxs)(`div`,{className:`categoryFilters`,children:[(0,j.jsx)(`button`,{className:Rt===`all`?`active`:``,onClick:()=>zt(`all`),children:`All`}),Ie.map(e=>(0,j.jsxs)(`button`,{className:Rt===e.id?`active`:``,onClick:()=>zt(e.id),children:[e.emoji,` `,e.label]},e.id))]}),(()=>{let e=Bt.trim().toLowerCase(),t=Le.filter(t=>Rt===`all`||t.system===Rt?e?t.component.toLowerCase().includes(e)||(t.partNumber||``).toLowerCase().includes(e)||(t.lucasModel||``).toLowerCase().includes(e)||t.parts.some(t=>t.description.toLowerCase().includes(e)||t.partNumber.toLowerCase().includes(e)):!0:!1);if(t.length===0)return(0,j.jsxs)(`div`,{className:`emptyChecklist`,style:{marginTop:16},children:[(0,j.jsx)(A,{size:24}),(0,j.jsx)(`p`,{children:`No parts match your search.`})]});let n={};return t.forEach(e=>{n[e.system]||(n[e.system]=[]),n[e.system].push(e)}),Object.entries(n).map(([e,t])=>{let n=Ie.find(t=>t.id===e);return(0,j.jsxs)(`div`,{className:`partsGroup`,children:[(0,j.jsxs)(`h3`,{className:`partsGroupTitle`,children:[n?.emoji,` `,n?.label]}),(0,j.jsx)(`div`,{className:`lucasTable`,children:t.map(e=>(0,j.jsxs)(`div`,{className:`lucasComponent`,children:[(0,j.jsxs)(`div`,{className:`lucasComponentHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{className:`lucasComponentName`,children:e.component}),e.lucasModel&&(0,j.jsxs)(`span`,{className:`lucasModel`,children:[`Model: `,e.lucasModel]})]}),e.partNumber&&(0,j.jsx)(`code`,{className:`lucasPartNo`,children:e.partNumber})]}),e.notes&&(0,j.jsx)(`p`,{className:`partNotes`,children:e.notes}),e.parts.length>0&&(0,j.jsx)(`table`,{className:`lucasSubParts`,children:(0,j.jsx)(`tbody`,{children:e.parts.map((e,t)=>(0,j.jsxs)(`tr`,{className:e.recommended?`recommended`:``,children:[(0,j.jsxs)(`td`,{children:[e.description,e.recommended&&(0,j.jsx)(`span`,{className:`lucasRecommended`,children:`§`})]}),(0,j.jsx)(`td`,{children:(0,j.jsx)(`code`,{children:e.partNumber})})]},t))})})]},e.id))})]},e)})})(),(0,j.jsxs)(`div`,{className:`lucasKey`,children:[(0,j.jsx)(`strong`,{children:`Key:`}),(0,j.jsx)(`span`,{children:`§ Recommended spare for stock`}),(0,j.jsx)(`span`,{children:`* New item (at time of issue, Oct 1962)`}),(0,j.jsx)(`span`,{children:`† Quote bracketed part number when ordering`}),(0,j.jsx)(`span`,{children:`‡ Order separately`}),(0,j.jsx)(`span`,{children:`‖ Serviced by Vehicle Manufacturer`})]})]}),Mt===`specialists`&&(0,j.jsxs)(`div`,{className:`partsListView`,children:[(0,j.jsx)(`div`,{className:`partsListHeader`,children:(0,j.jsxs)(`p`,{className:`partsCredit`,children:[`🔧 Restoration specialists, Jensen dealers and parts suppliers. `,(0,j.jsx)(`strong`,{children:`Know of a specialist not listed? Get in touch.`})]})}),(0,j.jsxs)(`div`,{className:`specialistFilters`,children:[(0,j.jsxs)(`div`,{className:`modelFilterRow`,children:[(0,j.jsx)(`span`,{className:`modelFilterLabel`,children:`Type:`}),Ne.map(e=>(0,j.jsxs)(`button`,{className:Pt===e.id?`active`:``,onClick:()=>Ft(e.id),children:[e.emoji,` `,e.label]},e.id))]}),(0,j.jsxs)(`div`,{className:`modelFilterRow`,children:[(0,j.jsx)(`span`,{className:`modelFilterLabel`,children:`Country:`}),Pe.map(e=>(0,j.jsxs)(`button`,{className:It===e.code?`active`:``,onClick:()=>Lt(e.code),children:[e.flag,` `,e.name]},e.code))]})]}),(()=>{let e=Fe.filter(e=>(Pt===`all`||(e.types||[e.type]).includes(Pt))&&(It===`all`||e.countryCode===It));return e.length===0?(0,j.jsxs)(`div`,{className:`emptyChecklist`,style:{marginTop:16},children:[(0,j.jsx)(A,{size:24}),(0,j.jsx)(`p`,{children:`No specialists listed for this filter yet. More will be added as the community contributes them.`})]}):(0,j.jsx)(`div`,{className:`specialistGrid`,children:e.map(e=>(0,j.jsxs)(`div`,{className:`specialistCard${e.featured?` featured`:``}`,children:[(()=>{let t=Pe.find(t=>t.code===e.countryCode);return t?(0,j.jsx)(`span`,{className:`specialistCountryFlag`,children:t.flag}):null})(),e.logo&&(0,j.jsx)(`div`,{className:`specialistLogoWrap`,children:(0,j.jsx)(`img`,{src:e.logo,alt:`${e.name} logo`,className:`specialistLogo`,style:e.logoScale?{transform:`scale(${e.logoScale})`,transformOrigin:`left center`}:{}})}),(0,j.jsxs)(`div`,{className:`specialistCardTop`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`div`,{className:`specialistCardMeta`,children:[(e.types||[e.type]).map(e=>{let t=Ne.find(t=>t.id===e);return t?(0,j.jsxs)(`span`,{className:`specialistType`,children:[t.emoji,` `,t.label]},e):null}),(0,j.jsxs)(`span`,{className:`specialistLocation`,children:[`📍 `,e.city,`, `,e.region,`, `,e.country]})]}),(0,j.jsx)(`h3`,{className:`specialistName`,children:e.name}),e.tagline&&(0,j.jsxs)(`p`,{className:`specialistTagline`,children:[`"`,e.tagline,`"`]})]}),e.featured&&(0,j.jsx)(`span`,{className:`specialistFeatured`,children:`Featured`})]}),(0,j.jsx)(`p`,{className:`specialistDesc`,children:e.description}),(0,j.jsx)(`div`,{className:`specialistServices`,children:e.services.map(e=>(0,j.jsx)(`span`,{className:`sectionCardTag`,children:e},e))}),(0,j.jsxs)(`div`,{className:`specialistContacts`,children:[e.website&&(0,j.jsxs)(`a`,{href:e.website,target:`_blank`,rel:`noopener noreferrer`,className:`specialistLink`,children:[(0,j.jsx)(E,{size:13}),` `,e.website.replace(`https://`,``).replace(`http://`,``)]}),e.phone&&(0,j.jsxs)(`span`,{className:`specialistLink`,children:[`📞 `,e.phone]}),e.email&&(0,j.jsxs)(`a`,{href:`mailto:${e.email}`,className:`specialistLink`,children:[`✉ `,e.email]}),e.social?.facebook&&(0,j.jsx)(`a`,{href:e.social.facebook,target:`_blank`,rel:`noopener noreferrer`,className:`specialistLink`,children:`📘 Facebook`}),e.social?.instagram&&(0,j.jsx)(`a`,{href:e.social.instagram,target:`_blank`,rel:`noopener noreferrer`,className:`specialistLink`,children:`📷 Instagram`}),e.social?.twitter&&(0,j.jsx)(`a`,{href:e.social.twitter,target:`_blank`,rel:`noopener noreferrer`,className:`specialistLink`,children:`𝕏 Twitter`}),e.social?.ebay&&(0,j.jsx)(`a`,{href:e.social.ebay,target:`_blank`,rel:`noopener noreferrer`,className:`specialistLink`,children:`🛒 eBay shop`})]})]},e.id))})})()]})]})})})(),M===`registry`&&(0,j.jsxs)(`main`,{className:`registryEmbedMain`,children:[(0,j.jsxs)(`div`,{className:`registryEmbedHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`button`,{className:`backBtn`,onClick:()=>N(`home`),children:`← Back to home`}),(0,j.jsx)(`h2`,{className:`registryEmbedTitle`,children:`Jensen C-V8 Registry`}),(0,j.jsx)(`p`,{className:`registryEmbedSub`,children:`Tracking every surviving Jensen C-V8 — 500 built between 1962 and 1966. If you own one, please update your entry.`})]}),(0,j.jsxs)(`a`,{href:`https://airtable.com/appqtFw9HrvLwGDRV/shrc1eGBCmNryrv0M`,target:`_blank`,rel:`noopener noreferrer`,className:`dlBtn`,children:[(0,j.jsx)(E,{size:14}),` Open full screen`]})]}),(0,j.jsx)(`div`,{className:`registryEmbedWrap`,children:(0,j.jsx)(`iframe`,{className:`registryEmbedFrame`,src:`https://airtable.com/embed/appqtFw9HrvLwGDRV/shrc1eGBCmNryrv0M`,frameBorder:`0`,onWheel:()=>{},title:`Jensen C-V8 Registry`,allowFullScreen:!0})})]}),M===`showroom`&&(()=>{let e=ze.find(e=>e.id===tt),t=e=>`£`+e.toLocaleString(`en-GB`);return(0,j.jsxs)(`main`,{className:`showroomMain`,children:[(0,j.jsxs)(`div`,{className:`showroomHeader`,children:[(0,j.jsxs)(`div`,{className:`showroomHeaderLeft`,children:[(0,j.jsx)(`img`,{src:`/jensen-badge.png`,alt:`Jensen`,className:`showroomBadge`}),(0,j.jsxs)(`div`,{className:`showroomHeaderText`,children:[(0,j.jsx)(`p`,{className:`showroomEyebrow`,children:`Jensen Motors Ltd · West Bromwich`}),(0,j.jsx)(`h1`,{className:`showroomTitle`,children:`C-V8 Virtual Showroom`})]})]}),(0,j.jsxs)(`button`,{className:`showroomExitBtn`,onClick:()=>N(`home`),children:[(0,j.jsx)(`span`,{className:`showroomExitBtnLong`,children:`← Workshop Companion`}),(0,j.jsx)(`span`,{className:`showroomExitBtnShort`,children:`← Back`})]})]}),(0,j.jsxs)(`div`,{className:`showroomHero`,children:[(0,j.jsx)(`img`,{src:e.heroImage,alt:e.name,className:`showroomHeroImg`}),(0,j.jsxs)(`div`,{className:`showroomHeroOverlay`,children:[(0,j.jsxs)(`p`,{className:`showroomHeroEyebrow`,children:[e.years,` · `,e.produced,` built`]}),(0,j.jsx)(`h2`,{className:`showroomHeroTitle`,children:e.name}),(0,j.jsx)(`p`,{className:`showroomHeroTagline`,children:e.tagline})]})]}),(0,j.jsx)(`div`,{className:`showroomModelTabs`,children:ze.map(e=>(0,j.jsxs)(`button`,{className:`showroomModelTab${tt===e.id?` active`:``}`,onClick:()=>{st(e.id),Dt(`models`)},children:[(0,j.jsx)(`span`,{className:`showroomTabName`,children:e.name}),(0,j.jsx)(`span`,{className:`showroomTabYears`,children:e.years})]},e.id))}),(0,j.jsxs)(`div`,{className:`showroomSectionNav`,children:[(0,j.jsx)(`button`,{className:Et===`models`?`active`:``,onClick:()=>Dt(`models`),children:`Overview`}),(0,j.jsx)(`button`,{className:Et===`specs`?`active`:``,onClick:()=>Dt(`specs`),children:`Specifications`}),(0,j.jsx)(`button`,{className:Et===`configure`?`active`:``,onClick:()=>Dt(`configure`),children:`Configure`})]}),Et===`models`&&(0,j.jsx)(`div`,{className:`showroomContent`,children:(0,j.jsxs)(`div`,{className:`showroomOverviewGrid`,children:[(0,j.jsxs)(`div`,{className:`showroomOverviewText`,children:[(0,j.jsx)(`p`,{className:`showroomDescription`,children:e.description}),(0,j.jsx)(`ul`,{className:`showroomHighlights`,children:e.highlights.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))}),(0,j.jsxs)(`div`,{className:`showroomPricing`,children:[(0,j.jsxs)(`div`,{className:`showroomPrice original`,children:[(0,j.jsx)(`span`,{className:`priceLabel`,children:e.originalPriceManualGBP?`Original price — automatic`:`Original list price (${e.originalPriceNote})`}),(0,j.jsx)(`span`,{className:`priceValue`,children:t(e.originalPriceGBP)})]}),(0,j.jsxs)(`div`,{className:`showroomPrice today`,children:[(0,j.jsx)(`span`,{className:`priceLabel`,children:`Equivalent today (CPI adjusted)`}),(0,j.jsx)(`span`,{className:`priceValue`,children:t(e.todayEquivalentGBP)})]}),e.originalPriceManualGBP&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`showroomPrice original`,children:[(0,j.jsx)(`span`,{className:`priceLabel`,children:`Original price — manual transmission`}),(0,j.jsx)(`span`,{className:`priceValue`,children:t(e.originalPriceManualGBP)})]}),(0,j.jsxs)(`div`,{className:`showroomPrice today`,children:[(0,j.jsx)(`span`,{className:`priceLabel`,children:`Equivalent today (CPI adjusted)`}),(0,j.jsx)(`span`,{className:`priceValue`,children:t(e.todayEquivalentManualGBP)})]})]})]}),(0,j.jsx)(`p`,{className:`showroomPriceNote`,children:e.originalPriceSource?(0,j.jsxs)(j.Fragment,{children:[`Source: `,e.originalPriceSource,`. Prices include Purchase Tax. Today's equivalent uses Bank of England CPI data.`]}):(0,j.jsx)(j.Fragment,{children:`Pricing is approximate. Today's equivalent uses Bank of England CPI data.`})}),e.priceListImage&&(0,j.jsxs)(`div`,{className:`priceListImageWrap`,children:[(0,j.jsx)(`p`,{className:`priceListLabel`,children:`Original factory price list`}),(0,j.jsx)(`img`,{src:e.priceListImage,alt:`Original Jensen C-V8 Mk III Price List`,className:`priceListImg`})]}),e.standardColours&&(0,j.jsxs)(`div`,{className:`standardColoursNote`,children:[(0,j.jsx)(`p`,{className:`priceListLabel`,children:`Standard colours included in list price`}),(0,j.jsx)(`p`,{className:`standardColoursList`,children:e.standardColours.join(` · `)}),(0,j.jsxs)(`p`,{className:`showroomPriceNote`,children:[`Special exterior colours: +`,e.specialColourSurcharge,`. Special interior colours: +`,e.specialTrimSurcharge,`.`]})]}),(0,j.jsx)(`button`,{className:`showroomCta`,onClick:()=>Dt(`configure`),children:`Configure your C-V8 →`})]}),(0,j.jsx)(`div`,{className:`showroomOverviewImages`,children:e.overviewImages?e.overviewImages.map((e,t)=>(0,j.jsx)(`img`,{src:e.src,alt:e.alt,className:`showroomOverviewImg`},t)):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`img`,{src:e.frontImage||`/showroom/cv8-front.jpg`,alt:`${e.name} front`,className:`showroomOverviewImg`}),(0,j.jsx)(`img`,{src:`/showroom/cv8-engine.jpg`,alt:`Chrysler 383 V8 engine`,className:`showroomOverviewImg`})]})}),e.adImages&&e.adImages.length>0&&(0,j.jsxs)(`div`,{className:`showroomAdImages`,children:[(0,j.jsx)(`p`,{className:`showroomAdLabel`,children:`Original factory advertisements`}),(0,j.jsx)(`div`,{className:`showroomAdGrid`,children:e.adImages.map((e,t)=>(0,j.jsxs)(`div`,{className:`showroomAdWrap`,children:[(0,j.jsx)(`img`,{src:e.src,alt:e.caption,className:`showroomAdImg`}),(0,j.jsx)(`p`,{className:`showroomAdCaption`,children:e.caption})]},t))})]})]})}),Et===`specs`&&(0,j.jsxs)(`div`,{className:`showroomContent`,children:[(0,j.jsx)(`h3`,{className:`showroomSpecsTitle`,children:`Technical Specifications`}),(0,j.jsxs)(`p`,{className:`showroomSpecsSub`,children:[`Jensen C-V8 — all marks share the same Chrysler V8 powertrain. `,e.differences]}),(0,j.jsx)(`div`,{className:`showroomSpecsGrid`,children:Object.values(Ue).map(e=>(0,j.jsxs)(`div`,{className:`showroomSpec`,children:[(0,j.jsx)(`span`,{className:`specLabel`,children:e.label}),(0,j.jsx)(`span`,{className:`specValue`,children:e.value})]},e.label))}),(0,j.jsxs)(`div`,{className:`showroomSpecsProduction`,children:[(0,j.jsxs)(`h4`,{children:[`Production Record — `,e.name]}),(0,j.jsxs)(`div`,{className:`showroomProductionGrid`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`span`,{children:`Years produced`}),(0,j.jsx)(`strong`,{children:e.years})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`span`,{children:`Total built`}),(0,j.jsx)(`strong`,{children:e.produced})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`span`,{children:`Of 500 total C-V8s`}),(0,j.jsxs)(`strong`,{children:[Math.round(e.produced/500*100),`%`]})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`span`,{children:`Original list price`}),(0,j.jsx)(`strong`,{children:t(e.originalPriceGBP)})]})]})]})]}),Et===`configure`&&(0,j.jsx)(`div`,{className:`showroomContent`,children:(0,j.jsxs)(`div`,{className:`configuratorLayout`,children:[(0,j.jsxs)(`div`,{className:`configuratorPreview`,children:[(0,j.jsx)(`div`,{className:`configuratorCarWrap${P&&wt!==`interior`?` nightModeWrap`:``}`,children:(0,j.jsx)(`img`,{src:wt===`interior`?P?e.trimNightImages?.[bt.name]||e.defaultInteriorNightImage||e.defaultInteriorImage||e.heroImage:e.trimImages?.[bt.name]||e.defaultInteriorImage||e.heroImage:P?e.colourNightImages?.[gt.name]||e.heroNightImage||e.heroImage:e.colourImages?.[gt.name]||e.heroImage,alt:wt===`interior`?`${bt.name} Connolly Hide interior`:`${e.name} in ${gt.name}`,className:`configuratorCarImg`},`${wt}-${gt.name}-${bt.name}-${P}`)}),(0,j.jsxs)(`div`,{className:`configuratorColourPreview`,children:[(0,j.jsx)(`div`,{className:`colourPreviewBlock`,style:{background:gt.css},children:(0,j.jsx)(`span`,{className:`colourPreviewLabel`,style:{color:[`#fafafa`,`#f5f2ec`,`#f0ebe0`,`#f0aab8`,`#c8b898`,`#d4c4b0`,`#d4ae7a`,`#b8b0a4`].includes(gt.css)?`#333`:`white`},children:gt.name})}),(0,j.jsx)(`div`,{className:`trimPreviewBlock`,style:{background:bt.css},children:(0,j.jsxs)(`span`,{className:`trimPreviewLabel`,style:{color:[`#c8b898`,`#d4c4b0`,`#d4ae7a`,`#b8935a`,`#8a8a85`,`#8a9bb0`].includes(bt.css)?`#333`:`white`},children:[bt.name,` Connolly Hide`]})})]}),(()=>{let n=e.standardColours&&!e.standardColours.includes(gt.name),r=e.standardTrim&&!e.standardTrim.includes(bt.name),i=n&&e.specialExteriorSurcharge?.todayGBP||0,a=r&&e.specialInteriorSurcharge?.todayGBP||0,o=e.todayEquivalentGBP+i+a;return(0,j.jsxs)(`div`,{className:`configuratorSummary`,children:[(0,j.jsx)(`h4`,{children:`Your Configuration`}),(0,j.jsxs)(`div`,{className:`summaryRow`,children:[(0,j.jsx)(`span`,{children:`Model`}),(0,j.jsx)(`strong`,{children:e.name})]}),(0,j.jsxs)(`div`,{className:`summaryRow`,children:[(0,j.jsx)(`span`,{children:`Exterior`}),(0,j.jsxs)(`strong`,{children:[gt.name,n?(0,j.jsx)(`span`,{className:`surchargeTag`,children:` + special`}):``]})]}),(0,j.jsxs)(`div`,{className:`summaryRow`,children:[(0,j.jsx)(`span`,{children:`Interior`}),(0,j.jsxs)(`strong`,{children:[bt.name,` Connolly Hide`,r?(0,j.jsx)(`span`,{className:`surchargeTag`,children:` + special`}):``]})]}),(0,j.jsxs)(`div`,{className:`summaryRow`,children:[(0,j.jsx)(`span`,{children:`Wheels`}),(0,j.jsx)(`strong`,{children:St.name})]}),(n||r)&&(0,j.jsxs)(`div`,{className:`summaryRow surchargeRow`,children:[(0,j.jsx)(`span`,{children:`Surcharges`}),(0,j.jsxs)(`div`,{className:`surchargeList`,children:[n&&(0,j.jsxs)(`span`,{children:[`+`,t(i),` special exterior`]}),r&&(0,j.jsxs)(`span`,{children:[`+`,t(a),` special interior`]})]})]}),(0,j.jsxs)(`div`,{className:`summaryRow price`,children:[(0,j.jsx)(`span`,{children:`Total today`}),(0,j.jsx)(`strong`,{children:t(o)})]}),(0,j.jsxs)(`div`,{className:`configuratorActions`,children:[(0,j.jsx)(`button`,{className:`configActionBtn primary`,onClick:nn,children:`Share configuration`}),(0,j.jsx)(`button`,{className:`configActionBtn`,onClick:()=>window.print(),children:`Print summary`})]})]})})()]}),(0,j.jsxs)(`div`,{className:`configuratorSelectors`,children:[(0,j.jsxs)(`div`,{className:`dayNightToggle`,children:[(0,j.jsx)(`button`,{className:`dayNightBtn${P?``:` active`}`,onClick:()=>mt(!1),children:`☀ Day`}),(0,j.jsx)(`button`,{className:`dayNightBtn${P?` active`:``}`,onClick:()=>mt(!0),children:`☾ Night`})]}),(0,j.jsxs)(`div`,{className:`configTabs`,children:[(0,j.jsx)(`button`,{className:wt===`exterior`?`active`:``,onClick:()=>Tt(`exterior`),children:`Exterior`}),(0,j.jsx)(`button`,{className:wt===`interior`?`active`:``,onClick:()=>Tt(`interior`),children:`Interior`}),(0,j.jsx)(`button`,{className:wt===`wheels`?`active`:``,onClick:()=>Tt(`wheels`),children:`Wheels`})]}),wt===`exterior`&&(()=>{let n=e.standardColours?Be.filter(t=>e.standardColours.includes(t.name)):Be,r=e.standardColours?Be.filter(t=>!e.standardColours.includes(t.name)):[],i=e.standardColours&&!e.standardColours.includes(gt.name),a=e=>(0,j.jsx)(`button`,{className:`colourSwatch${gt.name===e.name?` selected`:``}`,style:{background:e.css},onClick:()=>yt(e),title:`${e.name} — ${e.made} made`,children:[`#fafafa`,`#f5f2ec`,`#f0ebe0`].includes(e.css)?(0,j.jsx)(`span`,{className:`swatchBorder`}):null},e.name);return(0,j.jsxs)(`div`,{className:`configSection`,children:[(0,j.jsx)(`p`,{className:`configSectionLabel`,children:`Standard body colours — included in list price`}),(0,j.jsx)(`div`,{className:`colourGrid`,children:n.map(a)}),r.length>0&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`p`,{className:`configSectionLabel specialColourLabel`,children:[`Special exterior colours — +`,t(e.specialExteriorSurcharge?.todayGBP),` today`,(0,j.jsxs)(`span`,{className:`originalPrice`,children:[` (original: `,e.specialExteriorSurcharge?.label,`)`]})]}),(0,j.jsx)(`div`,{className:`colourGrid`,children:r.map(a)})]}),(0,j.jsxs)(`div`,{className:`selectedColourInfo`,children:[(0,j.jsx)(`strong`,{children:gt.name}),(0,j.jsxs)(`span`,{children:[gt.made,` of 500 cars built in this colour (`,Math.round(gt.made/500*100),`%)`]}),gt.iciCode?(0,j.jsxs)(`span`,{className:`colourIci`,children:[`Paint code `,(0,j.jsx)(`code`,{children:gt.iciCode})]}):(0,j.jsx)(`span`,{className:`colourIci colourIciUnknown`,children:`Paint code unknown`}),i?(0,j.jsxs)(`span`,{className:`colourSpecial`,children:[`Special order — +`,t(e.specialExteriorSurcharge?.todayGBP),` · original `,e.specialExteriorSurcharge?.label]}):(0,j.jsx)(`span`,{className:`colourStandard`,children:`✓ Standard colour — included in list price`})]})]})})(),wt===`interior`&&(()=>{let n=e.standardTrim?Ve.filter(t=>e.standardTrim.includes(t.name)):Ve,r=e.standardTrim?Ve.filter(t=>!e.standardTrim.includes(t.name)):[],i=e.standardTrim&&!e.standardTrim.includes(bt.name),a=e=>(0,j.jsx)(`button`,{className:`colourSwatch${bt.name===e.name?` selected`:``}`,style:{background:e.css},onClick:()=>xt(e),title:`${e.name} — ${e.made} made`},e.name);return(0,j.jsxs)(`div`,{className:`configSection`,children:[(0,j.jsx)(`p`,{className:`configSectionLabel`,children:`Standard interior trim — Connolly hide, included in list price`}),(0,j.jsx)(`div`,{className:`colourGrid`,children:n.map(a)}),r.length>0&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`p`,{className:`configSectionLabel specialColourLabel`,children:[`Special interior colours — +`,t(e.specialInteriorSurcharge?.todayGBP),` today`,(0,j.jsxs)(`span`,{className:`originalPrice`,children:[` (original: `,e.specialInteriorSurcharge?.label,`)`]})]}),(0,j.jsx)(`div`,{className:`colourGrid`,children:r.map(a)})]}),(0,j.jsxs)(`div`,{className:`selectedColourInfo`,children:[(0,j.jsx)(`strong`,{children:bt.name}),(0,j.jsxs)(`span`,{children:[bt.made,` of 500 cars trimmed in this colour`]}),i?(0,j.jsxs)(`span`,{className:`colourSpecial`,children:[`Special order — +`,t(e.specialInteriorSurcharge?.todayGBP),` · original `,e.specialInteriorSurcharge?.label]}):(0,j.jsx)(`span`,{className:`colourStandard`,children:`✓ Standard trim — included in list price`})]})]})})(),wt===`wheels`&&(0,j.jsxs)(`div`,{className:`configSection`,children:[(0,j.jsx)(`p`,{className:`configSectionLabel`,children:`Wheel specification`}),(0,j.jsx)(`div`,{className:`wheelOptions`,children:He.map(e=>(0,j.jsxs)(`button`,{className:`wheelOption${St.id===e.id?` selected`:``}`,onClick:()=>Ct(e),children:[(0,j.jsx)(`div`,{className:`wheelOptionIcon`,children:e.id===`wire`?`◎`:`●`}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`strong`,{children:e.name}),(0,j.jsx)(`p`,{children:e.description}),(0,j.jsx)(`span`,{className:`wheelPeriod`,children:e.period})]})]},e.id))})]})]})]})}),(0,j.jsxs)(`div`,{className:`showroomLifestyle`,children:[(0,j.jsx)(`img`,{src:e.lifestyleImage||`/showroom/cv8-lifestyle.jpg`,alt:e.lifestyleCaption||`Jensen C-V8 — Deep Carriage Green`}),(0,j.jsxs)(`div`,{className:`showroomLifestyleCaption`,children:[(0,j.jsx)(`p`,{children:e.lifestyleCaption||`Jensen C-V8 in Deep Carriage Green with Beige Connolly Hide interior.`}),!e.lifestyleCaption&&(0,j.jsx)(`p`,{children:`54 of the 500 cars built were finished in Deep Carriage Green.`})]})]}),(0,j.jsxs)(`footer`,{className:`showroomFooter`,children:[(0,j.jsx)(`img`,{src:`/jensen-badge.png`,alt:`Jensen`,className:`showroomFooterBadge`}),(0,j.jsx)(`p`,{children:`Jensen Motors Ltd · Kelvin Way, West Bromwich, England`}),(0,j.jsx)(`p`,{className:`showroomFooterNote`,children:`This virtual showroom is a community tribute. Pricing and specifications are approximate, based on period documentation and the Jensen C-V8 Registry.`}),(0,j.jsx)(`button`,{className:`showroomExitBtn`,onClick:()=>N(`home`),children:`← Return to Workshop Companion`})]})]})})(),M===`manual`&&Tn,M===`manual`&&(0,j.jsxs)(j.Fragment,{children:[te&&(()=>{let e=Ee(o),t=w?e.sections.find(e=>e.id===w):null;return(0,j.jsxs)(`main`,{className:`wiringMain`,children:[(0,j.jsxs)(`div`,{className:`wiringHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`button`,{className:`backBtn`,onClick:()=>ne(!1),children:`← Back to manual`}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsx)(`p`,{className:`wiringSubtitle`,children:e.subtitle}),(0,j.jsxs)(`p`,{className:`wiringSubtitle`,style:{marginTop:4},children:[`Documentation contributed by:`,` `,e.contributors.map((t,n)=>(0,j.jsxs)(`span`,{children:[(0,j.jsx)(`strong`,{children:t.name}),n<e.contributors.length-1?` & `:``]},t.name))]})]}),(0,j.jsxs)(`div`,{className:`wiringHeaderActions`,children:[(0,j.jsxs)(`a`,{href:e.pdf,download:!0,className:`dlBtn`,children:[(0,j.jsx)(se,{size:15}),` Download PDF`]}),(0,j.jsxs)(`a`,{href:e.pdf,target:`_blank`,rel:`noopener noreferrer`,className:`dlBtn`,children:[(0,j.jsx)(E,{size:15}),` Open full screen`]})]})]}),(0,j.jsxs)(`div`,{className:`card selectarideOverview`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`What is the Selectaride?`}),e.overview.split(`

`).map((e,t)=>(0,j.jsx)(`p`,{children:e},t))]}),(0,j.jsxs)(`div`,{className:`card`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`Diagrams & documentation`}),(0,j.jsx)(`p`,{className:`helperText`,children:`Select a section to view the diagram and technical notes.`}),(0,j.jsx)(`div`,{className:`selectarideSections`,children:e.sections.map(e=>(0,j.jsxs)(`button`,{className:`selectarideSection${w===e.id?` active`:``}`,onClick:()=>ve(w===e.id?null:e.id),children:[(0,j.jsxs)(`div`,{className:`selectarideSectionTop`,children:[(0,j.jsx)(`strong`,{children:e.title}),(0,j.jsxs)(`span`,{className:`sectionCardPages`,children:[`PDF p. `,e.page]})]}),(0,j.jsx)(`p`,{children:e.subtitle}),(0,j.jsx)(`div`,{className:`sectionCardTags`,children:e.tags.slice(0,5).map(e=>(0,j.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]},e.id))}),t&&(0,j.jsxs)(`div`,{className:`selectarideViewer`,children:[(0,j.jsxs)(`div`,{className:`viewerTop`,children:[(0,j.jsx)(`h3`,{children:t.title}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,j.jsx)(`button`,{onClick:()=>be(e=>Math.max(60,e-20)),children:(0,j.jsx)(_e,{size:16})}),(0,j.jsx)(`button`,{onClick:()=>be(e=>Math.min(200,e+20)),children:(0,j.jsx)(ge,{size:16})}),(0,j.jsx)(`a`,{href:`${e.pdf}#page=${t.page}`,target:`_blank`,rel:`noopener noreferrer`,className:`iconBtn`,children:(0,j.jsx)(E,{size:16})})]})]}),t.image?(0,j.jsx)(`div`,{className:`selectarideImgWrap`,children:(0,j.jsx)(`img`,{src:t.image,alt:t.title,className:`selectarideImg`,style:{transform:`scale(${ye/100})`,transformOrigin:`top left`}})}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`pdfPageHint`,children:[(0,j.jsxs)(`span`,{children:[`📄 PDF page `,(0,j.jsx)(`strong`,{children:t.page})]}),(0,j.jsx)(`span`,{className:`pdfPageHintNote`,children:`If the wrong page shows, tap ↗ to open and navigate manually.`})]}),(0,j.jsx)(`iframe`,{title:t.title,src:`${e.pdf}#page=${t.page}&zoom=${ye}`,className:`wiringIframe`},`selectaride-${e.pdf}-${t.id}`)]}),(0,j.jsxs)(`div`,{className:`selectarideNotes`,children:[(0,j.jsx)(`h4`,{children:`Technical notes`}),(0,j.jsx)(`p`,{children:t.notes})]})]})]})]})})(),b&&(()=>{let e=Se(o),t=xe.trim().toLowerCase(),n=e.components.filter(e=>{let n=Te===`all`||e.circuit===Te,r=!t||e.name.toLowerCase().includes(t)||e.notes.toLowerCase().includes(t)||e.wires.some(e=>e.toLowerCase().includes(t))||e.circuit.toLowerCase().includes(t);return n&&r});return(0,j.jsxs)(`main`,{className:`wiringMain`,children:[(0,j.jsxs)(`div`,{className:`wiringHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`button`,{className:`backBtn`,onClick:()=>x(!1),children:`← Back to manual`}),(0,j.jsx)(`h2`,{children:e.title}),(0,j.jsxs)(`p`,{className:`wiringSubtitle`,children:[e.subtitle,` · `,(0,j.jsx)(`em`,{children:e.credit})]}),o===`all`&&(0,j.jsx)(`p`,{className:`wiringNote`,children:`Showing Mk I & II diagram. Select Mk III in the model selector for the Mk III diagram.`})]}),(0,j.jsxs)(`div`,{className:`wiringHeaderActions`,children:[(0,j.jsxs)(`a`,{href:e.pdf,download:!0,className:`dlBtn`,children:[(0,j.jsx)(se,{size:15}),` Download PDF`]}),(0,j.jsxs)(`a`,{href:e.pdf,target:`_blank`,rel:`noopener noreferrer`,className:`dlBtn`,children:[(0,j.jsx)(E,{size:15}),` Open full screen`]})]})]}),(0,j.jsxs)(`div`,{className:`card wiringViewer`,children:[(0,j.jsxs)(`div`,{className:`viewerTop`,children:[(0,j.jsxs)(`h3`,{children:[`Wiring diagram — `,e.title]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,j.jsx)(`button`,{onClick:()=>Ye(e=>Math.max(60,e-20)),children:(0,j.jsx)(_e,{size:16})}),(0,j.jsx)(`button`,{onClick:()=>Ye(e=>Math.min(200,e+20)),children:(0,j.jsx)(ge,{size:16})})]})]}),(0,j.jsx)(`iframe`,{title:e.title,src:`${e.pdf}#zoom=${Je}`,className:`wiringIframe`},`wiring-${e.id}`)]}),(0,j.jsxs)(`div`,{className:`card`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`Component & wire colour guide`}),(0,j.jsx)(`p`,{className:`helperText`,children:`Search by component name, wire colour or circuit. Tap a row to see wiring details.`}),(0,j.jsxs)(`div`,{className:`wiringSearch`,children:[(0,j.jsx)(fe,{size:16}),(0,j.jsx)(`input`,{value:xe,onChange:e=>we(e.target.value),placeholder:`Search: alternator, Blue/White, ignition, horn…`}),xe&&(0,j.jsx)(`button`,{onClick:()=>we(``),children:`Clear`})]}),(0,j.jsxs)(`div`,{className:`wiringCircuitFilters`,children:[(0,j.jsx)(`button`,{className:Te===`all`?`active`:``,onClick:()=>We(`all`),children:`All circuits`}),Ce.map(e=>(0,j.jsx)(`button`,{className:Te===e?`active`:``,onClick:()=>We(e),children:e},e))]}),n.length===0?(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(he,{size:24}),(0,j.jsx)(`p`,{children:`No components match your search. Try a wire colour or circuit name.`})]}):(0,j.jsx)(`div`,{className:`wiringComponents`,children:n.map(e=>(0,j.jsxs)(`div`,{className:`wiringComponent`,children:[(0,j.jsxs)(`div`,{className:`wiringComponentTop`,children:[(0,j.jsx)(`strong`,{children:e.name}),(0,j.jsx)(`span`,{className:`wiringCircuitBadge`,children:e.circuit})]}),(0,j.jsx)(`div`,{className:`wiringWires`,children:e.wires.map(e=>(0,j.jsx)(`span`,{className:`wirePill wire-${e.split(`(`)[0].trim().split(`/`)[0].trim().toLowerCase().replace(/\s/g,`-`)}`,children:e},e))}),(0,j.jsx)(`p`,{className:`wiringNotes`,children:e.notes})]},e.name))})]})]})})(),(0,j.jsxs)(`main`,{style:b||te?{display:`none`}:{},children:[(0,j.jsxs)(`section`,{className:`hero`,children:[(0,j.jsxs)(`div`,{className:`heroTop`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{className:`eyebrow`,children:`Garage-friendly manual app`}),(0,j.jsx)(`h2`,{children:`Jensen C-V8 Online Manual`})]}),(0,j.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),className:`modelSelect`,children:[(0,j.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,j.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,j.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,j.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]})]}),(0,j.jsxs)(`div`,{className:`heroSearch`,children:[(0,j.jsx)(fe,{size:18}),(0,j.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: no start, brake servo, 35 amp fuse, tyre pressure...`}),e&&(0,j.jsx)(`button`,{onClick:()=>t(``),children:`Clear`})]})]}),!e&&(()=>{let e=o===`mk3`?qe:Ke,t=[`all`,...Array.from(new Set(e.map(e=>e.category).filter(Boolean)))],n=g===`all`?e:e.filter(e=>e.category===g),r=new Set(cn.map(e=>e.page)),i=n.filter(e=>e.pages.some(e=>r.has(e))),a={all:`All`,overview:`Overview`,specs:`Specs`,mechanical:`Mechanical`,lubrication:`Lubrication`,electrical:`Electrical`,fuel:`Fuel`,brakes:`Brakes`,wheels:`Wheels & Tyres`,cooling:`Cooling`,interior:`Interior`,service:`Service`};return(0,j.jsxs)(`section`,{className:`repairGrid`,children:[(0,j.jsxs)(`div`,{className:`repairGridHeader`,children:[(0,j.jsx)(`p`,{className:`eyebrow`,children:`Manual Sections`}),(0,j.jsx)(`h3`,{children:`Organised repair cards`}),(0,j.jsx)(`p`,{className:`helperText`,children:`These summaries stay inside what the manual says. Use source scans for verification.`})]}),(0,j.jsx)(`div`,{className:`categoryFilters`,children:t.map(e=>(0,j.jsx)(`button`,{className:g===e?`active`:``,onClick:()=>_(e),children:a[e]||e},e))}),(0,j.jsx)(`div`,{className:`sectionCardGrid`,children:i.map(e=>{let t=e.pages.find(e=>r.has(e));return(0,j.jsxs)(`button`,{className:`sectionCard`,onClick:()=>_n(t),children:[(0,j.jsxs)(`div`,{className:`sectionCardTop`,children:[(0,j.jsx)(`span`,{className:`sectionCardCat`,children:a[e.category]||e.category}),(0,j.jsxs)(`span`,{className:`sectionCardPages`,children:[`p. `,e.pages.filter(e=>r.has(e)).join(`–`)]})]}),(0,j.jsx)(`h4`,{children:e.title}),e.tags.length>0&&(0,j.jsx)(`div`,{className:`sectionCardTags`,children:e.tags.slice(0,4).map(e=>(0,j.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]},e.title)})})]})})(),(0,j.jsxs)(`div`,{className:`tabs`,children:[(0,j.jsxs)(`button`,{className:u===`cards`?`active`:``,onClick:()=>d(`cards`),children:[(0,j.jsx)(le,{size:16}),` `,un===`repair`?`Repair Card`:`Overview`]}),(0,j.jsxs)(`button`,{className:u===`edit`?`active`:``,onClick:()=>d(`edit`),children:[(0,j.jsx)(de,{size:16}),` Edit OCR`]}),(0,j.jsxs)(`button`,{className:u===`page`?`active`:``,onClick:()=>d(`page`),children:[(0,j.jsx)(ce,{size:16}),` OCR Text`]}),(0,j.jsxs)(`button`,{className:u===`scan`?`active`:``,onClick:()=>d(`scan`),children:[(0,j.jsx)(O,{size:16}),` Scan Viewer`]}),(0,j.jsxs)(`button`,{className:u===`checklist`?`active`:``,onClick:()=>d(`checklist`),children:[(0,j.jsx)(ae,{size:16}),` Checklist`]})]}),(0,j.jsxs)(`section`,{className:`card pageHeader`,children:[(0,j.jsx)(`h2`,{children:Ze(F.page,o,F.title)}),Xe(F.page,o)?.isContinuation&&(0,j.jsxs)(`p`,{className:`continuationNote`,children:[`↩ Continued from `,(0,j.jsx)(`strong`,{children:Xe(F.page,o).sectionTitle})]}),(()=>{let e=ht(F.page,o,fn);return e.length>0?(0,j.jsxs)(`div`,{className:`tagPills`,children:[e.map(e=>(0,j.jsx)(`button`,{className:`tagPill${v===e?` active`:``}`,onClick:()=>y(v===e?null:e),children:e},e)),v&&(0,j.jsx)(`button`,{className:`tagPillClear`,onClick:()=>y(null),children:`✕ Clear filter`})]}):null})(),(0,j.jsxs)(`div`,{className:`manualRef`,children:[(0,j.jsx)(T,{size:14}),(0,j.jsxs)(`span`,{children:[`Manual p. `,F.page,Xe(F.page,o)?.isContinuation?` · Part of ${Xe(F.page,o).sectionTitle}`:``]})]}),(()=>{let e=F.summary&&!F.summary.startsWith(ot),t=/^[a-z()\d.]/,n=e?[]:ut(fn).filter(e=>!t.test(e)).slice(0,3);return e||n.length>0?(0,j.jsxs)(`div`,{className:`summarySection`,children:[e&&(0,j.jsx)(`p`,{className:`summaryLead`,children:F.summary}),n.length>0&&(0,j.jsx)(`ul`,{className:`summaryBullets`,children:n.map((e,t)=>(0,j.jsx)(`li`,{children:e},t))})]}):null})(),pn&&(0,j.jsxs)(`div`,{className:`editedBadge`,children:[(0,j.jsx)(de,{size:12}),` OCR edited`]}),o===`mk3`&&_t(fn)&&F.page!==20&&(0,j.jsxs)(`div`,{className:`lubRefBanner`,children:[(0,j.jsx)(`span`,{children:`📍 This page references lubrication point codes (A1, C2 etc.)`}),(0,j.jsx)(`button`,{onClick:()=>_n(20),children:`View lubrication diagram — p. 20`})]}),o===`mk3`&&F.page===20&&(0,j.jsxs)(`div`,{className:`lubRefBanner`,children:[(0,j.jsx)(`span`,{children:`📋 The codes on this diagram are referenced in the maintenance schedule`}),(0,j.jsx)(`button`,{onClick:()=>_n(21),children:`View maintenance schedule — p. 21`})]}),(0,j.jsxs)(`div`,{className:`buttons`,children:[(0,j.jsxs)(`button`,{onClick:vn,children:[(0,j.jsx)(re,{size:16}),` Previous`]}),(0,j.jsxs)(`button`,{onClick:yn,children:[`Next `,(0,j.jsx)(ie,{size:16})]}),(0,j.jsxs)(`button`,{onClick:()=>gn(F.page),children:[`Open original scan `,(0,j.jsx)(E,{size:16})]})]})]}),u===`cards`&&(0,j.jsxs)(`section`,{className:`card repairCard`,children:[o===`mk3`&&_t(fn)&&F.page!==20&&(0,j.jsxs)(`div`,{className:`lubRefBanner lubRefBannerCard`,children:[(0,j.jsx)(`span`,{children:`📍 References lubrication codes — see the diagram for locations`}),(0,j.jsx)(`button`,{onClick:()=>_n(20),children:`View diagram p. 20`})]}),(0,j.jsxs)(`div`,{className:`repairCardTop`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`p`,{className:`eyebrow`,children:[un===`repair`&&(Xe(F.page,o)?.category===`specs`?`Quick reference`:`Repair summary`),un===`reference`&&`Reference data`,un===`informational`&&`Informational page`,un===`diagram`&&`Diagram / image page`]}),(0,j.jsx)(`h3`,{children:Ze(F.page,o,F.title)})]}),(0,j.jsx)(`button`,{onClick:()=>d(`scan`),children:`View scan`})]}),un===`repair`&&(()=>{let e=Xe(F.page,o)?.category===`specs`,t=e?`Key specifications`:`Repair steps for this page:`,n=e?`No specifications have been extracted for this page yet.`:`No repair checklist has been generated for this page yet.`,r=lt(F.checklist),i=r?F.checklist.filter(e=>ct.test(e)):ut(fn),a=i;if(v){let e=pt(fn,v);a=e.length>0?e:i.filter(e=>ft(v,e))}let s=!!v;return(0,j.jsxs)(j.Fragment,{children:[F.summary&&!F.summary.startsWith(ot)&&(0,j.jsx)(`p`,{children:F.summary}),s&&(0,j.jsxs)(`div`,{className:`filterNotice`,children:[(0,j.jsxs)(`span`,{children:[`Showing steps for: `,(0,j.jsx)(`strong`,{children:v})]}),(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all`})]}),a.length>0?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`p`,{className:`helperText`,children:[r?t:`Key service facts extracted from this page:`,s&&` (${a.length} of ${i.length})`]}),(0,j.jsx)(`ol`,{className:`checklist compact`,children:a.slice(0,8).map((e,t)=>(0,j.jsxs)(`li`,{children:[(0,j.jsx)(`span`,{children:t+1}),(0,j.jsx)(`p`,{children:e})]},e))}),!r&&(0,j.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]}):s?(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(A,{size:24}),(0,j.jsxs)(`p`,{children:[`No steps found specifically for `,(0,j.jsx)(`strong`,{children:v}),` on this page.`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all steps`})]})]}):(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(A,{size:24}),(0,j.jsxs)(`p`,{children:[n,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View the OCR text`}),` for the full content.`]})]})]})})(),un===`reference`&&(0,j.jsxs)(j.Fragment,{children:[F.summary&&!F.summary.startsWith(ot)&&(0,j.jsx)(`p`,{children:F.summary}),(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(ce,{size:24}),(0,j.jsxs)(`p`,{children:[`This is a reference data page — specifications, capacities or tables.`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View OCR text`}),` `,`or`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`open the original scan`}),`.`]})]})]}),un===`informational`&&(0,j.jsxs)(j.Fragment,{children:[F.summary&&!F.summary.startsWith(ot)&&(0,j.jsx)(`p`,{children:F.summary}),(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(T,{size:24}),(0,j.jsxs)(`p`,{children:[`This is an informational page — no repair steps apply.`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`Read the OCR text`}),` `,`or`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`view the original scan`}),`.`]})]})]}),un===`diagram`&&(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(O,{size:24}),(0,j.jsxs)(`p`,{children:[`This is a diagram or image-only page. Use the`,` `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`scan viewer`}),` `,`to see the original page.`]})]})]}),u===`edit`&&(0,j.jsxs)(`section`,{className:`card`,children:[(0,j.jsxs)(`div`,{className:`editorHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`h3`,{className:`sectionTitle`,children:[`Edit OCR Text - Page `,F.page]}),(0,j.jsx)(`p`,{className:`helperText`,children:`Correct the OCR errors here. Changes autosave locally and are used by search immediately.`})]}),(0,j.jsx)(`div`,{className:`editorStatus`,children:pn?`Edited locally`:`Using original OCR`})]}),F.isImageOnly?(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(O,{size:24}),(0,j.jsx)(`p`,{children:`This page is image-only, so there is no OCR text to edit. Use the scan viewer for the original page image.`})]}):(0,j.jsx)(`textarea`,{className:`ocrEditor`,value:fn,onChange:e=>bn(e.target.value),spellCheck:`false`}),(0,j.jsxs)(`div`,{className:`buttons`,children:[(0,j.jsxs)(`button`,{onClick:Sn,children:[(0,j.jsx)(oe,{size:16}),` `,f?`Copied`:`Copy text`]}),(0,j.jsxs)(`button`,{onClick:Cn,children:[(0,j.jsx)(se,{size:16}),` Export OCR fixes`]}),(0,j.jsxs)(`button`,{onClick:wn,children:[(0,j.jsx)(de,{size:16}),` Import OCR fixes`]}),pn&&(0,j.jsx)(`button`,{onClick:xn,children:`Reset this page`}),(0,j.jsxs)(`button`,{onClick:()=>d(`scan`),children:[`View scan `,(0,j.jsx)(O,{size:16})]})]})]}),u===`page`&&(0,j.jsxs)(`section`,{className:`card`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`OCR text from this page`}),(0,j.jsx)(`p`,{className:`helperText`,children:`This view uses your corrected OCR text if you have edited this page.`}),(0,j.jsx)(`pre`,{className:`ocrText`,children:vt(fn||(F.isImageOnly?`This is an image-only reference page. Open the scan viewer to see the original page.`:`No readable OCR text was extracted from this page.`),e)})]}),u===`scan`&&(0,j.jsxs)(`section`,{className:`card viewer`,children:[(0,j.jsxs)(`div`,{className:`viewerTop`,children:[(0,j.jsxs)(`h3`,{children:[`Original scanned page `,F.page]}),(0,j.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,j.jsx)(`button`,{onClick:()=>a(Math.max(60,i-20)),children:(0,j.jsx)(_e,{size:16})}),(0,j.jsx)(`button`,{onClick:()=>a(Math.min(180,i+20)),children:(0,j.jsx)(ge,{size:16})}),(0,j.jsx)(`button`,{onClick:()=>gn(F.page),title:`Open in new tab`,children:(0,j.jsx)(E,{size:16})})]})]}),(0,j.jsxs)(`div`,{className:`pdfPageHint`,children:[(0,j.jsxs)(`span`,{children:[`📄 PDF page `,(0,j.jsx)(`strong`,{children:F.sourcePage||F.page})]}),(0,j.jsx)(`span`,{className:`pdfPageHintNote`,children:`If the wrong page shows, tap the ↗ button to open in your browser and navigate manually.`})]}),(0,j.jsx)(`iframe`,{title:`manual pdf`,src:`${F.sourcePdf||(o===`mk3`?et:$e)}#page=${F.sourcePage||F.page}&zoom=${i}`},`scan-${F.sourcePdf}-${F.sourcePage||F.page}`)]}),u===`checklist`&&(()=>{let e=lt(F.checklist)?F.checklist.filter(e=>ct.test(e)):[],t=e.length>0?e:ut(fn),n=t.filter((e,t)=>m[`${o}:${F.page}:${t}`]).length;return(0,j.jsxs)(`section`,{className:`card`,children:[(0,j.jsxs)(`div`,{className:`checklistHeader`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:e.length>0?`Troubleshooting checklist`:`Key service facts — checklist`}),(0,j.jsxs)(`p`,{className:`helperText`,children:[n,` of `,t.length,` checked`]})]}),n>0&&(0,j.jsx)(`button`,{className:`clearBtn`,onClick:()=>{let e={...m};t.forEach((t,n)=>delete e[`${o}:${F.page}:${n}`]),h(e)},children:`Clear all`})]}),t.length>0?(0,j.jsx)(`ul`,{className:`interactiveChecklist`,children:t.map((e,t)=>{let n=`${o}:${F.page}:${t}`,r=!!m[n];return(0,j.jsxs)(`li`,{className:r?`checked`:``,onClick:()=>h(e=>({...e,[n]:!e[n]})),children:[(0,j.jsx)(`span`,{className:`checkbox`,children:r?`✓`:``}),(0,j.jsx)(`p`,{children:e})]},t)})}):(0,j.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,j.jsx)(A,{size:24}),(0,j.jsx)(`p`,{children:F.isImageOnly?`This is a diagram/image page. Use the original scan.`:`No checklist available for this page yet.`})]}),e.length===0&&t.length>0&&(0,j.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,j.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]})})(),e&&(0,j.jsxs)(`section`,{className:`card`,children:[(0,j.jsx)(`h3`,{className:`sectionTitle`,children:`Search results from OCR text`}),(0,j.jsx)(`div`,{className:`searchResults`,children:hn.map(e=>(0,j.jsxs)(`button`,{onClick:()=>_n(e.page),children:[(0,j.jsxs)(`strong`,{children:[`Page `,e.page,`: `,e.title]}),(0,j.jsxs)(`span`,{children:[e.text.slice(0,260),`...`]})]},e.page))})]})]})]})]})]})}(0,ve.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(yt,{}));