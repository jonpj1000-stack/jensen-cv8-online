...
29. Petrol Filler Lid`,summary:`This page provides a labeled diagram identifying the dashboard instruments and controls in the Jensen C-V8.`,checklist:[`Check the ammeter to monitor electrical system charging status.`,`Inspect the oil pressure gauge to ensure proper engine lubrication readings.`,`Monitor the water temperature gauge to verify engine cooling system operation.`,`Check the low fuel warning light functionality to avoid running out of petrol.`,`Verify the L.H. and R.H. flasher warning lights illuminate when turn signals are activated.`,`Inspect the high beam warning light to confirm it indicates when headlamps are on high beam.`,`Check the instrument illumination control for proper dashboard lighting adjustment.`]},{page:5,title:`GENERAL DIMENSIONS AND DATA FOR QUICK REFERENCE`,text:`GENERAL DIMENSIONS AND DATA FOR QUICK REFERENCE
...
5`,summary:`This page provides essential identification locations, engine specifications, fluid capacities, gear ratios, and dimensional data for the Jensen C-V8.`,checklist:[`Locate the chassis number on the plate secured to the front of the scuttle or stamped on the front chassis frame cross member.`,`Locate the engine number stamped on the L.H. bank of the Cylinder Block immediately forward of No. 1 Cylinder.`,`Check engine oil level ensuring the dipstick top level is not exceeded, with sump capacity of 7 pints Imperial or 8 pints U.S.`,`Fill coolant system including heater to capacity of 24 pints Imperial, 29 pints U.S., or 13.638 litres.`,`Verify engine oil pressure reads 45-65 p.s.i. at 40-50 m.p.h.`,`Check tyre pressure to 24 p.s.i. all round and refer to notes on wheels and tyres on pages 17-18.`,`Fill automatic gearbox to capacity of 15.5 pints Imperial or 18.5 pints U.S.`,`Fill rear axle to capacity of 3 pints Imperial or 3.6 pints U.S.`]},{page:6,title:`Castor Angle (Static laden weight) 2> pos:`,text:`Castor Angle (Static laden weight) 2> pos:
...
27`,summary:`This page provides service lubrication intervals and procedures for the automatic transmission, manual transmission, propeller shaft universal joints, and rear axle.`,checklist:[`Check automatic transmission fluid level every 4,000 miles with engine and transmission at normal operating temperature, handbrake on, after momentarily engaging each gear and ending in neutral.`,`Adjust automatic transmission and replace oil and filter every 32,000 miles, or more frequently if towing trailers, operating in heavy traffic in hot weather, or carrying abnormal loads.`,`Check manual transmission fluid level every 4,000 miles by removing filler plug and replenish to filler hole as needed.`,`Drain and refill manual transmission fluid every 32,000 miles.`,`Disassemble, clean, and repack propeller shaft universal joints with multi-purpose grease (NLGI-0 or 1).`,`Check and top up rear axle fluid every 4,000 miles using only Shell S1747A.`,`Drain and refill rear axle every 12,000 miles, with initial drain and refill at 1,000 miles.`]},{page:28,title:`SERVICE LUBRICATION (continued)`,text:`SERVICE LUBRICATION (continued)
...
Printed in England by Jolly & Barber Led., Rugby.`,summary:`OCR text extracted from this scanned manual page. Use it as a searchable working copy and verify against the scan.`,checklist:[]}],ye=[{id:`mk3-p01`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:1,sourcePage:1,title:`HANDBOOK OF INSTRUCTIONS`,summary:`This is the title page of the Jensen C-V8 Mk.III owner's handbook, introducing the manual's purpose and noting the chassis serial number location for correspondence.`,plainEnglish:`Lubrication system, oil draining, filter changing and lubrication/maintenance schedule information.`,ocrText:`HANDBOOK OF INSTRUCTIONS
FOR THE
JENSEN C-V8 MK.III
eg P
a ee "~& *
...
JENSEN MOTORS LIMITED
3`,checklist:[],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p06`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:6,sourcePage:6,title:`Blank page`,summary:`Blank or spacer page in the scanned manual.`,plainEnglish:`Blank or spacer page in the scanned manual.`,ocrText:``,checklist:[],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`blank`,hidden:!0,isImageOnly:!1},{id:`mk3-p07`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:7,sourcePage:7,title:`General Dimensions and Data`,summary:`This page provides essential specifications for the Jensen C-V8, including chassis and engine identification locations, engine specifications, fluid capacities, gear ratios, tyre specifications, and suspension alignment data.`,plainEnglish:`Key Mk III dimensions, capacities, tyre pressures, tuning data and basic specifications.`,ocrText:`General Dimensions and Data
...
'
|`,checklist:[`Locate the chassis number on the plate secured to the underside of the companion box lid, on the front of the scuttle plate, or stamped on the front chassis frame cross member.`,`Locate the engine number stamped on the left-hand bank of the cylinder block immediately forward of No. 1 cylinder.`,`Fill the oil sump to 8.5 pints (Imp.) or 10 pints (U.S.) including filter, ensuring the dipstick top level is not exceeded.`,`Fill the cooling system including heater to 32 pints (Imp.), 38 pints (U.S.), or 18.2 litres.`,`Fill the automatic gearbox to 17 pints (Imp.), 20 pints (U.S.), or 9.5 litres, or the manual gearbox to 6 pints (Imp.), 7 pints (U.S.), or 3.3 litres.`,`Fill the rear axle to 3 pints (Imp.), 3.6 pints (U.S.), or 1.705 litres.`,`Check engine oil pressure reads 45-65 psi at 40-50 m.p.h.`,`Set tyre pressure to 24 PSI (1.68 kg/sq. cm.) all round and refer to Notes on Wheels and Tyres on page 20.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p08`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:8,sourcePage:8,title:`'Overall Height 4 ft, 7 ins, (1,397 metres)`,summary:`OCR text extracted from the Mk III instruction manual for searching and editing.`,plainEnglish:`OCR text extracted from the Mk III instruction manual for searching and editing.`,ocrText:`'Overall Height 4 ft, 7 ins, (1,397 metres)
...
a`,checklist:[`Keep close watch on the engine oil level during the running-in period.`,`Monitor the temperature and oil pressure gauges closely, especially during early engine life.`,`Avoid speeds in excess of 60 miles per hour for the first 300 miles of operation.`,`Avoid operating at top speed until the car has been driven at least 500 miles.`,`Ensure the handbrake is applied before starting the engine.`,`Move the gear range selector lever to neutral position 'N' before starting on cars with automatic transmission.`,`Depress the accelerator pedal slowly to one third of its travel and release before starting from cold.`,`Give careful attention to the lubrication diagram and ensure proper lubrication at all times.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p16`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:16,sourcePage:16,title:`GEARBOX OPERATION`,summary:`Automatic gearbox operation, selector use, driving speeds, towing and push-start guidance.`,plainEnglish:`Automatic gearbox operation, selector use, driving speeds, towing and push-start guidance.`,ocrText:`GEARBOX OPERATION
...
Check water level and connections and tighten if necessary.`,checklist:[`Drain and refill the rear axle.`,`Check contact breakers and adjust if necessary.`,`Check steering and front end geometry.`,`Check all hydraulic reservoirs for fluid level.`,`Tighten the driving belt if necessary.`,`Check the electrical system.`,`Check tyre pressures.`,`Check all lights.`,`Check braking system.`,`Check water level and connections and tighten if necessary.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1,lubricationDiagram:!0},{id:`mk3-p21`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:21,sourcePage:21,title:`4,000 MILES`,summary:`This page outlines the scheduled maintenance intervals from 1,000 to 16,000 miles for the Jensen C-V8, covering lubrication points, fluid checks, and component inspections.`,plainEnglish:`Brake system operation and service notes.`,ocrText:`A~1,000 MILES (second end subsequent)
Al — King Pin Bearings Upper and Lower—Grease Gun (4 nipples).
A2 — Front Suspension Lower—Grease Gun (2 nipples}.
...
41 — Cerburettor Inlet Pipe Fuel Filter—Replace,`,checklist:[`Replace the sparking plugs at 20,000 miles.`,`Replace the fuel pump inlet filter at 20,000 miles.`,`Clean and repack the wheel hubs at 32,000 miles.`,`Replace the air cleaner element at 32,000 miles under heavy operating conditions.`,`Drain, refill, and adjust the automatic transmission at 32,000 miles under heavy operating conditions.`,`Replace the automatic transmission oil filter at 32,000 miles under heavy operating conditions.`,`Clean and repack the propeller shaft joints at 32,000 miles under heavy operating conditions.`,`Replace the carburettor inlet pipe fuel filter at 80,000 miles.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p23`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:23,sourcePage:23,title:`Fuel System and Carburettor`,summary:`This page describes the fuel system components including the tank, fuel lines, filters, mechanical pump, and Carter AFB carburettor, along with filter replacement intervals and idle speed adjustment procedures.`,plainEnglish:`OCR text extracted from the Mk III instruction manual for searching and editing.`,ocrText:`Fuel System and Carburettor
Fuel System
...
The documentation on this page covers the original Armstrong wiring arrangement and two community-developed wiring modifications that improve reliability: one using additional external relays to protect the switch contacts from high current, the other a complete rewire of the system. Both modifications allow the original Selectaride units to function correctly if the solenoid valves inside the shock absorbers are still serviceable.`,pdf:`/manuals/jensen-cv8-mk1-mk2-selectaride.pdf`,sections:[{id:`wiring-complete`,title:`Complete Wiring Modification Diagram`,subtitle:`Full rewire showing Control Switch, LED Display, Relays and Shock Absorbers`,page:1,tags:[`wiring modification`,`control switch`,`relay`,`LED display`,`shock absorber`,`T1`,`T2`,`T3`,`T4`],notes:`The complete diagram shows the four-position Control Switch (T1–T4) connected via the LED indicator display to two relays, which in turn drive the left and right shock absorber solenoid valves (S1–S4). Wire colours: Red = 12V supply feed, Black = ground, White/Green/Blue = control signals between switch positions and valve contacts, Brown = coil feed to shock absorber solenoids, Yellow = relay output.`},{id:`overview-1`,title:`General Overview — Part 1`,subtitle:`Block diagram: Control Switch → Wiring Loom → Shock Absorber Electrical Boxes`,page:3,tags:[`overview`,`wiring loom`,`control switch`,`shock absorber`,`left`,`right`,`T1`,`T2`,`T3`,`T4`,`S1`,`S2`,`S3`,`S4`],notes:`Simplified block diagram showing how the single Selectaride Control Switch (T1–T4) connects via the wiring loom to two identical Shock Absorber Electrical Boxes — one for the left damper (S1–S4) and one for the right (R1–R4). Each box contains a coil which, when energised, moves the internal valve to select the correct damping rate.`},{id:`overview-2`,title:`General Overview — Part 2`,subtitle:`Detailed views: Control Switch (bottom) and Shock Absorber Electrical Box (top)`,page:4,tags:[`overview`,`rotor`,`bottom view`,`top view`,`S1`,`S2`,`S3`,`S4`,`R1`,`R2`,`R3`,`R4`,`coil`,`ground`],notes:`Shows the physical construction of the Control Switch rotor (bottom view, T1–T4 contacts) and the Shock Absorber Electrical Box (top view, S1–S4 contacts). Important: S1=R1, S2=R2, S3=R3, S4=R4 — the left and right boxes use the same contact layout, just labelled differently in the wiring diagrams.`},{id:`switching-soft`,title:`Switching Procedure — To Position SOFT`,subtitle:`What happens electrically when selecting the softest damper setting`,page:5,tags:[`switching`,`SOFT`,`rotor`,`T1`,`S1`,`R1`,`valve`,`procedure`],notes:`When turning the selector from position 4 to SOFT, contact T1 briefly closes during rotor travel. S1 and R1 are already closed in this position. The valve inside the shock absorber moves to the SOFT position. Note the rotor position while moving — the transition period is important for understanding why the system can fail if contacts are worn or dirty.`},{id:`external-relay`,title:`Optional Modification — External Relay`,subtitle:`Protecting switch contacts from high current with an additional relay`,page:2,tags:[`modification`,`relay`,`external relay`,`high current`,`switch contacts`,`coil`,`ground`,`12V`],notes:`The standard Selectaride wiring passes the full solenoid current through the small switch contacts on the Control Switch, which causes arcing and wear over time. This optional modification adds an external relay between the switch and the shock absorber coil. The switch now only energises the relay coil (low current), while the relay contacts carry the high current to the shock absorber solenoid — greatly extending contact life.`}]},we=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),A=o(((e,t)=>{t.exports=we()}))(),Te=[{title:`Dashboard & Controls`,pages:[4],tags:`dashboard instruments controls switches gauges warning lights`},{title:`Specifications & Capacities`,pages:[5,6],tags:`specifications capacity timing plug gap compression oil dimensions`},{title:`Motor, Starting & Running`,pages:[7,8,9],tags:`engine motor starting running gearbox transmission overdrive towing`},{title:`Lubrication & Maintenance`,pages:[10,11,25,26,27,28],tags:`lubrication maintenance grease oil service miles`},{title:`Electrical, Battery & Fuses`,pages:[12,13],tags:`electrical lucas autolite battery positive earth fuse fuses bulbs lamps wiper`},{title:`Brakes & Servo`,pages:[13],tags:`brakes servo dunlop brake fluid handbrake vacuum`},{title:`Fuel System & Carburetter`,pages:[15,16],tags:`fuel carburetter carter idle fast idle choke throttle linkage`},{title:`Tyres, Wheels & Alignment`,pages:[17,18,19],tags:`tyres tires wheels alignment bearings toe-in castor camber`},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],tags:`cooling fan radiator heater ventilation antifreeze coolant rear axle powr-lok drive belt`},{title:`Interior & Owner Information`,pages:[2,3,22,23,31,32],tags:`owner warranty seats upholstery vehicle particulars chassis engine key`}],Ee=[{title:`Cover`,pages:[1],category:`overview`,tags:[]},{title:`Introduction`,pages:[2,3],category:`overview`,tags:[`owner`,`handbook`,`warranty`]},{title:`Dashboard & Controls`,pages:[4],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`gauges`,`switches`,`warning lights`]},{title:`Specifications & Dimensions`,pages:[5,6],category:`specs`,tags:[`specifications`,`dimensions`,`capacity`,`timing`,`compression`,`spark plug`,`ignition`]},{title:`Starting, Gearbox & Towing`,pages:[7,8,9],category:`mechanical`,tags:[`starting`,`engine`,`gearbox`,`overdrive`,`towing`,`transmission`,`running-in`]},{title:`Lubrication & Maintenance`,pages:[10,11],category:`lubrication`,tags:[`lubrication`,`oil`,`grease`,`maintenance`,`filter`,`dipstick`]},{title:`Electrical Equipment`,pages:[12,13],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`bulbs`,`wiring`,`lucas`,`autolite`,`wiper`]},{title:`Brakes & Servo`,pages:[14],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`handbrake`,`vacuum`,`dunlop`]},{title:`Fuel System & Carburettor`,pages:[15,16,17],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`carter`]},{title:`Tyres, Wheels & Alignment`,pages:[18,19],category:`wheels`,tags:[`tyres`,`wheels`,`alignment`,`toe-in`,`camber`,`bearings`,`tyre pressure`]},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],category:`cooling`,tags:[`cooling`,`radiator`,`antifreeze`,`heater`,`rear axle`,`fan belt`,`powr-lok`]},{title:`Interior & Owner Information`,pages:[22,23,24],category:`interior`,tags:[`seats`,`upholstery`,`interior`,`owner`,`chassis number`]},{title:`Service Lubrication`,pages:[25,26,27,28],category:`service`,tags:[`service`,`lubrication`,`grease points`,`capacities`,`oil change`]},{title:`Index`,pages:[29],category:`overview`,tags:[`index`]},{title:`Vehicle Particulars`,pages:[31,32],category:`overview`,tags:[`chassis number`,`engine number`,`registration`,`delivery`]}],De=[{title:`Handbook Cover`,pages:[1],category:`overview`,tags:[]},{title:`Vehicle Particulars`,pages:[3],category:`overview`,tags:[`chassis number`,`key number`,`registration`,`delivery`]},{title:`Foreword`,pages:[5],category:`overview`,tags:[`handbook`,`owner`,`jensen motors`]},{title:`General Dimensions & Data`,pages:[7,8],category:`specs`,tags:[`dimensions`,`specifications`,`weight`,`wheelbase`,`turning circle`,`gear ratios`]},{title:`Instruments & Controls Diagram`,pages:[9],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`diagram`,`layout`]},{title:`Controls & Instruments`,pages:[11,12,13],category:`overview`,tags:[`controls`,`instruments`,`gauges`,`switches`,`headlights`,`horn`,`heater fan`,`selectaride`,`speedometer`,`ammeter`,`oil pressure`]},{title:`Starting Up & Running`,pages:[15,16,17,18],category:`mechanical`,tags:[`starting`,`running-in`,`gearbox`,`overdrive`,`towing`,`push starting`,`choke`,`transmission`]},{title:`Engine Lubrication System`,pages:[19],category:`lubrication`,tags:[`engine oil`,`oil filter`,`sump`,`oil change`,`dipstick`,`oil pressure`,`4000 miles`]},{title:`Maintenance Schedule`,pages:[20,21,22],category:`service`,tags:[`maintenance`,`service intervals`,`king pin`,`spark plugs`,`lubrication diagram`,`grease points`]},{title:`Fuel System & Carburettor`,pages:[23,24,25,26,27],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`air cleaner`,`crankcase vent`]},{title:`Ignition`,pages:[29,30],category:`electrical`,tags:[`ignition`,`contact breaker`,`timing`,`distributor`,`coil`,`ballast resistor`]},{title:`Cooling System`,pages:[31,32],category:`cooling`,tags:[`cooling`,`radiator`,`coolant`,`fan`,`thermostat`,`antifreeze`,`electric fans`]},{title:`Transmission & Propeller Shaft`,pages:[33,34],category:`mechanical`,tags:[`transmission`,`gearbox`,`propeller shaft`,`universal joint`,`transmission fluid`]},{title:`Steering & Suspension`,pages:[35,36,37],category:`mechanical`,tags:[`steering`,`suspension`,`rack and pinion`,`wishbone`,`front hubs`,`wheel alignment`,`dampers`]},{title:`Brake Servo Unit`,pages:[38],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`disc brakes`,`handbrake`]},{title:`Wheels & Tyres`,pages:[39,40],category:`wheels`,tags:[`wheels`,`tyres`,`tyre pressure`,`wheel changing`,`jack`,`spare wheel`]},{title:`Bodywork & Seats`,pages:[41,42],category:`interior`,tags:[`bodywork`,`doors`,`seats`,`upholstery`,`adjustment`]},{title:`Spare Wheel`,pages:[43],category:`wheels`,tags:[`spare wheel`,`boot`,`jack`]},{title:`Cabin Heating & Ventilation`,pages:[45,46],category:`interior`,tags:[`heating`,`ventilation`,`heater`,`fresh air`,`fan`,`demist`]},{title:`Electrical System`,pages:[47,48],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`wiring`,`earth`,`alternator`,`interior light`]},{title:`Lights`,pages:[49,50],category:`electrical`,tags:[`lights`,`headlamps`,`sidelights`,`bulbs`,`reversing light`,`number plate light`,`flasher`]},{title:`Tool Kit & Equipment`,pages:[51,52,53],category:`overview`,tags:[`tools`,`toolkit`,`equipment`,`accessories`]},{title:`Service Lubrication`,pages:[55,56,57,58],category:`service`,tags:[`service`,`lubrication`,`oil change`,`grease`,`intervals`,`capacities`,`transmission fluid`]},{title:`Index`,pages:[59,60],category:`overview`,tags:[`index`]}];function Oe(e){let t=new Map;for(let n of e)n.pages.forEach((e,r)=>{t.set(e,{sectionTitle:n.title,isContinuation:r>0,category:n.category||`general`,tags:n.tags||[]})});return t}var ke=Oe(Ee),Ae=Oe(De);function je(e,t){return(t===`mk3`?Ae:ke).get(e)||null}function Me(e,t,n){let r=je(e,t);return r?r.isContinuation?`${r.sectionTitle} (cont.)`:r.sectionTitle:n}var Ne={all:`All Models`,mk1:`Mk I`,mk2:`Mk II`,mk3:`Mk III`},Pe=`/manuals/jensen_cv8_owners_manual.pdf`,Fe=`/manuals/jensen-cv8-mk3-instruction-manual.pdf`;function Ie(e){let t=String(e.title||``).toLowerCase(),n=String(e.text??e.ocrText??``).trim();return e.hidden||e.type===`blank`||t===`blank page`?`blank`:e.type?e.type:n?`text`:`diagram`}function Le(e,t,n,r){return e.map(e=>{let i=e.text??e.ocrText??``,a=Ie({...e,text:i}),o=a===`blank`,s=a===`diagram`||e.isImageOnly===!0;return{...e,type:a,hidden:o||e.hidden===!0,isImageOnly:s,model:e.model||t,modelLabel:e.modelLabel||n,sourcePdf:e.sourcePdf||r,sourcePage:e.sourcePage||e.page,text:i,summary:e.summary??e.plainEnglish??(s?`Image-only reference page. Use the original scan for this page.`:``),title:e.title||`Page ${e.page}`}})}function Re(e){return e.filter(e=>!e.hidden)}function ze(e,t,n=1){let r=Re(e);if(!r.length)return null;let i=r.find(e=>e.page===t);if(i)return i;let a=[...r].sort((e,t)=>e.page-t.page);return n>=0?a.find(e=>e.page>=t)||a[a.length-1]:[...a].reverse().find(e=>e.page<=t)||a[0]}var Be=Le(ve,`base`,`Jensen C-V8`,Pe),Ve=Le(ye,`mk3`,`Jensen C-V8 Mk III`,Fe),He=`OCR text extracted from this scanned manual page`,j=[`foreword`,`introduction`,`handbook of instructions`,`vehicle particulars`,`warranty`,`index`,`contents`,`cover`,`title page`,`jensen`],Ue=/^(check|inspect|change|replace|drain|fill|remove|install|adjust|clean|tighten|loosen|ensure|apply|add|use|do not|never|always|confirm|photograph|identify|select|engage|depress|set|verify|refit|recheck|run|start|allow|push|pull|turn|disconnect|connect|torque|grease|lubricate|bleed|test|reset|secure|re-?tighten|re-?fit|re-?check)/i;function We(e){return!Array.isArray(e)||e.length<2?!1:e.filter(e=>e.length>35&&Ue.test(e)).length>=2}function Ge(e){if(!e||e.length<40)return[];let t=e.replace(/\n+/g,` `).split(/(?<=[.!?])\s+/).map(e=>e.trim()).filter(e=>e.length>25&&e.length<300),n=new Set,r=[];for(let e of t){let t=e.slice(0,40).toLowerCase();n.has(t)||(/every\s+[\d,]+\s*(miles?|km|months?|years?|hours?)/i.test(e)||/\d+[\s-]*(p\.?s\.?i\.?|psi|rpm|r\.p\.m|°|degrees?|mm|ins?\.)\b/i.test(e)||/should\s+be\s+(changed|checked|drained|replaced|inspected|cleaned|adjusted|refilled|topped|removed|fitted)/i.test(e)||/must\s+(be|not)\s+/i.test(e)||/\bdo not\b|\bnever\b/i.test(e)||Ue.test(e))&&(n.add(t),r.push(e))}return r.slice(0,8)}function Ke(e){if(e.isImageOnly||e.type===`diagram`||!e.text?.trim())return`diagram`;let t=(e.title||``).toLowerCase();return j.some(e=>t.includes(e))?`informational`:We(e.checklist)||Ge(e.text).length>0?`repair`:`reference`}function qe(e){return e.toLowerCase().replace(/(\d),(\d)/g,`$1$2`).replace(/\s+/g,` `).trim()}function Je(e,t){return qe(t).includes(qe(e))}function Ye(e,t){if(!e)return[];let n=t.replace(/[^\d]/g,``);if(!n||n.length<3)return[];let r=e.split(`
`).map(e=>e.trim()).filter(Boolean),i=!1,a=[];for(let e of r){let t=e.match(/([\d,]{4,})\s*(miles?|km)/i);if(t){if(t[1].replace(/,/g,``)===n){i=!0;continue}else if(i)break;continue}if(i&&e.length>3){let t=e.replace(/^[A-Z]\d+\.?\s*[—–\-]+\s*/,``).trim();t.length>4&&a.push(t)}}return a}function Xe(e){if(!e)return[];let t=[...e.matchAll(/([\d,]+)\s*miles/gi)],n=new Set;for(let e of t){let t=parseInt(e[1].replace(/,/g,``),10);t>=500&&t<=15e4&&n.add(t)}return[...n].sort((e,t)=>e-t).map(e=>`${e.toLocaleString()} miles`)}function Ze(e,t,n){let r=(je(e,t)?.tags||[]).filter(e=>!/\d.*miles/i.test(e)),i=Xe(n);return[...r,...i]}var M=/\b[A-J]\d+\s*[—–\-]/;function Qe(e){return M.test(e||``)}function $e(e,t){if(!t.trim())return e;let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return e.split(RegExp(`(${n})`,`ig`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,A.jsx)(`mark`,{children:e},n):e)}function et(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)(4),[i,a]=(0,S.useState)(100),[o,s]=(0,S.useState)(()=>localStorage.getItem(`jensen-model`)||`all`),[c,l]=(0,S.useState)(!1),[u,d]=(0,S.useState)(`cards`),[f,p]=(0,S.useState)(!1),[m,h]=(0,S.useState)({}),[g,_]=(0,S.useState)(`all`),[v,y]=(0,S.useState)(null),[b,x]=(0,S.useState)(!1),[ee,C]=(0,S.useState)(!1),[te,ne]=(0,S.useState)(null),[w,_e]=(0,S.useState)(100),[ve,ye]=(0,S.useState)(``),[be,we]=(0,S.useState)(`all`),[Oe,ke]=(0,S.useState)(100),[Ae,Ie]=(0,S.useState)(()=>{try{return JSON.parse(localStorage.getItem(`jensen-ocr-edits`)||`{}`)}catch{return{}}});(0,S.useEffect)(()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).then(e=>{!e||!Object.keys(e).length||Ie(t=>({...e,...t}))}).catch(()=>{})},[]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-model`,o)},[o]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-ocr-edits`,JSON.stringify(Ae))},[Ae]);let Le=Ne[o]||Ne.all,j=(0,S.useMemo)(()=>o===`mk3`?Ve:Be,[o]),qe=(0,S.useMemo)(()=>Re(j),[j]),Xe=(0,S.useMemo)(()=>{let e=new Set(qe.map(e=>e.page));return Te.map(t=>({...t,pages:t.pages.filter(t=>e.has(t))})).filter(e=>e.pages.length)},[qe]);(0,S.useEffect)(()=>{let e=ze(j,n,1);e&&e.page!==n&&r(e.page)},[j,n]);let M=qe.find(e=>e.page===n)||qe[0]||j[0],et=Ke(M),tt=`${o}:${M?.page||1}`,nt=Ae[tt]??M.text??``,rt=Object.prototype.hasOwnProperty.call(Ae,tt);Object.keys(Ae).filter(e=>e.startsWith(`${o}:`)).length,qe.filter(e=>e.checklist&&e.checklist.length).length;let it=(0,S.useMemo)(()=>qe.map(e=>{let t=`${o}:${e.page}`;return{...e,text:Ae[t]??e.text??``}}),[Ae,qe,o]),at=(0,S.useMemo)(()=>{let t=e.trim().toLowerCase();if(!t)return[];let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return it.map(e=>{let t=(`${e.title} ${e.text} ${e.summary}`.toLowerCase().match(new RegExp(n,`g`))||[]).length;return{...e,score:t}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score)},[e,it]),ot=(e=n)=>{let t=j.find(t=>t.page===e)||M,r=t?.sourcePdf||(o===`mk3`?Fe:Pe),i=t?.sourcePage||t?.page||e;window.open(`${r}#page=${i}`,`_blank`)},st=(e,t=1)=>{let n=ze(j,e,t);if(n){r(n.page);let e=Ke(n);e===`diagram`?d(`scan`):e===`repair`?d(`cards`):(e===`informational`||u===`cards`)&&d(`page`)}l(!1),p(!1),y(null)},ct=()=>st(n-1,-1),lt=()=>st(n+1,1),ut=e=>{Ie({...Ae,[tt]:e})},dt=()=>{let e={...Ae};delete e[tt],Ie(e)},ft=async()=>{await navigator.clipboard.writeText(nt),p(!0),setTimeout(()=>p(!1),1600)},pt=()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).catch(()=>({})).then(e=>{let t={...e,...Ae},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`jensen-ocr-edits.json`,i.click(),URL.revokeObjectURL(r)})},mt=()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json,.json`,e.onchange=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);typeof t==`object`&&t&&Ie(e=>({...e,...t}))}catch{alert(`Could not read the file — make sure it is a valid jensen-ocr-edits.json export.`)}},n.readAsText(t)},e.click()},ht=(0,A.jsxs)(`aside`,{className:c?`sidebar open`:`sidebar`,children:[(0,A.jsxs)(`div`,{className:`mobileClose`,children:[(0,A.jsx)(`strong`,{children:`Manual Library`}),(0,A.jsx)(`button`,{onClick:()=>l(!1),children:(0,A.jsx)(k,{size:20})})]}),(0,A.jsxs)(`div`,{className:`searchBox`,children:[(0,A.jsxs)(`label`,{children:[(0,A.jsx)(fe,{size:16}),` Search manual`]}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: ballast resistor, brake fluid, tyre pressure...`})]}),e&&(0,A.jsxs)(`div`,{className:`resultsBox`,children:[(0,A.jsxs)(`strong`,{children:[at.length,` result`,at.length===1?``:`s`]}),at.slice(0,8).map(e=>(0,A.jsxs)(`button`,{onClick:()=>st(e.page),children:[`p`,e.page,`: `,e.title,(0,A.jsxs)(`small`,{children:[e.score,` hit`,e.score===1?``:`s`]})]},e.page))]}),(0,A.jsxs)(`button`,{className:`wiringNavBtn${b?` active`:``}`,onClick:()=>{x(!0),C(!1),l(!1)},children:[(0,A.jsx)(me,{size:16}),` Wiring Diagrams`,(0,A.jsxs)(`small`,{children:[o===`mk3`?`Mk III`:`Mk I & II`,` · colourised`]})]}),o!==`mk3`&&(0,A.jsxs)(`button`,{className:`wiringNavBtn selectarideNavBtn${ee?` active`:``}`,onClick:()=>{C(!0),x(!1),l(!1)},children:[(0,A.jsx)(pe,{size:16}),` Selectaride`,(0,A.jsx)(`small`,{children:`Mk I & II · shock absorbers`})]}),(0,A.jsx)(`h3`,{children:`Manual Sections`}),(0,A.jsx)(`nav`,{className:`topics`,children:Xe.map(e=>(0,A.jsxs)(`button`,{onClick:()=>st(e.pages[0]),children:[(0,A.jsx)(T,{size:16}),(0,A.jsx)(`span`,{children:e.title}),(0,A.jsxs)(`small`,{children:[`p`,e.pages.join(`, `)]})]},e.title))}),(0,A.jsx)(`h3`,{children:`All Pages`}),(0,A.jsx)(`nav`,{children:qe.map(e=>{let t=Me(e.page,o,e.title),r=je(e.page,o);return(0,A.jsxs)(`button`,{className:[e.page===n?`selected`:``,r?.isContinuation?`continuation`:``].join(` `).trim(),onClick:()=>st(e.page),children:[(0,A.jsx)(le,{size:16}),(0,A.jsxs)(`span`,{children:[`Page `,e.page]}),(0,A.jsxs)(`small`,{children:[t,Ae[`${o}:${e.page}`]?` · edited`:``]})]},e.page)})})]});return(0,A.jsxs)(`div`,{className:`app`,children:[(0,A.jsxs)(`header`,{className:`topBar`,children:[(0,A.jsx)(`button`,{className:`hamburger`,onClick:()=>l(!0),children:(0,A.jsx)(ue,{})}),(0,A.jsxs)(`div`,{className:`brand`,children:[(0,A.jsx)(`img`,{src:`/jensen-logo.png`,alt:`Jensen logo`}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{children:`Jensen C-V8`}),(0,A.jsx)(`h1`,{children:`Online Manual`}),(0,A.jsx)(`small`,{children:Le})]})]}),(0,A.jsx)(`button`,{className:`openPdf`,onClick:()=>ot(),children:`Open PDF`})]}),(0,A.jsxs)(`div`,{className:`layout`,children:[ht,ee&&(()=>{let e=te?Ce.sections.find(e=>e.id===te):null;return(0,A.jsxs)(`main`,{className:`wiringMain`,children:[(0,A.jsxs)(`div`,{className:`wiringHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`button`,{className:`backBtn`,onClick:()=>C(!1),children:`← Back to manual`}),(0,A.jsx)(`h2`,{children:Ce.title}),(0,A.jsx)(`p`,{className:`wiringSubtitle`,children:Ce.subtitle}),(0,A.jsxs)(`p`,{className:`wiringSubtitle`,style:{marginTop:4},children:[`Documentation contributed by:`,` `,Ce.contributors.map((e,t)=>(0,A.jsxs)(`span`,{children:[(0,A.jsx)(`strong`,{children:e.name}),t<Ce.contributors.length-1?` & `:``]},e.name))]})]}),(0,A.jsxs)(`div`,{className:`wiringHeaderActions`,children:[(0,A.jsxs)(`a`,{href:Ce.pdf,download:!0,className:`dlBtn`,children:[(0,A.jsx)(se,{size:15}),` Download PDF`]}),(0,A.jsxs)(`a`,{href:Ce.pdf,target:`_blank`,rel:`noopener noreferrer`,className:`dlBtn`,children:[(0,A.jsx)(ce,{size:15}),` Open full screen`]})]})]}),(0,A.jsxs)(`div`,{className:`card selectarideOverview`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`What is the Selectaride?`}),Ce.overview.split(`

`).map((e,t)=>(0,A.jsx)(`p`,{children:e},t))]}),(0,A.jsxs)(`div`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Diagrams & documentation`}),(0,A.jsx)(`p`,{className:`helperText`,children:`Select a section to view the diagram and technical notes.`}),(0,A.jsx)(`div`,{className:`selectarideSections`,children:Ce.sections.map(e=>(0,A.jsxs)(`button`,{className:`selectarideSection${te===e.id?` active`:``}`,onClick:()=>ne(te===e.id?null:e.id),children:[(0,A.jsxs)(`div`,{className:`selectarideSectionTop`,children:[(0,A.jsx)(`strong`,{children:e.title}),(0,A.jsxs)(`span`,{className:`sectionCardPages`,children:[`PDF p. `,e.page]})]}),(0,A.jsx)(`p`,{children:e.subtitle}),(0,A.jsx)(`div`,{className:`sectionCardTags`,children:e.tags.slice(0,5).map(e=>(0,A.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]},e.id))}),e&&(0,A.jsxs)(`div`,{className:`selectarideViewer`,children:[(0,A.jsxs)(`div`,{className:`viewerTop`,children:[(0,A.jsx)(`h3`,{children:e.title}),(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(`button`,{onClick:()=>_e(e=>Math.max(60,e-20)),children:(0,A.jsx)(ge,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>_e(e=>Math.min(200,e+20)),children:(0,A.jsx)(he,{size:16})}),(0,A.jsx)(`a`,{href:`${Ce.pdf}#page=${e.page}`,target:`_blank`,rel:`noopener noreferrer`,className:`iconBtn`,children:(0,A.jsx)(ce,{size:16})})]})]}),(0,A.jsxs)(`div`,{className:`pdfPageHint`,children:[(0,A.jsxs)(`span`,{children:[`📄 PDF page `,(0,A.jsx)(`strong`,{children:e.page})]}),(0,A.jsx)(`span`,{className:`pdfPageHintNote`,children:`If the wrong page shows, tap ↗ to open and navigate manually.`})]}),(0,A.jsx)(`iframe`,{title:e.title,src:`${Ce.pdf}#page=${e.page}&zoom=${w}`,className:`wiringIframe`},`selectaride-${e.id}`),(0,A.jsxs)(`div`,{className:`selectarideNotes`,children:[(0,A.jsx)(`h4`,{children:`Technical notes`}),(0,A.jsx)(`p`,{children:e.notes})]})]})]})]})})(),b&&(()=>{let e=xe(o),t=ve.trim().toLowerCase(),n=e.components.filter(e=>{let n=be===`all`||e.circuit===be,r=!t||e.name.toLowerCase().includes(t)||e.notes.toLowerCase().includes(t)||e.wires.some(e=>e.toLowerCase().includes(t))||e.circuit.toLowerCase().includes(t);return n&&r});return(0,A.jsxs)(`main`,{className:`wiringMain`,children:[(0,A.jsxs)(`div`,{className:`wiringHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`button`,{className:`backBtn`,onClick:()=>x(!1),children:`← Back to manual`}),(0,A.jsx)(`h2`,{children:e.title}),(0,A.jsxs)(`p`,{className:`wiringSubtitle`,children:[e.subtitle,` · `,(0,A.jsx)(`em`,{children:e.credit})]}),o===`all`&&(0,A.jsx)(`p`,{className:`wiringNote`,children:`Showing Mk I & II diagram. Select Mk III in the model selector for the Mk III diagram.`})]}),(0,A.jsxs)(`div`,{className:`wiringHeaderActions`,children:[(0,A.jsxs)(`a`,{href:e.pdf,download:!0,className:`dlBtn`,children:[(0,A.jsx)(se,{size:15}),` Download PDF`]}),(0,A.jsxs)(`a`,{href:e.pdf,target:`_blank`,rel:`noopener noreferrer`,className:`dlBtn`,children:[(0,A.jsx)(ce,{size:15}),` Open full screen`]})]})]}),(0,A.jsxs)(`div`,{className:`card wiringViewer`,children:[(0,A.jsxs)(`div`,{className:`viewerTop`,children:[(0,A.jsxs)(`h3`,{children:[`Wiring diagram — `,e.title]}),(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(`button`,{onClick:()=>ke(e=>Math.max(60,e-20)),children:(0,A.jsx)(ge,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>ke(e=>Math.min(200,e+20)),children:(0,A.jsx)(he,{size:16})})]})]}),(0,A.jsx)(`iframe`,{title:e.title,src:`${e.pdf}#zoom=${Oe}`,className:`wiringIframe`},`wiring-${e.id}`)]}),(0,A.jsxs)(`div`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Component & wire colour guide`}),(0,A.jsx)(`p`,{className:`helperText`,children:`Search by component name, wire colour or circuit. Tap a row to see wiring details.`}),(0,A.jsxs)(`div`,{className:`wiringSearch`,children:[(0,A.jsx)(fe,{size:16}),(0,A.jsx)(`input`,{value:ve,onChange:e=>ye(e.target.value),placeholder:`Search: alternator, Blue/White, ignition, horn…`}),ve&&(0,A.jsx)(`button`,{onClick:()=>ye(``),children:`Clear`})]}),(0,A.jsxs)(`div`,{className:`wiringCircuitFilters`,children:[(0,A.jsx)(`button`,{className:be===`all`?`active`:``,onClick:()=>we(`all`),children:`All circuits`}),Se.map(e=>(0,A.jsx)(`button`,{className:be===e?`active`:``,onClick:()=>we(e),children:e},e))]}),n.length===0?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(me,{size:24}),(0,A.jsx)(`p`,{children:`No components match your search. Try a wire colour or circuit name.`})]}):(0,A.jsx)(`div`,{className:`wiringComponents`,children:n.map(e=>(0,A.jsxs)(`div`,{className:`wiringComponent`,children:[(0,A.jsxs)(`div`,{className:`wiringComponentTop`,children:[(0,A.jsx)(`strong`,{children:e.name}),(0,A.jsx)(`span`,{className:`wiringCircuitBadge`,children:e.circuit})]}),(0,A.jsx)(`div`,{className:`wiringWires`,children:e.wires.map(e=>(0,A.jsx)(`span`,{className:`wirePill wire-${e.split(`(`)[0].trim().split(`/`)[0].trim().toLowerCase().replace(/\s/g,`-`)}`,children:e},e))}),(0,A.jsx)(`p`,{className:`wiringNotes`,children:e.notes})]},e.name))})]})]})})(),(0,A.jsxs)(`main`,{style:b||ee?{display:`none`}:{},children:[(0,A.jsxs)(`section`,{className:`hero`,children:[(0,A.jsxs)(`div`,{className:`heroTop`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Garage-friendly manual app`}),(0,A.jsx)(`h2`,{children:`Jensen C-V8 Online Manual`})]}),(0,A.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),className:`modelSelect`,children:[(0,A.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,A.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,A.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,A.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]})]}),(0,A.jsxs)(`div`,{className:`heroSearch`,children:[(0,A.jsx)(fe,{size:18}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: no start, brake servo, 35 amp fuse, tyre pressure...`}),e&&(0,A.jsx)(`button`,{onClick:()=>t(``),children:`Clear`})]})]}),!e&&(()=>{let e=o===`mk3`?De:Ee,t=[`all`,...Array.from(new Set(e.map(e=>e.category).filter(Boolean)))],n=g===`all`?e:e.filter(e=>e.category===g),r=new Set(qe.map(e=>e.page)),i=n.filter(e=>e.pages.some(e=>r.has(e))),a={all:`All`,overview:`Overview`,specs:`Specs`,mechanical:`Mechanical`,lubrication:`Lubrication`,electrical:`Electrical`,fuel:`Fuel`,brakes:`Brakes`,wheels:`Wheels & Tyres`,cooling:`Cooling`,interior:`Interior`,service:`Service`};return(0,A.jsxs)(`section`,{className:`repairGrid`,children:[(0,A.jsxs)(`div`,{className:`repairGridHeader`,children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Manual Sections`}),(0,A.jsx)(`h3`,{children:`Organised repair cards`}),(0,A.jsx)(`p`,{className:`helperText`,children:`These summaries stay inside what the manual says. Use source scans for verification.`})]}),(0,A.jsx)(`div`,{className:`categoryFilters`,children:t.map(e=>(0,A.jsx)(`button`,{className:g===e?`active`:``,onClick:()=>_(e),children:a[e]||e},e))}),(0,A.jsx)(`div`,{className:`sectionCardGrid`,children:i.map(e=>{let t=e.pages.find(e=>r.has(e));return(0,A.jsxs)(`button`,{className:`sectionCard`,onClick:()=>st(t),children:[(0,A.jsxs)(`div`,{className:`sectionCardTop`,children:[(0,A.jsx)(`span`,{className:`sectionCardCat`,children:a[e.category]||e.category}),(0,A.jsxs)(`span`,{className:`sectionCardPages`,children:[`p. `,e.pages.filter(e=>r.has(e)).join(`–`)]})]}),(0,A.jsx)(`h4`,{children:e.title}),e.tags.length>0&&(0,A.jsx)(`div`,{className:`sectionCardTags`,children:e.tags.slice(0,4).map(e=>(0,A.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]},e.title)})})]})})(),(0,A.jsxs)(`div`,{className:`tabs`,children:[(0,A.jsxs)(`button`,{className:u===`cards`?`active`:``,onClick:()=>d(`cards`),children:[(0,A.jsx)(D,{size:16}),` `,et===`repair`?`Repair Card`:`Overview`]}),(0,A.jsxs)(`button`,{className:u===`edit`?`active`:``,onClick:()=>d(`edit`),children:[(0,A.jsx)(de,{size:16}),` Edit OCR`]}),(0,A.jsxs)(`button`,{className:u===`page`?`active`:``,onClick:()=>d(`page`),children:[(0,A.jsx)(le,{size:16}),` OCR Text`]}),(0,A.jsxs)(`button`,{className:u===`scan`?`active`:``,onClick:()=>d(`scan`),children:[(0,A.jsx)(E,{size:16}),` Scan Viewer`]}),(0,A.jsxs)(`button`,{className:u===`checklist`?`active`:``,onClick:()=>d(`checklist`),children:[(0,A.jsx)(ae,{size:16}),` Checklist`]})]}),(0,A.jsxs)(`section`,{className:`card pageHeader`,children:[(0,A.jsx)(`h2`,{children:Me(M.page,o,M.title)}),je(M.page,o)?.isContinuation&&(0,A.jsxs)(`p`,{className:`continuationNote`,children:[`↩ Continued from `,(0,A.jsx)(`strong`,{children:je(M.page,o).sectionTitle})]}),(()=>{let e=Ze(M.page,o,nt);return e.length>0?(0,A.jsxs)(`div`,{className:`tagPills`,children:[e.map(e=>(0,A.jsx)(`button`,{className:`tagPill${v===e?` active`:``}`,onClick:()=>y(v===e?null:e),children:e},e)),v&&(0,A.jsx)(`button`,{className:`tagPillClear`,onClick:()=>y(null),children:`✕ Clear filter`})]}):null})(),(0,A.jsxs)(`div`,{className:`manualRef`,children:[(0,A.jsx)(T,{size:14}),(0,A.jsxs)(`span`,{children:[`Manual p. `,M.page,je(M.page,o)?.isContinuation?` · Part of ${je(M.page,o).sectionTitle}`:``]}),(0,A.jsxs)(`button`,{className:`refLink`,onClick:()=>ot(M.page),children:[`Open scan `,(0,A.jsx)(ce,{size:12})]})]}),(()=>{let e=M.summary&&!M.summary.startsWith(He),t=Ge(nt).slice(0,3);return(0,A.jsxs)(`div`,{className:`summarySection`,children:[e&&(0,A.jsx)(`p`,{className:`summaryLead`,children:M.summary}),t.length>0&&(0,A.jsx)(`ul`,{className:`summaryBullets`,children:t.map((e,t)=>(0,A.jsx)(`li`,{children:e},t))})]})})(),rt&&(0,A.jsxs)(`div`,{className:`editedBadge`,children:[(0,A.jsx)(de,{size:12}),` OCR edited`]}),o===`mk3`&&Qe(nt)&&M.page!==20&&(0,A.jsxs)(`div`,{className:`lubRefBanner`,children:[(0,A.jsx)(`span`,{children:`📍 This page references lubrication point codes (A1, C2 etc.)`}),(0,A.jsx)(`button`,{onClick:()=>st(20),children:`View lubrication diagram — p. 20`})]}),o===`mk3`&&M.page===20&&(0,A.jsxs)(`div`,{className:`lubRefBanner`,children:[(0,A.jsx)(`span`,{children:`📋 The codes on this diagram are referenced in the maintenance schedule`}),(0,A.jsx)(`button`,{onClick:()=>st(21),children:`View maintenance schedule — p. 21`})]}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:ct,children:[(0,A.jsx)(re,{size:16}),` Previous`]}),(0,A.jsxs)(`button`,{onClick:lt,children:[`Next `,(0,A.jsx)(ie,{size:16})]}),(0,A.jsxs)(`button`,{onClick:()=>ot(M.page),children:[`Open original scan `,(0,A.jsx)(ce,{size:16})]})]})]}),u===`cards`&&(0,A.jsxs)(`section`,{className:`card repairCard`,children:[o===`mk3`&&Qe(nt)&&M.page!==20&&(0,A.jsxs)(`div`,{className:`lubRefBanner lubRefBannerCard`,children:[(0,A.jsx)(`span`,{children:`📍 References lubrication codes — see the diagram for locations`}),(0,A.jsx)(`button`,{onClick:()=>st(20),children:`View diagram p. 20`})]}),(0,A.jsxs)(`div`,{className:`repairCardTop`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`p`,{className:`eyebrow`,children:[et===`repair`&&`Repair summary`,et===`reference`&&`Reference data`,et===`informational`&&`Informational page`,et===`diagram`&&`Diagram / image page`]}),(0,A.jsx)(`h3`,{children:Me(M.page,o,M.title)})]}),(0,A.jsx)(`button`,{onClick:()=>d(`scan`),children:`View scan`})]}),et===`repair`&&(()=>{let e=We(M.checklist),t=e?M.checklist.filter(e=>Ue.test(e)):Ge(nt),n=t;if(v){let e=Ye(nt,v);n=e.length>0?e:t.filter(e=>Je(v,e))}let r=!!v;return(0,A.jsxs)(A.Fragment,{children:[M.summary&&!M.summary.startsWith(He)&&(0,A.jsx)(`p`,{children:M.summary}),r&&(0,A.jsxs)(`div`,{className:`filterNotice`,children:[(0,A.jsxs)(`span`,{children:[`Showing steps for: `,(0,A.jsx)(`strong`,{children:v})]}),(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all`})]}),n.length>0?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(`p`,{className:`helperText`,children:[e?`Repair steps for this page:`:`Key service facts extracted from this page:`,r&&` (${n.length} of ${t.length})`]}),(0,A.jsx)(`ol`,{className:`checklist compact`,children:n.slice(0,8).map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(`span`,{children:t+1}),(0,A.jsx)(`p`,{children:e})]},e))}),!e&&(0,A.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]}):r?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(O,{size:24}),(0,A.jsxs)(`p`,{children:[`No steps found specifically for `,(0,A.jsx)(`strong`,{children:v}),` on this page.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all steps`})]})]}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(O,{size:24}),(0,A.jsxs)(`p`,{children:[`No repair checklist has been generated for this page yet. `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View the OCR text`}),` for the full content.`]})]})]})})(),et===`reference`&&(0,A.jsxs)(A.Fragment,{children:[M.summary&&!M.summary.startsWith(He)&&(0,A.jsx)(`p`,{children:M.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(le,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a reference data page — specifications, capacities or tables.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`open the original scan`}),`.`]})]})]}),et===`informational`&&(0,A.jsxs)(A.Fragment,{children:[M.summary&&!M.summary.startsWith(He)&&(0,A.jsx)(`p`,{children:M.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(T,{size:24}),(0,A.jsxs)(`p`,{children:[`This is an informational page — no repair steps apply.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`Read the OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`view the original scan`}),`.`]})]})]}),et===`diagram`&&(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(E,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a diagram or image-only page. Use the`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`scan viewer`}),` `,`to see the original page.`]})]})]}),u===`edit`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsxs)(`div`,{className:`editorHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`h3`,{className:`sectionTitle`,children:[`Edit OCR Text - Page `,M.page]}),(0,A.jsx)(`p`,{className:`helperText`,children:`Correct the OCR errors here. Changes autosave locally and are used by search immediately.`})]}),(0,A.jsx)(`div`,{className:`editorStatus`,children:rt?`Edited locally`:`Using original OCR`})]}),M.isImageOnly?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(E,{size:24}),(0,A.jsx)(`p`,{children:`This page is image-only, so there is no OCR text to edit. Use the scan viewer for the original page image.`})]}):(0,A.jsx)(`textarea`,{className:`ocrEditor`,value:nt,onChange:e=>ut(e.target.value),spellCheck:`false`}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:ft,children:[(0,A.jsx)(oe,{size:16}),` `,f?`Copied`:`Copy text`]}),(0,A.jsxs)(`button`,{onClick:pt,children:[(0,A.jsx)(se,{size:16}),` Export OCR fixes`]}),(0,A.jsxs)(`button`,{onClick:mt,children:[(0,A.jsx)(de,{size:16}),` Import OCR fixes`]}),rt&&(0,A.jsx)(`button`,{onClick:dt,children:`Reset this page`}),(0,A.jsxs)(`button`,{onClick:()=>d(`scan`),children:[`View scan `,(0,A.jsx)(E,{size:16})]})]})]}),u===`page`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`OCR text from this page`}),(0,A.jsx)(`p`,{className:`helperText`,children:`This view uses your corrected OCR text if you have edited this page.`}),(0,A.jsx)(`pre`,{className:`ocrText`,children:$e(nt||(M.isImageOnly?`This is an image-only reference page. Open the scan viewer to see the original page.`:`No readable OCR text was extracted from this page.`),e)})]}),u===`scan`&&(0,A.jsxs)(`section`,{className:`card viewer`,children:[(0,A.jsxs)(`div`,{className:`viewerTop`,children:[(0,A.jsxs)(`h3`,{children:[`Original scanned page `,M.page]}),(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,A.jsx)(`button`,{onClick:()=>a(Math.max(60,i-20)),children:(0,A.jsx)(ge,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>a(Math.min(180,i+20)),children:(0,A.jsx)(he,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>ot(M.page),title:`Open in new tab`,children:(0,A.jsx)(ce,{size:16})})]})]}),(0,A.jsxs)(`div`,{className:`pdfPageHint`,children:[(0,A.jsxs)(`span`,{children:[`📄 PDF page `,(0,A.jsx)(`strong`,{children:M.sourcePage||M.page})]}),(0,A.jsx)(`span`,{className:`pdfPageHintNote`,children:`If the wrong page shows, tap the ↗ button to open in your browser and navigate manually.`})]}),(0,A.jsx)(`iframe`,{title:`manual pdf`,src:`${M.sourcePdf||(o===`mk3`?Fe:Pe)}#page=${M.sourcePage||M.page}&zoom=${i}`},`scan-${M.sourcePdf}-${M.sourcePage||M.page}`)]}),u===`checklist`&&(()=>{let e=We(M.checklist)?M.checklist.filter(e=>Ue.test(e)):[],t=e.length>0?e:Ge(nt),n=t.filter((e,t)=>m[`${o}:${M.page}:${t}`]).length;return(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsxs)(`div`,{className:`checklistHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:e.length>0?`Troubleshooting checklist`:`Key service facts — checklist`}),(0,A.jsxs)(`p`,{className:`helperText`,children:[n,` of `,t.length,` checked`]})]}),n>0&&(0,A.jsx)(`button`,{className:`clearBtn`,onClick:()=>{let e={...m};t.forEach((t,n)=>delete e[`${o}:${M.page}:${n}`]),h(e)},children:`Clear all`})]}),t.length>0?(0,A.jsx)(`ul`,{className:`interactiveChecklist`,children:t.map((e,t)=>{let n=`${o}:${M.page}:${t}`,r=!!m[n];return(0,A.jsxs)(`li`,{className:r?`checked`:``,onClick:()=>h(e=>({...e,[n]:!e[n]})),children:[(0,A.jsx)(`span`,{className:`checkbox`,children:r?`✓`:``}),(0,A.jsx)(`p`,{children:e})]},t)})}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(O,{size:24}),(0,A.jsx)(`p`,{children:M.isImageOnly?`This is a diagram/image page. Use the original scan.`:`No checklist available for this page yet.`})]}),e.length===0&&t.length>0&&(0,A.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]})})(),e&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Search results from OCR text`}),(0,A.jsx)(`div`,{className:`searchResults`,children:at.map(e=>(0,A.jsxs)(`button`,{onClick:()=>st(e.page),children:[(0,A.jsxs)(`strong`,{children:[`Page `,e.page,`: `,e.title]}),(0,A.jsxs)(`span`,{children:[e.text.slice(0,260),`...`]})]},e.page))})]})]})]})]})}(0,_e.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(et,{}));