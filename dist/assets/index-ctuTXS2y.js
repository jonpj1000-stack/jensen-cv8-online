...
Printed in England by Jolly & Barber Led., Rugby.`,summary:`OCR text extracted from this scanned manual page. Use it as a searchable working copy and verify against the scan.`,checklist:[]}],_e=[{id:`mk3-p01`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:1,sourcePage:1,title:`HANDBOOK OF INSTRUCTIONS`,summary:`This is the title page of the Jensen C-V8 Mk.III owner's handbook, introducing the manual's purpose and noting the chassis serial number location for correspondence.`,plainEnglish:`Lubrication system, oil draining, filter changing and lubrication/maintenance schedule information.`,ocrText:`HANDBOOK OF INSTRUCTIONS
FOR THE
JENSEN C-V8 MK.III
eg P
a ee "~& *
...
Printed in Emgland by Bachan Prone Lick, Saver`,checklist:[`Lubrication—chart | 19 Sav =, he`,`Lubrication—enging = = 28 Shroud ee |`,`Lubrication—gearbox 28 © Siowrunning = s`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1}],ve=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),A=o(((e,t)=>{t.exports=ve()}))(),ye=[{title:`Dashboard & Controls`,pages:[4],tags:`dashboard instruments controls switches gauges warning lights`},{title:`Specifications & Capacities`,pages:[5,6],tags:`specifications capacity timing plug gap compression oil dimensions`},{title:`Motor, Starting & Running`,pages:[7,8,9],tags:`engine motor starting running gearbox transmission overdrive towing`},{title:`Lubrication & Maintenance`,pages:[10,11,25,26,27,28],tags:`lubrication maintenance grease oil service miles`},{title:`Electrical, Battery & Fuses`,pages:[12,13],tags:`electrical lucas autolite battery positive earth fuse fuses bulbs lamps wiper`},{title:`Brakes & Servo`,pages:[13],tags:`brakes servo dunlop brake fluid handbrake vacuum`},{title:`Fuel System & Carburetter`,pages:[15,16],tags:`fuel carburetter carter idle fast idle choke throttle linkage`},{title:`Tyres, Wheels & Alignment`,pages:[17,18,19],tags:`tyres tires wheels alignment bearings toe-in castor camber`},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],tags:`cooling fan radiator heater ventilation antifreeze coolant rear axle powr-lok drive belt`},{title:`Interior & Owner Information`,pages:[2,3,22,23,31,32],tags:`owner warranty seats upholstery vehicle particulars chassis engine key`}],be=[{title:`Cover`,pages:[1],category:`overview`,tags:[]},{title:`Introduction`,pages:[2,3],category:`overview`,tags:[`owner`,`handbook`,`warranty`]},{title:`Dashboard & Controls`,pages:[4],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`gauges`,`switches`,`warning lights`]},{title:`Specifications & Dimensions`,pages:[5,6],category:`specs`,tags:[`specifications`,`dimensions`,`capacity`,`timing`,`compression`,`spark plug`,`ignition`]},{title:`Starting, Gearbox & Towing`,pages:[7,8,9],category:`mechanical`,tags:[`starting`,`engine`,`gearbox`,`overdrive`,`towing`,`transmission`,`running-in`]},{title:`Lubrication & Maintenance`,pages:[10,11],category:`lubrication`,tags:[`lubrication`,`oil`,`grease`,`maintenance`,`filter`,`dipstick`]},{title:`Electrical Equipment`,pages:[12,13],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`bulbs`,`wiring`,`lucas`,`autolite`,`wiper`]},{title:`Brakes & Servo`,pages:[14],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`handbrake`,`vacuum`,`dunlop`]},{title:`Fuel System & Carburettor`,pages:[15,16,17],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`carter`]},{title:`Tyres, Wheels & Alignment`,pages:[18,19],category:`wheels`,tags:[`tyres`,`wheels`,`alignment`,`toe-in`,`camber`,`bearings`,`tyre pressure`]},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],category:`cooling`,tags:[`cooling`,`radiator`,`antifreeze`,`heater`,`rear axle`,`fan belt`,`powr-lok`]},{title:`Interior & Owner Information`,pages:[22,23,24],category:`interior`,tags:[`seats`,`upholstery`,`interior`,`owner`,`chassis number`]},{title:`Service Lubrication`,pages:[25,26,27,28],category:`service`,tags:[`service`,`lubrication`,`grease points`,`intervals`,`capacities`,`oil change`]},{title:`Index`,pages:[29],category:`overview`,tags:[`index`]},{title:`Vehicle Particulars`,pages:[31,32],category:`overview`,tags:[`chassis number`,`engine number`,`registration`,`delivery`]}],xe=[{title:`Handbook Cover`,pages:[1],category:`overview`,tags:[]},{title:`Vehicle Particulars`,pages:[3],category:`overview`,tags:[`chassis number`,`key number`,`registration`,`delivery`]},{title:`Foreword`,pages:[5],category:`overview`,tags:[`handbook`,`owner`,`jensen motors`]},{title:`General Dimensions & Data`,pages:[7,8],category:`specs`,tags:[`dimensions`,`specifications`,`weight`,`wheelbase`,`turning circle`,`gear ratios`]},{title:`Instruments & Controls Diagram`,pages:[9],category:`overview`,tags:[`dashboard`,`instruments`,`controls`,`diagram`,`layout`]},{title:`Controls & Instruments`,pages:[11,12,13],category:`overview`,tags:[`controls`,`instruments`,`gauges`,`switches`,`headlights`,`horn`,`heater fan`,`selectaride`,`speedometer`,`ammeter`,`oil pressure`]},{title:`Starting Up & Running`,pages:[15,16,17,18],category:`mechanical`,tags:[`starting`,`running-in`,`gearbox`,`overdrive`,`towing`,`push starting`,`choke`,`transmission`]},{title:`Engine Lubrication System`,pages:[19],category:`lubrication`,tags:[`engine oil`,`oil filter`,`sump`,`oil change`,`dipstick`,`oil pressure`,`4000 miles`]},{title:`Lubrication Diagram`,pages:[20],category:`lubrication`,tags:[`lubrication`,`diagram`,`grease points`]},{title:`Maintenance Schedule`,pages:[21,22],category:`service`,tags:[`maintenance`,`service intervals`,`1000 miles`,`4000 miles`,`20000 miles`,`king pin`,`spark plugs`]},{title:`Fuel System & Carburettor`,pages:[23,24,25,26,27],category:`fuel`,tags:[`fuel`,`carburettor`,`choke`,`throttle`,`idle`,`accelerator`,`air cleaner`,`crankcase vent`]},{title:`Ignition`,pages:[29,30],category:`electrical`,tags:[`ignition`,`contact breaker`,`timing`,`distributor`,`coil`,`ballast resistor`]},{title:`Cooling System`,pages:[31,32],category:`cooling`,tags:[`cooling`,`radiator`,`coolant`,`fan`,`thermostat`,`antifreeze`,`electric fans`]},{title:`Transmission & Propeller Shaft`,pages:[33,34],category:`mechanical`,tags:[`transmission`,`gearbox`,`propeller shaft`,`universal joint`,`transmission fluid`]},{title:`Steering & Suspension`,pages:[35,36,37],category:`mechanical`,tags:[`steering`,`suspension`,`rack and pinion`,`wishbone`,`front hubs`,`wheel alignment`,`dampers`]},{title:`Brake Servo Unit`,pages:[38],category:`brakes`,tags:[`brakes`,`servo`,`brake fluid`,`disc brakes`,`handbrake`]},{title:`Wheels & Tyres`,pages:[39,40],category:`wheels`,tags:[`wheels`,`tyres`,`tyre pressure`,`wheel changing`,`jack`,`spare wheel`]},{title:`Bodywork & Seats`,pages:[41,42],category:`interior`,tags:[`bodywork`,`doors`,`seats`,`upholstery`,`adjustment`]},{title:`Spare Wheel`,pages:[43],category:`wheels`,tags:[`spare wheel`,`boot`,`jack`]},{title:`Cabin Heating & Ventilation`,pages:[45,46],category:`interior`,tags:[`heating`,`ventilation`,`heater`,`fresh air`,`fan`,`demist`]},{title:`Electrical System`,pages:[47,48],category:`electrical`,tags:[`electrical`,`battery`,`fuses`,`wiring`,`earth`,`alternator`,`interior light`]},{title:`Lights`,pages:[49,50],category:`electrical`,tags:[`lights`,`headlamps`,`sidelights`,`bulbs`,`reversing light`,`number plate light`,`flasher`]},{title:`Tool Kit & Equipment`,pages:[51,52,53],category:`overview`,tags:[`tools`,`toolkit`,`equipment`,`accessories`]},{title:`Service Lubrication`,pages:[55,56,57,58],category:`service`,tags:[`service`,`lubrication`,`oil change`,`grease`,`intervals`,`capacities`,`transmission fluid`]},{title:`Index`,pages:[59,60],category:`overview`,tags:[`index`]}];function Se(e){let t=new Map;for(let n of e)n.pages.forEach((e,r)=>{t.set(e,{sectionTitle:n.title,isContinuation:r>0,category:n.category||`general`,tags:n.tags||[]})});return t}var Ce=Se(be),we=Se(xe);function Te(e,t){return(t===`mk3`?we:Ce).get(e)||null}function Ee(e,t,n){let r=Te(e,t);return r?r.isContinuation?`${r.sectionTitle} (cont.)`:r.sectionTitle:n}var De={all:`All Models`,mk1:`Mk I`,mk2:`Mk II`,mk3:`Mk III`},Oe=`/manuals/jensen_cv8_owners_manual.pdf`,ke=`/manuals/jensen-cv8-mk3-instruction-manual.pdf`;function Ae(e){let t=String(e.title||``).toLowerCase(),n=String(e.text??e.ocrText??``).trim();return e.hidden||e.type===`blank`||t===`blank page`?`blank`:e.type?e.type:n?`text`:`diagram`}function je(e,t,n,r){return e.map(e=>{let i=e.text??e.ocrText??``,a=Ae({...e,text:i}),o=a===`blank`,s=a===`diagram`||e.isImageOnly===!0;return{...e,type:a,hidden:o||e.hidden===!0,isImageOnly:s,model:e.model||t,modelLabel:e.modelLabel||n,sourcePdf:e.sourcePdf||r,sourcePage:e.sourcePage||e.page,text:i,summary:e.summary??e.plainEnglish??(s?`Image-only reference page. Use the original scan for this page.`:``),title:e.title||`Page ${e.page}`}})}function Me(e){return e.filter(e=>!e.hidden)}function Ne(e,t,n=1){let r=Me(e);if(!r.length)return null;let i=r.find(e=>e.page===t);if(i)return i;let a=[...r].sort((e,t)=>e.page-t.page);return n>=0?a.find(e=>e.page>=t)||a[a.length-1]:[...a].reverse().find(e=>e.page<=t)||a[0]}var Pe=je(ge,`base`,`Jensen C-V8`,Oe),Fe=je(_e,`mk3`,`Jensen C-V8 Mk III`,ke),Ie=`OCR text extracted from this scanned manual page`,Le=[`foreword`,`introduction`,`handbook of instructions`,`vehicle particulars`,`warranty`,`index`,`contents`,`cover`,`title page`,`jensen`],Re=/^(check|inspect|change|replace|drain|fill|remove|install|adjust|clean|tighten|loosen|ensure|apply|add|use|do not|never|always|confirm|photograph|identify|select|engage|depress|set|verify|refit|recheck|run|start|allow|push|pull|turn|disconnect|connect|torque|grease|lubricate|bleed|test|reset|secure|re-?tighten|re-?fit|re-?check)/i;function ze(e){return!Array.isArray(e)||e.length<2?!1:e.filter(e=>e.length>35&&Re.test(e)).length>=2}function Be(e){if(!e||e.length<40)return[];let t=e.replace(/\n+/g,` `).split(/(?<=[.!?])\s+/).map(e=>e.trim()).filter(e=>e.length>25&&e.length<300),n=new Set,r=[];for(let e of t){let t=e.slice(0,40).toLowerCase();n.has(t)||(/every\s+[\d,]+\s*(miles?|km|months?|years?|hours?)/i.test(e)||/\d+[\s-]*(p\.?s\.?i\.?|psi|rpm|r\.p\.m|°|degrees?|mm|ins?\.)\b/i.test(e)||/should\s+be\s+(changed|checked|drained|replaced|inspected|cleaned|adjusted|refilled|topped|removed|fitted)/i.test(e)||/must\s+(be|not)\s+/i.test(e)||/\bdo not\b|\bnever\b/i.test(e)||Re.test(e))&&(n.add(t),r.push(e))}return r.slice(0,8)}function Ve(e){if(e.isImageOnly||e.type===`diagram`||!e.text?.trim())return`diagram`;let t=(e.title||``).toLowerCase();return Le.some(e=>t.includes(e))?`informational`:ze(e.checklist)||Be(e.text).length>0?`repair`:`reference`}function He(e){return e.toLowerCase().replace(/(\d),(\d)/g,`$1$2`).replace(/\s+/g,` `).trim()}function Ue(e,t){return He(t).includes(He(e))}function We(e,t){if(!e)return[];let n=t.replace(/[^\d]/g,``);if(!n||n.length<3)return[];let r=e.split(`
`).map(e=>e.trim()).filter(Boolean),i=!1,a=[];for(let e of r){let t=e.match(/([\d,]{4,})\s*(miles?|km)/i);if(t){if(t[1].replace(/,/g,``)===n){i=!0;continue}else if(i)break;continue}if(i&&e.length>3){let t=e.replace(/^[A-Z]\d+\.?\s*[—–\-]+\s*/,``).trim();t.length>4&&a.push(t)}}return a}function Ge(e,t){if(!t.trim())return e;let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return e.split(RegExp(`(${n})`,`ig`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,A.jsx)(`mark`,{children:e},n):e)}function Ke(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)(4),[i,a]=(0,S.useState)(100),[o,s]=(0,S.useState)(()=>localStorage.getItem(`jensen-model`)||`all`),[c,l]=(0,S.useState)(!1),[u,d]=(0,S.useState)(`cards`),[f,p]=(0,S.useState)(!1),[m,h]=(0,S.useState)({}),[g,_]=(0,S.useState)(`all`),[v,y]=(0,S.useState)(null),[b,x]=(0,S.useState)(()=>{try{return JSON.parse(localStorage.getItem(`jensen-ocr-edits`)||`{}`)}catch{return{}}});(0,S.useEffect)(()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).then(e=>{!e||!Object.keys(e).length||x(t=>({...e,...t}))}).catch(()=>{})},[]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-model`,o)},[o]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-ocr-edits`,JSON.stringify(b))},[b]);let ee=De[o]||De.all,C=(0,S.useMemo)(()=>o===`mk3`?Fe:Pe,[o]),te=(0,S.useMemo)(()=>Me(C),[C]),ne=(0,S.useMemo)(()=>{let e=new Set(te.map(e=>e.page));return ye.map(t=>({...t,pages:t.pages.filter(t=>e.has(t))})).filter(e=>e.pages.length)},[te]);(0,S.useEffect)(()=>{let e=Ne(C,n,1);e&&e.page!==n&&r(e.page)},[C,n]);let w=te.find(e=>e.page===n)||te[0]||C[0],he=Ve(w),ge=`${o}:${w?.page||1}`,_e=b[ge]??w.text??``,ve=Object.prototype.hasOwnProperty.call(b,ge);Object.keys(b).filter(e=>e.startsWith(`${o}:`)).length,te.filter(e=>e.checklist&&e.checklist.length).length;let Se=(0,S.useMemo)(()=>te.map(e=>{let t=`${o}:${e.page}`;return{...e,text:b[t]??e.text??``}}),[b,te,o]),Ce=(0,S.useMemo)(()=>{let t=e.trim().toLowerCase();if(!t)return[];let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return Se.map(e=>{let t=(`${e.title} ${e.text} ${e.summary}`.toLowerCase().match(new RegExp(n,`g`))||[]).length;return{...e,score:t}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score)},[e,Se]),we=(e=n)=>{let t=C.find(t=>t.page===e)||w,r=t?.sourcePdf||(o===`mk3`?ke:Oe),i=t?.sourcePage||t?.page||e;window.open(`${r}#page=${i}`,`_blank`)},Ae=(e,t=1)=>{let n=Ne(C,e,t);if(n){r(n.page);let e=Ve(n);e===`diagram`?d(`scan`):e===`repair`?d(`cards`):(e===`informational`||u===`cards`)&&d(`page`)}l(!1),p(!1),y(null)},je=()=>Ae(n-1,-1),Le=()=>Ae(n+1,1),He=e=>{x({...b,[ge]:e})},Ke=()=>{let e={...b};delete e[ge],x(e)},qe=async()=>{await navigator.clipboard.writeText(_e),p(!0),setTimeout(()=>p(!1),1600)},Je=()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).catch(()=>({})).then(e=>{let t={...e,...b},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`jensen-ocr-edits.json`,i.click(),URL.revokeObjectURL(r)})},Ye=()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json,.json`,e.onchange=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);typeof t==`object`&&t&&x(e=>({...e,...t}))}catch{alert(`Could not read the file — make sure it is a valid jensen-ocr-edits.json export.`)}},n.readAsText(t)},e.click()},Xe=(0,A.jsxs)(`aside`,{className:c?`sidebar open`:`sidebar`,children:[(0,A.jsxs)(`div`,{className:`mobileClose`,children:[(0,A.jsx)(`strong`,{children:`Manual Library`}),(0,A.jsx)(`button`,{onClick:()=>l(!1),children:(0,A.jsx)(O,{size:20})})]}),(0,A.jsxs)(`div`,{className:`searchBox`,children:[(0,A.jsxs)(`label`,{children:[(0,A.jsx)(fe,{size:16}),` Search manual`]}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: ballast resistor, brake fluid, tyre pressure...`})]}),e&&(0,A.jsxs)(`div`,{className:`resultsBox`,children:[(0,A.jsxs)(`strong`,{children:[Ce.length,` result`,Ce.length===1?``:`s`]}),Ce.slice(0,8).map(e=>(0,A.jsxs)(`button`,{onClick:()=>Ae(e.page),children:[`p`,e.page,`: `,e.title,(0,A.jsxs)(`small`,{children:[e.score,` hit`,e.score===1?``:`s`]})]},e.page))]}),(0,A.jsx)(`h3`,{children:`Manual Sections`}),(0,A.jsx)(`nav`,{className:`topics`,children:ne.map(e=>(0,A.jsxs)(`button`,{onClick:()=>Ae(e.pages[0]),children:[(0,A.jsx)(T,{size:16}),(0,A.jsx)(`span`,{children:e.title}),(0,A.jsxs)(`small`,{children:[`p`,e.pages.join(`, `)]})]},e.title))}),(0,A.jsx)(`h3`,{children:`All Pages`}),(0,A.jsx)(`nav`,{children:te.map(e=>{let t=Ee(e.page,o,e.title),r=Te(e.page,o);return(0,A.jsxs)(`button`,{className:[e.page===n?`selected`:``,r?.isContinuation?`continuation`:``].join(` `).trim(),onClick:()=>Ae(e.page),children:[(0,A.jsx)(le,{size:16}),(0,A.jsxs)(`span`,{children:[`Page `,e.page]}),(0,A.jsxs)(`small`,{children:[t,b[`${o}:${e.page}`]?` · edited`:``]})]},e.page)})})]});return(0,A.jsxs)(`div`,{className:`app`,children:[(0,A.jsxs)(`header`,{className:`topBar`,children:[(0,A.jsx)(`button`,{className:`hamburger`,onClick:()=>l(!0),children:(0,A.jsx)(ue,{})}),(0,A.jsxs)(`div`,{className:`brand`,children:[(0,A.jsx)(`img`,{src:`/jensen-logo.png`,alt:`Jensen logo`}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{children:`Jensen C-V8`}),(0,A.jsx)(`h1`,{children:`Online Manual`}),(0,A.jsx)(`small`,{children:ee})]})]}),(0,A.jsx)(`button`,{className:`openPdf`,onClick:()=>we(),children:`Open PDF`})]}),(0,A.jsxs)(`div`,{className:`layout`,children:[Xe,(0,A.jsxs)(`main`,{children:[(0,A.jsxs)(`section`,{className:`hero`,children:[(0,A.jsxs)(`div`,{className:`heroTop`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Garage-friendly manual app`}),(0,A.jsx)(`h2`,{children:`Jensen C-V8 Online Manual`})]}),(0,A.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),className:`modelSelect`,children:[(0,A.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,A.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,A.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,A.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]})]}),(0,A.jsxs)(`div`,{className:`heroSearch`,children:[(0,A.jsx)(fe,{size:18}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: no start, brake servo, 35 amp fuse, tyre pressure...`}),e&&(0,A.jsx)(`button`,{onClick:()=>t(``),children:`Clear`})]})]}),!e&&(()=>{let e=o===`mk3`?xe:be,t=[`all`,...Array.from(new Set(e.map(e=>e.category).filter(Boolean)))],n=g===`all`?e:e.filter(e=>e.category===g),r=new Set(te.map(e=>e.page)),i=n.filter(e=>e.pages.some(e=>r.has(e))),a={all:`All`,overview:`Overview`,specs:`Specs`,mechanical:`Mechanical`,lubrication:`Lubrication`,electrical:`Electrical`,fuel:`Fuel`,brakes:`Brakes`,wheels:`Wheels & Tyres`,cooling:`Cooling`,interior:`Interior`,service:`Service`};return(0,A.jsxs)(`section`,{className:`repairGrid`,children:[(0,A.jsxs)(`div`,{className:`repairGridHeader`,children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Manual Sections`}),(0,A.jsx)(`h3`,{children:`Organised repair cards`}),(0,A.jsx)(`p`,{className:`helperText`,children:`These summaries stay inside what the manual says. Use source scans for verification.`})]}),(0,A.jsx)(`div`,{className:`categoryFilters`,children:t.map(e=>(0,A.jsx)(`button`,{className:g===e?`active`:``,onClick:()=>_(e),children:a[e]||e},e))}),(0,A.jsx)(`div`,{className:`sectionCardGrid`,children:i.map(e=>{let t=e.pages.find(e=>r.has(e));return(0,A.jsxs)(`button`,{className:`sectionCard`,onClick:()=>Ae(t),children:[(0,A.jsxs)(`div`,{className:`sectionCardTop`,children:[(0,A.jsx)(`span`,{className:`sectionCardCat`,children:a[e.category]||e.category}),(0,A.jsxs)(`span`,{className:`sectionCardPages`,children:[`p. `,e.pages.filter(e=>r.has(e)).join(`–`)]})]}),(0,A.jsx)(`h4`,{children:e.title}),e.tags.length>0&&(0,A.jsx)(`div`,{className:`sectionCardTags`,children:e.tags.slice(0,4).map(e=>(0,A.jsx)(`span`,{className:`sectionCardTag`,children:e},e))})]},e.title)})})]})})(),(0,A.jsxs)(`div`,{className:`tabs`,children:[(0,A.jsxs)(`button`,{className:u===`cards`?`active`:``,onClick:()=>d(`cards`),children:[(0,A.jsx)(D,{size:16}),` `,he===`repair`?`Repair Card`:`Overview`]}),(0,A.jsxs)(`button`,{className:u===`edit`?`active`:``,onClick:()=>d(`edit`),children:[(0,A.jsx)(de,{size:16}),` Edit OCR`]}),(0,A.jsxs)(`button`,{className:u===`page`?`active`:``,onClick:()=>d(`page`),children:[(0,A.jsx)(le,{size:16}),` OCR Text`]}),(0,A.jsxs)(`button`,{className:u===`scan`?`active`:``,onClick:()=>d(`scan`),children:[(0,A.jsx)(E,{size:16}),` Scan Viewer`]}),(0,A.jsxs)(`button`,{className:u===`checklist`?`active`:``,onClick:()=>d(`checklist`),children:[(0,A.jsx)(ae,{size:16}),` Checklist`]})]}),(0,A.jsxs)(`section`,{className:`card pageHeader`,children:[(0,A.jsx)(`h2`,{children:Ee(w.page,o,w.title)}),Te(w.page,o)?.isContinuation&&(0,A.jsxs)(`p`,{className:`continuationNote`,children:[`↩ Continued from `,(0,A.jsx)(`strong`,{children:Te(w.page,o).sectionTitle})]}),(()=>{let e=Te(w.page,o)?.tags||[];return e.length>0?(0,A.jsxs)(`div`,{className:`tagPills`,children:[e.map(e=>(0,A.jsx)(`button`,{className:`tagPill${v===e?` active`:``}`,onClick:()=>y(v===e?null:e),children:e},e)),v&&(0,A.jsx)(`button`,{className:`tagPillClear`,onClick:()=>y(null),children:`✕ Clear filter`})]}):null})(),(0,A.jsxs)(`div`,{className:`manualRef`,children:[(0,A.jsx)(T,{size:14}),(0,A.jsxs)(`span`,{children:[`Manual p. `,w.page,Te(w.page,o)?.isContinuation?` · Part of ${Te(w.page,o).sectionTitle}`:``]}),(0,A.jsxs)(`button`,{className:`refLink`,onClick:()=>we(w.page),children:[`Open scan `,(0,A.jsx)(ce,{size:12})]})]}),(()=>{let e=w.summary&&!w.summary.startsWith(Ie),t=Be(_e).slice(0,3);return(0,A.jsxs)(`div`,{className:`summarySection`,children:[e&&(0,A.jsx)(`p`,{className:`summaryLead`,children:w.summary}),t.length>0&&(0,A.jsx)(`ul`,{className:`summaryBullets`,children:t.map((e,t)=>(0,A.jsx)(`li`,{children:e},t))})]})})(),ve&&(0,A.jsxs)(`div`,{className:`editedBadge`,children:[(0,A.jsx)(de,{size:12}),` OCR edited`]}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:je,children:[(0,A.jsx)(re,{size:16}),` Previous`]}),(0,A.jsxs)(`button`,{onClick:Le,children:[`Next `,(0,A.jsx)(ie,{size:16})]}),(0,A.jsxs)(`button`,{onClick:()=>we(w.page),children:[`Open original scan `,(0,A.jsx)(ce,{size:16})]})]})]}),u===`cards`&&(0,A.jsxs)(`section`,{className:`card repairCard`,children:[(0,A.jsxs)(`div`,{className:`repairCardTop`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`p`,{className:`eyebrow`,children:[he===`repair`&&`Repair summary`,he===`reference`&&`Reference data`,he===`informational`&&`Informational page`,he===`diagram`&&`Diagram / image page`]}),(0,A.jsx)(`h3`,{children:Ee(w.page,o,w.title)})]}),(0,A.jsx)(`button`,{onClick:()=>d(`scan`),children:`View scan`})]}),he===`repair`&&(()=>{let e=ze(w.checklist),t=e?w.checklist.filter(e=>Re.test(e)):Be(_e),n=t;if(v){let e=We(_e,v);n=e.length>0?e:t.filter(e=>Ue(v,e))}let r=!!v;return(0,A.jsxs)(A.Fragment,{children:[w.summary&&!w.summary.startsWith(Ie)&&(0,A.jsx)(`p`,{children:w.summary}),r&&(0,A.jsxs)(`div`,{className:`filterNotice`,children:[(0,A.jsxs)(`span`,{children:[`Showing steps for: `,(0,A.jsx)(`strong`,{children:v})]}),(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all`})]}),n.length>0?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(`p`,{className:`helperText`,children:[e?`Repair steps for this page:`:`Key service facts extracted from this page:`,r&&` (${n.length} of ${t.length})`]}),(0,A.jsx)(`ol`,{className:`checklist compact`,children:n.slice(0,8).map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(`span`,{children:t+1}),(0,A.jsx)(`p`,{children:e})]},e))}),!e&&(0,A.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]}):r?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(pe,{size:24}),(0,A.jsxs)(`p`,{children:[`No steps found specifically for `,(0,A.jsx)(`strong`,{children:v}),` on this page.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>y(null),children:`Show all steps`})]})]}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(pe,{size:24}),(0,A.jsxs)(`p`,{children:[`No repair checklist has been generated for this page yet. `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View the OCR text`}),` for the full content.`]})]})]})})(),he===`reference`&&(0,A.jsxs)(A.Fragment,{children:[w.summary&&!w.summary.startsWith(Ie)&&(0,A.jsx)(`p`,{children:w.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(le,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a reference data page — specifications, capacities or tables.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`open the original scan`}),`.`]})]})]}),he===`informational`&&(0,A.jsxs)(A.Fragment,{children:[w.summary&&!w.summary.startsWith(Ie)&&(0,A.jsx)(`p`,{children:w.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(T,{size:24}),(0,A.jsxs)(`p`,{children:[`This is an informational page — no repair steps apply.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`Read the OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`view the original scan`}),`.`]})]})]}),he===`diagram`&&(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(E,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a diagram or image-only page. Use the`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`scan viewer`}),` `,`to see the original page.`]})]})]}),u===`edit`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsxs)(`div`,{className:`editorHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`h3`,{className:`sectionTitle`,children:[`Edit OCR Text - Page `,w.page]}),(0,A.jsx)(`p`,{className:`helperText`,children:`Correct the OCR errors here. Changes autosave locally and are used by search immediately.`})]}),(0,A.jsx)(`div`,{className:`editorStatus`,children:ve?`Edited locally`:`Using original OCR`})]}),w.isImageOnly?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(E,{size:24}),(0,A.jsx)(`p`,{children:`This page is image-only, so there is no OCR text to edit. Use the scan viewer for the original page image.`})]}):(0,A.jsx)(`textarea`,{className:`ocrEditor`,value:_e,onChange:e=>He(e.target.value),spellCheck:`false`}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:qe,children:[(0,A.jsx)(oe,{size:16}),` `,f?`Copied`:`Copy text`]}),(0,A.jsxs)(`button`,{onClick:Je,children:[(0,A.jsx)(se,{size:16}),` Export OCR fixes`]}),(0,A.jsxs)(`button`,{onClick:Ye,children:[(0,A.jsx)(de,{size:16}),` Import OCR fixes`]}),ve&&(0,A.jsx)(`button`,{onClick:Ke,children:`Reset this page`}),(0,A.jsxs)(`button`,{onClick:()=>d(`scan`),children:[`View scan `,(0,A.jsx)(E,{size:16})]})]})]}),u===`page`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`OCR text from this page`}),(0,A.jsx)(`p`,{className:`helperText`,children:`This view uses your corrected OCR text if you have edited this page.`}),(0,A.jsx)(`pre`,{className:`ocrText`,children:Ge(_e||(w.isImageOnly?`This is an image-only reference page. Open the scan viewer to see the original page.`:`No readable OCR text was extracted from this page.`),e)})]}),u===`scan`&&(0,A.jsxs)(`section`,{className:`card viewer`,children:[(0,A.jsxs)(`div`,{className:`viewerTop`,children:[(0,A.jsxs)(`h3`,{children:[`Original scanned page `,w.page]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`button`,{onClick:()=>a(Math.max(60,i-20)),children:(0,A.jsx)(me,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>a(Math.min(180,i+20)),children:(0,A.jsx)(k,{size:16})})]})]}),(0,A.jsx)(`iframe`,{title:`manual pdf`,src:`${w.sourcePdf||(o===`mk3`?ke:Oe)}#page=${w.sourcePage||w.page}&zoom=${i}`})]}),u===`checklist`&&(()=>{let e=ze(w.checklist)?w.checklist.filter(e=>Re.test(e)):[],t=e.length>0?e:Be(_e),n=t.filter((e,t)=>m[`${o}:${w.page}:${t}`]).length;return(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsxs)(`div`,{className:`checklistHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:e.length>0?`Troubleshooting checklist`:`Key service facts — checklist`}),(0,A.jsxs)(`p`,{className:`helperText`,children:[n,` of `,t.length,` checked`]})]}),n>0&&(0,A.jsx)(`button`,{className:`clearBtn`,onClick:()=>{let e={...m};t.forEach((t,n)=>delete e[`${o}:${w.page}:${n}`]),h(e)},children:`Clear all`})]}),t.length>0?(0,A.jsx)(`ul`,{className:`interactiveChecklist`,children:t.map((e,t)=>{let n=`${o}:${w.page}:${t}`,r=!!m[n];return(0,A.jsxs)(`li`,{className:r?`checked`:``,onClick:()=>h(e=>({...e,[n]:!e[n]})),children:[(0,A.jsx)(`span`,{className:`checkbox`,children:r?`✓`:``}),(0,A.jsx)(`p`,{children:e})]},t)})}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(pe,{size:24}),(0,A.jsx)(`p`,{children:w.isImageOnly?`This is a diagram/image page. Use the original scan.`:`No checklist available for this page yet.`})]}),e.length===0&&t.length>0&&(0,A.jsxs)(`p`,{className:`helperText dimText`,children:[`Extracted from OCR text. Fix errors in the `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),`.`]})]})})(),e&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Search results from OCR text`}),(0,A.jsx)(`div`,{className:`searchResults`,children:Ce.map(e=>(0,A.jsxs)(`button`,{onClick:()=>Ae(e.page),children:[(0,A.jsxs)(`strong`,{children:[`Page `,e.page,`: `,e.title]}),(0,A.jsxs)(`span`,{children:[e.text.slice(0,260),`...`]})]},e.page))})]})]})]})]})}(0,he.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(Ke,{}));