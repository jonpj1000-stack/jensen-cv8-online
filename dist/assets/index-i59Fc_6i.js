...
Printed in Emgland by Bachan Prone Lick, Saver`,checklist:[`Lubrication—chart | 19 Sav =, he`,`Lubrication—enging = = 28 Shroud ee |`,`Lubrication—gearbox 28 © Siowrunning = s`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1}],xe=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),k=o(((e,t)=>{t.exports=xe()}))(),Se=[{title:`Dashboard & Controls`,pages:[4],tags:`dashboard instruments controls switches gauges warning lights`},{title:`Specifications & Capacities`,pages:[5,6],tags:`specifications capacity timing plug gap compression oil dimensions`},{title:`Motor, Starting & Running`,pages:[7,8,9],tags:`engine motor starting running gearbox transmission overdrive towing`},{title:`Lubrication & Maintenance`,pages:[10,11,25,26,27,28],tags:`lubrication maintenance grease oil service miles`},{title:`Electrical, Battery & Fuses`,pages:[12,13],tags:`electrical lucas autolite battery positive earth fuse fuses bulbs lamps wiper`},{title:`Brakes & Servo`,pages:[13],tags:`brakes servo dunlop brake fluid handbrake vacuum`},{title:`Fuel System & Carburetter`,pages:[15,16],tags:`fuel carburetter carter idle fast idle choke throttle linkage`},{title:`Tyres, Wheels & Alignment`,pages:[17,18,19],tags:`tyres tires wheels alignment bearings toe-in castor camber`},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],tags:`cooling fan radiator heater ventilation antifreeze coolant rear axle powr-lok drive belt`},{title:`Interior & Owner Information`,pages:[2,3,22,23,31,32],tags:`owner warranty seats upholstery vehicle particulars chassis engine key`}],Ce={all:`All Models`,mk1:`Mk I`,mk2:`Mk II`,mk3:`Mk III`},we=`/manuals/jensen_cv8_owners_manual.pdf`,Te=`/manuals/jensen-cv8-mk3-instruction-manual.pdf`;function Ee(e){let t=String(e.title||``).toLowerCase(),n=String(e.text??e.ocrText??``).trim();return e.hidden||e.type===`blank`||t===`blank page`?`blank`:e.type?e.type:n?`text`:`diagram`}function De(e,t,n,r){return e.map(e=>{let i=e.text??e.ocrText??``,a=Ee({...e,text:i}),o=a===`blank`,s=a===`diagram`||e.isImageOnly===!0;return{...e,type:a,hidden:o||e.hidden===!0,isImageOnly:s,model:e.model||t,modelLabel:e.modelLabel||n,sourcePdf:e.sourcePdf||r,sourcePage:e.sourcePage||e.page,text:i,summary:e.summary??e.plainEnglish??(s?`Image-only reference page. Use the original scan for this page.`:``),title:e.title||`Page ${e.page}`}})}function Oe(e){return e.filter(e=>!e.hidden)}function ke(e,t,n=1){let r=Oe(e);if(!r.length)return null;let i=r.find(e=>e.page===t);if(i)return i;let a=[...r].sort((e,t)=>e.page-t.page);return n>=0?a.find(e=>e.page>=t)||a[a.length-1]:[...a].reverse().find(e=>e.page<=t)||a[0]}var Ae=De(ye,`base`,`Jensen C-V8`,we),je=De(be,`mk3`,`Jensen C-V8 Mk III`,Te);function Me(e,t){if(!t.trim())return e;let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return e.split(RegExp(`(${n})`,`ig`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,k.jsx)(`mark`,{children:e},n):e)}function Ne(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)(4),[i,a]=(0,S.useState)(100),[o,s]=(0,S.useState)(()=>localStorage.getItem(`jensen-model`)||`all`),[c,l]=(0,S.useState)(!1),[u,d]=(0,S.useState)(`cards`),[f,p]=(0,S.useState)(!1),[m,h]=(0,S.useState)(()=>{try{return JSON.parse(localStorage.getItem(`jensen-ocr-edits`)||`{}`)}catch{return{}}});(0,S.useEffect)(()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).then(e=>{!e||!Object.keys(e).length||h(t=>({...e,...t}))}).catch(()=>{})},[]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-model`,o)},[o]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-ocr-edits`,JSON.stringify(m))},[m]);let g=Ce[o]||Ce.all,_=(0,S.useMemo)(()=>o===`mk3`?je:Ae,[o]),v=(0,S.useMemo)(()=>Oe(_),[_]),y=(0,S.useMemo)(()=>{let e=new Set(v.map(e=>e.page));return Se.map(t=>({...t,pages:t.pages.filter(t=>e.has(t))})).filter(e=>e.pages.length)},[v]);(0,S.useEffect)(()=>{let e=ke(_,n,1);e&&e.page!==n&&r(e.page)},[_,n]);let b=v.find(e=>e.page===n)||v[0]||_[0],x=`${o}:${b?.page||1}`,ee=m[x]??b.text??``,C=Object.prototype.hasOwnProperty.call(m,x),te=Object.keys(m).filter(e=>e.startsWith(`${o}:`)).length,ne=v.filter(e=>e.checklist&&e.checklist.length).length,w=(0,S.useMemo)(()=>v.map(e=>{let t=`${o}:${e.page}`;return{...e,text:m[t]??e.text??``}}),[m,v,o]),ve=(0,S.useMemo)(()=>{let t=e.trim().toLowerCase();if(!t)return[];let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return w.map(e=>{let t=(`${e.title} ${e.text} ${e.summary}`.toLowerCase().match(new RegExp(n,`g`))||[]).length;return{...e,score:t}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score)},[e,w]),ye=(e=n)=>{let t=_.find(t=>t.page===e)||b,r=t?.sourcePdf||(o===`mk3`?Te:we),i=t?.sourcePage||t?.page||e;window.open(`${r}#page=${i}`,`_blank`)},be=(e,t=1)=>{let n=ke(_,e,t);n&&r(n.page),l(!1),p(!1)},xe=()=>be(n-1,-1),Ee=()=>be(n+1,1),De=e=>{h({...m,[x]:e})},Ne=()=>{let e={...m};delete e[x],h(e)},Pe=async()=>{await navigator.clipboard.writeText(ee),p(!0),setTimeout(()=>p(!1),1600)},Fe=()=>{let e=new Blob([JSON.stringify(m,null,2)],{type:`application/json`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`jensen-ocr-edits.json`,n.click(),URL.revokeObjectURL(t)},Ie=()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json,.json`,e.onchange=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);typeof t==`object`&&t&&h(e=>({...e,...t}))}catch{alert(`Could not read the file — make sure it is a valid jensen-ocr-edits.json export.`)}},n.readAsText(t)},e.click()},Le=(0,k.jsxs)(`aside`,{className:c?`sidebar open`:`sidebar`,children:[(0,k.jsxs)(`div`,{className:`mobileClose`,children:[(0,k.jsx)(`strong`,{children:`Manual Library`}),(0,k.jsx)(`button`,{onClick:()=>l(!1),children:(0,k.jsx)(he,{size:20})})]}),(0,k.jsxs)(`div`,{className:`searchBox`,children:[(0,k.jsxs)(`label`,{children:[(0,k.jsx)(me,{size:16}),` Search manual`]}),(0,k.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: ballast resistor, brake fluid, tyre pressure...`})]}),e&&(0,k.jsxs)(`div`,{className:`resultsBox`,children:[(0,k.jsxs)(`strong`,{children:[ve.length,` result`,ve.length===1?``:`s`]}),ve.slice(0,8).map(e=>(0,k.jsxs)(`button`,{onClick:()=>be(e.page),children:[`p`,e.page,`: `,e.title,(0,k.jsxs)(`small`,{children:[e.score,` hit`,e.score===1?``:`s`]})]},e.page))]}),(0,k.jsx)(`h3`,{children:`Manual Sections`}),(0,k.jsx)(`nav`,{className:`topics`,children:y.map(e=>(0,k.jsxs)(`button`,{onClick:()=>be(e.pages[0]),children:[(0,k.jsx)(re,{size:16}),(0,k.jsx)(`span`,{children:e.title}),(0,k.jsxs)(`small`,{children:[`p`,e.pages.join(`, `)]})]},e.title))}),(0,k.jsx)(`h3`,{children:`All Pages`}),(0,k.jsx)(`nav`,{children:v.map(e=>(0,k.jsxs)(`button`,{className:e.page===n?`selected`:``,onClick:()=>be(e.page),children:[(0,k.jsx)(ue,{size:16}),(0,k.jsxs)(`span`,{children:[`Page `,e.page]}),(0,k.jsxs)(`small`,{children:[e.title,m[`${o}:${e.page}`]?` · edited`:``]})]},e.page))})]});return(0,k.jsxs)(`div`,{className:`app`,children:[(0,k.jsxs)(`header`,{className:`topBar`,children:[(0,k.jsx)(`button`,{className:`hamburger`,onClick:()=>l(!0),children:(0,k.jsx)(fe,{})}),(0,k.jsxs)(`div`,{className:`brand`,children:[(0,k.jsx)(`img`,{src:`/jensen-logo.png`,alt:`Jensen logo`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{children:`Jensen C-V8`}),(0,k.jsx)(`h1`,{children:`Online Manual`}),(0,k.jsx)(`small`,{children:g})]})]}),(0,k.jsx)(`button`,{className:`openPdf`,onClick:()=>ye(),children:`Open PDF`})]}),(0,k.jsxs)(`div`,{className:`layout`,children:[Le,(0,k.jsxs)(`main`,{children:[(0,k.jsxs)(`section`,{className:`hero`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`Garage-friendly manual app`}),(0,k.jsx)(`h2`,{children:`Search the Jensen C-V8 manual like it was built for the driveway.`}),(0,k.jsx)(`p`,{children:`Plain-English summaries, repair checklists, editable OCR text, source-page buttons, and the original scanned manual in one place.`})]}),(0,k.jsxs)(`div`,{className:`card`,style:{marginTop:`1rem`},children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`Your Car`}),(0,k.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),style:{width:`100%`,padding:`12px`,borderRadius:`10px`,marginTop:`8px`},children:[(0,k.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,k.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,k.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,k.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]}),(0,k.jsxs)(`p`,{style:{marginTop:`10px`,opacity:.8},children:[`Current selection: `,(0,k.jsx)(`strong`,{children:g})]})]}),(0,k.jsxs)(`div`,{className:`heroStats`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:v.length}),(0,k.jsx)(`span`,{children:`manual pages`})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:y.length}),(0,k.jsx)(`span`,{children:`sections`})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:ne}),(0,k.jsx)(`span`,{children:`checklists`})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:te}),(0,k.jsx)(`span`,{children:`OCR edits`})]})]}),(0,k.jsxs)(`div`,{className:`heroSearch`,children:[(0,k.jsx)(me,{size:18}),(0,k.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: no start, brake servo, 35 amp fuse, tyre pressure...`}),e&&(0,k.jsx)(`button`,{onClick:()=>t(``),children:`Clear`})]})]}),(0,k.jsxs)(`div`,{className:`tabs`,children:[(0,k.jsxs)(`button`,{className:u===`cards`?`active`:``,onClick:()=>d(`cards`),children:[(0,k.jsx)(de,{size:16}),` Repair Card`]}),(0,k.jsxs)(`button`,{className:u===`edit`?`active`:``,onClick:()=>d(`edit`),children:[(0,k.jsx)(pe,{size:16}),` Edit OCR`]}),(0,k.jsxs)(`button`,{className:u===`page`?`active`:``,onClick:()=>d(`page`),children:[(0,k.jsx)(ue,{size:16}),` OCR Text`]}),(0,k.jsxs)(`button`,{className:u===`scan`?`active`:``,onClick:()=>d(`scan`),children:[(0,k.jsx)(E,{size:16}),` Scan Viewer`]}),(0,k.jsxs)(`button`,{className:u===`checklist`?`active`:``,onClick:()=>d(`checklist`),children:[(0,k.jsx)(oe,{size:16}),` Checklist`]})]}),(0,k.jsxs)(`section`,{className:`card pageHeader`,children:[(0,k.jsxs)(`div`,{className:`kicker`,children:[`Instruction Book · Page `,b.page]}),(0,k.jsx)(`h2`,{children:b.title}),(0,k.jsx)(`p`,{children:b.summary}),(0,k.jsxs)(`div`,{className:`tagRow`,children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(T,{size:14}),` Jensen C-V8`]}),(0,k.jsx)(`span`,{children:g}),(0,k.jsxs)(`span`,{children:[`Manual p. `,b.page]}),(0,k.jsxs)(`span`,{children:[b.checklist?.length||0,` checklist items`]}),C&&(0,k.jsx)(`span`,{children:`OCR edited locally`})]}),b.isImageOnly?(0,k.jsxs)(`div`,{className:`warn`,children:[(0,k.jsx)(E,{size:18}),(0,k.jsx)(`span`,{children:`This is an image-only reference page. It stays in the app and opens in the scan viewer, but it is not treated as editable OCR text.`})]}):(0,k.jsxs)(`div`,{className:`warn`,children:[(0,k.jsx)(D,{size:18}),(0,k.jsxs)(`span`,{children:[`OCR edits are saved locally and loaded from the committed corrections file. Export your edits, save the file as `,(0,k.jsx)(`code`,{children:`public/ocr-corrections.json`}),`, and commit to make them permanent for all devices.`]})]}),(0,k.jsxs)(`div`,{className:`buttons`,children:[(0,k.jsxs)(`button`,{onClick:xe,children:[(0,k.jsx)(ie,{size:16}),` Previous`]}),(0,k.jsxs)(`button`,{onClick:Ee,children:[`Next `,(0,k.jsx)(ae,{size:16})]}),(0,k.jsxs)(`button`,{onClick:()=>ye(b.page),children:[`Open original scan `,(0,k.jsx)(le,{size:16})]})]})]}),u===`cards`&&(0,k.jsxs)(`section`,{className:`card repairCard`,children:[(0,k.jsxs)(`div`,{className:`repairCardTop`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`eyebrow`,children:`Repair summary`}),(0,k.jsx)(`h3`,{children:b.title})]}),(0,k.jsx)(`button`,{onClick:()=>d(`scan`),children:`View scan`})]}),(0,k.jsx)(`p`,{children:b.summary}),b.checklist&&b.checklist.length?(0,k.jsx)(`ol`,{className:`checklist compact`,children:b.checklist.slice(0,5).map((e,t)=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{children:t+1}),(0,k.jsx)(`p`,{children:e})]},e))}):(0,k.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,k.jsx)(O,{size:24}),(0,k.jsx)(`p`,{children:b.isImageOnly?`This is a diagram/image page. Use the original scan rather than an OCR checklist.`:`No repair checklist has been generated for this page yet.`})]})]}),u===`edit`&&(0,k.jsxs)(`section`,{className:`card`,children:[(0,k.jsxs)(`div`,{className:`editorHeader`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`h3`,{className:`sectionTitle`,children:[`Edit OCR Text - Page `,b.page]}),(0,k.jsx)(`p`,{className:`helperText`,children:`Correct the OCR errors here. Changes autosave locally and are used by search immediately.`})]}),(0,k.jsx)(`div`,{className:`editorStatus`,children:C?`Edited locally`:`Using original OCR`})]}),b.isImageOnly?(0,k.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,k.jsx)(E,{size:24}),(0,k.jsx)(`p`,{children:`This page is image-only, so there is no OCR text to edit. Use the scan viewer for the original page image.`})]}):(0,k.jsx)(`textarea`,{className:`ocrEditor`,value:ee,onChange:e=>De(e.target.value),spellCheck:`false`}),(0,k.jsxs)(`div`,{className:`buttons`,children:[(0,k.jsxs)(`button`,{onClick:Pe,children:[(0,k.jsx)(se,{size:16}),` `,f?`Copied`:`Copy text`]}),(0,k.jsxs)(`button`,{onClick:Fe,children:[(0,k.jsx)(ce,{size:16}),` Export OCR fixes`]}),(0,k.jsxs)(`button`,{onClick:Ie,children:[(0,k.jsx)(pe,{size:16}),` Import OCR fixes`]}),C&&(0,k.jsx)(`button`,{onClick:Ne,children:`Reset this page`}),(0,k.jsxs)(`button`,{onClick:()=>d(`scan`),children:[`View scan `,(0,k.jsx)(E,{size:16})]})]})]}),u===`page`&&(0,k.jsxs)(`section`,{className:`card`,children:[(0,k.jsx)(`h3`,{className:`sectionTitle`,children:`OCR text from this page`}),(0,k.jsx)(`p`,{className:`helperText`,children:`This view uses your corrected OCR text if you have edited this page.`}),(0,k.jsx)(`pre`,{className:`ocrText`,children:Me(ee||(b.isImageOnly?`This is an image-only reference page. Open the scan viewer to see the original page.`:`No readable OCR text was extracted from this page.`),e)})]}),u===`scan`&&(0,k.jsxs)(`section`,{className:`card viewer`,children:[(0,k.jsxs)(`div`,{className:`viewerTop`,children:[(0,k.jsxs)(`h3`,{children:[`Original scanned page `,b.page]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`button`,{onClick:()=>a(Math.max(60,i-20)),children:(0,k.jsx)(_e,{size:16})}),(0,k.jsx)(`button`,{onClick:()=>a(Math.min(180,i+20)),children:(0,k.jsx)(ge,{size:16})})]})]}),(0,k.jsx)(`iframe`,{title:`manual pdf`,src:`${b.sourcePdf||(o===`mk3`?Te:we)}#page=${b.sourcePage||b.page}&zoom=${i}`})]}),u===`checklist`&&(0,k.jsxs)(`section`,{className:`card`,children:[(0,k.jsx)(`h3`,{className:`sectionTitle`,children:`Plain-English checklist`}),b.checklist&&b.checklist.length?(0,k.jsx)(`ol`,{className:`checklist`,children:b.checklist.map((e,t)=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{children:t+1}),(0,k.jsx)(`p`,{children:e})]},e))}):(0,k.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,k.jsx)(O,{size:24}),(0,k.jsx)(`p`,{children:b.isImageOnly?`This is a diagram/image page. Use the original scan rather than an OCR checklist.`:`No specific repair checklist has been generated for this page yet.`})]})]}),e&&(0,k.jsxs)(`section`,{className:`card`,children:[(0,k.jsx)(`h3`,{className:`sectionTitle`,children:`Search results from OCR text`}),(0,k.jsx)(`div`,{className:`searchResults`,children:ve.map(e=>(0,k.jsxs)(`button`,{onClick:()=>be(e.page),children:[(0,k.jsxs)(`strong`,{children:[`Page `,e.page,`: `,e.title]}),(0,k.jsxs)(`span`,{children:[e.text.slice(0,260),`...`]})]},e.page))})]})]})]})]})}(0,ve.createRoot)(document.getElementById(`root`)).render((0,k.jsx)(Ne,{}));