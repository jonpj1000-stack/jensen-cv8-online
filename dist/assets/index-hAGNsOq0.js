...
29. Petrol Filler Lid`,summary:`This page provides a labeled diagram identifying the dashboard instruments and controls layout for the Jensen C-V8, including gauges, warning lights, heater controls, and switches.`,checklist:[`Check the ammeter to monitor electrical system charging status.`,`Inspect the oil pressure gauge for proper engine lubrication readings.`,`Check the water temperature gauge to ensure engine cooling is within normal range.`,`Verify the L.H. and R.H. flasher warning lights illuminate when turn signals are activated.`,`Inspect the low fuel warning light for proper operation.`,`Check the high beam warning light activates when headlamps are on high beam.`,`Verify the instrument illumination control adjusts dashboard lighting properly.`]},{page:5,title:`GENERAL DIMENSIONS AND DATA FOR QUICK REFERENCE`,text:`GENERAL DIMENSIONS AND DATA FOR QUICK REFERENCE
...
5`,summary:`This page provides essential vehicle identification locations, engine specifications, fluid capacities, gear ratios, and dimensional data for quick reference on the Jensen C-V8.`,checklist:[`Locate the chassis number on the plate secured to the front of the scuttle or stamped on the front of the frame front cross member.`,`Locate the engine number stamped on the L.H. bank of the cylinder block immediately forward of No. 1 cylinder.`,`Fill the cooling system including heater to capacity of 24 pints (Imp.) or 29 pints (U.S.).`,`Fill the oil sump to 7 pints (Imp.) or 8 pints (U.S.), ensuring the dipstick top level is not exceeded.`,`Check engine oil pressure at 40-50 m.p.h. to verify it reads 45-65 p.s.i.`,`Fill automatic gearbox to 15.5 pints (Imp.) or manual with overdrive gearbox to 5 pints (Imp.).`,`Fill rear axle to capacity of 3 pints (Imp.) or 3.6 pints (U.S.).`,`Set tyre pressure to 24 p.s.i. all round and refer to notes on wheels and tyres on pp. 17-18.`]},{page:6,title:`Castor Angle (Static laden weight) 2> pos:`,text:`Castor Angle (Static laden weight) 2> pos:
...
27`,summary:`This page details the service lubrication intervals and procedures for the automatic transmission, manual transmission, propeller shaft universal joints, and rear axle.`,checklist:[`Check automatic transmission fluid level at 4,000 miles with engine and transmission at normal operating temperature, handbrake on, after momentarily engaging each gear and ending in neutral.`,`Drain and replace automatic transmission oil and filter at 32,000 miles, or more frequently if towing trailers, operating in heavy traffic in hot weather, or carrying abnormal loads.`,`Check manual transmission fluid level at 4,000 miles by removing filler plug and replenish to filler hole as needed.`,`Drain and refill manual transmission at 32,000 miles.`,`Disassemble, clean, and repack propeller shaft universal joints with multi-purpose grease (NLGI-0 or 1).`,`Check and top up rear axle fluid at 4,000 miles using only Shell S1747A.`,`Drain and refill rear axle at 12,000 miles, with initial drain and refill at 1,000 miles.`]},{page:28,title:`SERVICE LUBRICATION (continued)`,text:`SERVICE LUBRICATION (continued)
...
Printed in England by Jolly & Barber Led., Rugby.`,summary:`OCR text extracted from this scanned manual page. Use it as a searchable working copy and verify against the scan.`,checklist:[]}],ye=[{id:`mk3-p01`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:1,sourcePage:1,title:`HANDBOOK OF INSTRUCTIONS`,summary:`This is the title page of the Jensen C-V8 Mk.III owners handbook, introducing the manual's purpose and providing manufacturer contact information along with instructions for locating the chassis serial number.`,plainEnglish:`Lubrication system, oil draining, filter changing and lubrication/maintenance schedule information.`,ocrText:`HANDBOOK OF INSTRUCTIONS
FOR THE
JENSEN C-V8 MK.III
eg P
a ee "~& *
...
'
|`,checklist:[`Locate the chassis number on the plate secured to the underside of the companion box lid or on the plate at the front of the scuttle.`,`Check the chassis number stamped on the front of the chassis frame front cross member for verification.`,`Locate the engine number stamped on the left-hand bank of the cylinder block immediately forward of No. 1 cylinder.`,`Fill the cooling system including heater to capacity of 32 pints Imperial (38 pints U.S. / 18.2 litres).`,`Fill the oil sump to 8½ pints Imperial (10 pints U.S. / 4.7 litres) including filter, ensuring the dipstick top level is not exceeded.`,`Check engine oil pressure at 40/50 m.p.h. reads between 45-65 psi.`,`Fill the automatic gearbox to 17 pints Imperial (20 pints U.S. / 9.5 litres) or manual gearbox to 6 pints Imperial (7 pints U.S. / 3.3 litres).`,`Check tyre pressure is set to 24 PSI (1.68 kg/sq. cm.) all round.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p08`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:8,sourcePage:8,title:`'Overall Height 4 ft, 7 ins, (1,397 metres)`,summary:`OCR text extracted from the Mk III instruction manual for searching and editing.`,plainEnglish:`OCR text extracted from the Mk III instruction manual for searching and editing.`,ocrText:`'Overall Height 4 ft, 7 ins, (1,397 metres)
...
a`,checklist:[`Check that speeds do not exceed 60 mph for the first 300 miles of operation.`,`Avoid operating the car at top speed until it has been driven at least 500 miles.`,`Monitor the engine oil level closely during the running-in period.`,`Check the temperature and oil pressure gauges regularly during early engine life.`,`Ensure the handbrake is applied before starting the engine.`,`Move the gear range selector lever to neutral position 'N' before starting on automatic transmission cars.`,`Depress the accelerator pedal slowly to one third of its travel and release before starting from cold.`,`Push the accelerator pedal slowly to full open while operating the starter if engine floods with excess fuel.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p16`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:16,sourcePage:16,title:`GEARBOX OPERATION`,summary:`Automatic gearbox operation, selector use, driving speeds, towing and push-start guidance.`,plainEnglish:`Automatic gearbox operation, selector use, driving speeds, towing and push-start guidance.`,ocrText:`GEARBOX OPERATION
...
2`,checklist:[`Replace the fuel filter between the tank and pump every 20,000 miles.`,`Replace the fuel filter after the pump every 80,000 miles.`,`Change fuel filters more frequently if dirty petrol has been used.`,`Disconnect the carburettor to bellcrank rod on cars with automatic transmission before adjusting idle speed.`,`Warm up the engine thoroughly and drive a minimum of five miles before making idle speed adjustments.`,`Turn the idle speed screw in or out to obtain 500 r.p.m. while ensuring the choke valve is fully open.`,`Verify that the fast idle adjustment screw is not contacting the fast idle cam during idle speed adjustment.`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1},{id:`mk3-p24`,model:`mk3`,modelLabel:`Jensen C-V8 Mk III`,page:24,sourcePage:24,title:`'COVER PLATE`,summary:`OCR text extracted from the Mk III instruction manual for searching and editing.`,plainEnglish:`OCR text extracted from the Mk III instruction manual for searching and editing.`,ocrText:`STE. uP ASTON
'COVER PLATE
ACCILERATCR PUMP
cnoet 'muniosp sea
