...
Printed in Emgland by Bachan Prone Lick, Saver`,checklist:[`Lubrication—chart | 19 Sav =, he`,`Lubrication—enging = = 28 Shroud ee |`,`Lubrication—gearbox 28 © Siowrunning = s`],sourcePdf:`/manuals/jensen-cv8-mk3-instruction-manual.pdf`,type:`text`,hidden:!1,isImageOnly:!1}],be=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),A=o(((e,t)=>{t.exports=be()}))(),xe=[{title:`Dashboard & Controls`,pages:[4],tags:`dashboard instruments controls switches gauges warning lights`},{title:`Specifications & Capacities`,pages:[5,6],tags:`specifications capacity timing plug gap compression oil dimensions`},{title:`Motor, Starting & Running`,pages:[7,8,9],tags:`engine motor starting running gearbox transmission overdrive towing`},{title:`Lubrication & Maintenance`,pages:[10,11,25,26,27,28],tags:`lubrication maintenance grease oil service miles`},{title:`Electrical, Battery & Fuses`,pages:[12,13],tags:`electrical lucas autolite battery positive earth fuse fuses bulbs lamps wiper`},{title:`Brakes & Servo`,pages:[13],tags:`brakes servo dunlop brake fluid handbrake vacuum`},{title:`Fuel System & Carburetter`,pages:[15,16],tags:`fuel carburetter carter idle fast idle choke throttle linkage`},{title:`Tyres, Wheels & Alignment`,pages:[17,18,19],tags:`tyres tires wheels alignment bearings toe-in castor camber`},{title:`Cooling, Heating & Rear Axle`,pages:[20,21],tags:`cooling fan radiator heater ventilation antifreeze coolant rear axle powr-lok drive belt`},{title:`Interior & Owner Information`,pages:[2,3,22,23,31,32],tags:`owner warranty seats upholstery vehicle particulars chassis engine key`}],Se={all:`All Models`,mk1:`Mk I`,mk2:`Mk II`,mk3:`Mk III`},Ce=`/manuals/jensen_cv8_owners_manual.pdf`,we=`/manuals/jensen-cv8-mk3-instruction-manual.pdf`;function Te(e){let t=String(e.title||``).toLowerCase(),n=String(e.text??e.ocrText??``).trim();return e.hidden||e.type===`blank`||t===`blank page`?`blank`:e.type?e.type:n?`text`:`diagram`}function Ee(e,t,n,r){return e.map(e=>{let i=e.text??e.ocrText??``,a=Te({...e,text:i}),o=a===`blank`,s=a===`diagram`||e.isImageOnly===!0;return{...e,type:a,hidden:o||e.hidden===!0,isImageOnly:s,model:e.model||t,modelLabel:e.modelLabel||n,sourcePdf:e.sourcePdf||r,sourcePage:e.sourcePage||e.page,text:i,summary:e.summary??e.plainEnglish??(s?`Image-only reference page. Use the original scan for this page.`:``),title:e.title||`Page ${e.page}`}})}function De(e){return e.filter(e=>!e.hidden)}function Oe(e,t,n=1){let r=De(e);if(!r.length)return null;let i=r.find(e=>e.page===t);if(i)return i;let a=[...r].sort((e,t)=>e.page-t.page);return n>=0?a.find(e=>e.page>=t)||a[a.length-1]:[...a].reverse().find(e=>e.page<=t)||a[0]}var ke=Ee(ve,`base`,`Jensen C-V8`,Ce),Ae=Ee(ye,`mk3`,`Jensen C-V8 Mk III`,we),je=`OCR text extracted from this scanned manual page`,Me=[`foreword`,`introduction`,`handbook of instructions`,`vehicle particulars`,`warranty`,`index`,`contents`,`cover`,`title page`,`jensen`],Ne=/^(check|inspect|change|replace|drain|fill|remove|install|adjust|clean|tighten|loosen|ensure|apply|add|use|do not|never|always|confirm|photograph|identify|select|engage|depress|set|verify|refit|recheck|run|start|allow|push|pull|turn|disconnect|connect|torque|grease|lubricate|bleed|test|reset|secure|re-?tighten|re-?fit|re-?check)/i;function Pe(e){return!Array.isArray(e)||e.length<2?!1:e.filter(e=>e.length>35&&Ne.test(e)).length>=2}function Fe(e){if(!e||e.length<40)return[];let t=e.replace(/\n+/g,` `).split(/(?<=[.!?])\s+/).map(e=>e.trim()).filter(e=>e.length>25&&e.length<300),n=new Set,r=[];for(let e of t){let t=e.slice(0,40).toLowerCase();n.has(t)||(/every\s+[\d,]+\s*(miles?|km|months?|years?|hours?)/i.test(e)||/\d+[\s-]*(p\.?s\.?i\.?|psi|rpm|r\.p\.m|°|degrees?|mm|ins?\.)\b/i.test(e)||/should\s+be\s+(changed|checked|drained|replaced|inspected|cleaned|adjusted|refilled|topped|removed|fitted)/i.test(e)||/must\s+(be|not)\s+/i.test(e)||/\bdo not\b|\bnever\b/i.test(e)||Ne.test(e))&&(n.add(t),r.push(e))}return r.slice(0,8)}function Ie(e){if(e.isImageOnly||e.type===`diagram`||!e.text?.trim())return`diagram`;let t=(e.title||``).toLowerCase();return Me.some(e=>t.includes(e))?`informational`:Pe(e.checklist)||Fe(e.text).length>0?`repair`:`reference`}function Le(e,t){if(!t.trim())return e;let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return e.split(RegExp(`(${n})`,`ig`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,A.jsx)(`mark`,{children:e},n):e)}function Re(){let[e,t]=(0,S.useState)(``),[n,r]=(0,S.useState)(4),[i,a]=(0,S.useState)(100),[o,s]=(0,S.useState)(()=>localStorage.getItem(`jensen-model`)||`all`),[c,l]=(0,S.useState)(!1),[u,d]=(0,S.useState)(`cards`),[f,p]=(0,S.useState)(!1),[m,h]=(0,S.useState)(()=>{try{return JSON.parse(localStorage.getItem(`jensen-ocr-edits`)||`{}`)}catch{return{}}});(0,S.useEffect)(()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).then(e=>{!e||!Object.keys(e).length||h(t=>({...e,...t}))}).catch(()=>{})},[]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-model`,o)},[o]),(0,S.useEffect)(()=>{localStorage.setItem(`jensen-ocr-edits`,JSON.stringify(m))},[m]);let g=Se[o]||Se.all,_=(0,S.useMemo)(()=>o===`mk3`?Ae:ke,[o]),v=(0,S.useMemo)(()=>De(_),[_]),y=(0,S.useMemo)(()=>{let e=new Set(v.map(e=>e.page));return xe.map(t=>({...t,pages:t.pages.filter(t=>e.has(t))})).filter(e=>e.pages.length)},[v]);(0,S.useEffect)(()=>{let e=Oe(_,n,1);e&&e.page!==n&&r(e.page)},[_,n]);let b=v.find(e=>e.page===n)||v[0]||_[0],x=Ie(b),ee=`${o}:${b?.page||1}`,C=m[ee]??b.text??``,te=Object.prototype.hasOwnProperty.call(m,ee),ne=Object.keys(m).filter(e=>e.startsWith(`${o}:`)).length,w=v.filter(e=>e.checklist&&e.checklist.length).length,_e=(0,S.useMemo)(()=>v.map(e=>{let t=`${o}:${e.page}`;return{...e,text:m[t]??e.text??``}}),[m,v,o]),ve=(0,S.useMemo)(()=>{let t=e.trim().toLowerCase();if(!t)return[];let n=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);return _e.map(e=>{let t=(`${e.title} ${e.text} ${e.summary}`.toLowerCase().match(new RegExp(n,`g`))||[]).length;return{...e,score:t}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score)},[e,_e]),ye=(e=n)=>{let t=_.find(t=>t.page===e)||b,r=t?.sourcePdf||(o===`mk3`?we:Ce),i=t?.sourcePage||t?.page||e;window.open(`${r}#page=${i}`,`_blank`)},be=(e,t=1)=>{let n=Oe(_,e,t);if(n){r(n.page);let e=Ie(n);e===`diagram`?d(`scan`):e===`repair`?d(`cards`):(e===`informational`||u===`cards`)&&d(`page`)}l(!1),p(!1)},Te=()=>be(n-1,-1),Ee=()=>be(n+1,1),Me=e=>{h({...m,[ee]:e})},Re=()=>{let e={...m};delete e[ee],h(e)},ze=async()=>{await navigator.clipboard.writeText(C),p(!0),setTimeout(()=>p(!1),1600)},Be=()=>{fetch(`/ocr-corrections.json`).then(e=>e.ok?e.json():{}).catch(()=>({})).then(e=>{let t={...e,...m},n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`jensen-ocr-edits.json`,i.click(),URL.revokeObjectURL(r)})},Ve=()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json,.json`,e.onchange=e=>{let t=e.target.files[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target.result);typeof t==`object`&&t&&h(e=>({...e,...t}))}catch{alert(`Could not read the file — make sure it is a valid jensen-ocr-edits.json export.`)}},n.readAsText(t)},e.click()},He=(0,A.jsxs)(`aside`,{className:c?`sidebar open`:`sidebar`,children:[(0,A.jsxs)(`div`,{className:`mobileClose`,children:[(0,A.jsx)(`strong`,{children:`Manual Library`}),(0,A.jsx)(`button`,{onClick:()=>l(!1),children:(0,A.jsx)(me,{size:20})})]}),(0,A.jsxs)(`div`,{className:`searchBox`,children:[(0,A.jsxs)(`label`,{children:[(0,A.jsx)(pe,{size:16}),` Search manual`]}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: ballast resistor, brake fluid, tyre pressure...`})]}),e&&(0,A.jsxs)(`div`,{className:`resultsBox`,children:[(0,A.jsxs)(`strong`,{children:[ve.length,` result`,ve.length===1?``:`s`]}),ve.slice(0,8).map(e=>(0,A.jsxs)(`button`,{onClick:()=>be(e.page),children:[`p`,e.page,`: `,e.title,(0,A.jsxs)(`small`,{children:[e.score,` hit`,e.score===1?``:`s`]})]},e.page))]}),(0,A.jsx)(`h3`,{children:`Manual Sections`}),(0,A.jsx)(`nav`,{className:`topics`,children:y.map(e=>(0,A.jsxs)(`button`,{onClick:()=>be(e.pages[0]),children:[(0,A.jsx)(T,{size:16}),(0,A.jsx)(`span`,{children:e.title}),(0,A.jsxs)(`small`,{children:[`p`,e.pages.join(`, `)]})]},e.title))}),(0,A.jsx)(`h3`,{children:`All Pages`}),(0,A.jsx)(`nav`,{children:v.map(e=>(0,A.jsxs)(`button`,{className:e.page===n?`selected`:``,onClick:()=>be(e.page),children:[(0,A.jsx)(le,{size:16}),(0,A.jsxs)(`span`,{children:[`Page `,e.page]}),(0,A.jsxs)(`small`,{children:[e.title,m[`${o}:${e.page}`]?` · edited`:``]})]},e.page))})]});return(0,A.jsxs)(`div`,{className:`app`,children:[(0,A.jsxs)(`header`,{className:`topBar`,children:[(0,A.jsx)(`button`,{className:`hamburger`,onClick:()=>l(!0),children:(0,A.jsx)(de,{})}),(0,A.jsxs)(`div`,{className:`brand`,children:[(0,A.jsx)(`img`,{src:`/jensen-logo.png`,alt:`Jensen logo`}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{children:`Jensen C-V8`}),(0,A.jsx)(`h1`,{children:`Online Manual`}),(0,A.jsx)(`small`,{children:g})]})]}),(0,A.jsx)(`button`,{className:`openPdf`,onClick:()=>ye(),children:`Open PDF`})]}),(0,A.jsxs)(`div`,{className:`layout`,children:[He,(0,A.jsxs)(`main`,{children:[(0,A.jsxs)(`section`,{className:`hero`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Garage-friendly manual app`}),(0,A.jsx)(`h2`,{children:`Search the Jensen C-V8 manual like it was built for the driveway.`}),(0,A.jsx)(`p`,{children:`Plain-English summaries, repair checklists, editable OCR text, source-page buttons, and the original scanned manual in one place.`})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginTop:`1rem`},children:[(0,A.jsx)(`p`,{className:`eyebrow`,children:`Your Car`}),(0,A.jsxs)(`select`,{value:o,onChange:e=>s(e.target.value),style:{width:`100%`,padding:`12px`,borderRadius:`10px`,marginTop:`8px`},children:[(0,A.jsx)(`option`,{value:`all`,children:`All Jensen C-V8 Models`}),(0,A.jsx)(`option`,{value:`mk1`,children:`Jensen C-V8 Mk I`}),(0,A.jsx)(`option`,{value:`mk2`,children:`Jensen C-V8 Mk II`}),(0,A.jsx)(`option`,{value:`mk3`,children:`Jensen C-V8 Mk III`})]}),(0,A.jsxs)(`p`,{style:{marginTop:`10px`,opacity:.8},children:[`Current selection: `,(0,A.jsx)(`strong`,{children:g})]})]}),(0,A.jsxs)(`div`,{className:`heroStats`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`strong`,{children:v.length}),(0,A.jsx)(`span`,{children:`manual pages`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`strong`,{children:y.length}),(0,A.jsx)(`span`,{children:`sections`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`strong`,{children:w}),(0,A.jsx)(`span`,{children:`checklists`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`strong`,{children:ne}),(0,A.jsx)(`span`,{children:`OCR edits`})]})]}),(0,A.jsxs)(`div`,{className:`heroSearch`,children:[(0,A.jsx)(pe,{size:18}),(0,A.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Try: no start, brake servo, 35 amp fuse, tyre pressure...`}),e&&(0,A.jsx)(`button`,{onClick:()=>t(``),children:`Clear`})]})]}),(0,A.jsxs)(`div`,{className:`tabs`,children:[(0,A.jsxs)(`button`,{className:u===`cards`?`active`:``,onClick:()=>d(`cards`),children:[(0,A.jsx)(ue,{size:16}),` `,x===`repair`?`Repair Card`:`Overview`]}),(0,A.jsxs)(`button`,{className:u===`edit`?`active`:``,onClick:()=>d(`edit`),children:[(0,A.jsx)(fe,{size:16}),` Edit OCR`]}),(0,A.jsxs)(`button`,{className:u===`page`?`active`:``,onClick:()=>d(`page`),children:[(0,A.jsx)(le,{size:16}),` OCR Text`]}),(0,A.jsxs)(`button`,{className:u===`scan`?`active`:``,onClick:()=>d(`scan`),children:[(0,A.jsx)(D,{size:16}),` Scan Viewer`]}),(0,A.jsxs)(`button`,{className:u===`checklist`?`active`:``,onClick:()=>d(`checklist`),children:[(0,A.jsx)(ae,{size:16}),` Checklist`]})]}),(0,A.jsxs)(`section`,{className:`card pageHeader`,children:[(0,A.jsxs)(`div`,{className:`kicker`,children:[`Instruction Book · Page `,b.page]}),(0,A.jsx)(`h2`,{children:b.title}),(0,A.jsx)(`p`,{children:b.summary}),(0,A.jsxs)(`div`,{className:`tagRow`,children:[(0,A.jsxs)(`span`,{children:[(0,A.jsx)(E,{size:14}),` Jensen C-V8`]}),(0,A.jsx)(`span`,{children:g}),(0,A.jsxs)(`span`,{children:[`Manual p. `,b.page]}),(0,A.jsxs)(`span`,{children:[b.checklist?.length||0,` checklist items`]}),te&&(0,A.jsx)(`span`,{children:`OCR edited locally`})]}),b.isImageOnly?(0,A.jsxs)(`div`,{className:`warn`,children:[(0,A.jsx)(D,{size:18}),(0,A.jsx)(`span`,{children:`This is an image-only reference page. It stays in the app and opens in the scan viewer, but it is not treated as editable OCR text.`})]}):(0,A.jsxs)(`div`,{className:`warn`,children:[(0,A.jsx)(O,{size:18}),(0,A.jsxs)(`span`,{children:[`OCR edits are saved locally and loaded from the committed corrections file. Export your edits, save the file as `,(0,A.jsx)(`code`,{children:`public/ocr-corrections.json`}),`, and commit to make them permanent for all devices.`]})]}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:Te,children:[(0,A.jsx)(re,{size:16}),` Previous`]}),(0,A.jsxs)(`button`,{onClick:Ee,children:[`Next `,(0,A.jsx)(ie,{size:16})]}),(0,A.jsxs)(`button`,{onClick:()=>ye(b.page),children:[`Open original scan `,(0,A.jsx)(ce,{size:16})]})]})]}),u===`cards`&&(0,A.jsxs)(`section`,{className:`card repairCard`,children:[(0,A.jsxs)(`div`,{className:`repairCardTop`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`p`,{className:`eyebrow`,children:[x===`repair`&&`Repair summary`,x===`reference`&&`Reference data`,x===`informational`&&`Informational page`,x===`diagram`&&`Diagram / image page`]}),(0,A.jsx)(`h3`,{children:b.title})]}),(0,A.jsx)(`button`,{onClick:()=>d(`scan`),children:`View scan`})]}),x===`repair`&&(()=>{let e=Pe(b.checklist),t=e?[]:Fe(C);return(0,A.jsxs)(A.Fragment,{children:[b.summary&&!b.summary.startsWith(je)&&(0,A.jsx)(`p`,{children:b.summary}),e?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`p`,{className:`helperText`,children:`Repair steps for this page:`}),(0,A.jsx)(`ol`,{className:`checklist compact`,children:b.checklist.filter(e=>Ne.test(e)).slice(0,6).map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(`span`,{children:t+1}),(0,A.jsx)(`p`,{children:e})]},e))})]}):t.length>0?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`p`,{className:`helperText`,children:`Key service facts extracted from this page:`}),(0,A.jsx)(`ul`,{className:`keyFacts`,children:t.map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(`span`,{children:(0,A.jsx)(k,{size:14})}),(0,A.jsx)(`p`,{children:e})]},t))}),(0,A.jsxs)(`p`,{className:`helperText dimText`,children:[`These are extracted directly from the OCR text. Correct any OCR errors in the `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`edit`),children:`Edit OCR tab`}),` to improve accuracy.`]})]}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(k,{size:24}),(0,A.jsxs)(`p`,{children:[`No repair checklist has been generated for this page yet. `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View the OCR text`}),` for the full content.`]})]})]})})(),x===`reference`&&(0,A.jsxs)(A.Fragment,{children:[b.summary&&!b.summary.startsWith(je)&&(0,A.jsx)(`p`,{children:b.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(le,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a reference data page — specifications, capacities or tables.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`View OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`open the original scan`}),`.`]})]})]}),x===`informational`&&(0,A.jsxs)(A.Fragment,{children:[b.summary&&!b.summary.startsWith(je)&&(0,A.jsx)(`p`,{children:b.summary}),(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(T,{size:24}),(0,A.jsxs)(`p`,{children:[`This is an informational page — no repair steps apply.`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`page`),children:`Read the OCR text`}),` `,`or`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`view the original scan`}),`.`]})]})]}),x===`diagram`&&(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(D,{size:24}),(0,A.jsxs)(`p`,{children:[`This is a diagram or image-only page. Use the`,` `,(0,A.jsx)(`button`,{className:`inlineLink`,onClick:()=>d(`scan`),children:`scan viewer`}),` `,`to see the original page.`]})]})]}),u===`edit`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsxs)(`div`,{className:`editorHeader`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`h3`,{className:`sectionTitle`,children:[`Edit OCR Text - Page `,b.page]}),(0,A.jsx)(`p`,{className:`helperText`,children:`Correct the OCR errors here. Changes autosave locally and are used by search immediately.`})]}),(0,A.jsx)(`div`,{className:`editorStatus`,children:te?`Edited locally`:`Using original OCR`})]}),b.isImageOnly?(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(D,{size:24}),(0,A.jsx)(`p`,{children:`This page is image-only, so there is no OCR text to edit. Use the scan viewer for the original page image.`})]}):(0,A.jsx)(`textarea`,{className:`ocrEditor`,value:C,onChange:e=>Me(e.target.value),spellCheck:`false`}),(0,A.jsxs)(`div`,{className:`buttons`,children:[(0,A.jsxs)(`button`,{onClick:ze,children:[(0,A.jsx)(oe,{size:16}),` `,f?`Copied`:`Copy text`]}),(0,A.jsxs)(`button`,{onClick:Be,children:[(0,A.jsx)(se,{size:16}),` Export OCR fixes`]}),(0,A.jsxs)(`button`,{onClick:Ve,children:[(0,A.jsx)(fe,{size:16}),` Import OCR fixes`]}),te&&(0,A.jsx)(`button`,{onClick:Re,children:`Reset this page`}),(0,A.jsxs)(`button`,{onClick:()=>d(`scan`),children:[`View scan `,(0,A.jsx)(D,{size:16})]})]})]}),u===`page`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`OCR text from this page`}),(0,A.jsx)(`p`,{className:`helperText`,children:`This view uses your corrected OCR text if you have edited this page.`}),(0,A.jsx)(`pre`,{className:`ocrText`,children:Le(C||(b.isImageOnly?`This is an image-only reference page. Open the scan viewer to see the original page.`:`No readable OCR text was extracted from this page.`),e)})]}),u===`scan`&&(0,A.jsxs)(`section`,{className:`card viewer`,children:[(0,A.jsxs)(`div`,{className:`viewerTop`,children:[(0,A.jsxs)(`h3`,{children:[`Original scanned page `,b.page]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`button`,{onClick:()=>a(Math.max(60,i-20)),children:(0,A.jsx)(ge,{size:16})}),(0,A.jsx)(`button`,{onClick:()=>a(Math.min(180,i+20)),children:(0,A.jsx)(he,{size:16})})]})]}),(0,A.jsx)(`iframe`,{title:`manual pdf`,src:`${b.sourcePdf||(o===`mk3`?we:Ce)}#page=${b.sourcePage||b.page}&zoom=${i}`})]}),u===`checklist`&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Plain-English checklist`}),b.checklist&&b.checklist.length?(0,A.jsx)(`ol`,{className:`checklist`,children:b.checklist.map((e,t)=>(0,A.jsxs)(`li`,{children:[(0,A.jsx)(`span`,{children:t+1}),(0,A.jsx)(`p`,{children:e})]},e))}):(0,A.jsxs)(`div`,{className:`emptyChecklist`,children:[(0,A.jsx)(k,{size:24}),(0,A.jsx)(`p`,{children:b.isImageOnly?`This is a diagram/image page. Use the original scan rather than an OCR checklist.`:`No specific repair checklist has been generated for this page yet.`})]})]}),e&&(0,A.jsxs)(`section`,{className:`card`,children:[(0,A.jsx)(`h3`,{className:`sectionTitle`,children:`Search results from OCR text`}),(0,A.jsx)(`div`,{className:`searchResults`,children:ve.map(e=>(0,A.jsxs)(`button`,{onClick:()=>be(e.page),children:[(0,A.jsxs)(`strong`,{children:[`Page `,e.page,`: `,e.title]}),(0,A.jsxs)(`span`,{children:[e.text.slice(0,260),`...`]})]},e.page))})]})]})]})]})}(0,_e.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(Re,{}));