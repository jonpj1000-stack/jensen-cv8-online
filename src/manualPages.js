export const manualPages = [
  ...
  },
  {
    ...
    "summary": "This page provides a labeled diagram identifying the dashboard instruments and controls located in the Jensen C-V8 interior.",
    "checklist": [
      "Check the ammeter to monitor the electrical charging system status.",
      "Inspect the oil pressure gauge to ensure proper engine lubrication readings.",
      "Check the water temperature gauge to verify engine cooling system operation.",
      "Verify that the L.H. and R.H. flasher warning lights illuminate when indicators are activated.",
      "Check the low fuel warning light for proper function before journeys.",
      "Inspect the high beam warning light to confirm it illuminates when headlamps are on high beam.",
      "Check that the instrument illumination control adjusts dashboard lighting correctly."
    ]
  },
  {
    "page": 5,
    ...
    "summary": "This page provides essential vehicle identification locations, engine specifications, fluid capacities, gear ratios, tyre specifications, and key dimensions for the Jensen C-V8.",
    "checklist": [
      ...
      "Locate the engine number stamped on the left-hand bank of the cylinder block immediately forward of No. 1 cylinder.",
  ...
  },
  {
    ...
    "summary": "Lubrication and maintenance schedule including the first 1,000-mile service.",
    "checklist": [
      "Complete the first 1,000-mile service items after recommissioning or major rebuild.",
      "Check fluid levels, fan belt, electrical system, tyres, lights and brakes.",
      "Follow the recurring mileage schedule for greasing and inspections.",
      "Record dates and mileage for future restoration history."
    ]
  },
  {
    "page": 11,
  ...
  },
  {
    ...
    "title": "NS",
    "text": "KK\n\nNS\n\nCc\n\nlb",
    "summary": "Front wheel alignment and bearing adjustment page.",
    "checklist": [
      "Measure toe-in at wheel height.",
      "Use 1/8 inch toe-in as the manual reference.",
      "Jack and secure the vehicle safely before bearing work.",
      "Remove nave plate and hub cap before adjustment.",
      "Recheck for free rotation and no excessive play."
    ]
  },
  {
    "page": 20,
    ...
    "summary": "Rear axle, cooling/heating and drive belt adjustment.",
    "checklist": [
      "Do not dismantle the Power-Lok rear axle without the correct Churchill tool.",
      "Do not remove the header tank cap when hot.",
      "Check coolant weekly when cold.",
      "Top up to about one inch below the top of the header tank.",
      "Adjust alternator/water pump belt using the alternator guide slot."
    ]
  },
  {
    "page": 21,
    ...
    "summary": "Winter precautions and anti-freeze guidance.",
    "checklist": [
      "Use anti-freeze in winter conditions.",
      "Check cooling system condition before relying on anti-freeze protection.",
      "Inspect hoses and radiator condition during seasonal maintenance.",
      "Record coolant type and change date."
    ]
  },
  {
    "page": 22,
  ...
  },
  {
    ...
    "summary": "This page details the lubrication service intervals and procedures for the automatic transmission, manual transmission, propeller shaft universal joints, and rear axle.",
    "checklist": [
      ...
      "Drain and replace automatic transmission oil and filter every 32,000 miles, or more frequently if towing trailers, operating in heavy traffic during hot weather, or carrying abnormal loads.",
      "Check manual transmission fluid level every 4,000 miles by removing the filler plug and replenish to the filler hole as needed.",
      ...
      "Check and top up rear axle fluid level every 4,000 miles using only Shell S1747A.",
      "Drain and refill rear axle at 1,000 miles initially, then every 12,000 miles thereafter."
    ]
  },
  {
    "page": 28,
  ...
  },
  {
    ...
    "summary": "Index page for quickly locating manual topics.",
    "checklist": [
      "Use the index to find source pages for a topic.",
      "Then open the scanned page and OCR text side by side.",
      "Confirm OCR against the original scan before using a specification."
    ]
  },
  {
    "page": 30,
  ...
  },
  {
    "page": 32,
    "title": "NREL = f .",
    "text": "NREL = f .\nFane’ = | ROD VAS 4\n\nWis r™ 10 VAR\n\n\\ AAT IS\n\nPrinted in England by Jolly & Barber Led., Rugby.",
    "summary": "OCR text extracted from this scanned manual page. Use it as a searchable working copy and verify against the scan.",
    "checklist": []
  }
];
