  ...
  'mk1-mk2': {
    ...
    sections: [
      ...
      },
      {
        ...
        // image pending — uses PDF page fallback
      },
      {
        id:       'overview-1',
      ...
      },
      {
        ...
        notes:    'A: While turning from position 4 to SOFT, T1 closes briefly (S1 & R1 already closed). B: After the switch settles, S1 & R1 open and S2 & R2 close — ready for the impulse of T2 on the next position change.',
      },
      {
        ...
        notes:    'C: While turning from SOFT to position 2, T2 closes briefly (S2 & R2 already closed). D: After settling, S2 & R2 open and S3 & R3 close — ready for the impulse of T3 when moving to position 3.',
      },
    ],
  },
