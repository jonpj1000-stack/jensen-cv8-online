export const mk3ManualPages = [
  ...
  },
  {
    ...
    "sourcePage": 2,
    "title": "Blank page",
    "summary": "Blank or spacer page in the scanned manual.",
  ...
  },
  {
    ...
    "summary": "This page provides blank fields for recording essential vehicle identification information including chassis number, engine number, key numbers, registration, and original delivery date.",
  ...
  },
  {
    ...
    "sourcePage": 5,
    "title": "Foreword",
    "summary": "This foreword introduces the Jensen C-V8 owner's handbook, emphasizing the car's quality construction and the importance of following the manual's instructions for proper care, while directing owners to authorized Jensen dealers or the factory Service Department for assistance.",
    "plainEnglish": "Introductory notes from Jensen Motors about correct operation and maintenance.",
  ...
  },
  {
    ...
    "page": 8,
    "sourcePage": 8,
    "title": "'Overall Height 4 ft, 7 ins, (1,397 metres)",
    "summary": "This page provides key vehicle specifications including dimensions, weight, and critical engine settings for ignition timing, contact breaker gap, spark plugs, and valve clearances.",
    "plainEnglish": "OCR text extracted from the Mk III instruction manual for searching and editing.",
    "ocrText": "'Overall Height 4 ft, 7 ins, (1,397 metres)\n'Overall Length 15 fr, 34 ins. (4.686 metres}\n| Ground Clearance 8 ins. (14,6 cm.)\nTurning Circle '36 fi, (11,892 metros)\nWeight (dry) 29. cant. (1413.2 kilogrammes)\n'Steering Ratio 17.2 :1 (3.3 turns, lock to lock}\n} IGNITION TIMING 10° betore T.0,C. at 500 rpm.\n| CONTACT GREAKER 094 ina to 019 ins. (.35 mm. to .48 mm)\nGAP\nSPARK PLUGS Champion J10Y. Gap .038 ins, (.89 mm)\nVALVE CLEARANCES Zerclash. No adjustment required\nDIL SUMP CAPACITY It is important that sump should not be filled\nabove the high level mark an the dipstick, other\nwise functioning of zerolash tappeis may be\n| impsired\n|\n|\n|",
    "checklist": [
      "Check ignition timing is set to 10° before T.D.C. at 500 rpm.",
      "Inspect and set contact breaker gap between .014 ins and .019 ins (.35 mm to .48 mm).",
      "Check spark plug gap is set to .035 ins (.89 mm) using Champion J10Y plugs.",
      "Verify oil sump level does not exceed the high level mark on the dipstick.",
      "Confirm valve clearances require no adjustment due to zerolash tappets."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "summary": "This page provides the lubrication diagram and outlines the required service checks after the first 1,000 miles of driving.",
    ...
    "checklist": [
      ...
      "Check contact breakers and adjust if necessary.",
      "Check steering and front end geometry.",
      "Check hydraulic reservoirs for fluid level.",
  ...
  },
  {
    ...
    "page": 22,
    "sourcePage": 22,
    "title": "G—20,000 MILES",
    "summary": "This page outlines scheduled maintenance tasks for the Jensen C-V8 at 20,000, 32,000, and 80,000 mile service intervals.",
    "plainEnglish": "Automatic gearbox operation, selector use, driving speeds, towing and push-start guidance.",
    "ocrText": "G—20,000 MILES\n\nGI — Sparking Plugs—Replace.\n\nG2 — Fuel Pump Inlet Fittwr-Raplace,\nH—22,000 MILES\n\nHit — Wheel Hubs—Clean and Repack.\n\n*H2 — Air Cleaner Elwnent—Replace.\n\n\"H3 — Automatic Transmission—Drain, Ratill and Adjust.\n\n\"HA — Automatic Transmission Oil Filter—Replace.\n\n\"HS — Propeller Shatt Joints—Clean and Repack,\n\n* Heavy aperating conditions only; normally no attention required.\nManual Transmission\n\n*H6 — Goarbox—Drain and Refill '\nJ—89,000 MILES:\n\n41 — Cerburettor Inlet Pipe Fuel Filter—Replace,",
    "checklist": [
      "Replace sparking plugs at 20,000 miles.",
      "Replace fuel pump inlet filter at 20,000 miles.",
      "Clean and repack wheel hubs at 32,000 miles.",
      "Replace air cleaner element at 32,000 miles under heavy operating conditions.",
      "Drain, refill, and adjust automatic transmission at 32,000 miles under heavy operating conditions.",
      "Replace automatic transmission oil filter at 32,000 miles under heavy operating conditions.",
      "Clean and repack propeller shaft joints at 32,000 miles under heavy operating conditions.",
      "Replace carburettor inlet pipe fuel filter at 80,000 miles."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "sourcePage": 29,
    "title": "Ignition",
    "summary": "This page explains the Jensen C-V8's ignition system featuring a ballast resistor and twin contact breakers, along with distributor maintenance intervals.",
    "plainEnglish": "OCR text extracted from the Mk III instruction manual for searching and editing.",
    ...
    "checklist": [
      "Add 5-10 drops of oil to the distributor oil cup every 8,000 miles.",
      "Add 2-3 drops of oil to the rotor wick every 8,000 miles.",
      "Apply a thin coating of grease to the cam and bumper block every 8,000 miles.",
      "Clean and check the contact breaker points every 8,000 miles.",
      "Block one contact breaker set with a thin strip of insulating material such as mica when setting the gap on the other.",
      "Set each contact breaker gap as if for a single unit."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "sourcePage": 37,
    "title": "G arom",
    "summary": "Brake system operation and service notes.",
    "plainEnglish": "Brake system operation and service notes.",
  ...
  },
  {
    ...
    "sourcePage": 41,
    "title": "Bodywork",
    "summary": "This page covers the operation of doors, front shroud, boot, and keys on the Jensen C-V8, including locking mechanisms and access procedures.",
    "plainEnglish": "OCR text extracted from the Mk III instruction manual for searching and editing.",
    ...
    "checklist": [
      "Unlock the small square panel at the front of the shroud using the ignition key to access the shroud release lever.",
      "Turn the shroud release lever upwards to a vertical position to release the main shroud securing pins.",
      "Pull forward the safety catch located in the air intake immediately to the right of the car centre-line before lifting the shroud.",
      "Lift the front shroud with both hands and ensure it stays open automatically in its fully open position.",
      "Verify that the small light on the underside of the shroud illuminates when opened with sidelights on.",
      "Check that the boot lid light in the forward left hand corner switches on when the boot is opened.",
      "Record the numbers of both keys on the designated page in the manual for future reference."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "page": 45,
    "sourcePage": 45,
    "title": "Cabin Heating and Ventilation Systems",
    "summary": "This page describes the operation and controls for the Jensen C-V8's cabin heating system and two independent ventilation systems.",
    "plainEnglish": "Dashboard, switchgear and instrument descriptions, including ignition, lights, wipers, gauges and warning lamps.",
    ...
    "checklist": [
      "Check that the engine has reached normal operating temperature before expecting full heater effectiveness.",
      "Operate the air cut-off control by moving the knob down to open the valve and allow air into the heater.",
      "Set the distribution control to 'INT' to direct airflow to front and rear footwells, or to 'DEMIST' to direct flow to the windscreen.",
      "Adjust the temperature control on the right side of the facia lower to set desired cabin temperature.",
      "Operate the two-speed fan switch on the facia: move halfway down for slow speed, fully down for high speed.",
      "Open the small sliding panels on each footwell exterior to enable speed-dependent ventilation from intakes below the headlights.",
      "Pull out the nozzles on the spherical facia-mounted air vents to open face-level ventilation.",
      "Operate the switch marked 'Air' on the facia to activate the booster fan for supplementing fresh air output."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "sourcePage": 49,
    "title": "Lights",
    "summary": "Index page for locating subjects in the handbook.",
    "plainEnglish": "Index page for locating subjects in the handbook.",
