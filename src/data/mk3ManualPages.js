export const mk3ManualPages = [
  ...
  },
  {
    ...
    "summary": "Owner record page for chassis, engine, key, registration and delivery details.",
  ...
  },
  {
    ...
    "sourcePage": 5,
    "title": "Foreword",
    "summary": "Introductory notes from Jensen Motors about correct operation and maintenance.",
  ...
  },
  {
    ...
    "summary": "Key Mk III dimensions, capacities, tyre pressures, tuning data and basic specifications.",
  ...
  },
  {
    ...
    "checklist": [
      "'While speeds in excess of 60 miles an hour should be avoided for",
      "not only permissible but desirable, The new car should not,",
      "High speed should always be avoided until the engine",
      "high engine speed should be avoided during early life of the new",
      "Car so that all parts will become adjusted to their position without"
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
  ...
  },
  {
    ...
    "checklist": [
      "81 — Brake and Clutch Master Cylinder Resevoirs—check and top up,",
      "— Steating Dampars—Check and Top Up.",
      "C4 — Front Shock Absorbers—inspect and Top Up,",
      "C5 — Sump—Orain and Refill,",
      "C7 — Rear Axle—Check and Top Up."
    ],
