export const mk3ManualPages = [
  {
    ...
    "summary": "This is the title page of the Jensen C-V8 Mk.III owner's handbook, introducing the manual's purpose and noting the chassis serial number location for correspondence.",
  ...
  },
  {
    ...
    "summary": "This page provides a fillable record for the owner to document key vehicle identification information including chassis number, engine number, key numbers, registration, and original delivery date.",
  ...
  },
  {
    ...
    "summary": "This page provides essential specifications for the Jensen C-V8, including chassis and engine identification locations, engine specifications, fluid capacities, gear ratios, tyre specifications, and suspension alignment data.",
    ...
    "checklist": [
      "Locate the chassis number on the plate secured to the underside of the companion box lid, on the front of the scuttle plate, or stamped on the front chassis frame cross member.",
      "Locate the engine number stamped on the left-hand bank of the cylinder block immediately forward of No. 1 cylinder.",
      "Fill the oil sump to 8.5 pints (Imp.) or 10 pints (U.S.) including filter, ensuring the dipstick top level is not exceeded.",
      "Fill the cooling system including heater to 32 pints (Imp.), 38 pints (U.S.), or 18.2 litres.",
      "Fill the automatic gearbox to 17 pints (Imp.), 20 pints (U.S.), or 9.5 litres, or the manual gearbox to 6 pints (Imp.), 7 pints (U.S.), or 3.3 litres.",
      "Fill the rear axle to 3 pints (Imp.), 3.6 pints (U.S.), or 1.705 litres.",
  ...
  },
  {
    ...
    "summary": "This page covers the engine running-in period guidelines for a new Jensen C-V8 and provides detailed instructions for starting the engine from cold.",
    ...
    "checklist": [
      "Keep close watch on the engine oil level during the running-in period.",
      "Monitor the temperature and oil pressure gauges closely, especially during early engine life.",
      "Avoid speeds in excess of 60 miles per hour for the first 300 miles of operation.",
      "Avoid operating at top speed until the car has been driven at least 500 miles.",
      "Ensure the handbrake is applied before starting the engine.",
      "Move the gear range selector lever to neutral position 'N' before starting on cars with automatic transmission.",
      "Depress the accelerator pedal slowly to one third of its travel and release before starting from cold.",
      "Give careful attention to the lubrication diagram and ensure proper lubrication at all times."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "sourcePage": 21,
    "title": "4,000 MILES",
    "summary": "This page outlines the scheduled maintenance intervals from 1,000 to 16,000 miles for the Jensen C-V8, covering lubrication points, fluid checks, and component inspections.",
  ...
  },
  {
    ...
    "summary": "This page describes the fuel system components including the tank, fuel lines, filters, mechanical pump, and Carter AFB carburettor, along with filter replacement intervals and idle speed adjustment procedures.",
    "plainEnglish": "OCR text extracted from the Mk III instruction manual for searching and editing.",
    ...
    "checklist": [
      ...
      "Turn the idle speed screw in or out to obtain 500 r.p.m.",
      "Check that the choke valve is fully open and that the fast idle adjustment screw is not contacting the fast idle cam."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
