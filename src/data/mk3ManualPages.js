export const mk3ManualPages = [
  {
    ...
    "summary": "This is the title page of the Jensen C-V8 Mk.III owners handbook, introducing the manual's purpose and providing manufacturer contact information along with instructions for locating the chassis serial number.",
  ...
  },
  {
    ...
    "sourcePage": 5,
    "title": "Foreword",
    "summary": "This foreword introduces the Jensen C-V8 handbook, emphasizing the car's quality construction and the importance of following maintenance instructions, while directing owners to authorized Jensen dealers or the factory Service Department for assistance.",
  ...
  },
  {
    ...
    "summary": "This page provides essential vehicle identification locations, engine specifications, fluid capacities, gear ratios, tyre specifications, and wheel alignment data for the Jensen C-V8.",
    ...
    "checklist": [
      "Locate the chassis number on the plate secured to the underside of the companion box lid or on the plate at the front of the scuttle.",
      "Check the chassis number stamped on the front of the chassis frame front cross member for verification.",
      "Locate the engine number stamped on the left-hand bank of the cylinder block immediately forward of No. 1 cylinder.",
      "Fill the cooling system including heater to capacity of 32 pints Imperial (38 pints U.S. / 18.2 litres).",
      "Fill the oil sump to 8½ pints Imperial (10 pints U.S. / 4.7 litres) including filter, ensuring the dipstick top level is not exceeded.",
      "Check engine oil pressure at 40/50 m.p.h. reads between 45-65 psi.",
      "Fill the automatic gearbox to 17 pints Imperial (20 pints U.S. / 9.5 litres) or manual gearbox to 6 pints Imperial (7 pints U.S. / 3.3 litres).",
      "Check tyre pressure is set to 24 PSI (1.68 kg/sq. cm.) all round."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "summary": "This page covers the engine running-in procedures for the first 500 miles and proper cold-start instructions for the Jensen C-V8.",
    ...
    "checklist": [
      "Check that speeds do not exceed 60 mph for the first 300 miles of operation.",
      "Avoid operating the car at top speed until it has been driven at least 500 miles.",
      "Monitor the engine oil level closely during the running-in period.",
      "Check the temperature and oil pressure gauges regularly during early engine life.",
      "Ensure the handbrake is applied before starting the engine.",
      "Move the gear range selector lever to neutral position 'N' before starting on automatic transmission cars.",
      "Depress the accelerator pedal slowly to one third of its travel and release before starting from cold.",
      "Push the accelerator pedal slowly to full open while operating the starter if engine floods with excess fuel."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "checklist": [
      "Replace the sparking plugs at 20,000 miles.",
      "Replace the fuel pump inlet filter at 20,000 miles.",
      "Clean and repack the wheel hubs at 32,000 miles.",
      "Replace the air cleaner element at 32,000 miles under heavy operating conditions.",
      "Drain, refill, and adjust the automatic transmission at 32,000 miles under heavy operating conditions.",
      "Replace the automatic transmission oil filter at 32,000 miles under heavy operating conditions.",
      "Clean and repack the propeller shaft joints at 32,000 miles under heavy operating conditions.",
      "Replace the carburettor inlet pipe fuel filter at 80,000 miles."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
  ...
  },
  {
    ...
    "summary": "This page describes the Jensen C-V8 fuel system components including the fuel tank, fuel lines, filters, mechanical fuel pump, and Carter AFB carburettor, with specific maintenance intervals and idle speed adjustment procedures.",
    "plainEnglish": "OCR text extracted from the Mk III instruction manual for searching and editing.",
    ...
    "checklist": [
      ...
      "Change fuel filters more frequently if dirty petrol has been used.",
      "Disconnect the carburettor to bellcrank rod on cars with automatic transmission before adjusting idle speed.",
      "Warm up the engine thoroughly and drive a minimum of five miles before making idle speed adjustments.",
      "Turn the idle speed screw in or out to obtain 500 r.p.m. while ensuring the choke valve is fully open.",
      "Verify that the fast idle adjustment screw is not contacting the fast idle cam during idle speed adjustment."
    ],
    "sourcePdf": "/manuals/jensen-cv8-mk3-instruction-manual.pdf",
    "type": "text",
    "hidden": false,
