...
export const specialists = [
  {
    ...
    social:      {
      facebook:  'https://www.facebook.com/cropredybridge',
      twitter:   'https://twitter.com/cropredybridge',
      instagram: 'https://www.instagram.com/cropredybridgecars',
    },
  ...
  {
    id:          'jensen-service',
    name:        'Jensen Service Ltd',
    types:       ['specialist', 'parts', 'restoration'],
    country:     'United Kingdom',
    countryCode: 'GB',
    region:      'Hampshire',
    city:        'Itchen Abbas',
    website:     'https://www.jensenservice.co.uk',
    phone:       null,
    email:       null,
    social:      { ebay: 'https://www.ebay.co.uk/str/jensenserviceltd' },
    logo:        '/specialists/jensen-service-logo.png',
    tagline:     'Specialist mechanics, genuine parts and bespoke trim',
    description: 'Jensen Service Ltd was founded by Director Paul Lawrence, who spent seven years sourcing and collecting genuine Jensen parts before establishing the business. Based at Abbas Business Centre in Itchen Abbas, Hampshire, they offer comprehensive support across all Jensen models including the C-V8. Their three pillars are specialist mechanics (led by auto electrical engineer Steve Clarke), a comprehensive collection of genuine Jensen parts, and bespoke trim craftsmanship using genuine Jensen forms and hand-stitched leather. Worldwide shipping available for parts and trim.',
    services:    ['Servicing & MOT prep', 'Engine rebuilds', 'Electrical rewiring', 'Genuine Jensen parts', 'Bespoke trim & upholstery', 'eBay parts shop'],
    models:      ['all'],
    featured:    true,
  },
  {
